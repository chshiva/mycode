...
/***/ function(module, exports, __webpack_require__) {
	...
	var _ref6 = _jsx(_TopMenu2.default, {
	  data: _ReportsMenu.reportsMainMenu
	});
	
	var _ref7 = _jsx(_SubMenu2.default, {
	  data: _ReportsMenu.courseReportsSubMenu
	});
	
	var _ref8 = _jsx('h2', {}, void 0, _jsx(_reactIntl.FormattedMessage, {
	  id: 'total_assignment_marks'
	}));
	...
	var _ref12 = _jsx('img', {
	  src: '/images/profile-pics/defaultStudent.jpg'
	});
	...
	var _ref15 = _jsx('h2', {}, void 0, _jsx(_reactFontawesome2.default, {
	  name: 'frown-o'
	}));
	
	var _ref16 = _jsx('p', {}, void 0, _jsx(_reactIntl.FormattedMessage, {
	  id: 'evaluation_not_yet_done'
	}));
	
	var _ref17 = _jsx(_Loading2.default, {
	  loadType: 'list'
	});
	
	var StudentAssignmentReportView = function (_Component) {
	  _inherits(StudentAssignmentReportView, _Component);
	
	  function StudentAssignmentReportView(props) {
	    _classCallCheck(this, StudentAssignmentReportView);
	
	    var _this = _possibleConstructorReturn(this, (StudentAssignmentReportView.__proto__ || Object.getPrototypeOf(StudentAssignmentReportView)).call(this, props));
	
	    _this.setdata = function (result) {
	      var assignmentId = _this.props.params.aid;
	      _this.props.dispatch((0, _ReportsActions.getStudentAssignmentResultData)(assignmentId)).then(function (res) {
	    ...
	    _this.setResponse = function (res) {
	      if (res.status) {
	        ...
	        _this.refs.room_container.error(res.error);
	        _this.setState({
	          loading: false,
	          resultData: {}
	        });
	    ...
	    _this.submenu = _Validator2.default.activeSubMenu(_ReportsMenu.courseReportsSubMenu, "linkAssignment");
	  ...
	  _createClass(StudentAssignmentReportView, [{
	    ...
	    key: 'render',
	    value: function render() {
	      var cls_text = _component2.default.txtppl + ' ' + _component2.default.txtSize;
	      var cls_button = _component2.default.resScored + ' ' + _component2.default.blue;
	      ...
	      var cls_isubmenu = _component2.default.iSubMenu + ' {componentStyles.oSubMenu}';
	      var totalMarks = 0;
	      var marksObtained = 0;
	      ...
	      return _jsx('div', {}, void 0, _react2.default.createElement(_lib.ToastContainer, {
	        ...
	        to: "/course/assignment-report-list/" + this.state.resultData.roomId
	      }, void 0, _ref4)), _ref5, _jsx('li', {}, void 0, this.state.resultData.assignmentName))), _ref6), _jsx('div', {
	        className: cls_isubmenu
	      }, void 0, _ref7), _jsx('div', {
	        className: _Admin2.default.midContainer
	      }, void 0, _jsx('div', {
	        className: _Admin2.default.whiteCard
	      }, void 0, !this.state.loading ? this.state.resultData.submissions[0].result.length > 0 ? _jsx('div', {
	        className: 'container-fluid'
	      }, void 0, _jsx('div', {
	        className: _component2.default.wrapper
	      }, void 0, _jsx(_reactBootstrap.Grid, {
	        fluid: true
	      }, void 0, _jsx(_reactBootstrap.Row, {}, void 0, _jsx(_reactBootstrap.Col, {
	        md: 7
	      }, void 0, _jsx('div', {
	        className: _component2.default.resultBox
	      }, void 0, _jsx('div', {
	        className: _component2.default.resultBlock
	      }, void 0, _jsx('div', {
	        className: _component2.default.resultHeader
	      }, void 0, _jsx('div', {
	        className: _component2.default.headingTxt
	      }, void 0, _ref8), _jsx('div', {
	        className: _component2.default.scoreBox
	      }, void 0, _jsx('div', {
	        className: _component2.default.scoreInput
	      }, void 0, _jsx('span', {
	        className: _component2.default.txtplBlue
	      }, void 0, marksObtained), ' /', _jsx('span', {}, void 0, totalMarks)))), this.state.resultData.submissions[0].result.map(function (data, i) {
	        var value = Math.floor(data.score / data.maximumMarks * 100);
	        var FieldValue = '';
	        if (value <= 100 && value > 80) {
	          cls_text = _component2.default.txtGreen + ' ' + _component2.default.txtSize;
	          FieldValue = 'Excellent';
	          cls_button = _component2.default.resScored + ' ' + _component2.default.green;
	        } else if (value <= 80 && value > 60) {
	          cls_text = _component2.default.txtBlue + ' ' + _component2.default.txtSize;
	          FieldValue = 'Good';
	          cls_button = _component2.default.resScored + ' ' + _component2.default.blue;
	        } else if (value <= 60 && value > 40) {
	          cls_text = _component2.default.txtYellow + ' ' + _component2.default.txtSize;
	          FieldValue = 'Average';
	          cls_button = _component2.default.resScored + ' ' + _component2.default.yellow;
	        } else if (value <= 40 && value > 20) {
	          cls_text = _component2.default.txtOrange + ' ' + _component2.default.txtSize;
	          FieldValue = 'Poor';
	          cls_button = _component2.default.resScored + ' ' + _component2.default.orange;
	        } else {
	          cls_text = _component2.default.txtRed + ' ' + _component2.default.txtSize;
	          FieldValue = 'Bad';
	          cls_button = _component2.default.resScored + ' ' + _component2.default.red;
	        }
	        console.log('FieldValue', FieldValue);
	        console.log('cls_text', cls_text);
	        console.log('cls_button', cls_button);
	        return _jsx('div', {
	          className: _component2.default.resultBody
	        }, i, _jsx('div', {
	          className: _component2.default.resGroup
	        }, void 0, _jsx('div', {
	          className: _component2.default.resTile
	        }, void 0, _jsx('div', {
	          className: _component2.default.resCriteria
	        }, void 0, _jsx('h4', {}, void 0, data.title)), _jsx('div', {
	          className: _component2.default.resRating
	        }, void 0, _ref9, _jsx('div', {
	          className: cls_text
	        }, void 0, FieldValue)), _jsx('div', {
	          className: cls_button
	        }, void 0, _ref10, _jsx('div', {
	          className: _component2.default.resInput
	        }, void 0, _jsx('span', {
	          className: _component2.default.activeTxt
	        }, void 0, data.score), ' /', _jsx('span', {}, void 0, data.maximumMarks))))));
	      })))), _jsx(_reactBootstrap.Col, {
	        md: 5
	      }, void 0, _jsx('div', {
	        className: _component2.default.feedbackBox
	      }, void 0, _jsx('div', {
	        className: _component2.default.fbHeader
	      }, void 0, _ref11), _jsx('div', {
	        className: _component2.default.feedbackGroup
	      }, void 0, _jsx('div', {
	        className: _component2.default.profileBox
	      }, void 0, _jsx('div', {
	        className: _component2.default.profileImg
	      }, void 0, this.state.resultData.submissions[0].evaluatedBy.profile == undefined || this.state.resultData.submissions[0].evaluatedBy.profile.profileImage == '' ? _ref12 : _jsx('img', {
	        src: "/uploads/" + this.state.resultData.submissions[0].evaluatedBy.profile.profileImage
	      })), _jsx('div', {
	        className: _component2.default.profileDetails
	      }, void 0, _jsx('span', {
	        className: 'name'
	      }, void 0, this.state.resultData.submissions[0].evaluatedBy.firstname, ' ', this.state.resultData.submissions[0].evaluatedBy.lastname), _ref13, _jsx('span', {}, void 0, this.state.resultData.submissions[0].evaluatedBy.email))), this.state.resultData.submissions[0].comment != '' && this.state.resultData.submissions[0].comment != undefined ? _jsx('div', {
	        className: _component2.default.commentBox
	      }, void 0, _ref14, _jsx('span', {
	        className: _component2.default.commentTxt
	      }, void 0, this.state.resultData.submissions[0].comment)) : null))))))) : _jsx('div', {
	        className: _DataTable2.default.noDataBox
	      }, void 0, _ref15, _ref16) : _ref17))));
	    }
	  }]);
	
	  return StudentAssignmentReportView;
	}(_react.Component);
	...
	exports.default = (0, _reactRedux.connect)(mapStateToProps)(StudentAssignmentReportView);
