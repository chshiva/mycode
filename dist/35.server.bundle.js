...
/***/ function(module, exports, __webpack_require__) {
	...
	var _ResultView = __webpack_require__(461);
	...
	var _ref10 = _jsx('li', {}, void 0, _jsx(_reactIntl.FormattedMessage, {
	  id: 'result_details'
	}));
	
	var _ref11 = _jsx(_TopMenu2.default, {
	  data: _RoomMenu.listResultMainMenu
	});
	
	var _ref12 = _jsx(_SubMenu2.default, {
	  data: _RoomMenu.viewResultSubMenu
	});
	
	var ViewResults = function (_Component) {
	  _inherits(ViewResults, _Component);
	
	  function ViewResults(props) {
	    _classCallCheck(this, ViewResults);
	
	    var _this = _possibleConstructorReturn(this, (ViewResults.__proto__ || Object.getPrototypeOf(ViewResults)).call(this, props));
	    ...
	    _this.listResults = function () {
	      var roomId = _this.props.params.rid;
	      var topicId = _this.props.params.tid;
	      var questionnaireId = _this.props.params.qid;
	      _reactRouter.browserHistory.push('/admin/room/list-results/' + roomId + '/' + topicId + '/' + questionnaireId);
	    };
	
	    _this.viewQuestionnaire = function () {
	      var roomId = _this.props.params.rid;
	      var topicId = _this.props.params.tid;
	      _reactRouter.browserHistory.push('/admin/room/questionnaire/' + topicId + '/' + roomId);
	    };
	    ...
	    _this.mainmenu = _RoomMenu.listResultMainMenu;
	    _this.schema = _RoomSchema.roomSchema;
	
	    _this.submenu = _RoomMenu.viewResultSubMenu;
	    _this.submenu.menus[0].action = _this.listResults.bind(_this);
	    return _this;
	  }
	
	  _createClass(ViewResults, [{
	    ...
	    value: function setdata(result) {
	      if (result && result.data && result.data._id) {
	        ...
	        this.props.dispatch((0, _RoomActions.getResultData)(resultId));
	      }
	    }
	  }, {
	    key: 'clear',
	    ...
	    value: function render() {
	      ...
	      }, void 0, _ref5)), _ref6, _jsx('li', {}, void 0, _jsx(_reactRouter.Link, {
	        onClick: this.viewQuestionnaire
	      }, void 0, this.props.roomData.topicdata.topicName)), _ref7, _jsx('li', {}, void 0, _jsx(_reactRouter.Link, {
	        onClick: this.listResults
	      }, void 0, _ref8)), _ref9, _ref10)), _ref11), _jsx('div', {
	        className: cls_isubmenu
	      }, void 0, _ref12), _jsx(_ResultView2.default, {
	        resultData: this.props.roomData.resultData,
	        error: this.props.roomData.error,
	...
	exports.default = (0, _reactRedux.connect)(mapStateToProps)(ViewResults);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _ref8 = _jsx('span', {}, void 0, '%');
	
	var _ref9 = _jsx('p', {}, void 0, _jsx('span', {}, void 0, _jsx(_reactIntl.FormattedMessage, {
	  id: 'no_questions_yet'
	})));
	
	var ResultView = exports.ResultView = function (_Component) {
	  ...
	  _createClass(ResultView, [{
	    ...
	    value: function viewUser() {
	      _reactRouter.browserHistory.push('/profile/' + this.props.resultData.submittedBy._id);
	    }
	  }, {
	    key: 'render',
	    value: function render() {
	      ...
	      if (this.props.resultData && this.props.resultData.questionnaireId && this.props.resultData.questionnaireId.questions) {
	        ...
	        var profileImage = resultData ? resultData.submittedBy ? resultData.submittedBy.profile ? resultData.submittedBy.profile.profileImage : '' : '' : '';
	      ...
	      return _jsx('div', {
	      ...
	      }, void 0, _ref), _jsx('h4', {}, void 0, this.props.resultData.totalMarks != 0 ? _jsx('span', {
	        className: _Dashboard2.default.marksCss
	      }, void 0, _ref2, ': ', _jsx('span', {
	        className: _Dashboard2.default.optainMarks
	      }, void 0, this.props.resultData.obtainedMarks), ' / ', _jsx('span', {}, void 0, this.props.resultData.totalMarks)) : null), _ref3), _jsx('div', {
	        className: _Dashboard2.default.resultsBlock
	      }, void 0), _jsx('div', {
	        className: _Dashboard2.default.resultsBlock
	      }, void 0, _jsx('div', {
	        className: _Dashboard2.default.resultsBody
	      }, void 0, _jsx('div', {
	        className: _Dashboard2.default.userInfoBlock
	      }, void 0, _jsx(_reactBootstrap.Row, {}, void 0, _jsx(_reactBootstrap.Col, {
	        md: 2
	      }, void 0, _jsx('div', {
	        className: _Dashboard2.default.resultsAvatar,
	        ...
	        className: _Dashboard2.default.resultsUserName
	      }, void 0, resultData ? resultData.submittedBy ? resultData.submittedBy.firstname : "-" : "-", ' ', resultData ? resultData.submittedBy ? resultData.submittedBy.lastname : "-" : "-"), _jsx('div', {
	        className: _Dashboard2.default.resCourseDtl
	      }, void 0, _jsx('span', {
	        className: _Dashboard2.default.spanNames
	      }, void 0, _ref4, ': '), _jsx('span', {}, void 0, resultData ? resultData.roomId ? resultData.roomId.roomName : "-" : "-")), _jsx('div', {
	        className: _Dashboard2.default.resCourseDtl
	      }, void 0, _jsx('span', {
	        className: _Dashboard2.default.spanNames
	      }, void 0, _ref5, ': '), _jsx('span', {}, void 0, resultData ? resultData.questionnaireId ? resultData.questionnaireId.questionnaireName : "-" : "-")))), _jsx(_reactBootstrap.Col, {
	        md: 1
	      }, void 0, _jsx('div', {
	        className: _Dashboard2.default.resultUserDetails
	      }, void 0, _jsx('h2', {
	      ...
	      }, void 0, _jsx('h2', {}, void 0, this.props.resultData.grade)))), _jsx(_reactBootstrap.Col, {
	        md: 2
	      }, void 0, _jsx('div', {
	        className: _Dashboard2.default.resultUserDetails
	      }, void 0, _jsx('h2', {
	      ...
	      }, void 0, _jsx('h2', {}, void 0, this.props.resultData.questionnairePercentage, _ref8)), _jsx('div', {
	        className: _Dashboard2.default.resultBg
	      }, void 0, _jsx('span', {
	        className: _Dashboard2.default.resultTxt
	      }, void 0, this.props.resultData.result)))))))), _jsx('div', {
	        className: _Dashboard2.default.topicsListBody
	      }, void 0, _jsx('ul', {}, void 0, resultDataQuestions ? resultDataQuestions.length > 0 ? resultDataQuestions.map(function (data, index) {
	        var indexQuestion = index;
	        if (data.questionType == "Radio") {
	          return _jsx(_MultipleChoice2.default, {
	            data: data,
	            wrong: _this2.props.resultData.wrongAns,
	            correct: _this2.props.resultData.correctAns,
	            showResult: true
	          }, indexQuestion);
	...
	exports.default = (0, _reactRedux.connect)(mapStateToProps)((0, _reactIntl.injectIntl)(ResultView));
