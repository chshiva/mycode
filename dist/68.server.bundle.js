...
/***/ function(module, exports, __webpack_require__) {
	...
	var _WorkEduView = __webpack_require__(447);
	
	var _WorkEduView2 = _interopRequireDefault(_WorkEduView);
	...
	var WorkEdu = function (_Component) {
	  _inherits(WorkEdu, _Component);
	
	  function WorkEdu() {
	    _classCallCheck(this, WorkEdu);
	
	    return _possibleConstructorReturn(this, (WorkEdu.__proto__ || Object.getPrototypeOf(WorkEdu)).apply(this, arguments));
	  }
	
	  _createClass(WorkEdu, [{
	    ...
	    value: function componentWillUnmount() {
	      this.props.dispatch((0, _ProfileActions.ClearProfile)());
	    }
	  }, {
	    key: 'render',
	    value: function render() {
	      ...
	      var submenu = _Validator2.default.activeSubMenu(_ProfileEditMenu.profileViewSubMenu, "lnkWorkEdu");
	      return _jsx('div', {
	        ...
	        data: submenu
	      })), _jsx(_WorkEduView2.default, {
	        profileData: this.props.loggedInData.data,
	        error: this.props.profile.error,
	        success: this.props.profile.success
	      }));
	    }
	  }]);
	...
	function mapStateToProps(state) {
	  return {
	    ...
	    profile: (0, _ProfileReducer.profileData)(state),
	...
	exports.default = (0, _reactRedux.connect)(mapStateToProps)(WorkEdu);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _ref13 = _jsx(_reactIntl.FormattedMessage, {
	  id: 'Please_enter_valid_To_Date'
	});
	
	var _ref14 = _jsx(_reactIntl.FormattedMessage, {
	  id: 'From_date_and_To_date_cannot_be_same'
	});
	
	var _ref15 = _jsx(_reactIntl.FormattedMessage, {
	  id: 'To_date_should_be_greater_than_From_date'
	});
	
	var _ref16 = _jsx(_reactIntl.FormattedMessage, {
	  id: 'Please_enter_School'
	});
	
	var _ref17 = _jsx(_reactIntl.FormattedMessage, {
	  id: 'School_field_cannot_have_empty_spaces'
	});
	...
	var _ref23 = _jsx(_reactIntl.FormattedMessage, {
	  id: 'Please_enter_University'
	});
	
	var _ref24 = _jsx(_reactIntl.FormattedMessage, {
	  id: 'University_field_cannot_have_empty_spaces'
	});
	...
	var _ref30 = _jsx(_reactIntl.FormattedMessage, {
	  id: 'Please_enter_atleast_one_skill'
	});
	
	var _ref31 = _jsx(_Modal.Header, {
	  closeButton: true
	}, void 0, _jsx(_Modal.Title, {}, void 0, _jsx(_reactIntl.FormattedMessage, {
	  id: 'add_workplace'
	})));
	...
	var _ref33 = _jsx(_reactIntl.FormattedMessage, {
	  id: 'work_education_position'
	});
	
	var _ref34 = _jsx('label', {
	  htmlFor: 'inputCity',
	...
	var _ref36 = _jsx('label', {
	  htmlFor: 'inputDesc',
	  className: 'control-label col-md-3'
	}, void 0, _jsx(_reactIntl.FormattedMessage, {
	  id: 'work_education_desciption'
	}), ':');
	
	var _ref37 = _jsx(_reactIntl.FormattedMessage, {
	  id: 'work_education_timeperiod'
	});
	
	var _ref38 = _jsx('label', {
	  htmlFor: 'inputCheck',
	  className: 'control-label'
	}, void 0, _jsx(_reactIntl.FormattedMessage, {
	  id: 'work_education_workStatus'
	}));
	
	var _ref39 = _jsx('label', {
	  htmlFor: 'inputTime',
	  className: 'control-label col-md-3'
	}, void 0, 'From');
	
	var _ref40 = _jsx('label', {
	  htmlFor: 'inputCheck',
	  className: 'control-label'
	}, void 0, 'To Present');
	
	var _ref41 = _jsx(_reactIntl.FormattedMessage, {
	  id: 'cancel'
	});
	...
	var _ref43 = _jsx(_reactIntl.FormattedMessage, {
	  id: 'save'
	});
	...
	var _ref45 = _jsx(_reactIntl.FormattedMessage, {
	  id: 'work_education_university'
	});
	
	var _ref46 = _jsx('label', {
	  htmlFor: 'inputCity',
	  className: 'control-label col-md-3'
	}, void 0, _jsx(_reactIntl.FormattedMessage, {
	  id: 'city_town'
	...
	var _ref49 = _jsx('label', {
	  htmlFor: 'inputCheck',
	  className: 'control-label col-md-3'
	}, void 0, ' ', _jsx(_reactIntl.FormattedMessage, {
	  id: 'work_education_graduated'
	}), ':');
	
	var _ref50 = _jsx('label', {
	  htmlFor: 'inputDesc',
	  className: 'control-label col-md-3'
	}, void 0, _jsx(_reactIntl.FormattedMessage, {
	  id: 'work_education_desciption'
	...
	var _ref51 = _jsx('label', {
	  htmlFor: 'inputCon',
	  className: 'control-label col-md-3'
	}, void 0, _jsx(_reactIntl.FormattedMessage, {
	  id: 'work_education_concentration'
	}), ':');
	...
	var _ref53 = _jsx(_reactIntl.FormattedMessage, {
	  id: 'Update'
	});
	...
	var _ref63 = _jsx(_reactIntl.FormattedMessage, {
	  id: 'Update'
	});
	...
	var _ref65 = _jsx(_reactIntl.FormattedMessage, {
	...
	var _ref68 = _jsx(_reactIntl.FormattedMessage, {
	  id: 'save'
	});
	
	var _ref69 = _jsx(_reactIntl.FormattedMessage, {
	  id: 'work_title'
	});
	
	var _ref70 = _jsx('img', {
	  src: '/images/icons/add-new-blue.png'
	});
	
	var _ref71 = _jsx(_reactIntl.FormattedMessage, {
	  id: 'add_workplace'
	});
	
	var _ref73 = _jsx('span', {}, void 0, '| ');
	...
	var _ref75 = _jsx(_reactIntl.FormattedMessage, {
	  id: 'edit'
	});
	...
	var _ref77 = _jsx(_reactIntl.FormattedMessage, {
	  id: 'professionalSkills_title'
	});
	...
	var _ref79 = _jsx(_reactIntl.FormattedMessage, {
	  id: 'add_professionalSkills'
	});
	...
	var _ref81 = _jsx(_reactIntl.FormattedMessage, {
	  id: 'edit'
	});
	...
	var _ref83 = _jsx(_reactIntl.FormattedMessage, {
	  id: 'college_title'
	});
	...
	var _ref88 = _jsx(_reactIntl.FormattedMessage, {
	  id: 'edit'
	});
	...
	var _ref90 = _jsx(_reactIntl.FormattedMessage, {
	  id: 'highSchool_title'
	});
	...
	var _ref94 = _jsx(_reactIntl.FormattedMessage, {
	  id: 'edit'
	});
	...
	var WorkEduView = exports.WorkEduView = function (_Component) {
	  _inherits(WorkEduView, _Component);
	
	  function WorkEduView(props) {
	    _classCallCheck(this, WorkEduView);
	
	    var _this = _possibleConstructorReturn(this, (WorkEduView.__proto__ || Object.getPrototypeOf(WorkEduView)).call(this, props));
	
	    _this.createWorkPlace = function (e) {
	      e.preventDefault();
	      var ipstime, ipetime;
	      if (_this.state.inputFromYear != false && _this.state.inputToYear != false) {
	        ipstime = (0, _moment2.default)(_this.state.yearFrom, "DD/MM/YYYY");
	        ipetime = (0, _moment2.default)(_this.state.yearTo, "DD/MM/YYYY");
	      } else if (_this.state.inputFromYear != false) {
	        ipstime = (0, _moment2.default)(_this.state.yearFrom, "DD/MM/YYYY");
	      } else if (_this.state.inputToYear != false) {
	        ipetime = (0, _moment2.default)(_this.state.yearTo, "DD/MM/YYYY");
	      }
	
	      var now = (0, _moment2.default)();
	      var errors = {};
	      if (_this.state.checkWork) {
	        if (_this.state.company == '' || _this.validCompanyStatus) errors['companyError'] = _ref;
	        if (_this.validPositionStatus || _this.state.position == '') errors['positionError'] = _ref2;
	        if (_this.validCountryStatus == false) {
	          errors['countryError'] = _ref3;
	        }
	        if (_this.validCityStatus == false) {
	          errors['cityError'] = _ref4;
	          _this.refs.city.focus();
	        }
	        if (_this.state.inputFromYear == false) errors['startDateError'] = _ref5;
	        if (+ipstime > +now) errors['startDateError'] = _ref6;
	        if (!_.isEmpty(errors)) {
	          _this.setState({ validationError: errors });
	        } else {
	          var workplaceObj = {
	            company: _this.state.company.trim(),
	            position: _this.state.position.trim(),
	            city: _this.state.city.trim(),
	            country: _this.state.country.trim(),
	            description: _this.state.desc.trim(),
	            yearFrom: (0, _moment2.default)(_this.state.yearFrom, "DD/MM/YYYY").utc().toDate(),
	            yearTo: '',
	            present: true
	          };
	          ...
	          _this.props.dispatch((0, _ProfileActions.createWorkPlaceRequest)({ workplaceObj: workplaceObj, userID: userID, companyID: companyID }));
	        }
	      } else {
	        if (_this.state.company == '' || _this.validCompanyStatus) errors['companyError'] = _ref7;
	        if (_this.validPositionStatus || _this.state.position == '') errors['positionError'] = _ref8;
	        if (_this.validCountryStatus == false) {
	          errors['countryError'] = _ref9;
	        }
	        if (_this.validCityStatus == false) {
	          errors['cityError'] = _ref10;
	          _this.refs.city.focus();
	        }
	        if (_this.state.inputFromYear == false) errors['startDateError'] = _ref11;else if (+ipstime > +now) errors['startDateError'] = _ref12;
	        if (_this.state.inputToYear == false) errors['endDateError'] = _ref13;else if (+ipstime == +ipetime) errors['endDateError'] = _ref14;else if (+ipstime > +ipetime) errors['endDateError'] = _ref15;
	        if (!_.isEmpty(errors)) {
	          _this.setState({ validationError: errors });
	        } else {
	          _this.setState({ validationError: {} });
	          var workplaceObj = {
	            company: _this.state.company.trim(),
	            position: _this.state.position.trim(),
	            city: _this.state.city.trim(),
	            ...
	            description: _this.state.desc.trim(),
	            yearFrom: (0, _moment2.default)(_this.state.yearFrom, "DD/MM/YYYY").utc().toDate(),
	            yearTo: (0, _moment2.default)(_this.state.yearTo, "DD/MM/YYYY").utc().toDate()
	          };
	
	          var _userID = _this.props.loggedInData.data._id;
	          var _companyID = _this.state.companyID;
	
	          _this.props.dispatch((0, _ProfileActions.createWorkPlaceRequest)({ workplaceObj: workplaceObj, userID: _userID, companyID: _companyID }));
	        }
	      }
	    };
	
	    _this.saveSchool = function (e) {
	      e.preventDefault();
	      var ipstime, ipetime;
	      if (_this.state.inputFromYear != false && _this.state.inputToYear != false) {
	        ipstime = (0, _moment2.default)(_this.state.yearFrom, "DD/MM/YYYY");
	      ...
	      var now = (0, _moment2.default)();
	      var errors = {};
	      if (_this.state.school == '') {
	        errors['schoolError'] = _ref16;
	        _this.refs.school.focus();
	      }if (_this.validSchoolStatus) {
	        errors['schoolError'] = _ref17;
	        _this.refs.school.focus();
	      }if (_this.state.inputFromYear == false) {
	        errors['startDateError'] = _ref18;
	      }
	      if (_this.state.inputToYear == false) {
	        errors['endDateError'] = _ref19;
	      } else if (+ipstime > +now) {
	        errors['endDateError'] = _ref20;
	      } else if (+ipstime == +ipetime) {
	        errors['endDateError'] = _ref21;
	      } else if (+ipstime > +ipetime) {
	        errors['endDateError'] = _ref22;
	      }
	      if (!_.isEmpty(errors)) {
	        _this.setState({
	        ...
	        var schoolObj = {
	          school: _this.state.school.trim(),
	          city: _this.state.city.trim(),
	          country: _this.state.country.trim(),
	          description: _this.state.schoolDesc.trim(),
	          graduated: _this.state.checkGraduated,
	          yearFrom: (0, _moment2.default)(_this.state.yearFrom, "DD/MM/YYYY").utc().toDate(),
	          yearTo: (0, _moment2.default)(_this.state.yearTo, "DD/MM/YYYY").utc().toDate()
	        };
	
	        _this.props.dispatch((0, _ProfileActions.createSchoolRequest)(schoolObj));
	      }
	    };
	
	    _this.createCollege = function (e) {
	      e.preventDefault();
	      ...
	      var now = (0, _moment2.default)();
	      var errors = {};
	      if (_this.state.university == '') {
	        errors['universityError'] = _ref23;
	        _this.refs.university.focus();
	      }if (_this.validUniversityStatus) {
	        errors['universityError'] = _ref24;
	        _this.refs.university.focus();
	      }if (_this.state.inputFromYear == false) {
	        errors['startDateError'] = _ref25;
	      }
	      if (_this.state.inputToYear == false) {
	        errors['endDateError'] = _ref26;
	      } else if (+ipstime > +now) {
	        errors['endDateError'] = _ref27;
	      } else if (+ipstime == +ipetime) {
	        errors['endDateError'] = _ref28;
	      } else if (+ipstime > +ipetime) {
	        errors['endDateError'] = _ref29;
	      }
	      if (!_.isEmpty(errors)) {
	        _this.setState({
	          validationError: errors
	        ...
	        var collegeObj = {
	          university: _this.state.university.trim(),
	          city: _this.state.city.trim(),
	          country: _this.state.country.trim(),
	          description: _this.state.desc.trim(),
	          concentration: _this.state.conc.trim(),
	          yearFrom: (0, _moment2.default)(_this.state.yearFrom, "DD/MM/YYYY").utc().toDate(),
	          yearTo: (0, _moment2.default)(_this.state.yearTo, "DD/MM/YYYY").utc().toDate(),
	          graduated: _this.state.checkGraduated
	        };
	        ...
	        var userID = _this.props.loggedInData.data._id;
	        var universityID = _this.state.universityID;
	
	        _this.props.dispatch((0, _ProfileActions.createCollegeRequest)({ collegeObj: collegeObj, userID: userID, universityID: universityID }));
	      }
	    };
	    ...
	    _this.handleKeyPress = function (e) {
	      ...
	      if (e.key === 'Enter' || e.key === ',') {
	        ...
	        if (skill != '') {
	          var skills = _this.state.skillList;
	          skills.push(skill);
	          _this.setState({ skillList: skills, value: '', error: '' });
	        } else {
	          _this.setState({ error: 'Please enter the skills' });
	        }
	        e.preventDefault();
	      }
	    };
	
	    _this.removeskill = function (e) {
	      var skills = _this.state.skillList;
	      var index = skills.indexOf(e.target.id);
	      if (index > -1) {
	        skills.splice(index, 1);
	      }
	      _this.setState({ skillList: skills });
	      _this.props.dispatch((0, _LoginActions.isLoggedIn)(_AuthController2.default.getSession(), '/admin/profile/workedu'));
	    };
	
	    _this.validCompanyStatus = false;
	    _this.validPositionStatus = false;
	    _this.validCityStatus = null;
	    _this.validCountryStatus = null;
	    _this.validUniversityStatus = false;
	    _this.validSchoolStatus = false;
	    _this.state = {
	      ...
	      error: '',
	      workDropdownCss: '' + _WorkEdu2.default.moreDropDown,
	      profDropdownCss: '' + _WorkEdu2.default.moreDropDown,
	      collegeDropdownCss: '' + _WorkEdu2.default.moreDropDown,
	      schoolDropdownCss: '' + _WorkEdu2.default.moreDropDown,
	      checkWork: false,
	      ...
	      value: '',
	      divValue: '',
	      yearFrom: (0, _moment2.default)().format('DD/MM/YYYY'),
	      yearFromFormat: "DD/MM/YYYY",
	      yearFromInputFormat: "DD/MM/YYYY",
	      yearFromMode: "date",
	      yearTo: (0, _moment2.default)().format('DD/MM/YYYY'),
	  ...
	  _createClass(WorkEduView, [{
	    ...
	    value: function setdata(result) {
	      if (result && result.data && result.data._id) {
	        ...
	        this.props.dispatch((0, _ProfileActions.getWorkEduDataRequest)() /*{ userID }*/);
	      }
	    }
	  }, {
	    key: 'myHandler',
	    value: function myHandler() {
	      if (this.state.workDropdownCss == _WorkEdu2.default.moreDropDown + ' ' + _WorkEdu2.default.slideDown || this.state.collegeDropdownCss == _WorkEdu2.default.moreDropDown + ' ' + _WorkEdu2.default.slideDown || this.state.schoolDropdownCss == _WorkEdu2.default.moreDropDown + ' ' + _WorkEdu2.default.slideDown || this.state.profDropdownCss == _WorkEdu2.default.moreDropDown + ' ' + _WorkEdu2.default.slideDown) {
	        this.setState({
	          workDropdownCss: '' + _WorkEdu2.default.moreDropDown,
	          collegeDropdownCss: '' + _WorkEdu2.default.moreDropDown,
	          schoolDropdownCss: '' + _WorkEdu2.default.moreDropDown,
	    ...
	    key: 'handleWorkPlace',
	    value: function handleWorkPlace() {
	      this.setState({
	        showAddWorkPlaceModal: true
	      });
	    }
	  }, {
	    key: 'hideAddWorkPlaceModal',
	    value: function hideAddWorkPlaceModal() {
	      this.setState({
	        showAddWorkPlaceModal: false,
	        showAddCollegeModal: false,
	        showAddHighSchoolModal: false,
	    ...
	    key: 'handleCollege',
	    value: function handleCollege() {
	      this.setState({
	        showAddCollegeModal: true
	      });
	    }
	  }, {
	    key: 'hideAddCollegeModal',
	    value: function hideAddCollegeModal() {
	      this.setState({
	        showAddWorkPlaceModal: false,
	        showAddCollegeModal: false,
	        showAddHighSchoolModal: false,
	    ...
	    key: 'handleHighSchool',
	    value: function handleHighSchool() {
	      this.setState({
	        showAddHighSchoolModal: true
	      });
	    }
	  }, {
	    key: 'hideAddHighSchoolModal',
	    value: function hideAddHighSchoolModal() {
	      this.setState({
	        showAddWorkPlaceModal: false,
	        showAddCollegeModal: false,
	        showAddHighSchoolModal: false,
	    ...
	    key: 'handleSchoolEdit',
	    value: function handleSchoolEdit() {
	      ...
	      this.setState({
	        ...
	        yearFrom: (0, _moment2.default)(schoolObj.yearFrom).format("DD/MM/YYYY"),
	        yearTo: (0, _moment2.default)(schoolObj.yearTo).format("DD/MM/YYYY"),
	        checkGraduated: schoolObj.graduated
	      });
	    }
	  }, {
	    key: 'handleSchoolDelete',
	    value: function handleSchoolDelete() {
	      var userID = this.props.loggedInData.data._id;
	      var props = this.props;
	      alertify.confirm(this.props.intl.messages.warning, this.props.intl.messages.delete_school_alert, function (result) {
	        if (result) {
	          props.dispatch((0, _ProfileActions.deleteSchoolRequest)());
	        }
	      }, function () {}).setting('labels', { 'ok': this.props.intl.messages.ok, 'cancel': this.props.intl.messages.cancel });;
	    }
	  }, {
	    key: 'handleWorkDropdown',
	    value: function handleWorkDropdown(val, e) {
	      e.stopPropagation();
	      if (this.state.workDropdownCss == _WorkEdu2.default.moreDropDown + ' ' + _WorkEdu2.default.slideDown) {
	        this.setState({
	          workDropdownCss: '' + _WorkEdu2.default.moreDropDown
	        });
	      } else if (this.state.workDropdownCss == '' + _WorkEdu2.default.moreDropDown) {
	        this.setState({
	          companyID: val,
	          workDropdownCss: _WorkEdu2.default.moreDropDown + ' ' + _WorkEdu2.default.slideDown
	        });
	      }
	    }
	  }, {
	    key: 'handleProfDropdown',
	    value: function handleProfDropdown(e) {
	      e.stopPropagation();
	      if (this.state.profDropdownCss == _WorkEdu2.default.moreDropDown + ' ' + _WorkEdu2.default.slideDown) {
	        this.setState({
	          profDropdownCss: '' + _WorkEdu2.default.moreDropDown,
	          showProfessionalUpdate: true
	        });
	      } else if (this.state.profDropdownCss == '' + _WorkEdu2.default.moreDropDown) {
	        this.setState({
	          profDropdownCss: _WorkEdu2.default.moreDropDown + ' ' + _WorkEdu2.default.slideDown,
	          showProfessionalUpdate: true
	        });
	      }
	    }
	  }, {
	    key: 'handleCollegeDropdown',
	    value: function handleCollegeDropdown(val, e) {
	      e.stopPropagation();
	      if (this.state.collegeDropdownCss == _WorkEdu2.default.moreDropDown + ' ' + _WorkEdu2.default.slideDown) {
	        this.setState({
	          collegeDropdownCss: '' + _WorkEdu2.default.moreDropDown,
	          showCollegeUpdate: true
	        });
	      } else if (this.state.collegeDropdownCss == '' + _WorkEdu2.default.moreDropDown) {
	        this.setState({
	          universityID: val,
	          collegeDropdownCss: _WorkEdu2.default.moreDropDown + ' ' + _WorkEdu2.default.slideDown,
	          showCollegeUpdate: true
	        });
	      }
	    }
	  }, {
	    key: 'handleSchoolDropdown',
	    value: function handleSchoolDropdown(e) {
	      e.stopPropagation();
	      if (this.state.schoolDropdownCss == _WorkEdu2.default.moreDropDown + ' ' + _WorkEdu2.default.slideDown) {
	        this.setState({
	          schoolDropdownCss: '' + _WorkEdu2.default.moreDropDown,
	          showSchoolUpdate: true
	        });
	      } else if (this.state.schoolDropdownCss == '' + _WorkEdu2.default.moreDropDown) {
	        this.setState({
	          schoolDropdownCss: _WorkEdu2.default.moreDropDown + ' ' + _WorkEdu2.default.slideDown,
	          showSchoolUpdate: true
	        });
	      }
	    }
	    ...
	    value: function handleProfessional() {
	      this.setState({
	        showAddProfessionalBlock: true
	      });
	    }
	  }, {
	    key: 'cancelProfessional',
	    value: function cancelProfessional(e) {
	      e.preventDefault();
	      this.setState({
	        showAddProfessionalBlock: false,
	        value: '',
	      ...
	      this.props.dispatch((0, _LoginActions.isLoggedIn)(_AuthController2.default.getSession(), '/admin/profile/workedu'));
	    }
	  }, {
	    key: 'handleCheck',
	    value: function handleCheck() {
	      ...
	      this.setState(function (prevState) {
	        return {
	          //   // flip boolean value
	          checkWork: !_this2.state.checkWork,
	          validationError: _extends({}, prevState.validationError, {
	    ...
	    key: 'handleGraduated',
	    value: function handleGraduated() {
	      this.setState({
	    ...
	    key: 'handleCompany',
	    value: function handleCompany(event) {
	    ...
	    value: function handlePosition(event) {
	      var val = _.startCase(_.toLower(event.target.value));
	    ...
	    key: 'handleDesc',
	    value: function handleDesc(event) {
	    ...
	    key: 'handleYearFrom',
	    value: function handleYearFrom(newYear) {
	      (0, _moment2.default)(newYear, "DD/MM/YYYY").isValid() ? this.setState({
	        yearFrom: newYear,
	        inputFromYear: null
	    ...
	    key: 'handleYearTo',
	    value: function handleYearTo(newYear) {
	      (0, _moment2.default)(newYear, "DD/MM/YYYY").isValid() ? this.setState({
	        yearTo: newYear,
	        inputToYear: null
	    ...
	    key: 'handleUniversity',
	    value: function handleUniversity(event) {
	      this.setState({ university: event.target.value });
	      this.validUniversityStatus = this.validateSpace(event.target.value);
	    }
	  }, {
	    key: 'handleConc',
	    value: function handleConc(event) {
	        ...
	        if (this.props.profile.workeduData.experience.workplace[i]._id == val) {
	          ...
	          if (data.yearTo == null && data.present == true) {
	            this.setState({
	              ...
	              yearFrom: (0, _moment2.default)(data.yearFrom).format("DD/MM/YYYY"),
	              checkWork: true,
	              companyID: val,
	              showWorkUpdate: true
	            });
	            ...
	            this.setState({
	              ...
	              desc: data.description,
	              yearFrom: (0, _moment2.default)(data.yearFrom).format("DD/MM/YYYY"),
	              yearTo: (0, _moment2.default)(data.yearTo).format("DD/MM/YYYY"),
	              companyID: val,
	              showWorkUpdate: true
	            });
	          }
	    ...
	    value: function handleDeleteWork(workId) {
	      var userID = this.props.loggedInData.data._id;
	      var props = this.props;
	      alertify.confirm(this.props.intl.messages.warning, this.props.intl.messages.delete_workplace_alert, function (result) {
	        if (result) {
	          props.dispatch((0, _ProfileActions.deleteWorkPlaceRequest)({ workId: workId /*, userID*/ }));
	        }
	      }, function () {}).setting('labels', { 'ok': this.props.intl.messages.ok, 'cancel': this.props.intl.messages.cancel });;
	    }
	  }, {
	    key: 'handleEditCollege',
	    value: function handleEditCollege(val) {
	    ...
	    key: 'handleDeleteCollege',
	    value: function handleDeleteCollege(collegeId) {
	      var userID = this.props.loggedInData.data._id;
	      var props = this.props;
	      alertify.confirm(this.props.intl.messages.warning, this.props.intl.messages.delete_college_alert, function (result) {
	        if (result) {
	          props.dispatch((0, _ProfileActions.deleteCollegeRequest)({ collegeId: collegeId /*, userID*/ }));
	        }
	      }, function () {}).setting('labels', { 'ok': this.props.intl.messages.ok, 'cancel': this.props.intl.messages.cancel });;
	    }
	  }, {
	    key: 'saveSkills',
	    value: function saveSkills(e) {
	      // console.log('saveSkills', e);
	      e.preventDefault();
	      var errors = {};
	      if (this.state.skillList.length <= 0) {
	        errors['skillError'] = _ref30;
	        this.setState({ validationError: errors });
	      } else {
	        this.setState({ validationError: {} });
	        var skills = this.state.skillList;
	        var userID = this.props.loggedInData.data._id;
	        this.props.dispatch((0, _ProfileActions.saveSkillsRequest)(skills));
	      }
	    }
	  }, {
	    key: 'handleEditSkill',
	    value: function handleEditSkill(e) {
	      this.setState({
	        showAddProfessionalBlock: true,
	        skillList: this.props.loggedInData.data.profile.experience.professionalSkills,
	        divValue: 'hidden'
	    ...
	    value: function handleDeleteSkill(e) {
	      var userID = this.props.loggedInData.data._id;
	      var props = this.props;
	      alertify.confirm(this.props.intl.messages.warning, this.props.intl.messages.delete_professional_alert, function (result) {
	        if (result) {
	          props.dispatch((0, _ProfileActions.deleteAllSkillRequest)());
	        }
	      }, function () {}).setting('labels', { 'ok': this.props.intl.messages.ok, 'cancel': this.props.intl.messages.cancel });;
	    }
	  }, {
	    ...
	    value: function render() {
	      ...
	      var addInfoBlock = _WorkEdu2.default.addInfoBlock + ' clearfix';
	      var iconBox = _WorkEdu2.default.iconBox + ' pull-left';
	      var addCategoryTxtBox = _WorkEdu2.default.addCategoryTxtBox + ' pull-left';
	      var displayInfoBlock = _WorkEdu2.default.displayInfoBlock + ' clearfix';
	      var informationBox = _WorkEdu2.default.informationBox + ' pull-left';
	      var moreInfoBlock = _WorkEdu2.default.moreInfoBlock + ' pull-right';
	      ...
	      var cls_btnSaveChanges = _WorkEdu2.default.btnSpace + ' btn btn-primary';
	      var cls_btnCancle = _WorkEdu2.default.btnSpace + ' btn btn-default';
	      var cls_toMarginLabelAll = _Dashboard2.default.toMarginLabel + ' control-label col-md-1 ';
	      var cls_workingCheckbox = _Dashboard2.default.workingCheck + ' col-md-1 ';
	      var cls_checkAfterLabel = _Dashboard2.default.checkAfter + ' col-md-1 ';
	      var cls_btnSaveEdit = ' ' + _Admin2.default.btnSaveAssign + ' ';
	      var cls_btnSaveEdit2 = ' ' + _Admin2.default.btnSaveAssign2 + ' ';
	
	      var skills = '';
	      if (this.state.skillList) {
	        if (this.state.skillList.length > 0) {
	          var docs = this.state.skillList;
	          var count = 10;
	          skills = docs.map(function (doc) {
	            return _jsx('div', {
	              className: cls_vr
	            }, count++, _jsx('span', {
	              className: cls_email
	              ...
	              className: cls_vm,
	              id: doc,
	              onClick: _this3.removeskill.bind(_this3)
	            })), _jsx('input', {
	              name: 'to',
	              type: 'hidden',
	              value: doc
	      ...
	      var _state = this.state,
	          yearFrom = _state.yearFrom,
	          yearFromFormat = _state.yearFromFormat,
	          yearFromInputFormat = _state.yearFromInputFormat,
	          yearFromMode = _state.yearFromMode,
	          yearFromViewMode = _state.yearFromViewMode,
	          yearTo = _state.yearTo,
	          maxDate = _state.maxDate;
	
	
	      var showAddWorkPlaceModal = this.state.showAddWorkPlaceModal ? _jsx(_reactBootstrap.Modal, {
	        show: this.state.showAddWorkPlaceModal,
	        onHide: this.hideAddWorkPlaceModal.bind(this)
	      }, void 0, _ref31, _jsx(_Modal.Body, {}, void 0, _jsx('form', {
	        ...
	        className: 'control-label col-md-3'
	      }, void 0, _ref32, _jsx('span', {
	        className: _component2.default.mandatory
	      }, void 0, '*'), ':'), _jsx('div', {
	        className: 'col-md-9'
	      }, void 0, _react2.default.createElement('input', { id: 'company', type: 'text', className: 'form-control', style: this.state.validationError && this.state.validationError.companyError ? { borderColor: "#ff0000" } : {}, placeholder: this.props.intl.messages.work_company_placeholder, value: this.state.company, onChange: this.handleCompany.bind(this), ref: 'company', maxLength: 50, autoFocus: 'true' }), _jsx('label', {
	        id: 'companyError',
	        className: _component2.default.errorPre
	      }, void 0, this.state.validationError && this.state.validationError.companyError ? this.state.validationError.companyError : ''))), _jsx('div', {
	        className: 'form-group'
	      }, void 0, _jsx('label', {
	        htmlFor: 'inputPosition',
	        className: 'control-label col-md-3'
	      }, void 0, _ref33, _jsx('span', {
	        className: _component2.default.mandatory
	      }, void 0, '*'), ':'), _jsx('div', {
	        className: 'col-md-9'
	      }, void 0, _react2.default.createElement('input', { id: 'position', type: 'text', className: 'form-control', style: this.state.validationError && this.state.validationError.positionError ? { borderColor: "#ff0000" } : {}, placeholder: this.props.intl.messages.work_position_placeholder, value: this.state.position, onChange: this.handlePosition.bind(this), ref: 'position', maxLength: 30 }), _jsx('label', {
	        id: 'positionError',
	        className: _component2.default.errorPre
	      }, void 0, this.state.validationError && this.state.validationError.positionError ? this.state.validationError.positionError : ''))), _jsx('div', {
	        className: 'form-group'
	      }, void 0, _ref34, _jsx('div', {
	        className: 'col-md-9'
	      }, void 0, _react2.default.createElement('input', { id: 'city', type: 'text', className: 'form-control', value: this.state.city, style: this.state.validationError && this.state.validationError.cityError ? { borderColor: "#ff0000" } : {}, onChange: this.handleCity.bind(this), ref: 'city', maxLength: 20 }), _jsx('label', {
	        id: 'cityError',
	        className: _component2.default.errorPre
	        ...
	        className: 'col-md-9'
	      }, void 0, _react2.default.createElement('input', { id: 'country', type: 'text', className: 'form-control', value: this.state.country, style: this.state.validationError && this.state.validationError.countryError ? { borderColor: "#ff0000" } : {}, onChange: this.handleCountry.bind(this), ref: 'country', maxLength: 20 }), _jsx('label', {
	        id: 'countryError',
	        className: _component2.default.errorPre
	      }, void 0, this.state.validationError && this.state.validationError.countryError ? this.state.validationError.countryError : ''))), _jsx('div', {
	        className: 'form-group'
	      }, void 0, _ref36, _jsx('div', {
	        className: 'col-md-9'
	      }, void 0, _react2.default.createElement('textarea', { id: 'desc', className: 'form-control', value: this.state.desc, onChange: this.handleDesc.bind(this), ref: 'desc', maxLength: 150 }))), _jsx('div', {
	        className: 'form-group'
	      }, void 0, _jsx('label', {
	        htmlFor: 'inputTime',
	        className: 'control-label col-md-3'
	      }, void 0, _ref37, _jsx('span', {
	        className: _component2.default.mandatory
	      }, void 0, '*'), ':'), _jsx('div', {
	        className: 'col-md-9'
	      }, void 0, _jsx('input', {
	        id: 'workCheck',
	        type: 'checkbox',
	        className: cls_workingCheckbox,
	        checked: this.state.checkWork,
	        ...
	        id: 'fromError',
	        className: _component2.default.errorPre
	      }, void 0, this.state.validationError && this.state.validationError.startDateError ? this.state.validationError.startDateError : '')), this.state.checkWork ? _ref40 : _jsx('div', {}, void 0, _jsx('label', {
	        className: cls_toMarginLabelAll
	      }, void 0, 'To'), _jsx('div', {
	        id: 'toDate',
	        className: 'col-md-4'
	      }, void 0, _jsx(_reactBootstrapDatetimepicker2.default, {
	        ...
	        id: 'toError',
	        className: _component2.default.errorPre
	      }, void 0, this.state.validationError && this.state.validationError.endDateError ? this.state.validationError.endDateError : '')))))), _jsx(_Modal.Footer, {
	        className: _Admin2.default.mainSaveAssign
	      }, void 0, _jsx('div', {
	        className: _Admin2.default.errorSaveAssign
	      }, void 0, _jsx('label', {
	        id: 'Error',
	        className: _WorkEdu2.default.error
	      }, void 0, this.state.error)), _jsx('div', {
	        className: _Admin2.default.blockSaveAssign
	      }, void 0, _jsx('button', {
	        id: 'workCancelBtn',
	        onClick: this.hideAddWorkPlaceModal.bind(this)
	      }, void 0, _ref41), _jsx('button', {
	        id: 'workSaveBtn',
	        className: cls_btnSaveEdit,
	        onClick: this.createWorkPlace
	      }, void 0, this.state.showWorkUpdate == true ? _ref42 : _ref43)))) : null;
	
	      var showAddCollegeModal = this.state.showAddCollegeModal ? _jsx(_reactBootstrap.Modal, {
	        show: this.state.showAddCollegeModal,
	        onHide: this.hideAddCollegeModal.bind(this)
	      }, void 0, _jsx(_Modal.Header, {
	        closeButton: true
	      }, void 0, _jsx(_Modal.Title, {
	        className: _Admin2.default.popHeadingAll
	      }, void 0, _ref44)), _jsx(_Modal.Body, {}, void 0, _jsx('form', {
	        className: 'form-horizontal'
	      }, void 0, _jsx('div', {
	        className: 'form-group'
	      }, void 0, _jsx('label', {
	        htmlFor: 'inputUniversity',
	        className: 'control-label col-md-3'
	      }, void 0, _ref45, _jsx('span', {
	        className: _component2.default.mandatory
	      }, void 0, '*'), ':'), _jsx('div', {
	        className: 'col-md-9'
	      }, void 0, _react2.default.createElement('input', { id: 'university', type: 'text', className: 'form-control', style: this.state.validationError && this.state.validationError.universityError ? { borderColor: "#ff0000" } : {},
	        placeholder: this.props.intl.messages.college_university_placeholder, value: this.state.university, onChange: this.handleUniversity.bind(this), ref: 'university', maxLength: 50, autoFocus: 'true' }), _jsx('label', {
	        id: 'universityError',
	        className: _component2.default.errorPre
	      }, void 0, this.state.validationError && this.state.validationError.universityError ? this.state.validationError.universityError : ''))), _jsx('div', {
	        className: 'form-group'
	      }, void 0, _ref46, _jsx('div', {
	        className: 'col-md-9'
	      }, void 0, _react2.default.createElement('input', { id: 'city', type: 'text', className: 'form-control', value: this.state.city, onChange: this.handleCity.bind(this), ref: 'city', maxLength: 20 }))), _jsx('div', {
	        className: 'form-group'
	      }, void 0, _ref47, _jsx('div', {
	        className: 'col-md-9'
	      }, void 0, _react2.default.createElement('input', { id: 'country', type: 'text', className: 'form-control', value: this.state.country, onChange: this.handleCountry.bind(this), ref: 'country', maxLength: 20 }))), _jsx('div', {
	        className: 'form-group '
	      }, void 0, _jsx('label', {
	        htmlFor: 'inputTime',
	        className: 'control-label col-md-3'
	      }, void 0, _ref48, _jsx('span', {
	        className: _component2.default.mandatory
	      }, void 0, '*'), ':'), _jsx('div', {
	        id: 'fromDate',
	        className: 'col-md-4'
	        ...
	        id: 'fromError',
	        className: _component2.default.errorPre
	      }, void 0, this.state.validationError && this.state.validationError.startDateError ? this.state.validationError.startDateError : '')), _jsx('label', {
	        className: cls_toMarginLabelAll
	      }, void 0, 'to'), _jsx('div', {
	        id: 'toDate',
	        className: 'col-md-4'
	        ...
	        id: 'toError',
	        className: _component2.default.errorPre
	      }, void 0, this.state.validationError && this.state.validationError.endDateError ? this.state.validationError.endDateError : ''))), _jsx('div', {
	        className: 'form-group'
	      }, void 0, _ref49, '\xA0', _jsx('input', {
	        id: 'checkGraduated',
	        type: 'checkbox',
	        className: cls_checkAfterLabel,
	        checked: this.state.checkGraduated,
	        onChange: this.handleGraduated.bind(this)
	      })), _jsx('div', {
	        className: 'form-group'
	      }, void 0, _ref50, _jsx('div', {
	        className: 'col-md-9'
	      }, void 0, _react2.default.createElement('textarea', { id: 'desc', className: 'form-control', value: this.state.desc, onChange: this.handleDesc.bind(this), ref: 'desc', maxLength: 150 }))), _jsx('div', {
	        className: 'form-group'
	      }, void 0, _ref51, _jsx('div', {
	        className: 'col-md-9'
	      }, void 0, _react2.default.createElement('input', { id: 'conc', type: 'text', className: 'form-control', value: this.state.conc, onChange: this.handleConc.bind(this), ref: 'conc', maxLength: 30 }))))), _jsx(_Modal.Footer, {
	        className: _Admin2.default.mainSaveAssign
	      }, void 0, _jsx('div', {
	        className: _Admin2.default.errorSaveAssign
	      }, void 0, _jsx('label', {
	        ...
	        id: 'collegeCancelBtn',
	        onClick: this.hideAddCollegeModal.bind(this)
	      }, void 0, _ref52), _jsx('button', {
	        id: 'collegeSaveBtn',
	        className: cls_btnSaveEdit,
	        onClick: this.createCollege
	      }, void 0, this.state.showCollegeUpdate == true ? _ref53 : _ref54)))) : null;
	
	      var showAddHighSchoolModal = this.state.showAddHighSchoolModal ? _jsx(_reactBootstrap.Modal, {
	        show: this.state.showAddHighSchoolModal,
	        onHide: this.hideAddHighSchoolModal.bind(this)
	      }, void 0, _ref55, _jsx(_Modal.Body, {}, void 0, _jsx('form', {
	        className: 'form-horizontal'
	      }, void 0, _jsx('div', {
	        className: 'form-group'
	      }, void 0, _jsx('label', {
	        htmlFor: 'inputSchool',
	        className: 'control-label col-md-3'
	      }, void 0, _ref56, _jsx('span', {
	        className: _component2.default.mandatory
	      }, void 0, '*'), ':'), _jsx('div', {
	        className: 'col-md-9'
	      }, void 0, _react2.default.createElement('input', (_React$createElement = { id: 'school', type: 'text', className: 'form-control', style: this.state.validationError && this.state.validationError.schoolError ? { borderColor: "red" } : {}, placeholder: this.props.intl.messages.school_placeholder,
	        value: this.state.school }, _defineProperty(_React$createElement, 'style', this.state.validationError && this.state.validationError.schoolError ? { borderColor: "#ff0000" } : {}), _defineProperty(_React$createElement, 'onChange', this.handleSchool.bind(this)), _defineProperty(_React$createElement, 'ref', 'school'), _defineProperty(_React$createElement, 'maxLength', 50), _defineProperty(_React$createElement, 'autoFocus', 'true'), _React$createElement)), _jsx('label', {
	        id: 'schoolError',
	        className: _component2.default.errorPre
	      }, void 0, this.state.validationError && this.state.validationError.schoolError ? this.state.validationError.schoolError : ''))), _jsx('div', {
	        className: 'form-group'
	        ...
	        className: 'form-group'
	      }, void 0, _ref61, _jsx('div', {
	        className: 'col-md-9'
	      }, void 0, _react2.default.createElement('textarea', { id: 'desc', className: 'form-control', value: this.state.schoolDesc, onChange: this.handleSchoolDesc.bind(this), ref: 'desc', maxLength: 150 }))))), _jsx(_Modal.Footer, {
	        className: _Admin2.default.mainSaveAssign
	      }, void 0, _jsx('div', {
	        className: _Admin2.default.errorSaveAssign
	      }, void 0, _jsx('label', {
	        ...
	        id: 'highSchoolCancelBtn',
	        onClick: this.hideAddHighSchoolModal.bind(this)
	      }, void 0, _ref62), _jsx('button', {
	        id: 'highSchoolSaveBtn',
	        className: cls_btnSaveEdit,
	        onClick: this.saveSchool
	      }, void 0, this.state.showSchoolUpdate == true ? _ref63 : _ref64)))) : null;
	
	      var showAddProfessionalBlock = this.state.showAddProfessionalBlock ? _jsx('li', {}, void 0, _jsx('div', {
	        className: _WorkEdu2.default.profileEditBlock
	      }, void 0, _jsx('form', {
	        className: 'form-horizontal'
	      }, void 0, _jsx('div', {
	        className: 'form-group'
	      }, void 0, _jsx('label', {
	        htmlFor: 'inputPrSkills',
	        className: 'control-label col-md-3 col-xs-12'
	      }, void 0, _ref65, _jsx('span', {
	        className: _component2.default.mandatory
	      }, void 0, '*'), ':'), _jsx('div', {
	        ...
	        style: this.state.validationError && this.state.validationError.skillError ? { borderColor: "#ff0000" } : {},
	        ...
	        id: 'skillsError',
	        className: _component2.default.errorPre
	      }, void 0, this.state.validationError && this.state.validationError.skillError ? this.state.validationError.skillError : '')))), _jsx('div', {
	        className: 'form-group'
	      }, void 0, _jsx('div', {
	        className: 'col-md-offset-3 col-md-9 col-xs-12'
	      }, void 0, _jsx('div', {
	        className: _Admin2.default.blockSaveAssign2
	      }, void 0, _jsx('button', {
	        id: 'profCancelBtn',
	        onClick: this.cancelProfessional.bind(this)
	      }, void 0, _ref66), _jsx('button', {
	        id: 'profSaveBtn',
	        className: cls_btnSaveEdit2,
	        onClick: this.saveSkills.bind(this)
	      }, void 0, this.state.showProfessionalUpdate == true ? _ref67 : _ref68))))))) : null;
	      ...
	      return _jsx('div', {
	      ...
	      }, void 0, _ref69), _jsx('ul', {}, void 0, _jsx('li', {}, void 0, _jsx('div', {
	        className: addInfoBlock,
	        id: 'addWorkplaceBtn',
	        onClick: this.handleWorkPlace.bind(this)
	      }, void 0, _jsx('div', {
	        className: iconBox
	      }, void 0, _ref70), _jsx('div', {
	        className: addCategoryTxtBox
	      }, void 0, _jsx('h2', {
	        className: _WorkEdu2.default.addCategoryTxt
	      }, void 0, _ref71))), showAddWorkPlaceModal), this.props.profile.isFetchedWorkEduData ? this.props.profile.workeduData.experience.workplace.map(function (data) {
	        if (data.yearTo == null && data.present == true) {
	          var yearTo = "present";
	        } else {
	          var yearTo = (0, _moment2.default)(data.yearTo).format("DD/MM/YYYY");
	        }
	        return _jsx('li', {}, data._id, _jsx('div', {
	          className: displayInfoBlock
	        }, void 0, _ref72, _jsx('div', {
	          className: informationBox
	        }, void 0, _jsx('h2', {
	          className: _WorkEdu2.default.displayHeadingTxt
	        }, void 0, data.company), _jsx('span', {
	          className: _WorkEdu2.default.capitalize
	        }, void 0, data.position, ' '), _ref73, _jsx('span', {}, void 0, (0, _moment2.default)(data.yearFrom).format("DD/MM/YYYY"), ' to ', yearTo, ' '), _jsx('span', {
	          className: _WorkEdu2.default.capitalize
	        }, void 0, data.city ? '| ' + data.city : null), _jsx('span', {
	          className: _WorkEdu2.default.capitalize
	        }, void 0, data.country ? ', ' + data.country : null), _jsx('p', {
	          className: _WorkEdu2.default.descriptionTxt
	        }, void 0, data.description)), _jsx('div', {
	          className: moreInfoBlock
	        }, void 0, _jsx('div', {
	          className: _WorkEdu2.default.moreIconBox,
	          id: 'workDropdownBtn',
	          onClick: _this3.handleWorkDropdown.bind(_this3, data._id)
	        }, void 0, _ref74, _this3.state.companyID == data._id ? _jsx('div', {
	          className: _this3.state.workDropdownCss
	        }, void 0, _jsx('ul', {}, void 0, _jsx('li', {
	          id: 'workEditBtn',
	          onClick: _this3.handleEditWork.bind(_this3, _this3.state.companyID)
	        }, void 0, _ref75), _jsx('li', {
	          id: 'workDeleteBtn',
	          onClick: _this3.handleDeleteWork.bind(_this3, _this3.state.companyID)
	        }, void 0, _ref76))) : null))));
	      }) : null)), _jsx('div', {
	        className: _WorkEdu2.default.userCategoryInfo
	      }, void 0, _jsx('h2', {
	        className: _WorkEdu2.default.categoryHeading
	      }, void 0, _ref77), _jsx('ul', {}, void 0, this.props.loggedInData ? this.props.loggedInData.data ? this.props.loggedInData.data.profile ? this.props.loggedInData.data.profile.experience.professionalSkills.length == 0 ? this.state.showAddProfessionalBlock == true ? _jsx('div', {}, void 0, showAddProfessionalBlock) : _jsx('li', {}, void 0, _jsx('div', {
	        className: addInfoBlock,
	        id: 'addProSkillsBtn',
	        onClick: this.handleProfessional.bind(this)
	      }, void 0, _jsx('div', {
	        className: iconBox
	        ...
	        className: _WorkEdu2.default.addCategoryTxt
	      }, void 0, _ref79)))) : this.state.showAddProfessionalBlock == true ? _jsx('div', {}, void 0, showAddProfessionalBlock) : _jsx('li', {}, void 0, _jsx('div', {
	        className: displayInfoBlock
	      }, void 0, _jsx('div', {
	        className: singleInfoBox
	      }, void 0, _jsx('h2', {
	        className: _WorkEdu2.default.displayHeadingTxt
	      }, void 0, this.props.loggedInData.data.profile.experience.professionalSkills.map(function (data, index) {
	        return _jsx('div', {
	          className: cls_vr
	        }, index, _jsx('span', {
	          className: cls_email
	        ...
	        id: 'profDropdown',
	        className: _WorkEdu2.default.moreIconBox,
	        onClick: this.handleProfDropdown.bind(this)
	      }, void 0, _ref80, _jsx('div', {
	        className: this.state.profDropdownCss
	      }, void 0, _jsx('ul', {}, void 0, _jsx('li', {
	        id: 'editSkillsBtn',
	        onClick: this.handleEditSkill.bind(this)
	      }, void 0, _ref81), _jsx('li', {
	        id: 'deleteSkills',
	        onClick: this.handleDeleteSkill.bind(this)
	      }, void 0, _ref82))))))) : null : null : null)), _jsx('div', {
	        className: _WorkEdu2.default.userCategoryInfo
	      }, void 0, _jsx('h2', {
	        className: _WorkEdu2.default.categoryHeading
	      }, void 0, _ref83), _jsx('ul', {}, void 0, _jsx('li', {}, void 0, _jsx('div', {
	        className: addInfoBlock,
	        id: 'addCollegeBtn',
	        onClick: this.handleCollege.bind(this)
	      }, void 0, _jsx('div', {
	        className: iconBox
	      }, void 0, _ref84), _jsx('div', {
	        className: addCategoryTxtBox
	      }, void 0, _jsx('h2', {
	        className: _WorkEdu2.default.addCategoryTxt
	      }, void 0, _ref85))), showAddCollegeModal), this.props.profile.isFetchedWorkEduData ? this.props.profile.workeduData.education.college.map(function (data) {
	        return _jsx('li', {}, data._id, _jsx('div', {
	          className: displayInfoBlock
	        }, void 0, _ref86, _jsx('div', {
	          className: informationBox
	        }, void 0, _jsx('h2', {
	          className: _WorkEdu2.default.displayHeadingTxt
	        }, void 0, data.university), _jsx('span', {}, void 0, (0, _moment2.default)(data.yearFrom).format("DD/MM/YYYY"), ' to ', (0, _moment2.default)(data.yearTo).format("DD/MM/YYYY"), ' '), _jsx('span', {
	          className: _WorkEdu2.default.capitalize
	        }, void 0, data.city ? '| ' + data.city : null), _jsx('span', {
	          className: _WorkEdu2.default.capitalize
	        }, void 0, data.country ? ', ' + data.country : null), _jsx('p', {
	          ...
	          id: 'collegeDropdown',
	          className: _WorkEdu2.default.moreIconBox,
	          onClick: _this3.handleCollegeDropdown.bind(_this3, data._id)
	        }, void 0, _ref87, _this3.state.universityID == data._id ? _jsx('div', {
	          className: _this3.state.collegeDropdownCss
	        }, void 0, _jsx('ul', {}, void 0, _jsx('li', {
	          id: 'editCollegeBtn',
	          onClick: _this3.handleEditCollege.bind(_this3, _this3.state.universityID)
	        }, void 0, _ref88), _jsx('li', {
	          id: 'deleteCollegeBtn',
	          onClick: _this3.handleDeleteCollege.bind(_this3, _this3.state.universityID)
	        }, void 0, _ref89))) : null))));
	      }) : null)), _jsx('div', {
	        className: _WorkEdu2.default.userCategoryInfo
	      }, void 0, _jsx('h2', {
	        className: _WorkEdu2.default.categoryHeading
	      }, void 0, _ref90), _jsx('ul', {}, void 0, this.props.loggedInData ? this.props.loggedInData.data ? this.props.loggedInData.data.profile ? !this.props.loggedInData.data.profile.education.highSchool ? _jsx('li', {}, void 0, _jsx('div', {
	        className: addInfoBlock,
	        id: 'addHighSchoolBtn',
	        onClick: this.handleHighSchool.bind(this)
	      }, void 0, _jsx('div', {
	        className: iconBox
	        ...
	        className: _WorkEdu2.default.addCategoryTxt
	      }, void 0, _ref92))), showAddHighSchoolModal) : _jsx('li', {}, void 0, _jsx('div', {
	        className: displayInfoBlock
	      }, void 0, _jsx('div', {
	        className: iconBox
	      }, void 0, _ref93), _jsx('div', {
	        className: informationBox
	      }, void 0, _jsx('h2', {
	        className: _WorkEdu2.default.displayHeadingTxt
	      }, void 0, this.props.loggedInData.data.profile.education.highSchool.school), _jsx('span', {}, void 0, (0, _moment2.default)(this.props.loggedInData.data.profile.education.highSchool.yearFrom).format("DD/MM/YYYY"), ' to ', (0, _moment2.default)(this.props.loggedInData.data.profile.education.highSchool.yearTo).format("DD/MM/YYYY"), ' '), _jsx('span', {
	        className: _WorkEdu2.default.capitalize
	      }, void 0, this.props.loggedInData.data.profile.education.highSchool.city ? '| ' + this.props.loggedInData.data.profile.education.highSchool.city : null), _jsx('span', {
	        className: _WorkEdu2.default.capitalize
	      }, void 0, this.props.loggedInData.data.profile.education.highSchool.country ? ', ' + this.props.loggedInData.data.profile.education.highSchool.country : null), _jsx('p', {
	        className: _WorkEdu2.default.descriptionTxt
	      }, void 0, this.props.loggedInData.data.profile.education.highSchool.description)), _jsx('div', {
	        className: moreInfoBlock
	      }, void 0, _jsx('div', {
	        className: _WorkEdu2.default.moreIconBox
	      }, void 0, _jsx('i', {
	        ...
	        className: 'fa fa-ellipsis-v',
	        'aria-hidden': 'true',
	        onClick: this.handleSchoolDropdown.bind(this)
	      }), _jsx('div', {
	        className: this.state.schoolDropdownCss
	      }, void 0, _jsx('ul', {}, void 0, _jsx('li', {
	        id: 'editSchoolBtn',
	        onClick: this.handleSchoolEdit.bind(this)
	      }, void 0, _ref94), _jsx('li', {
	        id: 'deleteSchoolBtn',
	        onClick: this.handleSchoolDelete.bind(this)
	      }, void 0, _ref95)))))), showAddHighSchoolModal) : null : null : null)))));
	    }
	  }]);
	...
	exports.default = (0, _reactRedux.connect)(mapStateToProps)(WorkEduView);
