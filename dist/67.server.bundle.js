...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Rooms = __webpack_require__(500);
	...
	var _reactPopup = __webpack_require__(528);
	...
	var Dashboard = function (_Component) {
	  ...
	  function Dashboard(props) {
	    ...
	    _this.startConference = function (link) {
	    ...
	    _this.showOrHideInviteBox = function (response) {
	      if (_this.state.showInviteBox) {
	        ...
	        _this.setState({
	          showInviteBox: !_this.state.showInviteBox, roomId: response.roomid, scheduleId: response.scheduleid, roomKey: response.roomkey, slotId: response.slotId
	        });
	      }
	    };
	
	    _this.updateRoomswithNewKey = function (response) {
	      if (response) {
	        _this.setState({ roomKey: response.link, selectedDate: moment().endOf('day').utc().toDate() });
	        var obj = {
	          startDate: moment(_this.props.dashboardData.selectedDate).startOf('day').utc().format('x'),
	          endDate: moment(_this.props.dashboardData.selectedDate).endOf('day').utc().format('x')
	        };
	        _this.props.dispatch((0, _UserDashboardActions.getMyDateSchedules)(obj));
	        _this.props.dispatch((0, _UserDashboardActions.setMyRooms)(response));
	      }
	    };
	  ...
	  _createClass(Dashboard, [{
	    ...
	    value: function componentWillReceiveProps(nextProps) {
	      if (nextProps.dashboardData && nextProps.dashboardData.success && nextProps.dashboardData.success != "") {
	        ...
	        this.props.dispatch((0, _UserDashboardActions.ClearFeeadback)());
	      }
	    }
	  }, {
	    ...
	    value: function componentDidMount() {
	      ...
	      this.props.dispatch((0, _UserDashboardActions.getMyRooms)());
	    ...
	    value: function setdata(result) {
	      ...
	      if (result && result.data && result.data._id) {
	        ...
	        result.data.contacts.forEach(function (contact) {
	          _SocketHandler2.default.subscribeStatus(contact._id);
	        });
	      }
	    }
	  }, {
	    ...
	    value: function render() {
	      ...
	      return _jsx(_reactBootstrap.Row, {}, void 0, _jsx(_InviteBox2.default, {
	        showModal: this.state.showInviteBox,
	        hidecallback: this.showOrHideInviteBox.bind(this),
	        roomId: this.state.roomId,
	        scheduleId: this.state.scheduleId,
	        slotId: this.state.slotId,
	        userId: this.state.userData && this.state.userData._id ? this.state.userData._id : null,
	        errorCallback: this.showResponse.bind(this),
	        roomKey: this.state.roomKey,
	        getNewRooms: this.updateRoomswithNewKey,
	        confFlag: this.confObject.getConnectionStatus()
	      }), _jsx(_reactBootstrap.Col, {
	        md: 5
	      }, void 0, _jsx('div', {
	        className: _Dashboard2.default.modDashboardCard
	      }, void 0, _jsx(_Rooms2.default, {
	        userData: this.state.userData,
	        showInviteBox: this.showOrHideInviteBox,
	        getConnection: this.confObject.getConnectionStatus()
	      }))), _jsx(_reactBootstrap.Col, {
	        md: 7
	      }, void 0, _jsx('div', {
	        className: _Dashboard2.default.modDashboardCard
	      ...
	      }), _jsx(_Schedule2.default, {
	        invite: this.showOrHideInviteBox,
	        ...
	        getConnection: this.confObject.getConnectionStatus()
	      })), this.props.loggedInData.data.role != _roles.Roles.Student ? _react2.default.createElement(
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.CarouselRoomsList = undefined;
	...
	var _Carousel = __webpack_require__(523);
	...
	var CarouselRoomsList = exports.CarouselRoomsList = function (_Component) {
	  _inherits(CarouselRoomsList, _Component);
	
	  function CarouselRoomsList() {
	    var _ref;
	
	    var _temp, _this, _ret;
	
	    _classCallCheck(this, CarouselRoomsList);
	
	    for (var _len = arguments.length, args = Array(_len), _key = 0; _key < _len; _key++) {
	      args[_key] = arguments[_key];
	    }
	
	    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = CarouselRoomsList.__proto__ || Object.getPrototypeOf(CarouselRoomsList)).call.apply(_ref, [this].concat(args))), _this), _this.showValidity = function (expdate) {
	      var ipdate = moment(expdate).startOf('day');
	      var now = moment().startOf('day');
	      if (+ipdate < +now) {
	        return _jsx('span', {}, void 0, _ref2, ': ', _jsx('strong', {
	          className: _Dashboard2.default.expired
	        }, void 0, 'Expired'));
	      } else {
	        return _jsx('span', {}, void 0, _ref3, ': ', _jsx('strong', {}, void 0, ipdate.format("MMM Do YYYY")));
	      }
	    }, _temp), _possibleConstructorReturn(_this, _ret);
	  }
	
	  _createClass(CarouselRoomsList, [{
	    key: 'handle',
	    ...
	    value: function render() {
	      ...
	      var cls_roomInfoBlk = _Dashboard2.default.modRoomInfoBlock + ' clearfix';
	      var listRooms = _jsx(_Carousel.Item, {
	        active: true
	      }, 'no rooms', _jsx('div', {
	        className: _Dashboard2.default.roomItem
	      }, void 0, _ref4));
	      if (this.props.roomsList != null) {
	        var docs = this.props.roomsList;
	        if (docs.length > 0) {
	          listRooms = docs.map(function (doc) {
	            return _jsx(_Carousel.Item, {}, doc._id, _jsx('div', {
	              className: _Dashboard2.default.roomItem
	            }, void 0, _jsx('h2', {}, void 0, doc.roomName, '.'), _jsx('p', {}, void 0, _ref5, ' ', _this2.showValidity(doc.selPackage.packageValidity))));
	          });
	        }
	      }
	
	      return _jsx('div', {
	        className: cls_roomInfoBlk
	      }, void 0, _jsx('div', {
	        className: _Dashboard2.default.myRoomListBlock
	      }, void 0, _jsx('div', {
	        className: _Dashboard2.default.sliderWrapper
	      }, void 0, _ref6, _jsx('div', {
	        className: _Dashboard2.default.slider
	      }, void 0, _jsx(_reactBootstrap.Carousel, {
	        bsClass: 'roomCarousel',
	        indicators: false,
	        slide: true,
	        interval: 0,
	        onSelect: this.handle.bind(this),
	        defaultActiveIndex: 0
	      }, void 0, listRooms)))));
	    }
	  }]);
	
	  return CarouselRoomsList;
	}(_react.Component);
	...
	exports.default = (0, _reactIntl.injectIntl)(CarouselRoomsList);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _reactCopyToClipboard = __webpack_require__(526);
	...
	var _ref = _jsx('img', {
	  src: '/images/black-icons/black-copy.png',
	  alt: 'copy-icon'
	});
	
	var _ref2 = _jsx('img', {
	  src: '/images/black-icons/black-share.png',
	  alt: 'share-icon'
	});
	
	var _ref3 = _jsx('img', {
	  src: '/images/black-icons/black-mailclient.png',
	  alt: 'mailclient-icon'
	});
	
	var _ref4 = _jsx('img', {
	  src: '/images/black-icons/black-manage-user.png',
	...
	var _ref8 = _jsx('img', {
	  src: '/images/black-icons/black-view-attendance.png',
	  alt: 'view-attendance-icon'
	});
	...
	var RoomOptions = exports.RoomOptions = function (_Component) {
	  _inherits(RoomOptions, _Component);
	
	  function RoomOptions(props) {
	    _classCallCheck(this, RoomOptions);
	
	    var _this = _possibleConstructorReturn(this, (RoomOptions.__proto__ || Object.getPrototypeOf(RoomOptions)).call(this, props));
	
	    _this.copyLink = function () {
	      _this.refs.roomoptions_container.success(" Link Copied. ", '');
	    };
	
	    _this.getNewRooms = function (response) {
	      console.log("response === ", response);
	      _this.props.getNewRooms(response);
	    };
	
	    _this.handleAssignment = function (event) {
	      var link = event.currentTarget.id;
	      _this.props.handleAssignment(link);
	    };
	
	    _this.state = {
	      // showInviteBox: false
	    };
	    _this.cls_lnkBox = _Dashboard2.default.linkColor + ' ' + _Dashboard2.default.lnkBox;
	    return _this;
	  }
	  ...
	  _createClass(RoomOptions, [{
	    ...
	    value: function render() {
	      if (this.props.roomData) {
	        ...
	        var guestUrl = this.props.roomData.roomKey.split("/conf/");
	        var tmpRoomKey = guestUrl[1];
	        guestUrl[1] = "/conf/guest/";
	        guestUrl[2] = tmpRoomKey;
	        guestUrl = guestUrl.join("") ? guestUrl.join("") : "no link";
	
	        var cls_roomInfoDetail = _Dashboard2.default.roomInfoDetaile + ' hidden-xs hidden-sm';
	        var cls_clearFix_m = 'clearfix hidden-xs hidden-sm';
	        var cls_inviteAction = _Dashboard2.default.inviteActions + ' clearfix';
	        var cls_rightActionBlock = _Dashboard2.default.rightActionBlock + ' pull-right';
	        var cls_actionBlock = _Dashboard2.default.actionBlock + ' pull-left';
	        var openMail = 'mailto:?Subject=Conference Link&body=Conference link is :: ' + guestUrl;
	        var usersLink = '/admin/room/adduser/' + this.props.roomData._id;
	        var topicLink = '/admin/room/listtopic/' + this.props.roomData._id;
	        var assignmentLink = '/admin/room/assignments/' + this.props.roomData._id;
	        var questionnaireLink = '/admin/questionnaire/list';
	        var attendanceLink = '/course/attendance/' + this.props.roomData._id;
	        return _jsx('div', {
	          className: 'clearfix'
	        }, void 0, _react2.default.createElement(_lib.ToastContainer, {
	          toastMessageFactory: ToastMessageFactory,
	          ...
	          className: _Dashboard2.default.roomLinkTxtBlock
	        }, void 0), _jsx('div', {
	          className: cls_actionBlock
	        }, void 0, this.props.roomData.roomKey && this.props.role != _roles.Roles.Student && this.props.role != _roles.Roles.Attendee ? _jsx('ul', {}, void 0, _jsx('li', {}, void 0, _jsx(_reactRouter.Link, {
	          id: 'copy',
	          title: this.props.intl.messages.copy_this_link
	        }, void 0, _jsx('div', {
	          className: _Dashboard2.default.actionIcon
	        }, void 0, _jsx(_reactCopyToClipboard2.default, {
	          text: guestUrl,
	          onCopy: this.copyLink
	        }, void 0, _ref)))), _jsx('li', {}, void 0, _jsx(_reactRouter.Link, {
	          id: 'shareLink',
	          title: this.props.intl.messages.share_Link,
	          onClick: this.showInviteBox.bind(this)
	        }, void 0, _jsx('div', {
	          className: _Dashboard2.default.actionIcon
	        }, void 0, _ref2))), _jsx('li', {}, void 0, _jsx(_reactRouter.Link, {
	          id: 'openMail',
	          to: openMail,
	          target: '_top',
	          title: this.props.intl.messages.open_mail_client
	        }, void 0, _jsx('div', {
	          className: _Dashboard2.default.actionIcon
	        }, void 0, _ref3)))) : null), _jsx('div', {
	          className: cls_rightActionBlock
	        }, void 0, _jsx('ul', {}, void 0, this.props.userId == this.props.roomData.createdBy || this.props.role == _roles.Roles.Superadmin || this.props.role == _roles.Roles.Admin || this.props.role == _roles.Roles.Lmsadmin || this.props.role == _roles.Roles.CRMadmin || this.props.role == _roles.Roles.Presenteradmin ? _jsx('li', {}, void 0, _jsx(_reactRouter.Link, {
	          id: 'addParticipants',
	          to: usersLink,
	          title: this.props.intl.messages.add_participants
	        }, void 0, _jsx('div', {
	          className: _Dashboard2.default.actionIcon
	        }, void 0, _ref4))) : null, this.props.roomData.selPackage.features.indexOf("Topics") != -1 && (this.props.role == _roles.Roles.Superadmin || this.props.role == _roles.Roles.Admin || this.props.role == _roles.Roles.Lmsadmin || this.props.role == _roles.Roles.Instructor || this.props.role == _roles.Roles.CRMadmin || this.props.role == _roles.Roles.Presenteradmin || this.props.role == _roles.Roles.Presenter) ? _jsx('li', {}, void 0, _jsx(_reactRouter.Link, {
	          id: 'addTopic',
	          to: topicLink,
	          title: this.props.intl.messages.add_topics
	        }, void 0, _jsx('div', {
	          className: _Dashboard2.default.actionIcon
	        }, void 0, _ref5))) : null, this.props.roomData.selPackage.features.indexOf("Topics") != -1 && (this.props.role == _roles.Roles.Superadmin || this.props.role == _roles.Roles.Admin || this.props.role == _roles.Roles.Lmsadmin || this.props.role == _roles.Roles.Instructor || this.props.role == _roles.Roles.CRMadmin || this.props.role == _roles.Roles.Presenteradmin || this.props.role == _roles.Roles.Presenter) ? _jsx('li', {}, void 0, _jsx(_reactRouter.Link, {
	          id: 'questionnaireLink',
	          to: questionnaireLink,
	          title: this.props.intl.messages.manage_questionnaire
	        }, void 0, _jsx('div', {
	          className: _Dashboard2.default.actionIcon
	        }, void 0, _ref6))) : null, this.props.roomData.selPackage.features.indexOf("Topics") != -1 && (this.props.role == _roles.Roles.Instructor || this.props.role == _roles.Roles.Presenter) ? _jsx('li', {}, void 0, _jsx(_reactRouter.Link, {
	          id: 'assignmentLink',
	          to: assignmentLink,
	          title: this.props.intl.messages.manage_assignments
	        }, void 0, _jsx('div', {
	          className: _Dashboard2.default.actionIcon
	        }, void 0, _ref7))) : null, this.props.role == _roles.Roles.Student ? _jsx('li', {}, void 0, _jsx(_reactRouter.Link, {
	          id: 'viewAttendance',
	          to: attendanceLink,
	          title: this.props.intl.messages.view_attendance
	        }, void 0, _jsx('div', {
	          className: _Dashboard2.default.actionIcon
	        }, void 0, _ref8))) : null, this.props.roomData.selPackage.features.indexOf("Topics") != -1 && this.props.role == _roles.Roles.Student ? _jsx('li', {}, void 0, _jsx(_reactRouter.Link, (_jsx2 = {
	          id: 'manageAssignments',
	          title: this.props.intl.messages.manage_assignments
	        }, _defineProperty(_jsx2, 'id', this.props.roomData.roomKey), _defineProperty(_jsx2, 'onClick', this.handleAssignment), _jsx2), void 0, _jsx('div', {
	          className: _Dashboard2.default.actionIcon
	        }, void 0, _ref9))) : null)));
	      } else {
	        return null;
	...
	exports.default = (0, _reactIntl.injectIntl)(RoomOptions);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _RoomOptions = __webpack_require__(499);
	
	var _RoomOptions2 = _interopRequireDefault(_RoomOptions);
	
	var _CarouselRoomsList = __webpack_require__(489);
	
	var _CarouselRoomsList2 = _interopRequireDefault(_CarouselRoomsList);
	...
	var _ref = _jsx('img', {
	  src: '/images/black-icons/black-manage-room.png'
	});
	...
	var _ref4 = _jsx('img', {
	  src: '/images/profile-pics/default-group.jpg'
	});
	...
	var _ref6 = _jsx(_Loading2.default, {
	  loadType: 'list'
	});
	
	var Rooms = exports.Rooms = function (_Component) {
	  ...
	  function Rooms(props) {
	    ...
	    _this.showValidity = function (expdate) {
	      var ipdate = moment(expdate);
	      var now = moment();
	      if (+ipdate < +now) {
	        return _jsx('span', {}, void 0, _this.props.intlData.messages.valid_untill, ' : ', _jsx('strong', {
	          className: _Dashboard2.default.expired
	        }, void 0, 'Expired'));
	      } else {
	        return _jsx('span', {}, void 0, _this.props.intlData.messages.valid_untill, ' : ', _jsx('strong', {}, void 0, ipdate.format("MMM Do YYYY")));
	      }
	    };
	
	    _this.startConference = function (e) {
	      var roomKey = e.currentTarget.id;
	      // this.props.dispatch(setWorkDashboard({ current : "roomchat" }));
	      _reactRouter.browserHistory.push(roomKey);
	    };
	
	    _this.handleAssignment = function (key) {
	      _this.props.dispatch((0, _WorkDashboardActions.setWorkDashboard)({ current: "assignmentList" }));
	      // let link = '/' + key;
	      _reactRouter.browserHistory.push(key);
	    };
	
	    _this.state = {
	      searchcss: '' + _Dashboard2.default.searchBox,
	      value: '',
	      currentId: '',
	      roomRefresh: false
	    };
	  ...
	  _createClass(Rooms, [{
	    key: 'updateRooms',
	    value: function updateRooms(response) {
	      if (response) {
	        this.props.getSchedules();
	        this.props.dispatch((0, _UserDashboardActions.setMyRooms)(response));
	      }
	    }
	  }, {
	    key: 'getnewRooms',
	    value: function getnewRooms() {
	      var _this2 = this;
	
	      this.setState({ roomRefresh: true });
	      this.props.dispatch((0, _UserDashboardActions.getMyRooms)()).then(function (res) {
	        _this2.setState({ roomRefresh: false });
	      });
	    }
	  }, {
	    key: 'showOrhideSearchbox',
	    value: function showOrhideSearchbox() {
	      if (this.state.searchcss == _Dashboard2.default.searchBox + ' ' + _Dashboard2.default.showSearchBox) {
	        this.setState({ searchcss: '' + _Dashboard2.default.searchBox, value: '' });
	        this.props.dispatch((0, _UserDashboardActions.searchMyRooms)(''));
	      } else {
	        this.setState({ searchcss: _Dashboard2.default.searchBox + ' ' + _Dashboard2.default.showSearchBox });
	      }
	    }
	  }, {
	    key: 'handleChange',
	    value: function handleChange(e) {
	      this.props.dispatch((0, _UserDashboardActions.searchMyRooms)(e.target.value));
	      this.setState({ currentId: '', value: e.target.value });
	    }
	  }, {
	    key: 'showRoomOptions',
	    value: function showRoomOptions(e) {
	    ...
	    value: function render() {
	      ...
	      var cls_roomInfoBlk = _Dashboard2.default.modRoomInfoBlock + ' clearfix';
	      var cls_roomLinkHide = _Dashboard2.default.roomLinkBlock + ' ' + _Dashboard2.default.roomLinkBlockHide;
	      var cls_roomLinkBlock = '' + _Dashboard2.default.roomLinkBlock;
	      var cls_contactContainer = _ConfSettings2.default.contactContainer + ' clearfix';
	
	      var myRooms = _jsx('div', {
	        className: _ConfSettings2.default.modNoContacts
	      }, void 0, _jsx('div', {
	        className: _ConfSettings2.default.noContactsCircle
	      }, void 0, _ref), _jsx('h2', {}, void 0, this.props.intlData.messages.no_rooms), this.props.userData && (this.props.userData.role == _roles.Roles.Superadmin || this.props.userData.role == _roles.Roles.Admin || this.props.userData.role == _roles.Roles.Lmsadmin || this.props.userData.role == _roles.Roles.CRMadmin || this.props.userData.role == _roles.Roles.Presenteradmin) ? _jsx('div', {
	        className: _Dashboard2.default.createBlock
	      }, void 0, _jsx(_reactRouter.Link, {
	        id: 'createNewRoom',
	        to: 'admin/room/new',
	        title: this.props.intlData.messages.create_new_room
	      }, void 0, this.props.intlData.messages.create_a_room, ' ', _ref2)) : null);
	      if (this.props.dashboardData && this.props.dashboardData.myrooms && this.props.dashboardData.myrooms.length > 0) {
	        var index = 0;
	        var background_color_active = { "backgroundColor": "#eee" };
	        var background_color = { "backgroundColor": "#fff" };
	        myRooms = this.props.dashboardData.myrooms.map(function (doc) {
	          index++;
	          return _jsx('li', {
	            style: index == 1 && _this3.state.currentId == '' ? background_color_active : _this3.state.currentId == doc._id ? background_color_active : background_color
	          }, doc._id, !_this3.props.getConnection ? _jsx('div', {
	            className: _Dashboard2.default.roomListactionBlock,
	            id: doc.roomKey,
	            onClick: _this3.startConference
	          }, void 0, _jsx('span', {
	            className: _Dashboard2.default.roomListactionStart,
	            title: _this3.props.userData && _this3.props.userData.role == _roles.Roles.Student ? _this3.props.intlData.messages.join_class : _this3.props.userData && (_this3.props.userData.role == _roles.Roles.Instructor || _this3.props.userData.role == _roles.Roles.Lmsadmin) ? _this3.props.intlData.messages.start_class : _this3.props.intlData.messages.start_conference
	          }, void 0, _ref3)) : null, _jsx(_reactRouter.Link, {
	            className: 'clearfix',
	            id: doc._id,
	            onClick: _this3.showRoomOptions.bind(_this3)
	          }, void 0, _jsx('div', {
	          ...
	          }, void 0, _jsx('h3', {}, void 0, doc.roomName, '.', _jsx('p', {}, void 0, _jsx('span', {
	            className: 'hidden-xs'
	          }, void 0, doc.corporateId ? doc.corporateId.businessType == 'Conference' || doc.corporateId.businessType == 'CRM' ? _this3.props.intlData.messages.conference_mode : _this3.props.intlData.messages.presenter_mode : _this3.props.intlData.messages.presenter_mode), ' ', doc.expiryDate != null ? _this3.showValidity(doc.expiryDate) : null))))), _jsx('div', {
	            className: index == 1 && _this3.state.currentId == '' ? cls_roomLinkBlock : _this3.state.currentId == doc._id ? cls_roomLinkBlock : cls_roomLinkHide
	          }, void 0, _jsx(_RoomOptions2.default, {
	            getNewRooms: _this3.updateRooms.bind(_this3),
	            roomData: doc,
	            userId: _this3.props.userData ? _this3.props.userData._id : null,
	            role: _this3.props.userData ? _this3.props.userData.role : -1,
	            handleAssignment: _this3.handleAssignment,
	            invite: _this3.props.showInviteBox
	          })));
	        });
	      }
	      return _jsx('div', {
	        ...
	        className: _Dashboard2.default.modCardHeader
	      }, void 0, _jsx('div', {
	        ...
	        id: 'search',
	        type: 'search',
	        className: _Dashboard2.default.searchInput,
	        placeholder: this.props.intlData.messages.search_rooms,
	        onChange: this.handleChange.bind(this),
	        value: this.state.value,
	        maxLength: 50,
	        autoFocus: 'true'
	        ...
	        id: 'closeSearchInput',
	        className: _Dashboard2.default.closeSearchInput,
	        onClick: this.showOrhideSearchbox.bind(this)
	      }, void 0, _ref5))), _jsx('h2', {}, void 0, _jsx('span', {}, void 0, this.props.intlData.messages.my_rooms)), _jsx('div', {
	        className: _Dashboard2.default.modRoomControls
	      }, void 0, _jsx('ul', {}, void 0, _jsx('li', {
	        className: 'hidden-xs'
	      }, void 0, _jsx(_reactRouter.Link, {
	        id: 'newRooms',
	        onClick: this.getnewRooms.bind(this)
	      }, void 0, _jsx('img', {
	        src: '/images/black-icons/black-regenerate.png',
	        className: this.state.roomRefresh == true ? _Dashboard2.default.spinAnimation : null,
	        title: this.props.intlData.messages.refresh_rooms
	      }))), _jsx('li', {}, void 0, _jsx(_reactRouter.Link, {
	        id: 'showOrhideSearchbox',
	        onClick: this.showOrhideSearchbox.bind(this)
	      }, void 0, _jsx('img', {
	        src: '/images/black-icons/black-search.png',
	        title: this.props.intlData.messages.search_room
	      })))))), _jsx('div', {
	        className: _Dashboard2.default.modCardBody
	      }, void 0, _jsx('div', {
	        className: _ConfSettings2.default.modAsideListBody
	      }, void 0, _jsx('div', {
	        className: _ConfSettings2.default.modContactList
	      }, void 0, this.props.dashboardData && this.props.dashboardData.myrooms != null ? _jsx('ul', {}, void 0, myRooms) : _jsx('div', {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _reactDaterangePicker = __webpack_require__(527);
	...
	var _ref = _jsx(_reactIntl.FormattedMessage, {
	  id: 'duration_time_should_be_greaterthan_current_time'
	});
	
	var _ref2 = _jsx(_reactIntl.FormattedMessage, {
	  id: 'Please_select_the_valid_starttime'
	});
	
	var _ref3 = _jsx(_reactIntl.FormattedMessage, {
	  id: 'Please_select_the_duration'
	});
	...
	var _ref16 = _jsx('img', {
	  src: '/images/profile-pics/no-schedule.png'
	});
	
	var _ref17 = _jsx('h2', {}, void 0, _jsx(_reactIntl.FormattedMessage, {
	  id: 'no_schedules'
	...
	var _ref24 = _jsx('p', {}, void 0, _jsx(_reactIntl.FormattedMessage, {
	  id: 'set_start_time'
	}));
	...
	var _ref26 = _jsx('p', {}, void 0, _jsx(_reactIntl.FormattedMessage, {
	  id: 'set_minutes'
	}));
	...
	var _ref29 = _jsx(_reactIntl.FormattedMessage, {
	  id: 'edit_current_day_recurring'
	});
	
	var _ref30 = _jsx(_reactBootstrap.Modal.Body, {}, void 0, _jsx(_reactIntl.FormattedMessage, {
	  id: 'want_to_edit_current_day_or_recurring_schedule'
	}));
	...
	var _ref33 = _jsx(_reactIntl.FormattedMessage, {
	  id: 'delete_current_day_recurring'
	});
	
	var _ref34 = _jsx(_reactBootstrap.Modal.Body, {}, void 0, _jsx(_reactIntl.FormattedMessage, {
	  id: 'want_to_delete_current_day_or_recurring_schedule'
	}));
	
	var _ref35 = _jsx(_reactIntl.FormattedMessage, {
	  id: 'current'
	});
	...
	var _ref37 = _jsx('h2', {}, void 0, _jsx(_reactIntl.FormattedMessage, {
	  id: 'my_classes'
	}));
	
	var _ref38 = _jsx('h2', {}, void 0, _jsx(_reactIntl.FormattedMessage, {
	  id: 'create_a_class'
	}));
	
	var _ref39 = _jsx('h2', {}, void 0, _jsx(_reactIntl.FormattedMessage, {
	  id: 'calendar'
	}));
	
	var _ref40 = _jsx(_reactIntl.FormattedMessage, {
	  id: 'your_selected_date'
	});
	...
	var _ref44 = _jsx(_reactFontawesome2.default, {
	  name: 'calendar-check-o'
	});
	
	var _ref45 = _jsx('span', {
	  className: 'hidden-xs hidden-sm'
	}, void 0, _jsx(_reactIntl.FormattedMessage, {
	  id: 'schedules'
	}));
	
	var _ref46 = _jsx('span', {
	  className: 'hidden-md hidden-lg sm-h2'
	}, void 0, 'Schedules');
	
	var _ref47 = _jsx(_reactFontawesome2.default, {
	  name: 'history'
	});
	...
	var Schedule = exports.Schedule = function (_Component) {
	  ...
	  function Schedule(props) {
	    ...
	    _this.reloadScheedule = function () {
	      _this.setState({ active: true, refresh: true });
	      var obj = {
	        startDate: Number(moment(_this.state.selectedDate).startOf('day').utc().format('x')),
	        endDate: Number(moment(_this.state.selectedDate).endOf('day').utc().format('x'))
	      };
	      _this.props.dispatch((0, _UserDashboardActions.getScheduleDates)());
	      _this.props.dispatch((0, _UserDashboardActions.getMyDateSchedules)(obj)).then(function (res) {
	        return _this.setState({ refresh: false });
	      });
	    };
	
	    _this.handleUpdate = function () {
	      var h = _this.state.hours != '' ? _this.state.hours * 60 : 0;
	      var m = _this.state.minutes != '' ? _this.state.minutes : 0;
	      var duration = Number(h) + Number(m);
	      if (duration > 0) {
	        if (_this.state.startTime != '' && moment(_this.state.startTime, 'x').isValid()) {
	          var endtime = moment(_this.state.startTime, 'x');
	          endtime.add(duration, 'minutes');
	          var obj = {
	            _id: _this.state.slotId,
	            startTime: Number(moment(_this.state.startTime, 'x').utc().format('x')),
	            endTime: Number(endtime.utc().format('x'))
	          };
	          var now = Number(moment().utc().format('x'));
	          if (obj.endTime > now) {
	            _this.setState({ error: '' });
	            _this.props.dispatch((0, _UserDashboardActions.updateSlotSchedule)(obj, _this.state.data._id)).then(function (res) {
	              return _this.setUpdateResponse(res);
	            });
	          } else {
	            _this.setState({ error: _ref });
	          }
	    ...
	    _this.handleStart = function (event) {
	      var link = event.currentTarget.id.substr(15);
	      _this.props.startConference(link);
	    };
	    ...
	    _this.editCurrentDay = function () {
	      var id = _this.state.recordId;
	      var slotId = _this.state.slotId;
	      _this.props.dispatch((0, _UserDashboardActions.getSchedule)(id)).then(function (res) {
	        return _this.setSchResponse(res, slotId);
	      });
	      _this.setState({ editshow: false, slotId: null, recordId: null });
	    };
	    ...
	    _this.editRecurring = function () {
	      var id = _this.state.recordId;
	      _this.props.dispatch((0, _UserDashboardActions.getSchedule)(id)).then(function (res) {
	        return _this.setSchResponse(res, null);
	      });
	      _this.setState({ editshow: false, slotId: null, recordId: null });
	    };
	    ...
	    _this.deleteCurrentDay = function () {
	      var id = _this.state.recordId;
	      var slotId = _this.state.slotId;
	      _this.props.dispatch((0, _UserDashboardActions.deleteMySchedule)(id, slotId)).then(function (res) {
	        return _this.setDelResponse(res);
	      });
	      _this.setState({ deleteshow: false, slotId: null, recordId: null });
	    };
	    ...
	    _this.showOrHideEditScheduler = function () {
	      if (_this.state.showEditSlot) {
	        _this.setState({ data: null, showEditSlot: false, slotId: null, scheduleId: null, startTime: '', hours: 0, minutes: 0 });
	      } else {
	        _this.setState({ showEditSlot: true });
	      }
	    };
	
	    _this.handleStartTimeChange = function (newTime) {
	      if (moment(newTime, "x").isValid()) {
	        var nt = moment(newTime, "x");
	        var st = moment(_this.state.startTime, 'x');
	        st.hours(nt.hours()).minutes(nt.minutes()).seconds(0);
	        _this.setState({ startTime: st.format('x') });
	      }
	    };
	  ...
	  _createClass(Schedule, [{
	    ...
	    value: function handleSelect(value, states) {
	      ...
	      var val = value.utc().toDate();
	      this.props.dispatch((0, _UserDashboardActions.setDashboard)({ selectedDate: val }));
	      ...
	      this.props.dispatch((0, _UserDashboardActions.getMyDateSchedules)(obj)).then(function (res) {
	        return _this2.setState({ refresh: false });
	      });
	    }
	  }, {
	    key: 'upcomingEvent',
	    value: function upcomingEvent() {
	      ...
	      this.props.dispatch((0, _UserDashboardActions.getMyDateSchedules)(obj));
	    }
	  }, {
	    key: 'pastEvent',
	    value: function pastEvent() {
	      this.setState({ active: false });
	      var obj = {
	        currentDate: Number(moment(this.state.selectedDate).startOf('day').utc().format('x'))
	      };
	      this.props.dispatch((0, _UserDashboardActions.getMyPastSchedules)(obj));
	    }
	  }, {
	    key: 'createSchedule',
	    ...
	    value: function setResponse(res) {
	      ...
	      if (res.status) {
	        ...
	        this.props.dispatch((0, _UserDashboardActions.getScheduleDates)()).then(function (res) {
	          return _this4.setState({ errorStatus: false });
	        });
	      } else if (res.error) {
	    ...
	    value: function deleteEvent(schid, recurring, e) {
	      var id = e.currentTarget.id.substr(16);
	      var props = this.props;
	      var self = this;
	        ...
	        if (result) {
	          if (recurring) {
	            ...
	            props.dispatch((0, _UserDashboardActions.deleteMySchedule)(id, schid)).then(function (res) {
	              return self.setDelResponse(res);
	            });
	          }
	        }
	    ...
	    key: 'setDelResponse',
	    value: function setDelResponse(res) {
	      if (res.status) {
	        this.refs.schedulecontainer.success(res.message + ' ', '');
	        var obj = {
	        ...
	        this.props.dispatch((0, _UserDashboardActions.getMyDateSchedules)(obj));
	        this.props.dispatch((0, _UserDashboardActions.getScheduleDates)());
	      } else if (res.error) {
	        this.refs.schedulecontainer.error(res.error + ' ', '');
	      }
	    }
	    ...
	    key: 'editEvent',
	    value: function editEvent(slotid, recurring, e) {
	      var id = e.currentTarget.id.substr(14);
	      var props = this.props;
	      var self = this;
	      alertify.confirm(props.intlData.messages.warning, props.role == _roles.Roles.Instructor || props.role == _roles.Roles.Lmsadmin ? props.intlData.messages.edit_class_alert : props.intlData.messages.edit_schedule_alert, function (result) {
	        if (result) {
	          if (recurring) {
	            ...
	            props.dispatch((0, _UserDashboardActions.getSchedule)(id)).then(function (res) {
	              return self.setSchResponse(res, null);
	            });
	          }
	        }
	      }, function () {}).setting('labels', { 'ok': this.props.intlData.messages.ok, 'cancel': this.props.intlData.messages.cancel });
	    ...
	    key: 'setSchResponse',
	    value: function setSchResponse(response, slotId) {
	      if (response.status) {
	        ...
	        if (slotId != null) {
	          ...
	          if (index > -1) {
	            var startTime = moment(dates[index].startTime, 'x');
	            var endTime = moment(dates[index].endTime, 'x');
	    ...
	    key: 'setUpdateResponse',
	    value: function setUpdateResponse(res) {
	      if (res.status) {
	        this.refs.schedulecontainer.success(res.message + ' ', '');
	        var obj = {
	          startDate: moment(this.state.selectedDate).startOf('day').utc().format('x'),
	    ...
	    key: 'inviteEvent',
	    value: function inviteEvent(roomkey, roomid, slotId, e) {
	    ...
	    key: 'scheduleOptions',
	    value: function scheduleOptions(userId, data, role) {
	      ...
	      var recurring = data.pattern && data.pattern != '' ? true : false;
	      if (userId == data.createdBy._id && start <= now && now <= date) {
	        return _jsx('ul', {
	          className: 'clearfix'
	        }, void 0, !this.props.getConnection ? _jsx('li', {}, void 0, _jsx(_reactRouter.Link, {
	          onClick: this.handleStart,
	          id: data.roomId && data.roomId.roomKey ? "start_schedule_" + data.roomId.roomKey : "start_schedule_#",
	          title: role == _roles.Roles.Student ? this.props.intlData.messages.join_class : role == _roles.Roles.Instructor || role == _roles.Roles.Lmsadmin ? this.props.intlData.messages.start_class : this.props.intlData.messages.start_conference
	        }, void 0, _jsx('div', {
	          className: cls_imgcontrol
	        }, void 0, _ref4), _ref5)) : null, _jsx('li', {
	          className: _Dashboard2.default.inviteContacts
	        }, void 0, _jsx(_reactRouter.Link, {
	          onClick: this.inviteEvent.bind(this, data.roomId.roomKey, data.roomId._id, data.dates._id),
	          id: "invite_schedule_" + data._id,
	          title: this.props.intlData.messages.invite_contacts
	        }, void 0, _jsx('div', {
	          className: _Dashboard2.default.iconCircle
	        }, void 0, _ref6), _ref7)));
	      }
	      if (userId == data.createdBy._id && now < start) {
	        return _jsx('ul', {
	          ...
	          title: this.props.intlData.messages.edit_schedule,
	          id: "edit_schedule_" + data._id,
	          onClick: this.editEvent.bind(this, data.dates._id, recurring)
	        }, void 0, _jsx('div', {
	          className: _Dashboard2.default.iconCircle
	        }, void 0, _ref8), _ref9)), _jsx('li', {
	          className: _Dashboard2.default.deleteSchedule
	        }, void 0, _jsx(_reactRouter.Link, {
	          title: this.props.intlData.messages.delete_schedule,
	          id: "delete_schedule_" + data._id,
	          onClick: this.deleteEvent.bind(this, data.dates._id, recurring)
	        }, void 0, _jsx('div', {
	          className: _Dashboard2.default.iconCircle
	        }, void 0, _ref10), _ref11)), _jsx('li', {
	          className: _Dashboard2.default.inviteContacts
	        }, void 0, _jsx(_reactRouter.Link, {
	          onClick: this.inviteEvent.bind(this, data.roomId.roomKey, data.roomId._id, data.dates._id),
	          id: "invite_schedule_" + data._id,
	    ...
	    value: function showOrHideScheduler() {
	      if (this.state.showScheduler) {
	        ...
	        this.props.dispatch((0, _UserDashboardActions.clearSchedule)());
	      } else {
	        var toDate = moment().startOf('day').utc().toDate();
	    ...
	    value: function render() {
	      ...
	      var cls_imgcontrol = _Dashboard2.default.iconCircle + ' ' + _Dashboard2.default.bgStart;
	      var cls_scheduFullBlock = _ConfSettings2.default.modNoContacts + ' ' + _ConfSettings2.default.scheduFullBlock;
	      var cls_noschedule = _ConfSettings2.default.scheduImgBlock + ' ' + _ConfSettings2.default.noContactsCircle + ' ' + _ConfSettings2.default.topMrgZero;
	      ...
	      var schedulesList = _jsx('li', {}, void 0, _jsx(_reactBootstrap.Row, {}, void 0, _jsx(_reactBootstrap.Col, {
	        md: 12
	      }, void 0, _jsx('div', {
	        className: cls_scheduFullBlock
	      }, void 0, _jsx('div', {
	        className: cls_noschedule
	      }, void 0, _ref16), _ref17))));
	      var upcomingClass = '';
	      var pastClass = '';
	      var newSchedules = [];
	      if (this.state.active) {
	        upcomingClass = _Dashboard2.default.current;
	      } else {
	        pastClass = _Dashboard2.default.current;
	      }
	      if (this.props.dashboardData.upcoming) {
	        var userId = this.props.userId;
	        var docs = this.props.dashboardData.upcoming;
	        if (docs.length > 0) {
	          schedulesList = docs.map(function (doc) {
	            if (doc.dates.endTime >= Number(moment().utc().format('x'))) {
	              newSchedules.push(_jsx('li', {}, doc.dates._id, _jsx(_reactBootstrap.Row, {}, void 0, _jsx('div', {
	                className: role == _roles.Roles.Student ? "col-xs-9" : "col-md-6"
	              }, void 0, _jsx('div', {
	                className: _Dashboard2.default.modMeetingDetails
	              }, void 0, _jsx('h2', {
	                className: _Dashboard2.default.meetingTitle
	              }, void 0, doc.meetingName), _jsx('div', {
	                className: _Dashboard2.default.organizerDetials
	              }, void 0, _jsx('img', {
	                id: 'viewprofile',
	                src: doc.createdBy && doc.createdBy.profile && doc.createdBy.profile.profileImage != undefined && doc.createdBy.profile.profileImage != '' && doc.createdBy.profile.profileImage != null ? "/uploads/" + doc.createdBy.profile.profileImage : "/images/profile-pics/defaultStudent.jpg",
	                onClick: _this5.viewUser.bind(_this5, doc.createdBy._id),
	                title: _this5.props.intlData.messages.viewprofile
	              }), _jsx('p', {}, void 0, ' ', moment(doc.dates.startTime, 'x').format('ddd'), ', ', moment(doc.dates.startTime, 'x').format('YYYY-DD-MM'), ', ', moment(doc.dates.startTime, 'x').format('hh:mm'), _jsx('span', {
	                className: _Dashboard2.default.adjustTime
	              }, void 0, moment(doc.dates.startTime, 'x').format('A')), ' - ', moment(doc.dates.endTime, 'x').format('hh:mm'), _jsx('span', {
	                className: _Dashboard2.default.adjustTime
	              }, void 0, moment(doc.dates.endTime, 'x').format('A'))), _jsx('p', {}, void 0, _ref18, ' : ', doc.roomId.roomName), _jsx('p', {}, void 0, _ref19, ' : ', doc.createdBy.firstname)))), _jsx('div', {
	                className: role == _roles.Roles.Student ? "col-xs-3" : "col-md-6"
	              }, void 0, _jsx('div', {
	                className: _Dashboard2.default.modScheduleControls
	              }, void 0, _this5.scheduleOptions(userId, doc, role))))));
	              return null;
	            } else {
	              return _jsx('li', {}, doc.dates._id, _jsx(_reactBootstrap.Row, {}, void 0, _jsx('div', {
	                className: role == _roles.Roles.Student ? "col-xs-9" : "col-md-6"
	              }, void 0, _jsx('div', {
	                className: _Dashboard2.default.modMeetingDetails
	              }, void 0, _jsx('h2', {
	                ...
	                className: _Dashboard2.default.adjustTime
	              }, void 0, moment(doc.dates.endTime, 'x').format('A'))), _jsx('p', {}, void 0, _ref20, ' : ', doc.roomId.roomName), _jsx('p', {}, void 0, _ref21, ' : ', doc.createdBy.firstname)))), _jsx('div', {
	                className: role == _roles.Roles.Student ? "col-xs-3" : "col-md-6"
	              }, void 0, _jsx('div', {
	                className: _Dashboard2.default.modScheduleControls
	              }, void 0, _this5.scheduleOptions(userId, doc, role)))));
	      ...
	      if (this.props.dashboardData.past) {
	        var _docs = this.props.dashboardData.past;
	        // newSchedules = [];
	        if (_docs.length > 0) {
	          schedulesList = _docs.map(function (doc) {
	            return _jsx('li', {}, doc.dates._id, _jsx(_reactBootstrap.Row, {}, void 0, _jsx(_reactBootstrap.Col, {
	              md: 6
	            }, void 0, _jsx('div', {
	              className: _Dashboard2.default.modMeetingDetails
	            }, void 0, _jsx('h2', {
	              ...
	              id: 'viewprofile',
	              src: doc.createdBy && doc.createdBy.profile && doc.createdBy.profile.profileImage ? "/uploads/" + doc.createdBy.profile.profileImage : "/images/profile-pics/defaultStudent.jpg",
	              onClick: _this5.viewUser.bind(_this5, doc.createdBy._id),
	              title: _this5.props.intlData.messages.viewprofile
	            }), _jsx('p', {}, void 0, ' ', moment(doc.dates.startTime, 'x').format('ddd'), ', ', moment(doc.dates.startTime, 'x').format('YYYY-DD-MM'), ', ', moment(doc.dates.startTime, 'x').format('hh:mm'), _jsx('span', {
	              className: _Dashboard2.default.adjustTime
	              ...
	              className: _Dashboard2.default.adjustTime
	            }, void 0, moment(doc.dates.endTime, 'x').format('A'))), _jsx('p', {}, void 0, _ref22, ' : ', doc.roomId.roomName), _jsx('p', {}, void 0, _ref23, ' : ', doc.createdBy.firstname))))));
	          });
	        }
	      }
	      ...
	      return _jsx('div', {
	        ...
	        selectedDate: this.props.dashboardData.selectedDate
	        ...
	        className: _Dashboard2.default.popHeadingAll
	      }, void 0, _ref29)), _ref30, _jsx(_reactBootstrap.Modal.Footer, {}, void 0, _jsx(_reactBootstrap.Button, {
	        id: 'current',
	        className: _Dashboard2.default.btnApplyAll,
	        onClick: this.editCurrentDay
	      }, void 0, _ref31), _jsx(_reactBootstrap.Button, {
	        id: 'recurring',
	        className: _Dashboard2.default.btnApplyAll,
	        onClick: this.editRecurring
	      }, void 0, _ref32))), _jsx(_reactBootstrap.Modal, {
	        ...
	        id: 'contained-modal-title',
	        className: _Dashboard2.default.popHeadingAll
	      }, void 0, _ref33)), _ref34, _jsx(_reactBootstrap.Modal.Footer, {}, void 0, _jsx(_reactBootstrap.Button, {
	        id: 'current',
	        className: _Dashboard2.default.btnApplyAll,
	        onClick: this.deleteCurrentDay
	      }, void 0, _ref35), _jsx(_reactBootstrap.Button, {
	        id: 'recurring',
	        className: _Dashboard2.default.btnApplyAll,
	        onClick: this.deleteRecurring
	      }, void 0, _ref36))), _jsx('div', {
	        className: _Dashboard2.default.modCardHeader
	      }, void 0, role == _roles.Roles.Student ? _ref37 : role == _roles.Roles.Instructor || role == _roles.Roles.Lmsadmin ? _ref38 : _ref39, _jsx('div', {
	        className: _Dashboard2.default.modRoomControls
	      }, void 0, _jsx('ul', {}, void 0, _jsx('li', {
	        className: 'hidden-xs'
	      }, void 0, _jsx(_reactRouter.Link, {
	        id: 'reloadScheedule',
	        onClick: this.reloadScheedule
	      }, void 0, _jsx('img', {
	        src: '/images/black-icons/black-regenerate.png',
	        className: this.state.refresh == true ? _Dashboard2.default.spinAnimation : null,
	        title: this.props.intlData.messages.refresh_schedules
	      }))), role == _roles.Roles.Admin || role == _roles.Roles.Moderator || role == _roles.Roles.User ? _jsx('div', {
	        id: 'scheduleMeeting',
	        className: _Dashboard2.default.headerActionBtn,
	        title: this.props.intlData.messages.schedule_meeting,
	        onClick: this.showOrHideScheduler.bind(this)
	      }, void 0, _jsx('span', {}, void 0, this.props.intlData.messages.schedule_meeting)) : role != _roles.Roles.Student ? _jsx('li', {}, void 0, _jsx(_reactRouter.Link, {
	        id: 'showOrHideScheduler',
	        onClick: this.showOrHideScheduler.bind(this)
	      }, void 0, _jsx('img', {
	        src: '/images/icons/green-schedule.png',
	        title: role == _roles.Roles.Instructor || role == _roles.Roles.Lmsadmin ? this.props.intlData.messages.create_a_class : this.props.intlData.messages.schedule_meeting
	      }))) : null))), _jsx('div', {
	        className: _Dashboard2.default.modCardCalendarClock
	      }, void 0, _jsx('div', {
	        id: 'scheduleDate',
	        className: _Dashboard2.default.calendarBox
	      }, void 0, _jsx(_reactDaterangePicker2.default, {
	        firstOfWeek: 1,
	        numberOfCalendars: 1,
	        ...
	        className: _Dashboard2.default.datePicLegend
	      }, void 0, _jsx('li', {}, void 0, _jsx('span', {
	        className: _Dashboard2.default.selected
	      }), _jsx('span', {
	        className: _Dashboard2.default.txtDisplay
	      }, void 0, _ref40)), _jsx('li', {}, void 0, _jsx('span', {
	        className: _Dashboard2.default.scheduled
	      }), _jsx('span', {
	        className: _Dashboard2.default.txtDisplay
	      }, void 0, role == _roles.Roles.Student || role == _roles.Roles.Instructor || role == _roles.Roles.Lmsadmin ? _ref41 : _ref42)), _jsx('li', {}, void 0, _jsx('span', {
	        className: _Dashboard2.default.pastschedule
	      }), _jsx('span', {
	        className: _Dashboard2.default.txtDisplay
	      }, void 0, _ref43))))), _jsx('div', {
	        className: _Dashboard2.default.modCardNav
	      }, void 0, _jsx('ul', {
	        className: 'clearfix'
	      }, void 0, _jsx('li', {
	        ...
	        id: 'upcomingEvent',
	        onClick: this.upcomingEvent.bind(this)
	      }, void 0, _ref44, '\xA0', _ref45, '\xA0 (', moment(this.state.selectedDate).format('YYYY-DD-MM'), ')', _ref46)), _jsx('li', {
	        id: 'pastSchedules',
	        className: pastClass
	      }, void 0, _jsx('a', {
	        id: 'pastEvent',
	        onClick: this.pastEvent.bind(this)
	      }, void 0, _ref47, '\xA0', _jsx('span', {
	        className: 'hidden-xs hidden-sm'
	      }, void 0, role == _roles.Roles.Student || role == _roles.Roles.Instructor || role == _roles.Roles.Lmsadmin ? _ref48 : _ref49), _ref50)))), _jsx('div', {
	        className: _Dashboard2.default.modCardBody
	      }, void 0, _jsx('div', {
	        className: _Dashboard2.default.modCardChild
	      }, void 0, _jsx('div', {
	        className: _Dashboard2.default.modScheduleListBlock
	      }, void 0, _jsx('ul', {}, void 0, newSchedules, schedulesList)))));
	    }
	  }]);
	...
	exports.default = (0, _reactRedux.connect)(mapStateToProps)(Schedule);
