...
/***/ function(module, exports, __webpack_require__) {
	...
	var AddTopic = function (_Component) {
	  _inherits(AddTopic, _Component);
	
	  function AddTopic(props) {
	    _classCallCheck(this, AddTopic);
	
	    var _this = _possibleConstructorReturn(this, (AddTopic.__proto__ || Object.getPrototypeOf(AddTopic)).call(this, props));
	    ...
	    _this.save = function (event) {
	      ...
	      if (response.error.length > 0) {
	        ...
	        _this.props.dispatch((0, _RoomActions.SaveRoomTopic)(_this.form)).then(function (res) {
	    ...
	    _this.submenu = _RoomMenu.roomEditSubMenu;
	    _this.mainmenu = _RoomMenu.roomTopicNewMainMenu;
	  ...
	  _createClass(AddTopic, [{
	    ...
	    value: function setdata(result) {
	      ...
	      if (result && result.data && result.data._id) {
	        ...
	        this.props.dispatch((0, _RoomActions.RoomTopicStore)(obj));
	    ...
	    value: function render() {
	      ...
	      return _jsx('div', {}, void 0, _react2.default.createElement(_lib.ToastContainer, {
	        ...
	        data: this.props.roomData.schema,
	...
	exports.default = (0, _reactRedux.connect)(mapStateToProps)(AddTopic);
