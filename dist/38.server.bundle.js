...
/***/ function(module, exports, __webpack_require__) {
	...
	var _ActiveUsersList = __webpack_require__(479);
	
	var _ActiveUsersList2 = _interopRequireDefault(_ActiveUsersList);
	...
	var _ref2 = _jsx('ul', {}, void 0, _jsx('li', {}, void 0, _jsx(_reactIntl.FormattedMessage, {
	  id: 'you_are_in_mange_users_panel'
	})));
	...
	var ActiveUsersReport = function (_React$Component) {
	  _inherits(ActiveUsersReport, _React$Component);
	
	  function ActiveUsersReport(props) {
	    _classCallCheck(this, ActiveUsersReport);
	
	    var _this = _possibleConstructorReturn(this, (ActiveUsersReport.__proto__ || Object.getPrototypeOf(ActiveUsersReport)).call(this, props));
	
	    _this.getDates = function (obj) {
	      _this.setState({ chartData: '', fromDate: obj.fromDate, toDate: obj.toDate });
	      var companyId = "";
	      var roleId = _this.props.loggedInData.data.role;
	      if (_roles.Roles.Superadmin == roleId) {
	        companyId = _this.props.loggedInData.data._id;
	      } else if (_roles.Roles.Lmsadmin == roleId || _roles.Roles.Admin == roleId || _roles.Roles.Presenteradmin == roleId) {
	        companyId = _this.props.loggedInData.data.profile.companyid._id;
	      }
	      ...
	      _this.props.dispatch((0, _UsersActions.getActiveUsersReportRequest)(companyId, obj['fromDate'], obj['toDate'])).then(function (res) {
	        return _this.setData(res);
	      });
	    };
	
	    _this.backToReprots = function () {
	      _this.setState({
	        showList: false,
	        listIds: []
	      });
	    ...
	    _this.schema = _UserSchema.userSchema;
	    _this.submenu = _Validator2.default.activeSubMenu(_UserMenu.userListSubMenu, "lnkUsersActivity");
	    _this.mainmenu = _UserMenu.loggedInUsersMainMenu;
	
	    _this.mainmenu.menus[0].action = _this.clearError.bind(_this);
	    return _this;
	  }
	
	  _createClass(ActiveUsersReport, [{
	    key: 'clearError',
	    ...
	    key: 'handleActiveUsersList',
	    value: function handleActiveUsersList(event) {
	    ...
	    value: function render() {
	      ...
	      var removePdng = _Admin2.default.removePdng + ' control-label col-md-7';
	      var addpdng = _Admin2.default.addpdng + ' form-group clearfix';
	
	      var rangeLabel = _Admin2.default.lineHight32 + ' control-label col-md-5 ';
	      var loadType = 'list';
	      ...
	      }, void 0, _ref2), _jsx(_TopMenu2.default, {
	        data: this.mainmenu
	      })), _jsx('div', {
	      ...
	      }, void 0, _ref3, _ref4)))), this.state.showList ? _jsx('div', {
	        className: _Admin2.default.midContainer
	      }, void 0, _jsx('button', {
	        className: _Admin2.default.btnApplyAll,
	        id: 'backToReprots',
	        onClick: this.backToReprots,
	        style: { marginLeft: "16px" }
	      }, void 0, this.props.intlData.messages.back_to_reports), _jsx(_ActiveUsersList2.default, {
	...
	exports.default = (0, _reactRedux.connect)(mapStateToProps)(ActiveUsersReport);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ActiveUsersList = function (_Component) {
	  _inherits(ActiveUsersList, _Component);
	
	  function ActiveUsersList(props) {
	    _classCallCheck(this, ActiveUsersList);
	
	    var _this = _possibleConstructorReturn(this, (ActiveUsersList.__proto__ || Object.getPrototypeOf(ActiveUsersList)).call(this, props));
	  ...
	  _createClass(ActiveUsersList, [{
	    ...
	    value: function setdata(result) {
	      if (result && result.data && result.data._id) {
	        ...
	        this.props.dispatch((0, _UsersActions.UserStore)({ uid: result.data._id }));
	        this.getData({
	    ...
	    value: function getData(pageParam) {
	      ...
	      this.props.dispatch((0, _UsersActions.ActiveUsersListRequest)(pageParam, pageParam.currentPage)).then(function (res) {
	    ...
	    key: 'componentWillUnmount',
	    value: function componentWillUnmount() {
	      this.props.dispatch((0, _UsersActions.ClearActiveUsers)());
	    }
	  }, {
	    key: 'render',
	    value: function render() {
	
	      var objDisp = [{ title: _ref2, type: "function", callback: this.showUserName }, { fieldName: "email", title: _ref3, type: "text" }, { title: _ref4, type: "function", callback: this.showRole }, { title: _ref5, type: "function", callback: this.showCompanyId }];
	      ...
	      return _jsx('div', {}, void 0, _react2.default.createElement(_lib.ToastContainer, {
	        ...
	        data: this.props.userData.dataList,
	...
	exports.default = (0, _reactRedux.connect)(mapStateToProps)(ActiveUsersList);
