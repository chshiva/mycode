...
/***/ function(module, exports, __webpack_require__) {
	...
	var _ContactView = __webpack_require__(445);
	...
	var _ref3 = _jsx('ul', {}, void 0, _jsx('li', {}, void 0, _jsx(_reactIntl.FormattedMessage, {
	...
	var MyContact = function (_Component) {
	  ...
	  function MyContact() {
	    ...
	    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = MyContact.__proto__ || Object.getPrototypeOf(MyContact)).call.apply(_ref, [this].concat(args))), _this), _this.setdata = function (result) {
	  ...
	  _createClass(MyContact, [{
	    ...
	    value: function render() {
	      ...
	      var submenu = _Validator2.default.activeSubMenu(_ProfileEditMenu.profileViewSubMenu, "lnkContacts");
	      return _jsx('div', {
	...
	exports.default = (0, _reactRedux.connect)(mapStateToProps)(MyContact);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _ref8 = _jsx(_reactIntl.FormattedMessage, {
	  id: 'Please_enter_valid_website'
	});
	
	var _ref9 = _jsx(_reactIntl.FormattedMessage, {
	  id: 'Please_enter_social_link'
	});
	
	var _ref10 = _jsx(_reactIntl.FormattedMessage, {
	  id: 'Please_enter_valid_social_link'
	});
	...
	var _ref12 = _jsx(_reactIntl.FormattedMessage, {
	  id: 'Date_of_birth_cannot_be_future_Date'
	});
	
	var _ref13 = _jsx(_reactIntl.FormattedMessage, {
	  id: 'Please_select_Gender'
	});
	...
	var _ref18 = _jsx('label', {
	  htmlFor: 'inputLandmark',
	...
	var _ref39 = _jsx(_reactIntl.FormattedMessage, {
	  id: 'add_address'
	});
	...
	var _ref51 = _jsx(_reactIntl.FormattedMessage, {
	  id: 'add_website'
	});
	...
	var _ref55 = _jsx(_reactIntl.FormattedMessage, {
	  id: 'delete'
	});
	...
	var _ref60 = _jsx(_reactIntl.FormattedMessage, {
	  id: 'add_basic_information'
	});
	
	var _ref61 = _jsx(_reactIntl.FormattedMessage, {
	  id: 'birthday'
	});
	...
	var ContactView = exports.ContactView = function (_Component) {
	  ...
	  function ContactView(props) {
	    ...
	    _this.handleWesiteNameEnterKey = function (e) {
	      if (e.key === 'Enter') {
	        _this.saveUserWebsiteData(e);
	      }
	    };
	
	    _this.handleSocialLinkEnterKey = function (e) {
	      if (e.key === 'Enter') {
	        _this.saveSocialLinkData(e);
	      }
	    };
	
	    _this.validAddressStatus = false;
	    _this.validWebsiteStatus = false;
	    _this.validSocialStatus = false;
	    _this.validCityStatus = null;
	    _this.validZipStatus = null;
	    _this.state = {
	      ...
	      error: '',
	      addressDropdownCss: '' + _WorkEdu2.default.moreDropDown,
	      landmarkDropdownCss: '' + _WorkEdu2.default.moreDropDown,
	      websiteDropdownCss: '' + _WorkEdu2.default.moreDropDown,
	      socialDropdownCss: '' + _WorkEdu2.default.moreDropDown,
	      birthdateDropdownCss: '' + _WorkEdu2.default.moreDropDown,
	      birthyearDropdownCss: '' + _WorkEdu2.default.moreDropDown,
	      genderDropdownCss: '' + _WorkEdu2.default.moreDropDown,
	      startDate: null,
	  ...
	  _createClass(ContactView, [{
	    ...
	    key: 'myHandler',
	    value: function myHandler(e) {
	      if (this.state.addressDropdownCss == _WorkEdu2.default.moreDropDown + ' ' + _WorkEdu2.default.slideDown || this.state.genderDropdownCss == _WorkEdu2.default.moreDropDown + ' ' + _WorkEdu2.default.slideDown || this.state.birthdateDropdownCss == _WorkEdu2.default.moreDropDown + ' ' + _WorkEdu2.default.slideDown || this.state.websiteDropdownCss == _WorkEdu2.default.moreDropDown + ' ' + _WorkEdu2.default.slideDown || this.state.socialDropdownCss == _WorkEdu2.default.moreDropDown + ' ' + _WorkEdu2.default.slideDown) {
	        this.setState({
	          addressDropdownCss: '' + _WorkEdu2.default.moreDropDown,
	          birthdateDropdownCss: '' + _WorkEdu2.default.moreDropDown,
	          birthyearDropdownCss: '' + _WorkEdu2.default.moreDropDown,
	    ...
	    key: 'handleAddress',
	    value: function handleAddress() {
	      this.setState({
	        showAddAddressModal: true
	      });
	    }
	  }, {
	    key: 'hideAddAddressModal',
	    value: function hideAddAddressModal() {
	      this.setState({
	        showAddAddressModal: false,
	        showAddInfoModal: false,
	        showAddWebsiteBlock: false,
	    ...
	    key: 'hideAddInfoModal',
	    value: function hideAddInfoModal() {
	      this.setState({
	        showAddAddressModal: false,
	        showAddInfoModal: false,
	        showAddWebsiteBlock: false,
	    ...
	    key: 'handleAddressDropdown',
	    value: function handleAddressDropdown(e) {
	      e.stopPropagation();
	      if (this.state.addressDropdownCss == _WorkEdu2.default.moreDropDown + ' ' + _WorkEdu2.default.slideDown) {
	        this.setState({
	          addressDropdownCss: '' + _WorkEdu2.default.moreDropDown,
	          showAddressUpdate: true
	        });
	      } else if (this.state.addressDropdownCss == '' + _WorkEdu2.default.moreDropDown) {
	        this.setState({
	          addressDropdownCss: _WorkEdu2.default.moreDropDown + ' ' + _WorkEdu2.default.slideDown,
	          showAddressUpdate: true
	        });
	      }
	    }
	  }, {
	    key: 'handleLandmarkDropdown',
	    value: function handleLandmarkDropdown(e) {
	      e.stopPropagation();
	      if (this.state.landmarkDropdownCss == _WorkEdu2.default.moreDropDown + ' ' + _WorkEdu2.default.slideDown) {
	        this.setState({
	          landmarkDropdownCss: '' + _WorkEdu2.default.moreDropDown
	        });
	      } else if (this.state.landmarkDropdownCss == '' + _WorkEdu2.default.moreDropDown) {
	        this.setState({
	          landmarkDropdownCss: _WorkEdu2.default.moreDropDown + ' ' + _WorkEdu2.default.slideDown
	        });
	      }
	    }
	  }, {
	    key: 'handleWebsiteDropdown',
	    value: function handleWebsiteDropdown(e) {
	      e.stopPropagation();
	      if (this.state.websiteDropdownCss == '' + _WorkEdu2.default.moreDropDown) {
	        this.setState({
	          websiteDropdownCss: _WorkEdu2.default.moreDropDown + ' ' + _WorkEdu2.default.slideDown,
	          showWebsiteUpdate: true
	        });
	      } else if (this.state.websiteDropdownCss == _WorkEdu2.default.moreDropDown + ' ' + _WorkEdu2.default.slideDown) {
	        this.setState({
	          websiteDropdownCss: '' + _WorkEdu2.default.moreDropDown,
	          showWebsiteUpdate: true
	        });
	    ...
	    key: 'handleSocialDropdown',
	    value: function handleSocialDropdown(e) {
	      e.stopPropagation();
	      if (this.state.socialDropdownCss == _WorkEdu2.default.moreDropDown + ' ' + _WorkEdu2.default.slideDown) {
	        this.setState({
	          socialDropdownCss: '' + _WorkEdu2.default.moreDropDown,
	          showSocialUpdate: true
	        });
	      } else if (this.state.socialDropdownCss == '' + _WorkEdu2.default.moreDropDown) {
	        this.setState({
	          socialDropdownCss: _WorkEdu2.default.moreDropDown + ' ' + _WorkEdu2.default.slideDown,
	          showSocialUpdate: true
	        });
	      }
	    }
	  }, {
	    key: 'handleGenderDropdown',
	    value: function handleGenderDropdown(e) {
	      e.stopPropagation();
	      if (this.state.genderDropdownCss == _WorkEdu2.default.moreDropDown + ' ' + _WorkEdu2.default.slideDown) {
	        this.setState({
	          genderDropdownCss: '' + _WorkEdu2.default.moreDropDown,
	          showGenderUpdate: true
	        });
	      } else if (this.state.genderDropdownCss == '' + _WorkEdu2.default.moreDropDown) {
	        this.setState({
	          genderDropdownCss: _WorkEdu2.default.moreDropDown + ' ' + _WorkEdu2.default.slideDown,
	          showGenderUpdate: true
	        });
	      }
	    }
	  }, {
	    key: 'handleBirthDateDropdown',
	    value: function handleBirthDateDropdown(e) {
	      e.stopPropagation();
	      if (this.state.birthdateDropdownCss == _WorkEdu2.default.moreDropDown + ' ' + _WorkEdu2.default.slideDown) {
	        this.setState({
	          birthdateDropdownCss: '' + _WorkEdu2.default.moreDropDown,
	          showBirthUpdate: true
	        });
	      } else if (this.state.birthdateDropdownCss == '' + _WorkEdu2.default.moreDropDown) {
	        this.setState({
	          birthdateDropdownCss: _WorkEdu2.default.moreDropDown + ' ' + _WorkEdu2.default.slideDown,
	          showBirthUpdate: true
	        });
	      }
	    }
	  }, {
	    key: 'handleBirthYearDropdown',
	    value: function handleBirthYearDropdown(e) {
	      e.stopPropagation();
	      if (this.state.birthyearDropdownCss == _WorkEdu2.default.moreDropDown + ' ' + _WorkEdu2.default.slideDown) {
	        this.setState({
	          birthyearDropdownCss: '' + _WorkEdu2.default.moreDropDown
	        });
	      } else if (this.state.birthyearDropdownCss == '' + _WorkEdu2.default.moreDropDown) {
	        this.setState({
	          birthyearDropdownCss: _WorkEdu2.default.moreDropDown + ' ' + _WorkEdu2.default.slideDown
	        });
	      }
	    }
	  }, {
	    key: 'handleWebsite',
	    value: function handleWebsite() {
	      this.setState({
	    ...
	    key: 'cancelWebsite',
	    value: function cancelWebsite(e) {
	    ...
	    key: 'handleStartDate',
	    value: function handleStartDate(newDate) {
	      this.setState({ startDate: newDate });
	    }
	  }, {
	    key: 'handleUserAddress',
	    value: function handleUserAddress(event) {
	    ...
	    key: 'handleLandMark',
	    value: function handleLandMark(event) {
	      var val = _.startCase(_.toLower(event.target.value));
	      val = val.length != event.target.value.length ? event.target.value : val;
	    ...
	    value: function saveAddress(e) {
	      ...
	      var landmark = '';
	      var errors = {};
	      if (this.state.address == '') errors['addressError'] = _ref;else if (this.validateSpace(this.state.address) == true) {
	        errors['addressError'] = _ref2;
	        this.refs.address.focus();
	      }
	      if (this.state.city == '') errors['cityError'] = _ref3;else if (this.validateAplhaWithSpace(this.state.city) == false) {
	        errors['cityError'] = _ref4;
	        // this.refs.container.error("Please enter a valid city name");
	        this.refs.city.focus();
	      }
	      if (this.state.zip == '') errors['zipError'] = _ref5;else if (this.validateZip(this.state.zip) == false) {
	        errors['zipError'] = _ref6;
	      ...
	      if (!_.isEmpty(errors)) {
	        ...
	        };this.props.dispatch((0, _ProfileActions.saveUserAddress)(userAdressObj));
	      }
	    }
	  }, {
	    key: 'handleEditAddress',
	    value: function handleEditAddress() {
	    ...
	    value: function handleDeleteAddress() {
	      ...
	      alertify.confirm(this.props.intl.messages.warning, this.props.intl.messages.delete_address_alert, function (result) {
	        if (result) {
	          props.dispatch((0, _ProfileActions.deleteAddressRequest)({/*userID*/}));
	        }
	      }, function () {}).setting('labels', { 'ok': this.props.intl.messages.ok, 'cancel': this.props.intl.messages.cancel });
	    }
	  }, {
	    key: 'handleWebsiteChange',
	    value: function handleWebsiteChange(event) {
	    ...
	    key: 'saveUserWebsiteData',
	    value: function saveUserWebsiteData(e) {
	      e.preventDefault();
	      var errors = {};
	      if (this.state.website == '') {
	        errors['websiteError'] = _ref7;
	        ...
	        this.props.dispatch((0, _ProfileActions.saveUserWebsite)(userWebsiteObj));
	      }
	    }
	  }, {
	    key: 'handleSocialLink',
	    value: function handleSocialLink(event) {
	      this.setState({ socialLink: event.target.value });
	      this.validSocialStatus = this.validateUrl(event.target.value);
	    }
	  }, {
	    key: 'saveSocialLinkData',
	    value: function saveSocialLinkData(e) {
	      e.preventDefault();
	      var errors = {};
	      if (this.state.socialLink == '') {
	        errors['socialError'] = _ref9;
	        this.setState({ validationError: errors });
	        // this.refs.container.error("Please enter social link");
	        this.refs.social.focus();
	      } else if (!this.validSocialStatus) {
	        errors['socialError'] = _ref10;
	        this.setState({ validationError: errors });
	        // this.refs.container.error("Invalid format");
	        this.refs.social.focus();
	      } else {
	        ...
	        };this.props.dispatch((0, _ProfileActions.saveUserSocialLink)(userSocialObj));
	      }
	    }
	  }, {
	    key: 'handleGender',
	    ...
	    key: 'saveBasicInfo',
	    value: function saveBasicInfo(e) {
	      e.preventDefault();
	      var errors = {};
	      ...
	      if (this.state.startDate != null && this.state.gender || this.state.startDate != null) {
	        var newBDate = (0, _moment2.default)(this.state.startDate, 'DD/MM/YYYY');
	        var currentData = (0, _moment2.default)();
	        var _errors = {};
	        if (+newBDate < +currentData && this.state.startDate != null) {
	          this.setState({ validationError: {} });
	          this.props.dispatch((0, _ProfileActions.saveBasicInfoData)(userBasicInfoObj));
	        } else if (!newBDate.isValid()) {
	          _errors['dateError'] = _ref11;
	          this.setState({ validationError: _errors });
	        } else {
	          _errors['dateError'] = _ref12;
	          this.setState({ validationError: _errors });
	        }
	    ...
	    key: 'handleDeleteWebsite',
	    value: function handleDeleteWebsite() {
	      var userID = this.props.loggedInData.data._id;
	      var props = this.props;
	      alertify.confirm(this.props.intl.messages.warning, this.props.intl.messages.delete_link_alert, function (result) {
	        if (result) {
	          props.dispatch((0, _ProfileActions.deleteWebsiteRequest)({/*userID*/}));
	        }
	      }, function () {}).setting('labels', { 'ok': this.props.intl.messages.ok, 'cancel': this.props.intl.messages.cancel });
	    }
	  }, {
	    key: 'handleDeleteSocialLink',
	    value: function handleDeleteSocialLink() {
	      var userID = this.props.loggedInData.data._id;
	      var props = this.props;
	      alertify.confirm(this.props.intl.messages.warning, this.props.intl.messages.delete_social_link_alert, function (result) {
	        if (result) {
	          props.dispatch((0, _ProfileActions.deleteSocialLinkRequest)({/*userID*/}));
	        }
	      }, function () {}).setting('labels', { 'ok': this.props.intl.messages.ok, 'cancel': this.props.intl.messages.cancel });
	    }
	  }, {
	    key: 'handleDeleteBirthDay',
	    value: function handleDeleteBirthDay() {
	      var userID = this.props.loggedInData.data._id;
	      var props = this.props;
	      alertify.confirm(this.props.intl.messages.warning, this.props.intl.messages.delete_birth_day_alert, function (result) {
	        if (result) {
	          props.dispatch((0, _ProfileActions.deleteBirthDayRequest)({/*userID*/}));
	        }
	      }, function () {}).setting('labels', { 'ok': this.props.intl.messages.ok, 'cancel': this.props.intl.messages.cancel });
	    }
	  }, {
	    key: 'handleDeleteGender',
	    value: function handleDeleteGender() {
	      var userID = this.props.loggedInData.data._id;
	      var props = this.props;
	      alertify.confirm(this.props.intl.messages.warning, this.props.intl.messages.delete_gender_alert, function (result) {
	        if (result) {
	          props.dispatch((0, _ProfileActions.deleteGenderRequest)({/*userID*/}));
	        }
	      }, function () {}).setting('labels', { 'ok': this.props.intl.messages.ok, 'cancel': this.props.intl.messages.cancel });
	    }
	  }, {
	    key: 'handleEditWebsite',
	    value: function handleEditWebsite() {
	    ...
	    key: 'handleEditSocial',
	    value: function handleEditSocial() {
	    ...
	    key: 'handleEditBasic',
	    value: function handleEditBasic() {
	      ...
	      var dob = (0, _moment2.default)(dobDate).format('DD/MM/YYYY');
	      if (this.props.loggedInData && this.props.loggedInData.data && this.props.loggedInData.data.profile && this.props.loggedInData.data.profile.dateofbirth) {
	        dob = (0, _moment2.default)(dobDate).format('DD/MM/YYYY');
	      }
	      this.setState({
	        showAddInfoModal: true,
	        gender: gender,
	    ...
	    value: function render() {
	      ...
	      var _state = this.state,
	          startDateFormat = _state.startDateFormat,
	          startDateInputFormat = _state.startDateInputFormat,
	          startDateMode = _state.startDateMode;
	
	      var startDate = (0, _moment2.default)().format('DD/MM/YYYY');
	
	      var showAddAddressModal = this.state.showAddAddressModal ? _jsx(_reactBootstrap.Modal, {
	        show: this.state.showAddAddressModal,
	        onHide: this.hideAddAddressModal.bind(this)
	      }, void 0, _jsx(_Modal.Header, {
	        closeButton: true
	      }, void 0, _jsx(_Modal.Title, {
	        className: _Admin2.default.popHeadingAll
	      }, void 0, _ref14)), _jsx(_Modal.Body, {}, void 0, _jsx('form', {
	        ...
	        className: 'control-label col-md-3'
	      }, void 0, _ref15, _jsx('span', {
	        className: _component2.default.mandatory
	      }, void 0, '*'), ':'), _jsx('div', {
	        className: 'col-md-9'
	      }, void 0, _react2.default.createElement('input', { id: 'address', type: 'text', className: 'form-control', value: this.state.address, onChange: this.handleUserAddress.bind(this), ref: 'address', maxLength: 50, style: this.state.validationError && this.state.validationError.addressError ? { borderColor: "#ff0000" } : {}, autoFocus: 'true' }), _jsx('label', {
	        id: 'addressError',
	        className: _component2.default.errorPre
	      }, void 0, this.state.validationError && this.state.validationError.addressError ? this.state.validationError.addressError : ''))), _jsx('div', {
	        className: 'form-group'
	      }, void 0, _jsx('label', {
	        htmlFor: 'inputCity',
	        className: 'control-label col-md-3'
	      }, void 0, _ref16, _jsx('span', {
	        className: _component2.default.mandatory
	      }, void 0, '*'), ':'), _jsx('div', {
	        className: 'col-md-9'
	      }, void 0, _react2.default.createElement('input', { id: 'city', type: 'text', className: 'form-control', value: this.state.city, style: this.state.validationError && this.state.validationError.cityError ? { borderColor: "#ff0000" } : {},
	        onChange: this.handleCity.bind(this), ref: 'city', maxLength: 20 }), _jsx('label', {
	        id: 'cityError',
	        className: _component2.default.errorPre
	        ...
	        className: 'col-md-9'
	      }, void 0, _react2.default.createElement('input', { id: 'zip', type: 'text', className: 'form-control', value: this.state.zip, style: this.state.validationError && this.state.validationError.zipError ? { borderColor: "#ff0000" } : {},
	        onChange: this.handleZip.bind(this), ref: 'zip', maxLength: 10 }), _jsx('label', {
	        id: 'zipError',
	        className: _component2.default.errorPre
	        ...
	        onChange: this.handleLandMark.bind(this),
	        maxLength: 30
	      }))))), _jsx(_Modal.Footer, {
	        ...
	        id: 'addressCancelBtn',
	        onClick: this.hideAddAddressModal.bind(this)
	      }, void 0, _ref19), _jsx('button', {
	        id: 'addressSaveBtn',
	        className: cls_btnSaveEdit,
	        onClick: this.saveAddress.bind(this)
	      }, void 0, this.state.showAddressUpdate == true ? _ref20 : _ref21)))) : null;
	
	      var showAddInfoModal = this.state.showAddInfoModal ? _jsx(_reactBootstrap.Modal, {
	        show: this.state.showAddInfoModal,
	        onHide: this.hideAddInfoModal.bind(this)
	      }, void 0, _jsx(_Modal.Header, {
	        closeButton: true
	      }, void 0, _jsx(_Modal.Title, {
	        className: _Admin2.default.popHeadingAll
	      }, void 0, _jsx(_reactIntl.FormattedMessage, {
	        id: this.state.startDate ? 'update_basic_information' : 'add_basic_information'
	      }))), _jsx(_Modal.Body, {}, void 0, _jsx('form', {
	        className: 'form-horizontal'
	      }, void 0, _jsx('div', {
	        className: 'form-group'
	      }, void 0, _jsx('label', {
	        ...
	        htmlFor: 'inputGender',
	        className: 'control-label col-md-3'
	      }, void 0, _ref23, _jsx('span', {
	        className: _component2.default.mandatory
	      }, void 0, '*'), ':'), _jsx('div', {
	        className: 'col-md-9'
	      }, void 0, _jsx('div', {
	        className: _WorkEdu2.default.genderBlock
	      }, void 0, _jsx('input', {
	        id: 'genderMale',
	        type: 'radio',
	        name: 'gender',
	        ...
	        className: _WorkEdu2.default.genderText
	      }, void 0, _ref24), _jsx('input', {
	        id: 'genderFemale',
	        type: 'radio',
	        className: _WorkEdu2.default.genderInput,
	        name: 'gender',
	        value: 'Female',
	        onChange: this.handleGender.bind(this),
	        ...
	        className: _WorkEdu2.default.genderText
	      }, void 0, _ref25)), _jsx('label', {
	        id: 'genderError',
	        className: _component2.default.errorPre
	      }, void 0, this.state.validationError && this.state.validationError.genderError ? this.state.validationError.genderError : ''))))), _jsx(_Modal.Footer, {
	        className: _Admin2.default.mainSaveAssign
	      }, void 0, _jsx('div', {
	        className: _Admin2.default.errorSaveAssign
	      }, void 0, _jsx('label', {
	        ...
	        id: 'basicCancelBtn',
	        onClick: this.hideAddInfoModal.bind(this)
	      }, void 0, _ref26), _jsx('button', {
	        id: 'basicSaveBtn',
	        className: cls_btnSaveEdit,
	        onClick: this.saveBasicInfo.bind(this)
	      }, void 0, this.state.showBirthUpdate == true || this.state.showGenderUpdate == true ? _ref27 : _ref28)))) : null;
	
	      var showAddWebsiteBlock = this.state.showAddWebsiteBlock ? _jsx('li', {}, void 0, _jsx('div', {
	        ...
	        className: 'control-label col-md-3'
	      }, void 0, _ref29, _jsx('span', {
	        className: _component2.default.mandatory
	      }, void 0, '*'), ':'), _jsx('div', {
	        className: 'col-md-9'
	      }, void 0, _react2.default.createElement('input', (_React$createElement = { id: 'website', type: 'text', className: 'form-control', value: this.state.website, style: this.state.validationError && this.state.validationError.websiteError ? { borderColor: "#ff0000" } : {},
	        onChange: this.handleWebsiteChange.bind(this) }, _defineProperty(_React$createElement, 'id', ''), _defineProperty(_React$createElement, 'ref', 'website'), _defineProperty(_React$createElement, 'placeholder', 'https://www.google.com'), _defineProperty(_React$createElement, 'maxLength', 50), _defineProperty(_React$createElement, 'autoFocus', 'true'), _defineProperty(_React$createElement, 'onKeyPress', this.handleWesiteNameEnterKey), _React$createElement)), _jsx('label', {
	        id: 'websiteError',
	        className: _component2.default.errorPre
	      }, void 0, this.state.validationError && this.state.validationError.websiteError ? this.state.validationError.websiteError : ''))), _jsx('div', {
	        className: 'form-group'
	      }, void 0, _jsx('div', {
	        ...
	        id: 'websiteCancelBtn',
	        type: 'submit',
	        className: cls_btnCancle,
	        onClick: this.cancelWebsite.bind(this)
	      }, void 0, _ref30), _jsx('button', {
	        id: 'websiteSaveBtn',
	        type: 'submit',
	        className: cls_btnSaveEdit2,
	        onClick: this.saveUserWebsiteData.bind(this)
	      }, void 0, this.state.showWebsiteUpdate == true ? _ref31 : _ref32))))))) : null;
	
	      var showAddSocialBlock = this.state.showAddSocialBlock ? _jsx('li', {}, void 0, _jsx('div', {
	        className: _WorkEdu2.default.profileEditBlock
	      }, void 0, _jsx('form', {
	        className: 'form-horizontal'
	      }, void 0, _jsx('div', {
	        ...
	        className: 'col-md-9'
	      }, void 0, _react2.default.createElement('input', (_React$createElement2 = { id: 'socialLink', type: 'text', className: 'form-control' }, _defineProperty(_React$createElement2, 'id', ''), _defineProperty(_React$createElement2, 'value', this.state.socialLink), _defineProperty(_React$createElement2, 'style', this.state.validationError && this.state.validationError.socialError ? { borderColor: "#ff0000" } : {}), _defineProperty(_React$createElement2, 'onChange', this.handleSocialLink.bind(this)), _defineProperty(_React$createElement2, 'ref', 'social'), _defineProperty(_React$createElement2, 'placeholder', 'https://www.facebook.com/xxxxxx'), _defineProperty(_React$createElement2, 'maxLength', 50), _defineProperty(_React$createElement2, 'autoFocus', 'true'), _defineProperty(_React$createElement2, 'onKeyPress', this.handleSocialLinkEnterKey), _React$createElement2)), _jsx('label', {
	        id: 'socialError',
	        className: _component2.default.errorPre
	      }, void 0, this.state.validationError && this.state.validationError.socialError ? this.state.validationError.socialError : ''))), _jsx('div', {
	        className: 'form-group'
	      }, void 0, _jsx('div', {
	        className: 'col-md-offset-3 col-md-9'
	      }, void 0, _jsx('div', {
	        ...
	        type: 'submit',
	        className: cls_btnCancle,
	        onClick: this.cancelSocial.bind(this)
	      }, void 0, _ref34), _jsx('button', {
	        id: 'SocialSaveBtn',
	        type: 'submit',
	        className: cls_btnSaveEdit2,
	        onClick: this.saveSocialLinkData.bind(this)
	      }, void 0, this.state.showSocialUpdate == true ? _ref35 : _ref36))))))) : null;
	      ...
	      return _jsx('div', {
	      ...
	      }, void 0, _ref37), _jsx('ul', {}, void 0, !isAddressObj ? _jsx('li', {}, void 0, _jsx('div', {
	        className: addInfoBlock,
	        id: 'addAddress',
	        onClick: this.handleAddress.bind(this)
	      }, void 0, _jsx('div', {
	        className: iconBox
	      }, void 0, _ref38), _jsx('div', {
	        className: addCategoryTxtBox
	      }, void 0, _jsx('h2', {
	        className: _WorkEdu2.default.addCategoryTxt
	      }, void 0, _ref39))), showAddAddressModal) : null, isAddressObj ? _jsx('li', {}, void 0, _jsx('div', {
	        ...
	        className: _Admin2.default.txtDetailContent
	      }, void 0, userAddress), _jsx('li', {
	        className: _Admin2.default.txtDetailContent
	      }, void 0, userCity, ', ', userZip)))), userLandMark ? _jsx('div', {
	        className: 'row'
	      }, void 0, _jsx('div', {
	        className: 'col-md-3'
	      }, void 0, _jsx('div', {
	        ...
	        className: _Admin2.default.txtDetailContent
	      }, void 0, userLandMark)))) : null), _jsx('div', {
	        className: moreInfoBlock
	      }, void 0, _jsx('div', {
	        className: _WorkEdu2.default.moreIconBox,
	        onClick: this.handleAddressDropdown.bind(this)
	      }, void 0, _ref42, _jsx('div', {
	        className: this.state.addressDropdownCss
	      }, void 0, _jsx('ul', {}, void 0, _jsx('li', {
	        id: 'addressEditBtn',
	        onClick: this.handleEditAddress.bind(this)
	      }, void 0, _ref43), _jsx('li', {
	        id: 'addressSaveBtn',
	        onClick: this.handleDeleteAddress.bind(this)
	      }, void 0, _ref44)))))), showAddAddressModal) : null)), _jsx('div', {
	        className: _WorkEdu2.default.userCategoryInfo
	      }, void 0, _jsx('h2', {
	        className: _WorkEdu2.default.categoryHeading
	      }, void 0, _ref45), _jsx('ul', {}, void 0, isWebsiteObj ? this.state.showAddWebsiteBlock == false ? _jsx('li', {}, void 0, _jsx('div', {
	        className: displayInfoBlock
	      }, void 0, _jsx('div', {
	        className: singleInfoBox
	      }, void 0, _jsx('div', {
	        ...
	        href: websiteURL,
	        target: '_blank'
	      }, void 0, isWebsiteObj)))))), _jsx('div', {
	        className: moreInfoBlock
	      }, void 0, _jsx('div', {
	        id: 'websiteDropdown',
	        className: _WorkEdu2.default.moreIconBox,
	        onClick: this.handleWebsiteDropdown.bind(this)
	      }, void 0, _ref47, _jsx('div', {
	        className: this.state.websiteDropdownCss
	      }, void 0, _jsx('ul', {}, void 0, _jsx('li', {
	        id: 'websiteEditBtn',
	        onClick: this.handleEditWebsite.bind(this)
	      }, void 0, _ref48), _jsx('li', {
	        id: 'websiteDeleteBtn',
	        onClick: this.handleDeleteWebsite.bind(this)
	      }, void 0, _ref49))))))) : _jsx('div', {}, void 0, showAddWebsiteBlock) : null, !isWebsiteObj ? this.state.showAddWebsiteBlock == true ? _jsx('div', {}, void 0, showAddWebsiteBlock) : _jsx('li', {}, void 0, _jsx('div', {
	        id: 'addWebsite',
	        className: addInfoBlock,
	        onClick: this.handleWebsite.bind(this)
	      }, void 0, _jsx('div', {
	        className: iconBox
	        ...
	        className: _WorkEdu2.default.addCategoryTxt
	      }, void 0, _ref51)))) : null, isSociallinkObj ? this.state.showAddSocialBlock == false ? _jsx('li', {}, void 0, _jsx('div', {
	        className: displayInfoBlock
	      }, void 0, _jsx('div', {
	        className: singleInfoBox
	      }, void 0, _jsx('div', {
	        ...
	        href: socialURL,
	        target: '_blank'
	      }, void 0, isSociallinkObj)))))), _jsx('div', {
	        className: moreInfoBlock
	      }, void 0, _jsx('div', {
	        id: 'socialDropdown',
	        className: _WorkEdu2.default.moreIconBox,
	        onClick: this.handleSocialDropdown.bind(this)
	      }, void 0, _ref53, _jsx('div', {
	        className: this.state.socialDropdownCss
	      }, void 0, _jsx('ul', {}, void 0, _jsx('li', {
	        id: 'socialEditBtn',
	        onClick: this.handleEditSocial.bind(this)
	      }, void 0, _ref54), _jsx('li', {
	        id: 'socialDeleteBtn',
	        onClick: this.handleDeleteSocialLink.bind(this)
	      }, void 0, _ref55))))))) : _jsx('div', {}, void 0, showAddSocialBlock) : null, !isSociallinkObj ? this.state.showAddSocialBlock == true ? _jsx('div', {}, void 0, showAddSocialBlock) : _jsx('li', {}, void 0, _jsx('div', {
	        id: 'addSocialBtn',
	        className: addInfoBlock,
	        onClick: this.handleSocial.bind(this)
	      }, void 0, _jsx('div', {
	        className: iconBox
	        ...
	        className: _WorkEdu2.default.addCategoryTxt
	      }, void 0, _ref57)))) : null)), _jsx('div', {
	        className: _WorkEdu2.default.userCategoryInfo
	      }, void 0, _jsx('h2', {
	        className: _WorkEdu2.default.categoryHeading
	      }, void 0, _ref58), _jsx('ul', {}, void 0, isBasicInfoData ? _jsx('li', {}, void 0, _jsx('div', {
	        id: 'addInfo',
	        className: addInfoBlock,
	        ...
	        className: _WorkEdu2.default.addCategoryTxt
	      }, void 0, _ref60))), showAddInfoModal) : null, userBirthDate ? _jsx('li', {}, void 0, _jsx('div', {
	        className: displayInfoBlock
	      }, void 0, _jsx('div', {
	        className: singleInfoBox
	      }, void 0, _jsx('div', {
	        ...
	        className: _WorkEdu2.default.rightDetailInfo
	      }, void 0, _jsx('li', {}, void 0, userBirthDate))))), _jsx('div', {
	        className: moreInfoBlock
	      }, void 0, _jsx('div', {
	        className: _WorkEdu2.default.moreIconBox,
	        id: 'birthdayDropdown',
	        onClick: this.handleBirthDateDropdown.bind(this)
	      }, void 0, _ref62, _jsx('div', {
	        className: this.state.birthdateDropdownCss
	      }, void 0, _jsx('ul', {}, void 0, _jsx('li', {
	        id: 'editBasicBtn',
	        onClick: this.handleEditBasic.bind(this)
	      }, void 0, _ref63), _jsx('li', {
	        id: 'deleteBirthdayBtn',
	        onClick: this.handleDeleteBirthDay.bind(this)
	      }, void 0, _ref64)))))), showAddInfoModal) : null, userGender ? _jsx('li', {}, void 0, _jsx('div', {
	        className: displayInfoBlock
	      }, void 0, _jsx('div', {
	        className: singleInfoBox
	      }, void 0, _jsx('div', {
	        ...
	        className: _WorkEdu2.default.rightDetailInfo
	      }, void 0, _jsx('li', {}, void 0, userGender))))), _jsx('div', {
	        className: moreInfoBlock
	      }, void 0, _jsx('div', {
	        id: 'gender',
	        className: _WorkEdu2.default.moreIconBox,
	        onClick: this.handleGenderDropdown.bind(this)
	      }, void 0, _ref66, _jsx('div', {
	        className: this.state.genderDropdownCss
	      }, void 0, _jsx('ul', {}, void 0, _jsx('li', {
	        id: 'editBasic',
	        onClick: this.handleEditBasic.bind(this)
	      }, void 0, _ref67), _jsx('li', {
	        id: 'deleteGenderBtn',
	        onClick: this.handleDeleteGender.bind(this)
	      }, void 0, _ref68)))))), showAddInfoModal) : null)))));
	    }
	  }]);
	...
	exports.default = (0, _reactRedux.connect)(mapStateToProps)((0, _reactIntl.injectIntl)(ContactView));
