...
/***/ function(module, exports, __webpack_require__) {
	...
	var _PackageView = __webpack_require__(438);
	...
	var _PackageSchema = __webpack_require__(399);
	...
	var _PackageMenu = __webpack_require__(398);
	...
	var _ref4 = _jsx(_TopMenu2.default, {
	  data: _PackageMenu.packageViewMainMenu
	});
	
	var ViewPackage = function (_Component) {
	  _inherits(ViewPackage, _Component);
	
	  function ViewPackage(props) {
	    _classCallCheck(this, ViewPackage);
	
	    var _this = _possibleConstructorReturn(this, (ViewPackage.__proto__ || Object.getPrototypeOf(ViewPackage)).call(this, props));
	
	    _initialiseProps.call(_this);
	
	    _this.state = { loading: true };
	    _this.mainmenu = _PackageMenu.packageViewMainMenu;
	    _this.schema = _PackageSchema.packageSchema;
	
	    _this.mainmenu.menus[2].action = _this.edit.bind(_this); //this.save.bind(this);
	    _this.mainmenu.menus[1].action = _this.deletePackage.bind(_this);
	    return _this;
	  }
	  ...
	  _createClass(ViewPackage, [{
	    ...
	    value: function componentDidMount() {
	      ...
	      this.props.dispatch((0, _PackageActions.getPackageData)(this.props.params.pid)).then(function (res) {
	    ...
	    value: function setLoading() {
	      ...
	      this.props.dispatch((0, _PackageActions.ClearPackage)());
	    ...
	    value: function render() {
	      ...
	      var submenu = _PackageMenu.packageViewSubMenu;
	      return _jsx('div', {
	      ...
	      }, void 0, _jsx('ul', {}, void 0, _ref2, _ref3, _jsx('li', {}, void 0, this.props.packageData && this.props.packageData.data ? this.props.packageData.data.packageName : null))), _ref4), _jsx('div', {
	        className: cls_isubmenu
	      }, void 0, _jsx(_SubMenu2.default, {
	        data: submenu
	      })), _jsx(_PackageView2.default, {
	        packageData: this.props.packageData.data,
	...
	var _initialiseProps = function _initialiseProps() {
	  ...
	  this.edit = function () {
	    ...
	    if (response) {
	      ...
	      var packageId = _this3.props.params.pid;
	      _reactRouter.browserHistory.push('/admin/package/edit/' + packageId);
	    }
	  };
	
	  this.deletePackage = function () {
	    var packageId = _this3.props.params.pid;
	    var props = _this3.props;
	    var response = _this3.setresponse;
	
	    alertify.confirm(_this3.props.intl.messages.warning, _this3.props.intl.messages.delete_package_alert, function (result) {
	      if (result) {
	        props.dispatch((0, _PackageActions.DeletePackage)(packageId)).then(function (res) {
	          return response(res);
	        });
	      }
	  ...
	  this.setresponse = function (response) {
	    ...
	    if (response.status) {
	      _reactRouter.browserHistory.push('/admin/package/list');
	    } else {
	      _this3.refs.package_container.error(response.error + ' ', '');
	    }
	  };
	};
	...
	function mapStateToProps(state) {
	  return {
	    intl: state.intl,
	    packageData: (0, _PackageReducer.packageData)(state),
	...
	exports.default = (0, _reactRedux.connect)(mapStateToProps)(ViewPackage);
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.packageEditSubMenu = exports.packageNewSubMenu = exports.packageViewSubMenu = exports.packageListSubMenu = exports.packageMainMenu = exports.packageViewMainMenu = exports.packageEditMainMenu = exports.packageNewMainMenu = undefined;
	...
	//Main Menu
	var packageNewMainMenu = exports.packageNewMainMenu = {
			menus: [{ _id: "btnCancel", text: _jsx(_reactIntl.FormattedMessage, {
							id: 'cancel'
					}), actionType: "URL", action: "/admin/package/list", icon: "fa fa-ban" }, { _id: "btnSave", text: _jsx(_reactIntl.FormattedMessage, {
							id: 'save'
					}), actionType: "Function", action: null, icon: "fa fa-floppy-o" }]
	};
	
	var packageEditMainMenu = exports.packageEditMainMenu = {
			menus: [{ _id: "btnCancel", text: _jsx(_reactIntl.FormattedMessage, {
							id: 'cancel'
	...
	var packageViewMainMenu = exports.packageViewMainMenu = {
			menus: [{ _id: "btnList", text: _jsx(_reactIntl.FormattedMessage, {
							id: 'list'
					}), actionType: "URL", action: "/admin/package/list", icon: "fa fa-list" }, { _id: "btnDelete", text: _jsx(_reactIntl.FormattedMessage, {
							id: 'delete'
					}), actionType: "Function", action: null, icon: "fa fa-trash", role: [_roles.Roles.Superadmin] }, { _id: "btnEdit", text: _jsx(_reactIntl.FormattedMessage, {
							id: 'edit'
					}), actionType: "Function", action: null, icon: "fa fa-pencil", role: [_roles.Roles.Superadmin] }]
	};
	
	var packageMainMenu = exports.packageMainMenu = {
			menus: [{ _id: "btnNew", text: _jsx(_reactIntl.FormattedMessage, {
							id: 'new'
					}), actionType: "Function", action: null, icon: "fa fa-plus", role: [_roles.Roles.Superadmin] }]
	
			//SubMenu
	};var packageListSubMenu = exports.packageListSubMenu = {
			menus: [{ _id: "lnkPackage", text: _jsx(_reactIntl.FormattedMessage, {
							id: 'all_packages'
					}), actionType: "Function", action: null, active: "active" }]
	};
	
	var packageViewSubMenu = exports.packageViewSubMenu = {
			menus: [{ _id: "lnkPackage", text: _jsx(_reactIntl.FormattedMessage, {
							id: 'package_info'
					}), actionType: "Function", action: null, active: "active" }]
	};
	var packageNewSubMenu = exports.packageNewSubMenu = {
			menus: [{ _id: "lnkPackage", text: _jsx(_reactIntl.FormattedMessage, {
							id: 'new_package'
					}), actionType: "Function", action: null, active: "active" }]
	};
	var packageEditSubMenu = exports.packageEditSubMenu = {
			menus: [{ _id: "lnkPackage", text: _jsx(_reactIntl.FormattedMessage, {
							id: 'edit_package'
					}), actionType: "Function", action: null, active: "active" }]
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.packageSchema = undefined;
	...
	var packageSchema = exports.packageSchema = {
		_id: "PackageManager",
		formIcon: "fa fa-key",
		...
		schemas: {
			about_me: { //Position Name
				...
				{ type: "hidden", _id: "pid", text: _jsx(_reactIntl.FormattedMessage, {
						id: 'hidden'
						...
						id: 'package_info'
					}), icon: "fa fa-caret-right" }, { type: "text", _id: "packageName", text: _jsx(_reactIntl.FormattedMessage, {
						id: 'package_name'
					}), datafield: "packageName", required: true, error: "", exp: "ALPHANUMERICwithSPACE", errormsg: "", limit: 50, errorId: "packageNameError" },
				...
				{ type: "date", _id: "packageValidity", text: _jsx(_reactIntl.FormattedMessage, {
						id: 'package_validity'
					}), datafield: "packageValidity", required: true, error: "", exp: "", errormsg: "", errorId: "packageValidityError" }, { type: "text", _id: "userCount", text: _jsx(_reactIntl.FormattedMessage, {
						id: 'user_count'
					}), datafield: "userCount", required: true, error: "", exp: "LIMIT", errormsg: "", limit: 6, errorId: "userCountError" }, { type: "text", _id: "noOfRooms", text: _jsx(_reactIntl.FormattedMessage, {
						id: 'no_of_rooms'
					}), datafield: "roomCount", required: true, error: "", exp: "LIMIT", errormsg: "", limit: 6, errorId: "noOfRoomsError" },
				...
				{ type: "text", _id: "continuousPresence", text: _jsx(_reactIntl.FormattedMessage, {
						id: 'continuous_presence'
					}), datafield: "continuousPresence", required: true, error: "", exp: "LIMIT", errormsg: "", limit: 6, errorId: "continuousPresenceError" }, { type: "dynamicdropdown", _id: "serverLocation", text: _jsx(_reactIntl.FormattedMessage, {
						id: 'server_location'
					}), idfield: "serverLocation", datafield: "serverLocation", apicall: "server-list", value: "", required: true, error: "", errormsg: "", errorId: "serverLocationError" }, { type: "search", _id: "assignedTo", text: _jsx(_reactIntl.FormattedMessage, {
						id: 'assigned_to'
					}), datafield: "assignedTo", value: "", required: true, error: "", errorId: "assignedToError" }]
			},
			about_features: { //Position Name
				...
				/* commented because of no functionality, need to implement */
				{ type: "checkbox", _id: "features", text: _jsx(_reactIntl.FormattedMessage, {
						id: 'features'
					}), datafield: "features", required: true, error: "", errormsg: "", errorId: "featuresError", data: [['User Presence', 'user_presence'], ['Whiteboard', 'whiteboard'], ['Screen Share', 'screen_share'], ['Q&A', 'hand_raise'], ['Video Conference', 'video_conference'], ['Topics', 'room_topic'] /*, ['Server Recording', 'server_recording'], ['TelePresence', 'telepresence']*/] }]
			}
		}
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _ref6 = _jsx('label', {
	  htmlFor: 'Continuous Presence'
	}, void 0, _jsx(_reactIntl.FormattedMessage, {
	  id: 'continuous_presence'
	}), ':');
	
	var _ref7 = _jsx('label', {
	  htmlFor: 'Package Valid From'
	}, void 0, _jsx(_reactIntl.FormattedMessage, {
	  id: 'package_validFrom'
	}), ':');
	...
	var PackageView = exports.PackageView = function (_Component) {
	  _inherits(PackageView, _Component);
	  ...
	  function PackageView(props) {
	    ...
	    return _possibleConstructorReturn(this, (PackageView.__proto__ || Object.getPrototypeOf(PackageView)).call(this, props));
	  }
	  ...
	  _createClass(PackageView, [{
	    ...
	    value: function render() {
	      ...
	      if (this.props.packageData) {
	        ...
	        this.packageStartDate = (0, _moment2.default)(this.props.packageData.createdAt).format('DD/MM/YYYY');
	        ...
	        if (this.props.packageData.features) {
	          features = this.props.packageData.features.map(function (doc) {
	            return _jsx('div', {}, doc, ' ', doc, ' ');
	          });
	        }
	
	        var pkgVal = this.props.packageData.packageValidity;
	        pkgVal = (0, _moment2.default)(pkgVal).format('DD/MM/YYYY');
	      ...
	      }, void 0, this.packageName ? this.packageName : "-")), _jsx('div', {
	        className: cls_inlineEditGroup
	      }, void 0, _ref4, _jsx('div', {
	        className: _Admin2.default.inlineEdit
	      }, void 0, this.userCount ? this.userCount : "-")), _jsx('div', {
	        className: cls_inlineEditGroup
	      }, void 0, _ref5, _jsx('div', {
	        className: _Admin2.default.inlineEdit
	      }, void 0, this.roomCount ? this.roomCount : "-")), _jsx('div', {
	        className: cls_inlineEditGroup
	      }, void 0, _ref6, _jsx('div', {
	        className: _Admin2.default.inlineEdit
	      }, void 0, this.continuousPresence ? this.continuousPresence : "-")), _jsx('div', {
	        className: cls_inlineEditGroup
	      }, void 0, _ref7, _jsx('div', {
	        className: _Admin2.default.inlineEdit
	      }, void 0, this.packageStartDate ? this.packageStartDate : "-")), _jsx('div', {
	        className: cls_inlineEditGroup
	      }, void 0, _ref8, _jsx('div', {
	        className: _Admin2.default.inlineEdit
	      }, void 0, this.packageValidity ? this.packageValidity : "-")), _jsx('div', {
	        className: cls_inlineEditGroup
	      }, void 0, _ref9, _jsx('div', {
	        className: _Admin2.default.inlineEdit
	      }, void 0, this.location ? this.location : "-")), _jsx('div', {
	        className: cls_inlineEditGroup
	      }, void 0, _ref10, _jsx('div', {
	        className: _Admin2.default.inlineEdit
	      }, void 0, this.assignedTo ? this.assignedTo : "-"))))), _jsx(_reactBootstrap.Col, {
	        md: 6
	      }, void 0, _jsx('div', {
	        className: _Admin2.default.formField
