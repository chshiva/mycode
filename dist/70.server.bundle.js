...
/***/ function(module, exports, __webpack_require__) {
	...
	var _ref4 = _jsx('ul', {}, void 0, _jsx('li', {}, void 0, _jsx(_reactRouter.Link, {
	...
	var _ref6 = _jsx('h2', {}, void 0, _jsx('i', {
	...
	var _ref8 = _jsx('h2', {}, void 0, _jsx('i', {
	  className: '',
	  'aria-hidden': 'true'
	}), '\xA0');
	...
	var AddQuestionnaire = function (_Component) {
	  ...
	  function AddQuestionnaire(props) {
	    ...
	    var _this = _possibleConstructorReturn(this, (AddQuestionnaire.__proto__ || Object.getPrototypeOf(AddQuestionnaire)).call(this, props));
	    ...
	    _this.save = function () {
	      ...
	      if (!_.isEmpty(errors)) {
	        ...
	        _this.props.dispatch((0, _QuestionnaireActions.SaveQuestionnaireRequest)(_this.form)).then(function (res) {
	    ...
	    _this.submenu = _QuestionnaireMenu.questionnaireAddSubMenu;
	    _this.mainmenu = _QuestionnaireMenu.questionnaireAddMainMenu;
	  ...
	  _createClass(AddQuestionnaire, [{
	    ...
	    value: function setdata(result) {
	      if (result && result.data && result.data._id) {
	        ...
	        this.props.dispatch((0, _QuestionnaireActions.getCloneQuestionnaires)());
	      }
	    }
	  }, {
	    key: 'handleName',
	    ...
	    value: function render() {
	      ...
	      return _jsx('div', {
	      ...
	      }, void 0, _ref5, _jsx('div', {}, void 0, _jsx('div', {}, void 0, bredcrumb)), _jsx(_TopMenu2.default, {
	        data: this.mainmenu,
	        activeIcon: null
	      })), _jsx('div', {
	        ...
	        data: { text: _ref7 },
	        required: true
	      }), _react2.default.createElement('input', { id: 'questionnaire_name', ref: 'questionnari_name', type: 'text', className: this.state.validationError && this.state.validationError.nameError ? cls_error_element : cls_element,
	        placeholder: 'Questionnaire Name',
	        onChange: this.handleName.bind(this),
	        onKeyDown: this.handleKeyPress.bind(this),
	        maxLength: 100 }), _jsx('label', {
	        ...
	        data: { text: _ref9 },
	        required: true
	      }), _react2.default.createElement('textarea', { id: 'Description', ref: 'description', className: this.state.validationError && this.state.validationError.descriptionError ? cls_error_element : cls_element,
	        placeholder: 'Description',
	        onChange: this.handleDescription.bind(this),
	        maxLength: 150 }), _jsx('label', {
	        id: 'DescriptionError',
	        className: errcls
	...
	exports.default = (0, _reactRedux.connect)(mapStateToProps)(AddQuestionnaire);
