...
/***/ function(module, exports, __webpack_require__) {
	...
	var _ref10 = _jsx('div', {}, void 0, _jsx('p', {}, void 0, _jsx(_reactIntl.FormattedMessage, {
	  id: 'no_participants'
	})));
	
	var AddLocation = function (_Component) {
	  _inherits(AddLocation, _Component);
	  ...
	  function AddLocation(props) {
	    ...
	    _this.listlocation = function () {
	      var roomId = _this.props.params.cid;
	      _reactRouter.browserHistory.push('/admin/room/listlocation/' + roomId);
	    };
	
	    _this.saveLocation = function () {
	      if (_this.state.selectedLocation == undefined || _this.state.selectedLocation == null || _this.state.selectedLocation == '') {
	        _this.refs.room_container.error('Please select any of the location');
	      } else if (_this.clickedParticipant.length == 0) {
	        _this.refs.room_container.error('Please select any participant for location');
	      } else {
	        var locationObj = {
	          locationId: _this.state.selectedLocation,
	          locationParticipants: _this.clickedParticipant
	        };
	        var uid = _this.props.loggedInData.data._id;
	        var roomId = _this.props.params.cid;
	        _this.props.dispatch((0, _RoomActions.saveRoomLocation)({ locationObj: locationObj, uid: uid, roomId: roomId }));
	      }
	    };
	
	    _this.mainmenu = _RoomMenu.roomEditMainMenu;
	    _this.mainmenu.menus[0].action = _this.cancel.bind(_this);
	    _this.mainmenu.menus[1].action = _this.saveLocation.bind(_this);
	
	    _this.submenu = _Validator2.default.activeSubMenu(_RoomMenu.roomEditSubMenu, "lnkLocation");
	    ...
	    _this.submenu.menus[3].action = _this.feedback.bind(_this);
	    // this.submenu.menus[4].action = this.listlocation.bind(this);
	
	    _this.clickedParticipant = [];
	    _this.state = {
	      users: [],
	      selectedLocation: '',
	      flag: []
	  ...
	  _createClass(AddLocation, [{
	    ...
	    value: function setdata(result) {
	      ...
	      if (result && result.data && result.data._id) {
	        ...
	        this.props.dispatch((0, _RoomActions.getRoomLocations)(roomId)).then(function (roomData) {
	          if (roomData) {
	            _this2.props.dispatch((0, _RoomActions.getLocationList)()).then(function (result) {
	              if (result) {
	                var roomUsers = _this2.props.roomData.roomLocationList.users;
	                roomUsers.map(function (roomUsersData) {
	                  if (roomUsersData.role == 13) {
	                    var _uid = _this2.props.loggedInData.data._id;
	                    var _roomId = _this2.props.params.cid;
	                    var instructorId = roomUsersData._id;
	                    var flagArray = _this2.state.flag;
	                    var checkInstructorVisit = flagArray.includes(instructorId);
	                    if (checkInstructorVisit == true) {} else {
	                      _this2.getStudents(_uid, _roomId, instructorId);
	                    }
	                  }
	                });
	                var roomLocation = _this2.props.roomData.roomLocationList.locations;
	                if (roomLocation == null || roomLocation == undefined || roomLocation.length == 0) {
	                  ...
	                  roomLocation.map(function (roomLocationsObj) {
	    ...
	    key: 'selectedOption',
	    value: function selectedOption(e) {
	      e.preventDefault();
	      this.setState({
	    ...
	    value: function selectedParticipants(e) {
	      var selectedParticipants = this.clickedParticipant;
	    ...
	    key: 'roleName',
	    value: function roleName(data) {
	      var roleObj = _.invert(_roles.Roles);
	      var key = roleObj[data.role];
	      if (data.role == _roles.Roles.Lmsadmin || data.role == _roles.Roles.CRMadmin || data.role == _roles.Roles.Presenteradmin) {
	        key = roleObj[_roles.Roles.Admin];
	      } else if (data.role == _roles.Roles.CRMuser) {
	        key = roleObj[_roles.Roles.User];
	      }
	      return key;
	    }
	  }, {
	    key: 'getStudents',
	    value: function getStudents(uid, roomId, instructorId) {
	      var _this3 = this;
	
	      this.props.dispatch((0, _RoomActions.getinstructorStudents)({ roomId: roomId, instructorId: instructorId })).then(function (result) {
	        if (result.data == null || result.data.students.length == 0) {
	          var flagArray = _this3.state.flag;
	          ...
	          var usersArray = _this3.state.users;
	          var finalArray;
	          var flagArray = _this3.state.flag;
	          var roomLocation = _this3.props.roomData.roomLocationList.locations;
	          ...
	          if (!flagArray.includes(result.instructorId)) {
	            ...
	            studentArray.map(function (data) {
	    ...
	    value: function render() {
	      ...
	      var cls_inlineEditGroup = _Admin2.default.inlineEditGroup + ' clearfix table-responsive';
	
	      return _jsx('div', {}, void 0, this.props.roomData && this.props.roomData.locationList ? _jsx('div', {
	        ...
	        value: ''
	      }, void 0, this.props.intl.messages.select_location), this.props.roomData.locationList.map(function (data) {
	        return _jsx('option', {
	          value: data._id
	        }, data._id, data.locationName);
	      })))))), _jsx(_reactBootstrap.Row, {}, void 0, _jsx(_reactBootstrap.Col, {
	        md: 12
	      }, void 0, this.state.users.length > 0 ? _jsx('div', {
	        ...
	        className: _Admin2.default.tablestyle
	      }, void 0, _jsx('thead', {}, void 0, _jsx('tr', {}, void 0, _jsx('th', {
	        className: _Admin2.default.thStyle
	      }), _jsx('th', {
	        className: _Admin2.default.thStyle
	      }, void 0, 'Name'), _jsx('th', {
	        className: _Admin2.default.thStyle
	      }, void 0, 'Email'), _jsx('th', {
	        className: _Admin2.default.thStyle
	      }, void 0, 'Role'))), _jsx('tbody', {}, void 0, this.state.users.map(function (data) {
	        var ramdomNumber = Math.floor(Math.random(0, 9) * 100000);
	        return _jsx('tr', {}, ramdomNumber, _jsx('td', {
	          className: _Admin2.default.tdStyle
	        }, void 0, _jsx('input', {
	          type: 'checkbox',
	          value: data._id,
	          onChange: _this4.selectedParticipants.bind(_this4)
	        })), _jsx('td', {
	          className: _Admin2.default.tdStyle
	        }, void 0, _this4.combineName(data)), _jsx('td', {
	          className: _Admin2.default.tdStyle
	        }, void 0, data.email), _jsx('td', {
	          className: _Admin2.default.tdStyle
	        }, void 0, _this4.roleName(data)));
	      })))))) : _ref10)))))) : null);
	    }
	  }]);
	...
	exports.default = (0, _reactRedux.connect)(mapStateToProps)(AddLocation);
