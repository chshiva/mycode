...
/***/ function(module, exports, __webpack_require__) {
	...
	var _ref12 = _jsx('h2', {}, void 0, _jsx(_reactFontawesome2.default, {
		name: 'frown-o'
	}));
	...
	var ViewLocale = function (_Component) {
		...
		function ViewLocale(props) {
			...
			var _this = _possibleConstructorReturn(this, (ViewLocale.__proto__ || Object.getPrototypeOf(ViewLocale)).call(this, props));
			...
			_this.setdata = function (result) {
				if (result && result.data && result.data._id) {
					...
					(0, _UsersActions.getUserLocaleData)(_this.userId).then(function (res) {
			...
			_this.setresponse = function (response) {
				if (response.status) {
					_this.setState({ data: response.data && response.data.locale ? response.data.locale : null, name: response.data.firstname });
				}
			};
		...
		_createClass(ViewLocale, [{
			...
			value: function render() {
				...
				var submenu = _Validator2.default.activeSubMenu(_UserMenu.userProfileSubMenu, "lnkProfileLocale");
				var locale = this.state.data ? this.state.data : null;
				...
				}, void 0, _ref6))), locale != null ? _jsx(_reactBootstrap.Row, {}, void 0, _jsx(_reactBootstrap.Col, {
					md: 12
				}, void 0, _jsx('div', {
				...
				}, void 0, locale.timezone ? locale.timezone : "-")), _jsx('div', {
					className: cls_inlineEditGroup
				}, void 0, _ref8, _jsx('div', {
					className: _Admin2.default.inlineEdit
				}, void 0, locale.dateformat ? locale.dateformat : "-")), _jsx('div', {
					className: cls_inlineEditGroup
				}, void 0, _ref9, _jsx('div', {
					className: _Admin2.default.inlineEdit
				}, void 0, locale.timeformat ? locale.timeformat : "-")), _jsx('div', {
					className: cls_inlineEditGroup
				}, void 0, _ref10, _jsx('div', {
					className: _Admin2.default.inlineEdit
				}, void 0, locale.currencyformat ? locale.currencyformat : "-")), _jsx('div', {
					className: cls_inlineEditGroup
				}, void 0, _ref11, _jsx('div', {
					className: _Admin2.default.inlineEdit
				}, void 0, this.preferedlanguage ? this.preferedlanguage : "-")))))) : _jsx(_reactBootstrap.Row, {}, void 0, _jsx('div', {
