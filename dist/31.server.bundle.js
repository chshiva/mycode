...
/***/ function(module, exports, __webpack_require__) {
	  ...
	  function EditCategory(props) {
	    ...
	    _this.save = function (event) {
	      ...
	      if (response.error.length > 0) {
	        ...
	        _this.props.dispatch((0, _CategoryActions.UpdateCategorySchema)(_this.schema));
	      } else {
	        _this.setState({ activeIcon: event.currentTarget.id });
	        _this.props.dispatch((0, _CategoryActions.SaveCategoryRequest)(_this.form)).then(function (res) {
	    ...
	    _this.setresponse = function (response) {
	      if (response.status) {
	        _reactRouter.browserHistory.push('/admin/category/view/' + response.data._id);
	      } else {
	        _this.setState({ activeIcon: null });
	        _this.refs.corporate_container.error(response.error + ' ', '');
	        _this.props.dispatch((0, _CategoryActions.ClearCat)());
	      }
	    };
	
	    _this.view = function () {
	      var categoryId = _this.props.params.cid;
	      _reactRouter.browserHistory.push('/admin/category/view/' + categoryId);
	    };
	    ...
	    _this.res = {};
	    _this.submenu = _Validator2.default.activeSubMenu(_CategoryMenu.categoryViewToEditSubMenu, "editNewCategory");
	    _this.mainmenu = _CategoryMenu.categoryViewToEditMainMenu;
	  ...
	  _createClass(EditCategory, [{
	    ...
	    value: function setuserdata(result) {
	      ...
	      if (result && result.data && result.data._id) {
	        ...
	        this.props.dispatch((0, _CategoryActions.getCategoryData)(obj, '/admin/category/edit/' + obj.categoryId)).then(function (res) {
	          return _this2.setdata(res);
	        });
	        this.props.dispatch((0, _CategoryActions.CategoryStore)({ uid: result.data._id }));
	      }
	    }
	  }, {
	    key: 'setdata',
	    value: function setdata(result) {
	      ...
	      this.props.dispatch((0, _CategoryActions.CategoryStore)(new _DataObject2.default(result.data)));
	    }
	  }, {
	    key: 'clear',
	...
	exports.default = (0, _reactRedux.connect)(mapStateToProps)(EditCategory);
