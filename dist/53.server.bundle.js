...
/***/ function(module, exports, __webpack_require__) {
	...
	var _LocationView = __webpack_require__(437);
	...
	var _ref4 = _jsx(_TopMenu2.default, {
	  data: _LocationMenu.locationViewMainMenu
	});
	
	var _ref5 = _jsx(_SubMenu2.default, {
	  data: _LocationMenu.locationViewSubMenu
	});
	...
	var ViewLocation = function (_Component) {
	  ...
	  function ViewLocation(props) {
	    ...
	    _this.mainmenu = _LocationMenu.locationViewMainMenu;
	    ...
	    _this.mainmenu.menus[1].action = _this.deleteLocation.bind(_this);
	
	    _this.submenu = _Validator2.default.activeSubMenu(_LocationMenu.locationViewSubMenu, "lnkviewLocation");
	    _this.submenu.menus[0].action = _this.locationview.bind(_this);
	  ...
	  _createClass(ViewLocation, [{
	    ...
	    value: function setdata(result) {
	      ...
	      if (result && result.data && result.data._id) {
	        ...
	        this.props.dispatch((0, _LocationActions.getLocationData)(locationId, '/admin/location/view/' + locationId)).then(function (res) {
	    ...
	    value: function clear() {
	      this.props.dispatch((0, _LocationActions.ClearLocation)());
	    }
	  }, {
	    key: 'render',
	    value: function render() {
	      ...
	      }, void 0, _jsx('ul', {}, void 0, _ref2, _ref3, _jsx('li', {}, void 0, this.props.locationData.data.locationName))), _ref4), _jsx('div', {
	        className: cls_isubmenu
	      }, void 0, _ref5), _jsx(_LocationView2.default, {
	        locationData: this.props.locationData.data,
	        error: this.props.locationData.error,
	        success: this.props.locationData.success,
	        clear: this.clear,
	...
	var _initialiseProps = function _initialiseProps() {
	  ...
	  this.setResponse = function (response) {
	    if (!response.status) {
	      _this3.refs.location_container.error(response.error + ' ', '');
	    }
	  ...
	  this.edit = function () {
	    ...
	    if (response) {
	      _this3.props.dispatch((0, _LocationActions.UpdateLocationSchema)(response));
	      var locationId = _this3.props.params.cid;
	      _reactRouter.browserHistory.push('/admin/location/edit/' + locationId);
	    }
	  };
	  ...
	  this.deleteLocation = function () {
	    ...
	    alertify.confirm(_this3.props.intl.messages.warning, _this3.props.intl.messages.delete_location_alert, function (result) {
	      if (result) {
	        var obj = {
	          // uid : props.loggedInData.data._id,
	          locationId: locationId
	        };
	        props.dispatch((0, _LocationActions.DeleteLocation)(obj, '/admin/location/view/' + locationId));
	      }
	    }, function () {}).setting('labels', { 'ok': _this3.props.intl.messages.ok, 'cancel': _this3.props.intl.messages.cancel });
	  };
	
	  this.locationview = function () {
	    // console.log("ViewRoomSubtab");
	    var locationId = _this3.props.params.cid;
	    _reactRouter.browserHistory.push('/admin/location/view/' + locationId);
	  };
	};
	...
	exports.default = (0, _reactRedux.connect)(mapStateToProps)(ViewLocation);
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.LocationView = undefined;
	...
	var _ref = _jsx('p', {}, void 0, _jsx(_reactIntl.FormattedMessage, {
	  id: 'title_created_location_details'
	}));
	...
	var LocationView = exports.LocationView = function (_Component) {
	  _inherits(LocationView, _Component);
	
	  function LocationView() {
	    _classCallCheck(this, LocationView);
	
	    return _possibleConstructorReturn(this, (LocationView.__proto__ || Object.getPrototypeOf(LocationView)).apply(this, arguments));
	  }
	  ...
	  _createClass(LocationView, [{
	    ...
	    value: function render() {
	      ...
	      }, void 0, this.locationName ? this.locationName : "-")), _jsx('div', {
	        className: cls_inlineEditGroup
