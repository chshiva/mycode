...
/***/ function(module, exports, __webpack_require__) {
	...
	var _QuestionnaireView = __webpack_require__(452);
	
	var _QuestionnaireView2 = _interopRequireDefault(_QuestionnaireView);
	...
	var _ref4 = _jsx(_TopMenu2.default, {
	  data: _QuestionnaireMenu.questionnaireViewMainMenu
	});
	...
	var ViewQuestionnaire = function (_Component) {
	  _inherits(ViewQuestionnaire, _Component);
	
	  function ViewQuestionnaire(props) {
	    _classCallCheck(this, ViewQuestionnaire);
	
	    var _this = _possibleConstructorReturn(this, (ViewQuestionnaire.__proto__ || Object.getPrototypeOf(ViewQuestionnaire)).call(this, props));
	
	    _initialiseProps.call(_this);
	
	    _this.state = { loading: true };
	    _this.mainmenu = _QuestionnaireMenu.questionnaireViewMainMenu;
	    _this.schema = _QuestionnaireSchema.editQuestionnaireSchema;
	
	    _this.mainmenu.menus[2].action = _this.editQuestionnaire.bind(_this); //this.save.bind(this);
	    _this.mainmenu.menus[1].action = _this.deleteQuestionnaire.bind(_this);
	
	    _this.submenu = _Validator2.default.activeSubMenu(_QuestionnaireMenu.questionnaireViewSubMenu, "lnkViewQuestionnaire");
	  ...
	  _createClass(ViewQuestionnaire, [{
	    ...
	    value: function setdata(result) {
	      ...
	      if (result && result.data && result.data._id) {
	        ...
	        this.props.dispatch((0, _QuestionnaireActions.getQuestionnaireData)(obj, '/admin/questionnaire/view/' + questionnaireId)).then(function (res) {
	    ...
	    value: function render() {
	      ...
	      }, void 0, _jsx('ul', {}, void 0, _ref2, _ref3, _jsx('li', {}, void 0, this.props.questionnaireData && this.props.questionnaireData.data ? this.props.questionnaireData.data.questionnaireName : null))), _ref4), _jsx('div', {
	        className: cls_isubmenu
	      }, void 0, _ref5), _jsx(_QuestionnaireView2.default, {
	        questionnaireData: this.props.questionnaireData.data,
	        error: this.props.questionnaireData.error,
	...
	var _initialiseProps = function _initialiseProps() {
	  ...
	  this.editQuestionnaire = function () {
	    var response = _Validator2.default.freeError(_this3.schema);
	    if (response) {
	      // this.props.dispatch(UpdateQuestionnaireSchema(response));
	      var questionnaireId = _this3.props.params.cid;
	      _reactRouter.browserHistory.push('/admin/questionnaire/edit/' + questionnaireId);
	    }
	  };
	
	  this.deleteQuestionnaire = function () {
	    var questionnaireId = _this3.props.params.cid;
	    var props = _this3.props;
	    var response = _this3.setDeleteResponse;
	
	    alertify.confirm(_this3.props.intlData.messages.warning, _this3.props.intlData.messages.delete_questionaire_alert, function (result) {
	      if (result) {
	        var obj = {
	          questionnaireId: questionnaireId
	        };
	        props.dispatch((0, _QuestionnaireActions.DeleteQuestionnaire)(obj, '/admin/questionnaire/view/' + questionnaireId)).then(function (res) {
	          return response(res);
	        });
	      }
	  ...
	  this.setDeleteResponse = function (response) {
	    ...
	    var questionnaireId = _this3.props.params.cid;
	    var props = _this3.props;
	    var confirmedDelete = _this3.setConfirmedDeleteResponse;
	    if (response.httpstatuscode) {
	      alertify.confirm(_this3.props.intlData.messages.warning, '' + response.error, function (result) {
	        if (result) {
	          var obj = {
	            questionnaireId: questionnaireId,
	            dependentModule: response.dependentModule
	          };
	          props.dispatch((0, _QuestionnaireActions.ConfirmDeleteQuestionnaire)(obj, '/admin/questionnaire/view/' + questionnaireId)).then(function (res) {
	            return confirmedDelete(res);
	          });
	        }
	      }, function () {}).setting('labels', { 'ok': _this3.props.intlData.messages.ok, 'cancel': _this3.props.intlData.messages.cancel });
	      ...
	      _this3.refs.questionnaire_container.error(response.error + ' ', '');
	      _this3.props.dispatch((0, _QuestionnaireActions.ClearQuestionnaire)());
	    }
	  };
	
	  this.setConfirmedDeleteResponse = function (response) {
	...
	exports.default = (0, _reactRedux.connect)(mapStateToProps)(ViewQuestionnaire);
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.QuestionnaireView = undefined;
	...
	var _ref = _jsx('p', {}, void 0, _jsx(_reactIntl.FormattedMessage, {
	  id: 'title_questionnaire_details'
	}));
	...
	var QuestionnaireView = exports.QuestionnaireView = function (_Component) {
	  _inherits(QuestionnaireView, _Component);
	
	  function QuestionnaireView() {
	    _classCallCheck(this, QuestionnaireView);
	
	    return _possibleConstructorReturn(this, (QuestionnaireView.__proto__ || Object.getPrototypeOf(QuestionnaireView)).apply(this, arguments));
	  }
	
	  _createClass(QuestionnaireView, [{
	    ...
	    value: function render() {
	      ...
	      }, void 0, this.questionnaireName ? this.questionnaireName : "-")), _jsx('div', {
	        className: cls_inlineEditGroup
	      }, void 0, _ref4, _jsx('div', {
	        className: _Admin2.default.inlineEdit
	      }, void 0, this.description ? this.description : "-"))), _jsx('hr', {
	...
	exports.default = QuestionnaireView;
