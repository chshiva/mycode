...
/***/ function(module, exports, __webpack_require__) {
	...
	var EditUser = function (_Component) {
	  ...
	  function EditUser(props) {
	    ...
	    _this.updateschema = function (options, id) {
	      var dataObj = _this.form;
	      var schema = _this.schema;
	      var data = _this.props.userData.data;
	    ...
	    _this.view = function () {
	      _reactRouter.browserHistory.push('/admin/users/view/' + _this.props.params.viewUserId);
	    };
	    ...
	    _this.res = {};
	    _this.submenu = _Validator2.default.activeSubMenu(_UserMenu.userViewToEditSubMenu, "editNewUser");
	    _this.mainmenu = _UserMenu.userViewToEditMainMenu;
	  ...
	  _createClass(EditUser, [{
	    ...
	    value: function setuserdata(result) {
	      ...
	      if (result && result.data && result.data._id) {
	        ...
	        this.props.dispatch((0, _UsersActions.getUserData)(id, '/admin/users/edit/' + editUserId)).then(function (res) {
	          return _this2.setdata(res, uid);
	        });
	      }
	    }
	  }, {
	    key: 'setdata',
	    value: function setdata(result, uid) {
	      var _this3 = this;
	
	      /*console.log("result");
	      console.log(result);*/
	      var newData = new _DataObject2.default(result.data);
	      this.studentId = newData.studentId ? newData.studentId : "";
	      var msg = this.props.intlData.messages.company_code + ":" + newData["profile.companyid.businessId"];
	      this.setState({ headerData: msg });
	      this.form["profile.companyid"] = newData["profile.companyid._id"];
	      this.props.dispatch((0, _UsersActions.UserStore)(newData));
	      this.props.dispatch((0, _UsersActions.GetUpdateRoles)(newData._id)).then(function (res) {
	        return _this3.setupdateroles(res);
	      });
	    }
	  }, {
	    key: 'setupdateroles',
	    value: function setupdateroles(response) {
	      var newschema = this.updateschema(response.data, 'role');
	    ...
	    value: function datareceive(data) {
	      this.form = data;
	      if (data.role == _roles.Roles.Student && this.schema.schemas.other_details.company_info[1]._id !== "studentId") {
	        this.form["studentId"] = this.studentId;
	        this.schema.schemas.other_details.company_info.splice(1, 0, { type: "text", _id: "studentId", text: _ref, datafield: "studentId", exp: "ALPHANUMERIC", error: "" });
	        var newschema = this.updateschema(null, null);
	        // if( data.studentId != undefined) {
	        this.props.dispatch((0, _UsersActions.UpdateUserSchema)(this.schema));
	        // } 
	      } else if (data.role != '' && data.role != _roles.Roles.Student && this.schema.schemas.other_details.company_info[1]._id == "studentId" || data.role == "" && this.schema.schemas.other_details.company_info[1]._id == "studentId") {
	        this.schema.schemas.other_details.company_info.splice(1, 1);
	        delete this.form["studentId"];
	
	        var _newschema = this.updateschema(null, null);
	        this.props.dispatch((0, _UsersActions.UpdateUserSchema)(_newschema));
	      }
	    }
	  }, {
	    key: 'render',
	...
	exports.default = (0, _reactRedux.connect)(mapStateToProps)(EditUser);
