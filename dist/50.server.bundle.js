...
/***/ function(module, exports, __webpack_require__) {
	...
	var _LocaleView = __webpack_require__(446);
	
	var _LocaleView2 = _interopRequireDefault(_LocaleView);
	...
	var _ref3 = _jsx(_TopMenu2.default, {
	  data: _ProfileEditMenu.localeNewMainMenu
	});
	
	var ViewLocale = function (_Component) {
	  _inherits(ViewLocale, _Component);
	
	  function ViewLocale(props) {
	    _classCallCheck(this, ViewLocale);
	
	    return _possibleConstructorReturn(this, (ViewLocale.__proto__ || Object.getPrototypeOf(ViewLocale)).call(this, props));
	  }
	
	  _createClass(ViewLocale, [{
	    ...
	    value: function componentWillReceiveProps(nextProps) {
	      if (nextProps.profileData && nextProps.profileData.success && nextProps.profileData.success != "") {
	        ...
	        this.props.dispatch((0, _ProfileActions.ClearProfileRes)());
	      }
	    }
	  }, {
	    ...
	    value: function render() {
	      ...
	      var submenu = _Validator2.default.activeSubMenu(_ProfileEditMenu.profileViewSubMenu, "lnkLocale");
	      return _jsx('div', {
	...
	exports.default = (0, _reactRedux.connect)(mapStateToProps)(ViewLocale);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _ref2 = _jsx('label', {
	  htmlFor: 'Prefered Language'
	}, void 0, _jsx(_reactIntl.FormattedMessage, {
	  id: 'prefered_language'
	}), ':');
	
	var LocaleView = exports.LocaleView = function (_Component) {
	  _inherits(LocaleView, _Component);
	  ...
	  function LocaleView(props) {
	    _classCallCheck(this, LocaleView);
	
	    var _this = _possibleConstructorReturn(this, (LocaleView.__proto__ || Object.getPrototypeOf(LocaleView)).call(this, props));
	
	    _this.strTimezone = '';
	    _this.strDateformat = '';
	    _this.strTimeformat = '';
	    _this.strCurrencyformat = '';
	    _this.strPreferedlanguage = '';
	
	    return _this;
	  }
	
	  _createClass(LocaleView, [{
	    key: 'componentDidMount',
	    value: function componentDidMount() {
	    ...
	    value: function render() {
	      ...
	      }, void 0, this.strPreferedlanguage ? this.strPreferedlanguage : "-")))))))));
	    }
	  }]);
