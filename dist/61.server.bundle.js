...
/***/ function(module, exports, __webpack_require__) {
	...
	var _ref5 = _jsx('li', {}, void 0, _jsx(_reactRouter.Link, {
	  to: '/admin/room/list'
	...
	var ListResults = function (_Component) {
	  _inherits(ListResults, _Component);
	
	  function ListResults(props) {
	    _classCallCheck(this, ListResults);
	
	    var _this = _possibleConstructorReturn(this, (ListResults.__proto__ || Object.getPrototypeOf(ListResults)).call(this, props));
	    ...
	    _this.submenu = _RoomMenu.listResultSubMenu;
	  ...
	  _createClass(ListResults, [{
	    ...
	    value: function getData(pageParam) {
	      ...
	      this.props.dispatch((0, _RoomActions.TopicResultList)(pageParam, pageParam.currentPage)).then(function (res) {
	    ...
	    value: function questionnaireName(row) {
	      if (row.questionnaireId == null) {
	        return _ref;
	      } else {
	        return _jsx('div', {}, void 0, row.questionnaireId.questionnaireName);
	      }
	    }
	  }, {
	    key: 'candidateName',
	    value: function candidateName(row) {
	      if (row.submittedBy == null) {
	        return _ref2;
	      } else {
	        var candidateName = row.submittedBy.firstname + " " + row.submittedBy.lastname;
	        return _jsx('div', {}, void 0, candidateName);
	      }
	    }
	  }, {
	    key: 'roomName',
	    value: function roomName(row) {
	      if (row.roomId == null) {
	        return _ref3;
	      } else {
	        var roomName = row.roomId.roomName;
	        return _jsx('div', {}, void 0, roomName);
	      }
	    }
	  }, {
	    key: 'viewResults',
	    value: function viewResults(row) {
	      ...
	      return _jsx(_reactRouter.Link, {
	        id: 'questionnaireResult',
	        to: link
	      }, void 0, _ref4);
	    }
	  }, {
	    key: 'questionnaireResult',
	    value: function questionnaireResult(row) {
	      return _jsx('div', {}, void 0, _jsx('span', {}, void 0, row.questionnairePercentage, '% '), _jsx('span', {}, void 0, 'Grade ', row.grade));
	    }
	  }, {
	    key: 'render',
	    value: function render() {
	
	      var cls_failColor = _component2.default.gradeColor + ' ' + _component2.default.red;
	
	      var bredcrumb = _jsx('div', {
	        className: _component2.default.dynamicBreadCrumb
	      }, void 0, _jsx('ul', {}, void 0, _ref5, _ref6, _jsx('li', {}, void 0, _jsx(_reactRouter.Link, {
	        onClick: this.viewroom
	      }, void 0, this.props.roomData.data.roomName)), _ref7, _jsx('li', {}, void 0, _jsx(_reactRouter.Link, {
	        onClick: this.listtopic
	      }, void 0, _ref8)), _ref9, _jsx('li', {}, void 0, _jsx(_reactRouter.Link, {
	        onClick: this.viewQuestionnaire
	      }, void 0, this.props.roomData.topicdata.topicName)), _ref10, _ref11));
	
	      var objDisp = [{ title: _ref12, type: "function", callback: this.candidateName }, { title: _ref13, type: "function", callback: this.questionnaireName }, { title: _ref14, type: "function", callback: this.roomName }, { title: _ref15, type: "function", callback: this.questionnaireResult }, { title: _ref16, type: "function", callback: this.viewResults }];
	      ...
	      return _jsx('div', {}, void 0, _react2.default.createElement(_lib.ToastContainer, {
	        ...
	        data: this.props.roomData.resultList,
	...
	exports.default = (0, _reactRedux.connect)(mapStateToProps)(ListResults);
