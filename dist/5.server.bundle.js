...
/***/ function(module, exports, __webpack_require__) {
	...
	var _TopicViewedUsersReport = __webpack_require__(473);
	
	var _TopicViewedUsersReport2 = _interopRequireDefault(_TopicViewedUsersReport);
	
	var _AllTopicsViewedUsersReport = __webpack_require__(465);
	
	var _AllTopicsViewedUsersReport2 = _interopRequireDefault(_AllTopicsViewedUsersReport);
	
	var _UserViewedTopics = __webpack_require__(474);
	
	var _UserViewedTopics2 = _interopRequireDefault(_UserViewedTopics);
	
	var _AllUsersViewedTopicsReport = __webpack_require__(467);
	
	var _AllUsersViewedTopicsReport2 = _interopRequireDefault(_AllUsersViewedTopicsReport);
	...
	var _ref2 = _jsx('li', {}, void 0, '/');
	
	var _ref3 = _jsx('li', {}, void 0, '/');
	
	var _ref4 = _jsx(_TopMenu2.default, {
	  data: _RoomMenu.roomReportsMainMenu
	});
	
	var _ref5 = _jsx(_SubMenu2.default, {
	  data: _RoomMenu.roomReportsSubMenu
	});
	
	var RoomTopicsReport = function (_Component) {
	  _inherits(RoomTopicsReport, _Component);
	
	  function RoomTopicsReport(props) {
	    _classCallCheck(this, RoomTopicsReport);
	
	    var _this = _possibleConstructorReturn(this, (RoomTopicsReport.__proto__ || Object.getPrototypeOf(RoomTopicsReport)).call(this, props));
	
	    _this.topicsReport = function () {
	      var roomId = _this.props.params.cid;
	      _reactRouter.browserHistory.push('/admin/room/reports/topic/' + roomId);
	    };
	    ...
	    _this.handleTypeChange = function (e) {
	      ...
	      if (e.target.value == 'TOPICS') {
	        _this.setState({ topicId: 'ALL' });
	        _this.props.dispatch((0, _RoomActions.getCourseTopicsData)(_this.props.params.cid)).then(function (res) {
	          return _this.setOptionData(res);
	        });
	      } else {
	        _this.setState({ userId: 'ALL' });
	        _this.props.dispatch((0, _RoomActions.getTopicUsersData)(_this.props.params.cid)).then(function (res) {
	          return _this.setOptionData(res);
	        });
	      }
	    };
	    ...
	    _this.handleSelectChange = function (e) {
	      ...
	      if (_this.state.type == 'TOPICS') {
	        if (e.target.value == 'ALL') {
	          ...
	          var _index = e.target.selectedIndex;
	          _this.setState({
	            topicId: e.target.value,
	            topicName: e.target.options[_index].text
	          });
	        }
	      } else if (_this.state.type == 'USERS') {
	        if (e.target.value == 'ALL') {
	          var _index2 = e.target.selectedIndex;
	
	          _this.setState({
	            userId: e.target.value,
	            userName: e.target.options[_index2].text
	          });
	        } else {
	          var _index3 = e.target.selectedIndex;
	          _this.setState({
	            userId: e.target.value,
	            userName: e.target.options[_index3].text
	          });
	        }
	      }
	    };
	    ...
	    _this.handleSubmit = function (e) {
	      if (_this.state.type == 'TOPICS') {
	        ...
	        if (_this.state.topicId == 'ALL') {
	          var obj = {
	            topicId: _this.state.topicId,
	            topicName: _this.state.topicName,
	            userName: _this.props.intlData.messages.all
	          };
	        ...
	        _this.setState({
	          topicName: _this.props.intlData.messages.all
	        });
	
	        if (_this.state.userId == 'ALL') {
	    ...
	    _this.hideDropDowns = function (data) {
	      _this.setState({ showDropdowns: data });
	    };
	
	    _this.handleViewedTopicUsers = function (event) {
	      if (event.point.listIds && event.point.listIds.length > 0) {
	        _this.setState({
	          listIds: event.point.listIds,
	          showViewedTopicUserList: true
	        });
	        _this.props.hideDropDowns(false);
	      }
	    };
	    ...
	    _this.submenu = _Validator2.default.activeSubMenu(_RoomMenu.roomReportsSubMenu, "lnkTopics");
	  ...
	  _createClass(RoomTopicsReport, [{
	    ...
	    value: function componentDidMount() {
	      ...
	      this.props.dispatch((0, _RoomActions.getCourseTopicsData)(this.props.params.cid)).then(function (res) {
	        return _this2.setOptionData(res);
	      });
	    }
	  }, {
	    key: 'setOptionData',
	    value: function setOptionData(res) {
	    ...
	    value: function render() {
	      ...
	      var cls_btnApplyAll = _Admin2.default.btnApplyAll + ' ';
	
	      var removePdng = _Admin2.default.removePdng + ' control-label col-md-9';
	      var addpdng = _Admin2.default.addpdng + ' form-group clearfix';
	      var rangeLabel = _Admin2.default.lineHight32 + ' control-label col-md-3';
	      var applyBtn = _Admin2.default.applyBtn + ' ' + _Admin2.default.addpdng;
	
	      var fileterTypeOptions = [{ 'id': 'TOPICS', 'name': this.props.intlData.messages.topics }, { 'id': 'USERS', 'name': this.props.intlData.messages.topic_users }];
	
	      var courseId = this.props.params.cid;
	      var link = "/admin/room/view/" + courseId;
	      ...
	      return _jsx('div', {
	        ...
	        to: '/admin/room/list'
	      }, void 0, this.props.intlData.messages.all_rooms)), _ref2, _jsx('li', {}, void 0, _jsx(_reactRouter.Link, {
	        to: link
	      }, void 0, this.props.roomData.data.roomName)), _ref3, _jsx('li', {}, void 0, this.props.intlData.messages.reports))), _ref4), _jsx('div', {
	        className: cls_isubmenu
	      }, void 0, _ref5), _jsx('div', {
	        className: _Admin2.default.midContainer
	      }, void 0, _jsx('div', {}, void 0, this.state.showDropdowns == true ? _jsx(_reactBootstrap.Grid, {
	        fluid: true
	      }, void 0, _jsx(_reactBootstrap.Row, {}, void 0, _jsx(_reactBootstrap.Col, {
	        md: 12
	      }, void 0, _jsx('div', {
	        className: _Admin2.default.dateControls
	      }, void 0, _jsx('div', {
	        className: _Admin2.default.dateRange
	      }, void 0, _jsx('div', {
	        className: addpdng
	      }, void 0, _jsx('label', {
	        className: 'control-label'
	      }, void 0, ' ', this.props.intlData.messages.type, ' :'), _jsx('select', {
	        id: 'topicReportType',
	        className: 'form-control',
	        onChange: this.handleTypeChange,
	        value: this.state.type
	      }, void 0, fileterTypeOptions.map(function (data) {
	        return _jsx('option', {
	          value: data.id
	        }, data.id, ' ', data.name, ' ');
	      })))), _jsx('div', {
	        ...
	        className: 'control-label'
	      }, void 0, ' ', this.props.intlData.messages.select, ' :'), _jsx('select', {
	        id: 'topicDropdown',
	        className: 'form-control',
	        onChange: this.handleSelectChange,
	        value: this.state.type == 'TOPICS' ? this.state.topicId : this.state.userId
	      }, void 0, _jsx('option', {
	        value: 'ALL'
	      }, void 0, this.props.intlData.messages.all), this.state.filterData.map(function (data) {
	        return _this3.state.type == 'TOPICS' ? _jsx('option', {
	          value: data._id
	        }, data._id, ' ', data.topicName) : _jsx('option', {
	          value: data._id
	        ...
	        id: 'save',
	        type: 'submit',
	        value: this.props.intlData.messages.apply,
	        className: cls_btnApplyAll,
	        onClick: this.handleSubmit
	      }))))))) : null), _jsx('div', {}, void 0, this.state.showReport == "TOPIC" ? _jsx(_TopicViewedUsersReport2.default, {
	        data: this.state.data,
	        hideDropDowns: this.hideDropDowns,
	        courseId: courseId
	      }) : this.state.showReport == "ALLUSERS" ? _jsx(_AllUsersViewedTopicsReport2.default, {
	        data: this.state.data,
	        courseId: courseId,
	        hideDropDowns: this.hideDropDowns
	      }) : this.state.showReport == "USER" ? _jsx(_UserViewedTopics2.default, {
	        data: this.state.data,
	        courseId: courseId,
	        hideDropDowns: this.hideDropDowns
	      }) : _jsx(_AllTopicsViewedUsersReport2.default, {
	        data: this.state.data,
	        courseId: courseId,
	        hideDropDowns: this.hideDropDowns
	      }))));
	...
	exports.default = (0, _reactRedux.connect)(mapStateToProps)(RoomTopicsReport);
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.ListUserToRoom = undefined;
	...
	var _ref3 = _jsx('p', {}, void 0, _jsx(_reactIntl.FormattedMessage, {
	  id: 'title_contact_details'
	}), '.');
	
	var ListUserToRoom = exports.ListUserToRoom = function (_Component) {
	  _inherits(ListUserToRoom, _Component);
	
	  function ListUserToRoom(props) {
	    _classCallCheck(this, ListUserToRoom);
	
	    var _this = _possibleConstructorReturn(this, (ListUserToRoom.__proto__ || Object.getPrototypeOf(ListUserToRoom)).call(this, props));
	
	    _this.setresponse = function (response) {
	      if (response.status) {
	        _this.refs.room_container.success(response.message + ' ', '');
	      } else {
	        _this.refs.room_container.error(response.error + ' ', '');
	      }
	    };
	  ...
	  _createClass(ListUserToRoom, [{
	    ...
	    value: function setdata(result) {
	      ...
	      if (result.data && result.data._id) {
	        ...
	        this.props.dispatch((0, _RoomActions.getRoomData)(obj, '')).then(function (res) {
	    ...
	    value: function removeUser(userId) {
	      ...
	      alertify.confirm(this.props.intl.messages.warning, this.props.intl.messages.delete_room_user_alert, function (result) {
	        if (result) {
	          var obj = {
	            userId: userId,
	            roomId: roomId
	          };
	          props.dispatch((0, _RoomActions.removeRoomUser)(obj)).then(function (res) {
	            return response(res);
	          });
	        }
	    ...
	    value: function render() {
	      ...
	      if (this.props.roomData && this.props.roomData.data && this.props.roomData.data.users && this.props.roomData.data.users.length > 0) {
	        var roomUsers = this.props.roomData.data.users;
	        var roomId = this.props.roomData.data._id;
	        var uid = this.props.loggedInData.data._id;
	
	        // console.log("---", roomUsers);
	        listUsers = roomUsers.map(function (roomUser) {
	          if (roomUser._id == uid) {
	            mydata = _jsx(_ListItem2.default, {
	              value: roomUser,
	              roomId: roomId,
	              addStud: 'true',
	              getUserId: _this3.removeUser.bind(_this3),
	              classname: 'times',
	              classTitle: _this3.props.intl.messages.remove_user_from_room
	            }, roomUser._id);
	            return null;
	          } else {
	      ...
	      return _jsx('div', {
	        ...
	        className: _Admin2.default.headingBlock
	      }, void 0, _jsx('h2', {
	        className: _Admin2.default.headingTxt
	      }, void 0, _ref2, ' - ', _jsx('b', {}, void 0, this.props.roomData.data.roomName))), _jsx('div', {
	      ...
	      }, void 0, _ref3))), _jsx(_reactBootstrap.Row, {}, void 0, _jsx(_reactBootstrap.Col, {
	        md: 12
	      }, void 0, _jsx('div', {
	        className: _Admin2.default.userListGroup
	      }, void 0, _jsx('ul', {}, void 0, mydata, listUsers)))))));
	    }
	  }]);
	
	  return ListUserToRoom;
	}(_react.Component);
	...
	exports.default = (0, _reactRedux.connect)(mapStateToProps)((0, _reactIntl.injectIntl)(ListUserToRoom));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ShowAllTopicsList = function (_Component) {
	  _inherits(ShowAllTopicsList, _Component);
	
	  function ShowAllTopicsList(props) {
	    _classCallCheck(this, ShowAllTopicsList);
	
	    var _this = _possibleConstructorReturn(this, (ShowAllTopicsList.__proto__ || Object.getPrototypeOf(ShowAllTopicsList)).call(this, props));
	  ...
	  _createClass(ShowAllTopicsList, [{
	    key: 'componentWillReceiveProps',
	    value: function componentWillReceiveProps(nextProps) {
	    ...
	    value: function getData(pageParam) {
	      ...
	      this.props.dispatch((0, _RoomActions.getCourseTopicsList)(pageParam, pageParam.currentPage)).then(function (res) {
	    ...
	    key: 'showTopicName',
	    value: function showTopicName(row) {
	      //change by : pranathi, disc: only 50 charecters are showing in  topicName
	      if (row.topicName && row.topicName.length > 50) {
	        var topicName = row.topicName.substring(0, 50) + '...';
	        return _jsx('div', {}, void 0, topicName);
	      } else {
	        return _jsx('div', {}, void 0, row.topicName);
	      }
	    }
	  }, {
	    key: 'showDescription',
	    value: function showDescription(row) {
	      //change by : pranathi, disc: only 50 charecters are showing in  description
	      if (row.description && row.description.length > 50) {
	        var description = row.description.substring(0, 50) + '...';
	    ...
	    value: function render() {
	      ...
	      var cls_backButton = ' ' + _Admin2.default.btnApplyAll + ' ' + _Admin2.default.backButton + ' ';
	      var objDisp = [{ title: _ref, type: "function", callback: this.showTopicName }, { title: _ref2, type: "function", callback: this.showDescription }];
	
	      var filter = [(_ref3 = { type: 'search' }, _defineProperty(_ref3, 'type', 'topicSearch'), _defineProperty(_ref3, 'selectedfilter', this.searchFilter), _ref3)];
	      ...
	      return _jsx('div', {}, void 0, _react2.default.createElement(_lib.ToastContainer, {
	        ...
	        data: this.props.roomData.topicViewedList,
	...
	exports.default = (0, _reactRedux.connect)(mapStateToProps)(ShowAllTopicsList);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _AllTopicsViewedUsersList = __webpack_require__(464);
	
	var _AllTopicsViewedUsersList2 = _interopRequireDefault(_AllTopicsViewedUsersList);
	...
	var AllTopicsViewedUsers = function (_Component) {
	  _inherits(AllTopicsViewedUsers, _Component);
	
	  function AllTopicsViewedUsers(props) {
	    _classCallCheck(this, AllTopicsViewedUsers);
	
	    var _this = _possibleConstructorReturn(this, (AllTopicsViewedUsers.__proto__ || Object.getPrototypeOf(AllTopicsViewedUsers)).call(this, props));
	
	    _this.handleAllTopicsList = function (event) {
	      if (event.point.listIds && event.point.listIds.length > 0) {
	        _this.setState({
	          listIds: event.point.listIds,
	    ...
	    _this.backToReport = function (e) {
	      ...
	      _this.props.hideDropDowns(true);
	    };
	  ...
	  _createClass(AllTopicsViewedUsers, [{
	    key: 'componentDidMount',
	    value: function componentDidMount() {
	      var _this2 = this;
	      ...
	      this.props.dispatch((0, _RoomActions.getTopicViewedUsersRequest)(this.props.data)).then(function (res) {
	    ...
	    value: function componentWillReceiveProps(nextProps) {
	      ...
	      if (!_.isEqual(nextProps.data, this.props.data)) {
	        ...
	        this.props.dispatch((0, _RoomActions.getTopicViewedUsersRequest)(data)).then(function (res) {
	    ...
	    value: function render() {
	      ...
	      if (this.state.chartData != '') {
	        ...
	        var self = this;
	        var title = self.props.data.topicName + ' - ' + this.props.intlData.messages.viewed_users;
	        var options = {
	          chart: {
	      ...
	      return _jsx('div', {}, void 0, this.state.loading ? _jsx('div', {
	        ...
	        loadType: loadType
	      })))) : _jsx('div', {}, void 0, this.state.showAllTopicsList == true ? _jsx(_AllTopicsViewedUsersList2.default, {
	        listIds: this.state.listIds,
	        courseId: this.props.courseId,
	        backToReport: this.backToReport
	      }) : _jsx('div', {
	        className: _Admin2.default.attendenceBlockControl
	      }, void 0, this.state.chartData != '' ? _jsx('div', {
	...
	exports.default = (0, _reactRedux.connect)(mapStateToProps)(AllTopicsViewedUsers);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _ListUserToRoom = __webpack_require__(386);
	
	var _ListUserToRoom2 = _interopRequireDefault(_ListUserToRoom);
	...
	var _ref2 = _jsx('div', {}, void 0, ' Inprogress');
	
	var _ref3 = _jsx('div', {}, void 0, ' Completed ');
	
	var _ref4 = _jsx('div', {}, void 0, ' -- ');
	...
	var AllUsersViewedTopics = function (_Component) {
	  _inherits(AllUsersViewedTopics, _Component);
	
	  function AllUsersViewedTopics(props) {
	    _classCallCheck(this, AllUsersViewedTopics);
	
	    var _this = _possibleConstructorReturn(this, (AllUsersViewedTopics.__proto__ || Object.getPrototypeOf(AllUsersViewedTopics)).call(this, props));
	  ...
	  _createClass(AllUsersViewedTopics, [{
	    key: 'componentWillReceiveProps',
	    value: function componentWillReceiveProps(nextProps) {
	      if (nextProps.roomData.success != '') {
	        this.refs.room_container.success(nextProps.roomData.success + ' ', '');
	    ...
	    value: function getData(pageParam) {
	      ...
	      this.props.dispatch((0, _RoomActions.getuserViewedALLTopicsList)(pageParam, pageParam.currentPage)).then(function (res) {
	        return _this2.pageData(res);
	      });
	    }
	  }, {
	    ...
	    value: function showTopicName(row) {
	      ...
	      if (row.value && row.value.topicId && row.value.topicId != undefined && row.value.topicId.topicName) {
	        if (row.value.topicId.topicName.length > 50) {
	          var topicName = row.value.topicId.topicName.substring(0, 50) + '...';
	          return _jsx('div', {}, void 0, topicName);
	        } else {
	          return _jsx('div', {}, void 0, row.value.topicId.topicName);
	        }
	      } else {
	        return _ref;
	      }
	    ...
	    value: function render() {
	      var cls_backButton = ' ' + _Admin2.default.btnApplyAll + ' ' + _Admin2.default.backButton + ' ';
	      var objDisp = [{ title: _ref5, type: "function", callback: this.showTopicName }, { title: _ref6, type: "function", callback: this.showStatus }];
	...
	exports.default = (0, _reactRedux.connect)(mapStateToProps)(AllUsersViewedTopics);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _AllUsersViewedTopicsList = __webpack_require__(466);
	
	var _AllUsersViewedTopicsList2 = _interopRequireDefault(_AllUsersViewedTopicsList);
	...
	var AllUsersViewedTopics = function (_Component) {
	    ...
	    function AllUsersViewedTopics(props) {
	        ...
	        _this.handleList = function (userId, listIds, percent, e) {
	            if (percent > 0) {
	                _this.setState({
	                    showList: true,
	                    userId: userId,
	    ...
	    _createClass(AllUsersViewedTopics, [{
	        ...
	        value: function componentDidMount() {
	            ...
	            this.props.dispatch((0, _RoomActions.getUserViewedTopics)(this.props.data)).then(function (res) {
	                return _this2.setData(res);
	            });
	        }
	    }, {
	        ...
	        value: function componentWillReceiveProps(nextProps) {
	            ...
	            if (!_.isEqual(nextProps.data, this.props.data)) {
	                var data = nextProps.data;
	                data['courseId'] = nextProps.courseId;
	                this.props.dispatch((0, _RoomActions.getUserViewedTopics)(data)).then(function (res) {
	                    return _this3.setData(res);
	                });
	            }
	        }
	        ...
	        value: function render() {
	            ...
	            var progressLabel = _Admin2.default.progressLabel + ' progress-label col-md-2 ';
	            var progress = _Admin2.default.progress + ' progress col-md-10';
	            var progressBar = _Admin2.default.progressBar + ' progress-bar progress-bar-striped progress-bar-info';
	
	            var dataForList = this.state.prorassData;
	            var topicsCount = this.state.totalTopicsCount;
	            var loadType = 'list';
	            ...
	            return _jsx('div', {}, void 0, this.state.loading ? _jsx('div', {
	                ...
	                loadType: loadType
	            })))) : _jsx('div', {}, void 0, this.state.showList == true ? _jsx(_AllUsersViewedTopicsList2.default, {
	                ...
	                className: _Admin2.default.attendenceBlockControl
	            }, void 0, _jsx('p', {}, void 0, this.props.intlData.messages.topics_viewed), this.state.showChart == true ? _jsx('div', {
	                className: _Admin2.default.whiteCard
	            }, void 0, dataForList.map(function (data, index) {
	
	                var percentage = (1 / topicsCount * data.countOfCompleted + 1 / (topicsCount * 2) * data.countOfInProgress) * 100;
	
	                var percent = percentage + '%';
	                return _jsx('div', {
	                    className: _Admin2.default.progressBox
	                }, index, _jsx('ul', {}, void 0, _jsx('li', {
	                    className: 'clearfix'
	                }, void 0, _jsx('row', {}, void 0, _jsx('div', {
	                    className: progressLabel
	                }, void 0, ' ', data.username, ' :'), _jsx('div', {
	                    className: progress
	                }, void 0, _jsx('div', {
	                    className: progressBar,
	                    style: { width: percent },
	                    onClick: _this4.handleList.bind(_this4, data.userId, data.viewedTopicIds, percentage),
	                    max: '100'
	                }, void 0, percent))))));
	            })) : _jsx('div', {
	                className: _Admin2.default.whiteCard
...
/***/ function(module, exports, __webpack_require__) {
	...
	var TopicViewedUsersList = function (_Component) {
	  _inherits(TopicViewedUsersList, _Component);
	
	  function TopicViewedUsersList(props) {
	    _classCallCheck(this, TopicViewedUsersList);
	
	    var _this = _possibleConstructorReturn(this, (TopicViewedUsersList.__proto__ || Object.getPrototypeOf(TopicViewedUsersList)).call(this, props));
	  ...
	  _createClass(TopicViewedUsersList, [{
	    key: 'componentWillReceiveProps',
	    value: function componentWillReceiveProps(nextProps) {
	      if (nextProps.roomData.success != '') {
	        this.refs.room_container.success(nextProps.roomData.success + ' ', '');
	    ...
	    value: function getData(pageParam) {
	      ...
	      this.props.dispatch((0, _RoomActions.getTopicViewedUsersList)(pageParam, pageParam.currentPage)).then(function (res) {
	        return _this2.pageData(res);
	      });
	    }
	  }, {
	    ...
	    key: 'showUserName',
	    value: function showUserName(row) {
	      return _jsx('a', {
	        className: _Admin2.default.removeStyle
	      }, void 0, row.firstname, '  ', row.lastname);
	    }
	  }, {
	    key: 'showEmail',
	    value: function showEmail(row) {
	
	      return _jsx('div', {}, void 0, ' ', row.email);
	    }
	  }, {
	    key: 'render',
	    value: function render() {
	      ...
	      var cls_backButton = ' ' + _Admin2.default.btnApplyAll + ' ' + _Admin2.default.backButton + ' ';
	      var objDisp = [{ title: _ref, type: "function", callback: this.showUserName }, { title: _ref2, type: "function", callback: this.showEmail.bind(this) }];
	
	      var filter = [{ type: 'search', id: 'userSearch', selectedfilter: this.searchFilter }];
	      ...
	      return _jsx('div', {}, void 0, _react2.default.createElement(_lib.ToastContainer, {
	        ...
	        onClick: this.props.backToReport,
	        style: { marginLeft: "16px" }
	      }, void 0, this.props.intlData.messages.back_to_reports)), _jsx(_reactBootstrap.Col, {
	        md: 12
	      }, void 0, _jsx('div', {
	        className: _Admin2.default.topicNameReport
	      }, void 0, _jsx('p', {}, void 0, _ref3, ': ', this.props.topicName)))), _jsx(_DataTable2.default, {
	        data: this.props.roomData.topicViewedList,
	        count: this.props.roomData.topicListCount,
	        currentPage: this.props.roomData.currentListPage,
	        submenu: null,
	...
	exports.default = (0, _reactRedux.connect)(mapStateToProps)(TopicViewedUsersList);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _TopicViewedUsersList = __webpack_require__(472);
	
	var _TopicViewedUsersList2 = _interopRequireDefault(_TopicViewedUsersList);
	...
	var TopicViewedUsers = function (_Component) {
	  _inherits(TopicViewedUsers, _Component);
	
	  function TopicViewedUsers(props) {
	    _classCallCheck(this, TopicViewedUsers);
	
	    var _this = _possibleConstructorReturn(this, (TopicViewedUsers.__proto__ || Object.getPrototypeOf(TopicViewedUsers)).call(this, props));
	  ...
	  _createClass(TopicViewedUsers, [{
	    ...
	    value: function render() {
	      ...
	      return _jsx('div', {}, void 0, this.state.loading ? _jsx('div', {
	        ...
	        loadType: loadType
	      })))) : _jsx('div', {}, void 0, this.state.showViewedTopicUserList == true ? _jsx(_TopicViewedUsersList2.default, {
	        listIds: this.state.listIds,
	        courseId: this.props.data.courseId,
	        backToReport: this.backToReport,
	        topicId: this.props.data.topicId,
	        topicName: this.props.data.topicName
	      }) : _jsx('div', {
	        className: _Admin2.default.attendenceBlockControl
	      }, void 0, _jsx('div', {}, void 0, this.state.chartData != '' ? _jsx('div', {
	        className: _Admin2.default.chartBlock
	      }, void 0, _jsx(_Chart2.default, {
	        container: 'chart',
	        options: options
	...
	exports.default = (0, _reactRedux.connect)(mapStateToProps)(TopicViewedUsers);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _UserViewedTopicsList = __webpack_require__(475);
	
	var _UserViewedTopicsList2 = _interopRequireDefault(_UserViewedTopicsList);
	...
	var UserViewedTopics = function (_Component) {
	    _inherits(UserViewedTopics, _Component);
	
	    function UserViewedTopics(props) {
	        _classCallCheck(this, UserViewedTopics);
	
	        var _this = _possibleConstructorReturn(this, (UserViewedTopics.__proto__ || Object.getPrototypeOf(UserViewedTopics)).call(this, props));
	    ...
	    _createClass(UserViewedTopics, [{
	        ...
	        value: function componentWillReceiveProps(nextProps) {
	            ...
	            if (!_.isEqual(nextProps.data, this.props.data)) {
	                var data = nextProps.data;
	                data['courseId'] = nextProps.courseId;
	                this.props.dispatch((0, _RoomActions.getUserViewedTopics)(nextProps.data)).then(function (res) {
	                    return _this3.setData(res);
	                });
	            }
	        }
	        ...
	        key: 'handleUserViewedTopics',
	        value: function handleUserViewedTopics(event) {
	            if (event.point.listIds && event.point.listIds.length > 0) {
	                this.setState({
	        ...
	        value: function render() {
	            ...
	            if (this.state.chartData != '') {
	                ...
	                var self = this;
	                var title = self.props.data.userName + ' - ' + this.props.intlData.messages.viewed_topics;
	                var options = {
	                    chart: {
	                        type: 'column'
	                    },
	            ...
	            return _jsx('div', {}, void 0, this.state.loading ? _jsx('div', {
	                ...
	                loadType: loadType
	            })))) : _jsx('div', {}, void 0, this.state.ShowUserViewedTopicsList == true ? _jsx(_UserViewedTopicsList2.default, {
	                listIds: this.state.listIds,
	                courseId: this.props.data.courseId,
	...
	exports.default = (0, _reactRedux.connect)(mapStateToProps)(UserViewedTopics);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var UserViewedTopicsList = function (_Component) {
	    _inherits(UserViewedTopicsList, _Component);
	
	    function UserViewedTopicsList(props) {
	        _classCallCheck(this, UserViewedTopicsList);
	
	        var _this = _possibleConstructorReturn(this, (UserViewedTopicsList.__proto__ || Object.getPrototypeOf(UserViewedTopicsList)).call(this, props));
	    ...
	    _createClass(UserViewedTopicsList, [{
	        key: 'componentWillReceiveProps',
	        value: function componentWillReceiveProps(nextProps) {
	            if (nextProps.roomData.success != '') {
	                this.refs.room_container.success(nextProps.roomData.success + ' ', '');
	        ...
	        value: function render() {
	            ...
	            if (this.props.listIds.length == this.props.roomData.topicViewedList.length) {
	                ...
	                var filter = [{ type: 'search', id: "topicSearch", selectedfilter: this.searchFilter }];
	            } else {
	                var objDisp = [{ title: _ref3, type: "function", callback: this.showTopicName }, { title: _ref4, type: "function", callback: this.showDescription }];
	            ...
	            return (
	                ...
	                _jsx('div', {}, void 0, _react2.default.createElement(_lib.ToastContainer, {
	                    toastMessageFactory: ToastMessageFactory,
	                    ref: 'room_container',
	                    className: 'toast-top-right'
	                }), _jsx('div', {}, void 0, _jsx(_reactBootstrap.Row, {}, void 0, _jsx(_reactBootstrap.Col, {
	                    md: 12
	                }, void 0, _jsx('button', {
	                    id: 'backToReports',
	                    className: cls_backButton,
	                    ...
	                    className: _Admin2.default.stuReportsOne
	                }, void 0, _jsx('p', {}, void 0, _ref5, ': ', this.props.userName)), _jsx('div', {
	                    className: _Admin2.default.stuReportsTwo
	                }, void 0, this.props.listIds.length != this.props.roomData.topicViewedList.length ? _jsx('span', {}, void 0, 'NOTE: ', this.props.listIds.length - this.props.roomData.topicViewedList.length, ' out of ', this.props.listIds.length, ' topics are removed ') : null))), _jsx(_DataTable2.default, {
	                    data: this.props.roomData.topicViewedList,
	                    count: this.props.roomData.topicListCount,
	                    currentPage: this.props.roomData.currentListPage,
	                    submenu: null,
	...
	exports.default = (0, _reactRedux.connect)(mapStateToProps)(UserViewedTopicsList);
