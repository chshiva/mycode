...
/***/ function(module, exports, __webpack_require__) {
	...
	var _ref = _jsx(_reactIntl.FormattedMessage, {
	  id: 'Assignment_name_cannot_have_only_white_spaces'
	});
	
	var _ref2 = _jsx(_reactIntl.FormattedMessage, {
	  id: 'Please_enter_Assignment_Name'
	});
	...
	var _ref9 = _jsx('li', {}, void 0, _jsx(_reactIntl.FormattedMessage, {
	  id: 'add_assignment'
	}));
	
	var _ref10 = _jsx(_TopMenu2.default, {
	...
	var _ref12 = _jsx('h2', {}, void 0, _jsx('i', {
	  'aria-hidden': 'true'
	}), '\xA0');
	...
	var AddAssignment = function (_Component) {
	  ...
	  function AddAssignment(props) {
	    ...
	    var _this = _possibleConstructorReturn(this, (AddAssignment.__proto__ || Object.getPrototypeOf(AddAssignment)).call(this, props));
	  ...
	  _createClass(AddAssignment, [{
	    ...
	    value: function render() {
	      ...
	      var cls_formcontent = { height: 'calc(100vh - 262px)' };
	      ...
	      return _jsx('div', {}, void 0, _react2.default.createElement(_lib.ToastContainer, {
	      ...
	      }, void 0, this.props.roomData.data.roomName)), _ref6, _jsx('li', {}, void 0, _jsx(_reactRouter.Link, {
	        onClick: this.cancel.bind(this)
	      }, void 0, _ref7)), _ref8, _ref9)), _ref10), _jsx('div', {
	      ...
	      }, void 0, this.state.creating ? _jsx('div', {
	        className: _component2.default.mainSpinBlock
	      }, void 0, _jsx('div', {
	        className: _component2.default.innerSpinBlock
	      ...
	      }, void 0, '*'), ':'), _react2.default.createElement('input', { type: 'text', id: 'assignmentName', className: cls_textbox, ref: 'assignmentName', style: this.state.validationError && this.state.validationError.assignmentError ? { borderColor: "#ff0000" } : {},
	        value: this.state.assignmentName, onChange: this.handleAssignmentName.bind(this), placeholder: 'Assignment Name', maxLength: 30, autoFocus: 'true' }), _jsx('label', {
	        className: _component2.default.errorPre
	      }, void 0, this.state.validationError && this.state.validationError.assignmentError ? this.state.validationError.assignmentError : '')))))), _jsx('div', {
	        className: 'col-md-6'
	      }, void 0, _jsx('div', {
	        className: cls
	        ...
	        'select',
	        { id: 'assignTopic', className: cls_textbox, ref: 'topic' },
	        _ref13,
	        listTopics != null ? listTopics : _ref14
	      )))))), _jsx('div', {
	        className: 'col-md-12'
	      }, void 0, _jsx('div', {
	        className: cls
	        ...
	        className: cls_formfield
	      }, void 0, _jsx('formfield', {}, void 0, this.state.fileName ? _jsx('div', {}, void 0, _ref15, _jsx('span', {}, void 0, this.state.fileName), _jsx('span', {
	...
	exports.default = (0, _reactRedux.connect)(mapStateToProps)(AddAssignment);
