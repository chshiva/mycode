...
/***/ function(module, exports, __webpack_require__) {
	...
	var _ref3 = _jsx(_TopMenu2.default, {
	  data: _ProfileEditMenu.profileViewMainMenu
	});
	
	var _ref4 = _jsx('div', {}, void 0, _jsx(_Loading2.default, {}));
	...
	var MyProfile = function (_Component) {
	  ...
	  function MyProfile(props) {
	    ...
	    _this.setdata = function (result) {
	      if (result && result.data) {
	        ...
	        if (_.isEmpty(_this.props.loggedInData.data)) {
	          _this.setState({ loading: true });
	        } else {
	          _this.setState({ loading: false });
	        }
	        _this.props.dispatch((0, _LoginActions.getProfileImage)({ uid: result.data._id })).then(function (res) {
	    ...
	    _this.responseGoogle = function (response) {
	      ...
	      _this.props.dispatch((0, _LoginActions.connectWithGoogle)(obj)).then(function (res) {
	    ...
	    _this.responseFacebook = function (response) {
	      ...
	      if (response.status == "unknown" || response.error) {
	        ...
	        _this.refs.my_profile_container.error('Cancelled Facebook Link', '');
	      } else if (!response.email) {
	        _this.refs.my_profile_container.error('Please connect with facebook email Id', '');
	      } else {
	        var obj = {
	          // _id: this.props.loggedInData.data._id,
	          // email: this.props.loggedInData.data.email,
	    ...
	    _this.disconnectGoogle = function () {
	      var disObj = {
	        // _id: this.props.loggedInData.data._id,
	        type: 'Google'
	      };
	      _this.props.dispatch((0, _LoginActions.disConnectSocialMedia)(disObj)).then(function (res) {
	        return _this.showResponse(res);
	      });
	    };
	
	    _this.disconnectFacebook = function () {
	      var disObj = {
	        // _id: this.props.loggedInData.data._id,
	        type: 'Facebook'
	      };
	  ...
	  _createClass(MyProfile, [{
	    ...
	    value: function render() {
	      ...
	      var submenu = _Validator2.default.activeSubMenu(_ProfileEditMenu.profileViewSubMenu, "lnkMyProfile");
	      var loadType = 'list';
	      return _jsx('div', {
	      ...
	      }), this.state.loading == true ? _ref4 : _jsx('div', {}, void 0, _jsx(_ProfileView2.default, {
	        ...
	        profileLogData: this.props.profileData.logData,
	        src: this.props.loggedInData.file,
	        changeImage: true
	      })));
	    }
	  }]);
