...
/***/ function(module, exports, __webpack_require__) {
	...
	var _ListAttendance = __webpack_require__(469);
	
	var _ListAttendance2 = _interopRequireDefault(_ListAttendance);
	...
	var _ref4 = _jsx('h2', {}, void 0, _jsx(_reactFontawesome2.default, {
	  name: 'frown-o'
	}));
	...
	var _ref6 = _jsx('h2', {}, void 0, _jsx(_reactFontawesome2.default, {
	  name: 'frown-o'
	}));
	...
	var CourseAttendance = function (_Component) {
	  _inherits(CourseAttendance, _Component);
	
	  function CourseAttendance(props) {
	    _classCallCheck(this, CourseAttendance);
	
	    var _this = _possibleConstructorReturn(this, (CourseAttendance.__proto__ || Object.getPrototypeOf(CourseAttendance)).call(this, props));
	    ...
	    _this.getDates = function (obj) {
	      _this.setState({ insChartData: '', stuChartData: '', fromDate: obj.fromDate, toDate: obj.toDate, noStudents: false, noInstructor: false });
	      var courseId = _this.props.params.cid;
	      _this.setState({ loading: true });
	      _this.props.dispatch((0, _RoomActions.getCourseAttendanceRequest)(courseId, obj['fromDate'], obj['toDate'])).then(function (res) {
	        return _this.setData(res);
	      });
	    };
	
	    _this.backToReprots = function (e) {
	      _this.setState({
	        showList: false,
	        listIds: [],
	        reqType: null
	    ...
	    _this.state = {
	      fromDate: (0, _moment2.default)().startOf('day').utc().toDate(),
	      toDate: (0, _moment2.default)().endOf('day').utc().toDate(),
	      insChartData: '',
	      stuChartData: '',
	      showList: false,
	      listIds: [],
	    ...
	    _this.submenu = _Validator2.default.activeSubMenu(_RoomMenu.roomReportsNoTopicsSubMenu, "lnkAttendance");
	    _this.submenu.menus[0].action = _this.attendanceReport.bind(_this);
	    return _this;
	  }
	
	  _createClass(CourseAttendance, [{
	    ...
	    value: function componentDidMount() {
	      ...
	      this.props.dispatch((0, _RoomActions.getRoomData)(roomObj, '')).then(function (res) {
	        return _this2.setRoomData(res);
	      });
	    ...
	    key: 'setRoomData',
	    value: function setRoomData(res) {
	      if (res.status && res.data && res.data.selPackage && res.data.selPackage.features.indexOf("Topics") != -1) {
	        this.submenu = _Validator2.default.activeSubMenu(_RoomMenu.roomReportsSubMenu, "lnkAttendance");
	    ...
	    value: function handleAttendance(event) {
	    ...
	    key: 'render',
	    value: function render() {
	      var link = "/admin/room/view/" + this.props.params.cid;
	      ...
	      var cls_chartBlockCust = ' ' + _Admin2.default.chartBlockCust + ' ' + _Admin2.default.chartBlock + ' ';
	      var cls_midContainer = ' ' + _Admin2.default.midContainer + ' clearfix ';
	      ...
	      return _jsx('div', {
	        ...
	        to: link
	      }, void 0, this.props.roomData.data.roomName)), _ref3, _jsx('li', {}, void 0, this.props.intlData.messages.reports)))), _jsx('div', {
	        ...
	        loadType: loadType
	      })))) : _jsx('div', {}, void 0, role == _roles.Roles.Lmsadmin ? _jsx('div', {
	        className: cls_midContainer
	      }, void 0, this.state.insChartData != '' && !this.state.noInstructor ? _jsx('div', {
	        className: cls_chartBlockCust
	      }, void 0, _jsx(_Chart2.default, {
	        container: 'chart',
	        options: insChartOptions
	      })) : _jsx('div', {
	        className: cls_chartBlockCust
	      }, void 0, _jsx('div', {
	        className: _Admin2.default.whiteCard
	      ...
	      }, void 0, _ref4, _ref5))), this.state.stuChartData != '' && !this.state.noStudents ? _jsx('div', {
	        className: cls_chartBlockCust
	      }, void 0, _jsx(_Chart2.default, {
	        container: 'chart',
	        options: options
	        ...
	        className: _DataTable2.default.noDataBox
	      }, void 0, _ref6, _ref7)))) : role == _roles.Roles.Instructor ? _jsx('div', {
	        className: _Admin2.default.midContainer
	      }, void 0, this.state.stuChartData != '' && !this.state.noStudents ? _jsx('div', {
	        ...
	        className: _DataTable2.default.noDataBox
	      }, void 0, _ref8, _ref9))) : null)), this.state.showList ? _jsx('div', {
	        className: _Admin2.default.midContainer
	      }, void 0, _jsx(_ListAttendance2.default, {
	        listIds: this.state.listIds,
	        fromDate: this.state.fromDate,
	        toDate: this.state.toDate,
	        courseId: this.props.params.cid,
	        backToReport: this.backToReprots,
	...
	exports.default = (0, _reactRedux.connect)(mapStateToProps)(CourseAttendance);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _ListIndividualAttendance = __webpack_require__(470);
	
	var _ListIndividualAttendance2 = _interopRequireDefault(_ListIndividualAttendance);
	
	var _ListTotalSchedulesAttendance = __webpack_require__(471);
	
	var _ListTotalSchedulesAttendance2 = _interopRequireDefault(_ListTotalSchedulesAttendance);
	...
	var IndividualAttendance = function (_React$Component) {
	  _inherits(IndividualAttendance, _React$Component);
	
	  function IndividualAttendance(props) {
	    _classCallCheck(this, IndividualAttendance);
	
	    var _this = _possibleConstructorReturn(this, (IndividualAttendance.__proto__ || Object.getPrototypeOf(IndividualAttendance)).call(this, props));
	  ...
	  _createClass(IndividualAttendance, [{
	    key: 'componentDidMount',
	    value: function componentDidMount() {
	      var _this2 = this;
	      ...
	      this.props.dispatch((0, _RoomActions.getIndividualAttendance)(obj)).then(function (res) {
	    ...
	    value: function render() {
	      ...
	      var titleName = this.props.userData.firstname + '' + this.props.userData.lastname + ' - ' + this.props.intlData.messages.attendance;
	      var loadType = 'list';
	      var self = this;
	      ...
	      return _jsx('div', {}, void 0, this.state.loading ? _jsx('div', {
	        ...
	        loadType: loadType
	      })))) : _jsx('div', {}, void 0, this.state.showIndividualAttendedList == true ? _jsx(_reactBootstrap.Row, {}, void 0, _jsx(_reactBootstrap.Col, {
	        md: 12
	      }, void 0, _jsx(_ListIndividualAttendance2.default, {
	        listIds: this.state.listIds,
	        courseId: this.props.courseId,
	        backToReports: this.backToReports
	      }))) : this.state.showTotalSchedulesList == true ? _jsx('div', {
	        className: _Admin2.default.midContainer
	      }, void 0, _jsx(_reactBootstrap.Row, {}, void 0, _jsx(_reactBootstrap.Col, {
	        md: 12
	      }, void 0, _jsx(_ListTotalSchedulesAttendance2.default, {
	        listIds: this.state.listIds,
	      ...
	      }, void 0, this.props.intlData.messages.back_to_list))), _jsx(_reactBootstrap.Row, {}, void 0, _jsx(_reactBootstrap.Col, {
	        md: 12
	      }, void 0, _jsx('div', {
	...
	exports.default = (0, _reactRedux.connect)(mapStateToProps)(IndividualAttendance);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _IndividualAttendanceReport = __webpack_require__(468);
	
	var _IndividualAttendanceReport2 = _interopRequireDefault(_IndividualAttendanceReport);
	...
	var ListAttendance = function (_Component) {
	  _inherits(ListAttendance, _Component);
	  ...
	  function ListAttendance(props) {
	    ...
	    _this.showCompanyId = function (row) {
	      if (row.profile.companyid == null) {
	        return _ref;
	      } else {
	        return _jsx('div', {}, void 0, row.profile.companyid.businessId);
	      }
	    };
	  ...
	  _createClass(ListAttendance, [{
	    ...
	    value: function getData(pageParam) {
	      ...
	      this.props.dispatch((0, _RoomActions.getAttendanceList)(pageParam, pageParam.currentPage)).then(function (res) {
	    ...
	    key: 'componentWillUnmount',
	    value: function componentWillUnmount() {
	      this.props.dispatch((0, _RoomActions.clearAttendanceList)());
	    }
	  }, {
	    key: 'searchFilter',
	    ...
	    value: function showUserName(row) {
	      return _jsx('div', {}, void 0, row.firstname, ' ', row.lastname);
	    }
	  }, {
	    key: 'viewIndividualAttendance',
	    value: function viewIndividualAttendance(row) {
	      return _jsx('a', {
	        id: 'individualAttendanceView',
	        onClick: this.showIndvidualAttendance.bind(this, row)
	      }, void 0, _ref2);
	    }
	  }, {
	    key: 'showIndvidualAttendance',
	    value: function showIndvidualAttendance(row, e) {
	      this.setState({
	        rowData: row,
	    ...
	    key: 'showRole',
	    value: function showRole(row) {
	      var roleObj = _.invert(_roles.Roles);
	      var role = row.role;
	      this.role = roleObj[role];
	      return _jsx('div', {}, void 0, this.role);
	    }
	  }, {
	    key: 'render',
	    value: function render() {
	      var objDisp = [{ title: _ref3, type: "function", callback: this.showUserName.bind(this) }, { fieldName: "email", title: _ref4, type: "text" }, { title: _ref5, type: "function", callback: this.showRole }, { title: _ref6, type: "function", callback: this.showCompanyId }];
	      if (this.props.reqType == "Present") {
	        objDisp.push({ title: _ref7, type: "function", callback: this.viewIndividualAttendance.bind(this) });
	      }
	
	      var filter = [{ type: 'search', id: 'search', selectedfilter: this.searchFilter }];
	
	      return _jsx('div', {}, void 0, _react2.default.createElement(_lib.ToastContainer, {
	        toastMessageFactory: ToastMessageFactory,
	        ref: 'room_container',
	        className: 'toast-top-right'
	      }), this.state.showIndividualChart == true ? _jsx(_IndividualAttendanceReport2.default, {
	        userData: this.state.rowData,
	        fromDate: this.props.fromDate,
	        toDate: this.props.toDate,
	        courseId: this.props.courseId,
	        ...
	        data: this.props.roomData.attendanceList,
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ListIndividualAttendance = function (_React$Component) {
	  _inherits(ListIndividualAttendance, _React$Component);
	
	  function ListIndividualAttendance(props) {
	    _classCallCheck(this, ListIndividualAttendance);
	
	    var _this = _possibleConstructorReturn(this, (ListIndividualAttendance.__proto__ || Object.getPrototypeOf(ListIndividualAttendance)).call(this, props));
	  ...
	  _createClass(ListIndividualAttendance, [{
	    key: 'componentWillReceiveProps',
	    value: function componentWillReceiveProps(nextProps) {
	      if (nextProps.roomData.success != '') {
	        this.refs.room_container.success(nextProps.roomData.success + ' ', '');
	    ...
	    value: function getData(pageParam) {
	      ...
	      this.props.dispatch((0, _RoomActions.getIndividualAttendanceList)(pageParam, pageParam.currentPage)).then(function (res) {
	        return _this2.pageData(res);
	      });
	    }
	  }, {
	    ...
	    key: 'componentWillUnmount',
	    value: function componentWillUnmount() {
	      this.props.dispatch((0, _RoomActions.clearIndividualAttendanceList)());
	    }
	  }, {
	    key: 'render',
	    value: function render() {
	      ...
	      return _jsx('div', {}, void 0, _react2.default.createElement(_lib.ToastContainer, {
	        ...
	        data: this.props.roomData.individualAttendanceList,
	  ...
	  return ListIndividualAttendance;
	}(_react2.default.Component);
	...
	exports.default = (0, _reactRedux.connect)(mapStateToProps)(ListIndividualAttendance);
	...
	var ListTotalSchedules = function (_React$Component) {
	  ...
	  _createClass(ListTotalSchedules, [{
	    ...
	    value: function getData(pageParam) {
	      ...
	      this.props.dispatch((0, _RoomActions.getTotalSchedulesList)(pageParam, pageParam.currentPage)).then(function (res) {
	        return _this2.pageData(res);
	      });
	    }
	  }, {
	    ...
	    value: function render() {
	      ...
	      return _jsx('div', {}, void 0, _react2.default.createElement(_lib.ToastContainer, {
	        ...
	        className: _Admin2.default.btnApplyAll,
	        onClick: this.props.backToReport
	      }, void 0, 'Back to Reports'))), _jsx(_DataTable2.default, {
	        data: this.props.roomData.schedulesList,
