...
/***/ function(module, exports, __webpack_require__) {
	...
	var CreatePackage = function (_Component) {
	  _inherits(CreatePackage, _Component);
	
	  function CreatePackage(props) {
	    _classCallCheck(this, CreatePackage);
	
	    var _this = _possibleConstructorReturn(this, (CreatePackage.__proto__ || Object.getPrototypeOf(CreatePackage)).call(this, props));
	    ...
	    _this.save = function (event) {
	      ...
	      if (response.error.length > 0) {
	        ...
	        _this.props.dispatch((0, _PackageActions.SavePackage)(_this.form)).then(function (res) {
	    ...
	    _this.submenu = _Validator2.default.activeSubMenu(_PackageMenu.packageNewSubMenu, "lnkPackage");
	    _this.mainmenu = _PackageMenu.packageNewMainMenu;
	  ...
	  _createClass(CreatePackage, [{
	    ...
	    value: function setdata(result) {
	      ...
	      if (result && result.data && result.data._id) {
	        ...
	        this.props.dispatch((0, _PackageActions.UpdatePackageSchema)(this.schema));
	    ...
	    value: function render() {
	      ...
	      return _jsx('div', {}, void 0, _react2.default.createElement(_lib.ToastContainer, {
	        ...
	        data: this.props.packageData.schema,
	...
	exports.default = (0, _reactRedux.connect)(mapStateToProps)(CreatePackage);
