...
/***/ function(module, exports, __webpack_require__) {
	...
	var _ListStudentTopics = __webpack_require__(454);
	
	var _ListStudentTopics2 = _interopRequireDefault(_ListStudentTopics);
	...
	var studentTopicsReport = function (_Component) {
	  _inherits(studentTopicsReport, _Component);
	
	  function studentTopicsReport(props) {
	    _classCallCheck(this, studentTopicsReport);
	
	    var _this = _possibleConstructorReturn(this, (studentTopicsReport.__proto__ || Object.getPrototypeOf(studentTopicsReport)).call(this, props));
	    ...
	    _this.handleTopicsList = function (event) {
	    ...
	    _this.submenu = _Validator2.default.activeSubMenu(_ReportsMenu.courseReportsSubMenu, "linkTopics");
	    _this.submenu.menus[0].action = _this.attendanceReport.bind(_this);
	    _this.submenu.menus[1].action = _this.topicsReport.bind(_this);
	    return _this;
	  }
	
	  _createClass(studentTopicsReport, [{
	    ...
	    value: function componentDidMount() {
	      ...
	      this.props.dispatch((0, _ReportsActions.getTopicsReportRequest)(obj)).then(function (res) {
	...
	exports.default = (0, _reactRedux.connect)(mapStateToProps)(studentTopicsReport);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ListStudentTopics = function (_React$Component) {
	  _inherits(ListStudentTopics, _React$Component);
	
	  function ListStudentTopics(props) {
	    _classCallCheck(this, ListStudentTopics);
	
	    var _this = _possibleConstructorReturn(this, (ListStudentTopics.__proto__ || Object.getPrototypeOf(ListStudentTopics)).call(this, props));
	
	    _this.showTopicName = function (row) {
	    ...
	    _this.showDescription = function (row) {
	  ...
	  _createClass(ListStudentTopics, [{
	    key: 'componentDidMount',
	    value: function componentDidMount() {
	    ...
	    value: function getData(pageParam) {
	      ...
	      this.props.dispatch((0, _ReportsActions.getStudentTopicsList)(pageParam, pageParam.currentPage)).then(function (res) {
	    ...
	    value: function render() {
	      ...
	      return _jsx('div', {}, void 0, _react2.default.createElement(_lib.ToastContainer, {
	        ...
	        data: this.props.reportsData.topicsList,
	...
	exports.default = (0, _reactRedux.connect)(mapStateToProps)(ListStudentTopics);
