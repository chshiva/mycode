...
/***/ function(module, exports, __webpack_require__) {
	...
	var StudentCourseList = function (_Component) {
	  _inherits(StudentCourseList, _Component);
	
	  function StudentCourseList(props) {
	    _classCallCheck(this, StudentCourseList);
	
	    var _this = _possibleConstructorReturn(this, (StudentCourseList.__proto__ || Object.getPrototypeOf(StudentCourseList)).call(this, props));
	    ...
	    _this.submenu = _Validator2.default.activeSubMenu(_ReportsMenu.reportsSubMenu, "lnkReports");
	    _this.mainmenu = _ReportsMenu.reportsMainMenu;
	    _this.getData = _this.getData.bind(_this);
	
	    _this.currentPage = 1;
	    _this.itemsPerPage = 5;
	
	    _this.viewCourse = _this.viewCourse.bind(_this);
	    _this.searchFilter = _this.searchFilter.bind(_this);
	    _this.downloadCertificate = _this.downloadCertificate.bind(_this);
	    return _this;
	  }
	
	  _createClass(StudentCourseList, [{
	    key: 'componentDidMount',
	    value: function componentDidMount() {
	      this.setdata(this.props.loggedInData);
	      this.props.dispatch((0, _ReportsActions.checkCertificateEligibility)());
	    }
	  }, {
	    key: 'setdata',
	    value: function setdata(result) {
	      if (result && result.data && result.data._id) {
	        ...
	        this.props.dispatch((0, _ReportsActions.ReportsStore)({ uid: result.data._id }));
	        this.getData({
	    ...
	    value: function getData(pageParam) {
	      ...
	      this.props.dispatch((0, _ReportsActions.studentCourseList)(pageParam, pageParam.currentPage)).then(function (res) {
	    ...
	    key: 'handleDownloadCertificate',
	    value: function handleDownloadCertificate(roomId) {
	      this.props.dispatch((0, _ReportsActions.fetchCertificate)(roomId));
	    }
	  }, {
	    key: 'downloadCertificate',
	    value: function downloadCertificate(row) {
	      var roomId = row.roomId._id;
	
	      if (this.props.reportsData.eligibleRoomIds && this.props.reportsData.eligibleRoomIds.includes(roomId)) {
	        return _jsx(_reactRouter.Link, {
	          id: 'certDownload',
	          onClick: this.handleDownloadCertificate.bind(this, roomId)
	        }, void 0, _ref2);
	      }
	      return _ref3;
	    }
	    ...
	    key: 'showCourseName',
	    value: function showCourseName(row) {
	      var roomId = row.roomId._id;
	    ...
	    key: 'showCourseType',
	    value: function showCourseType(row) {
	      return _jsx('div', {}, void 0, row.roomId.roomType, ' ');
	    }
	  }, {
	    key: 'createdDate',
	    value: function createdDate(row) {
	      if (row.roomId && row.roomId.createdOn != null) {
	        var day = moment(row.roomId.createdOn).format('ddd');
	        var date = moment(row.roomId.createdOn).format('DD-MM-YYYY');
	        return _jsx('div', {}, void 0, day, ', ', date);
	      } else {
	        return _ref4;
	      }
	    }
	    ...
	    key: 'expiryDate',
	    value: function expiryDate(row) {
	      if (row.roomId && row.roomId.expiryDate != null) {
	        var day = moment(row.roomId.expiryDate).format('ddd');
	        var date = moment(row.roomId.expiryDate).format('DD-MM-YYYY');
	        return _jsx('div', {}, void 0, day, ', ', date);
	      } else {
	        return _ref5;
	      }
	    ...
	    value: function render() {
	      ...
	      var objDisp = [{ title: _ref7, type: "function", callback: this.showCourseName }, { title: _ref8, type: "function", callback: this.showCourseType }, { title: _ref9, type: "function", callback: this.createdDate }, { title: _ref10, type: "function", callback: this.expiryDate }, { title: _ref11, type: "function", callback: this.viewCourse }, { title: _ref12, type: "function", callback: this.downloadCertificate }];
	
	      var filter = [{ type: 'search', id: 'courseSearch', selectedfilter: this.searchFilter }];
	      ...
	      return _jsx('div', {}, void 0, _react2.default.createElement(_lib.ToastContainer, {
	        ...
	        data: this.props.reportsData.dataList,
	...
	exports.default = (0, _reactRedux.connect)(mapStateToProps)(StudentCourseList);
