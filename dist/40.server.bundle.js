...
/***/ function(module, exports, __webpack_require__) {
	...
	var _ViewUserFeedback = __webpack_require__(463);
	
	var _ViewUserFeedback2 = _interopRequireDefault(_ViewUserFeedback);
	...
	var _ref8 = _jsx(_TopMenu2.default, {
	  data: _RoomMenu.viewFeedbackMainMenu
	});
	
	var _ref9 = _jsx(_SubMenu2.default, {
	  data: _RoomMenu.viewFeedbackSubMenu
	});
	
	var ViewRoomFeedback = function (_Component) {
	  _inherits(ViewRoomFeedback, _Component);
	
	  function ViewRoomFeedback(props) {
	    _classCallCheck(this, ViewRoomFeedback);
	
	    var _this = _possibleConstructorReturn(this, (ViewRoomFeedback.__proto__ || Object.getPrototypeOf(ViewRoomFeedback)).call(this, props));
	
	    _this.feedback = function () {
	      //var fdId = this.props.feedbackData.data[0]._id;
	
	      if (_this.props.feedbackData.data && _this.props.feedbackData.data.roomId._id) {
	        var roomId = _this.props.feedbackData.data.roomId._id;
	    ...
	    _this.mainmenu = _RoomMenu.viewFeedbackMainMenu;
	    _this.schema = _RoomSchema.roomSchema;
	
	    _this.mainmenu.menus[0].action = _this.feedback.bind(_this); //this.save.bind(this);
	    // this.mainmenu.menus[1].action = this.deleteRoom.bind(this);
	    _this.submenu = _Validator2.default.activeSubMenu(_RoomMenu.viewFeedbackSubMenu, "lnkMyRoom");
	    ...
	    _this.submenu.menus[0].action = _this.feedback.bind(_this);
	    return _this;
	  }
	
	  _createClass(ViewRoomFeedback, [{
	    key: 'componentWillMount',
	    value: function componentWillMount() {
	    ...
	    value: function setdata(result) {
	      ...
	      if (result && result.data && result.data._id) {
	        ...
	        this.props.dispatch((0, _RoomActions.getRoomFeedbackData)(feedbackId, '/admin/room/view-feedback/' + feedbackId)).then(function (res) {
	    ...
	    value: function render() {
	      ...
	      }, void 0, courseName)), _ref4, _jsx('li', {}, void 0, _jsx(_reactRouter.Link, {
	        onClick: this.feedback
	      }, void 0, _ref5)), _ref6, _ref7)), _ref8), _jsx('div', {
	        className: cls_isubmenu
	      }, void 0, _ref9), _jsx(_ViewUserFeedback2.default, {
	        userFeedbackData: this.props.feedbackData.data.feedbacks,
	        roomdata: this.props.feedbackData.data.roomId,
	        userData: this.props.feedbackData.data.userId,
	        error: this.props.feedbackData.error,
	        success: this.props.feedbackData.success,
	        clear: this.clear,
	        role: this.props.loggedInData.data.role,
	        loading: this.state.loading
	      }, this.props.feedbackData.roomId));
	    }
	  }]);
	
	  return ViewRoomFeedback;
	}(_react.Component);
	...
	exports.default = (0, _reactRedux.connect)(mapStateToProps)(ViewRoomFeedback);
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.ViewUserFeedback = undefined;
	...
	var ViewUserFeedback = exports.ViewUserFeedback = function (_Component) {
	  _inherits(ViewUserFeedback, _Component);
	  ...
	  function ViewUserFeedback() {
	    ...
	    _classCallCheck(this, ViewUserFeedback);
	
	    for (var _len = arguments.length, args = Array(_len), _key = 0; _key < _len; _key++) {
	      args[_key] = arguments[_key];
	    }
	
	    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = ViewUserFeedback.__proto__ || Object.getPrototypeOf(ViewUserFeedback)).call.apply(_ref, [this].concat(args))), _this), _this.renderGivenFeedback = function (feedback) {
	      /*let cls_inlineEditGroup = `${styles.inlineEditGroupFlex} clearfix`;*/
	      var cls_fdListBlock = _Admin2.default.fdListBlock + ' clearfix';
	      var givenFeedback = [];
	      for (var list in feedback) {
	        ...
	        if (feedback.hasOwnProperty(list)) {
	          ...
	          givenFeedback.push(_jsx('div', {
	            className: cls_fdListBlock
	          }, randomNumber, _jsx('label', {
	            htmlFor: list,
	            className: _Admin2.default.fdQues
	          }, void 0, list, ':'), _jsx('ul', {
	            className: _Admin2.default.fdAns
	          }, void 0, _typeof(feedback[list]) == 'object' ? feedback[list].length > 0 ? feedback[list].map(function (answeredOption, i) {
	            return _jsx('li', {
	              className: _Admin2.default.labelResultFlex
	            }, i, feedback[list][i]);
	          }) : _jsx('li', {}, void 0, feedback[list][0]) : _jsx('li', {}, void 0, feedback[list]))));
	        }
	      }
	  ...
	  _createClass(ViewUserFeedback, [{
	    ...
	    value: function render() {
	      this.clsContainerRight = _Admin2.default.containerRight + ' pull-right';
	      var cls_fdInfoBlock = _Admin2.default.fdInfoBlock + ' clearfix';
	      ...
	      var cls_inlineEditGroup = _Admin2.default.inlineEditGroupFlex + ' clearfix';
	      var loadType = 'list';
	      ...
	      return _jsx('div', {
	        ...
	        className: _Admin2.default.infoTxt
	      }, void 0, _ref2))), _jsx(_reactBootstrap.Row, {}, void 0, _jsx(_reactBootstrap.Col, {
	        md: 12
	      }, void 0, _jsx('div', {
	        className: _Admin2.default.formField
	      }, void 0, _jsx('div', {
	        ...
	        className: cls_fdInfoBlock
	      }, void 0, _jsx('div', {
	        className: _Admin2.default.fdInfo
	      }, void 0, _ref3, _jsx('div', {
	        className: _Admin2.default.fdName
	      }, void 0, this.roomName ? this.roomName : "-")), _jsx('div', {
	        className: _Admin2.default.fdInfo
	      }, void 0, _ref4, _jsx('div', {
	        className: _Admin2.default.fdName
	      }, void 0, this.userName ? this.userName : "-"))), this.renderGivenFeedback(this.props.userFeedbackData))))))));
	    }
	  }]);
	...
	exports.default = ViewUserFeedback;
