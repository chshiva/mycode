...
/***/ function(module, exports, __webpack_require__) {
	...
	var RoomConfiguration = function (_Component) {
	  _inherits(RoomConfiguration, _Component);
	
	  function RoomConfiguration(props) {
	    _classCallCheck(this, RoomConfiguration);
	    ...
	    var _this = _possibleConstructorReturn(this, (RoomConfiguration.__proto__ || Object.getPrototypeOf(RoomConfiguration)).call(this, props));
	    ...
	    _this.locationList = function () {
	      var roomId = _this.props.params.cid;
	      _reactRouter.browserHistory.push('/admin/room/listlocation/' + roomId);
	    };
	    ...
	    _this.listCertificates = function () {
	      var roomId = _this.props.params.cid;
	      _reactRouter.browserHistory.push('/admin/room/certificates/' + roomId);
	    };
	    ...
	    _this.submenu = _Validator2.default.activeSubMenu(_RoomMenu.roomNoTopicSubMenu, "lnkRoomConfiguration");
	  ...
	  _createClass(RoomConfiguration, [{
	    ...
	    value: function setdata(result) {
	      ...
	      if (result && result.data && result.data._id) {
	        ...
	        this.props.dispatch((0, _RoomActions.getQuestionnaire)());
	
	        this.props.dispatch((0, _RoomActions.getFeedbackTypeValue)(roomId)).then(function (result) {
	          if (result.status) {
	    ...
	    key: 'saveFeedbackType',
	    value: function saveFeedbackType(e) {
	      var _this3 = this;
	
	      e.preventDefault();
	      var feedbackValue = _reactDom2.default.findDOMNode(this.refs.feedbackTypeValue).value;
	      ...
	      if (feedbackValue == null || feedbackValue == "" || feedbackValue == undefined) {
	        ...
	        var index = _reactDom2.default.findDOMNode(this.refs.feedbackQuestionnaire).value;
	        var customizeQuestionnaireData = index != undefined || index != '' ? this.props.roomData.roomQuestionnaireList[index] : undefined;
	        var customizeQuestionnaireId = customizeQuestionnaireData != undefined ? customizeQuestionnaireData._id : undefined;
	        var questionnaireQuestionsCount = customizeQuestionnaireData != undefined ? customizeQuestionnaireData.questions.length : null;
	        if (customizeQuestionnaireId == '' || customizeQuestionnaireId == undefined || customizeQuestionnaireId == null) {
	          ...
	          this.props.dispatch((0, _RoomActions.saveFeedbackTypeRequest)({ roomId: roomId, feedbackValue: feedbackValue, customizeQuestionnaireId: customizeQuestionnaireId })).then(function (res) {
	            return _this3.setForm(4);
	          });
	        }
	      } else {
	        this.props.dispatch((0, _RoomActions.saveFeedbackTypeRequest)({ uid: uid, roomId: roomId, feedbackValue: feedbackValue })).then(function (res) {
	          return _this3.setForm(1);
	        });
	      }
	    }
	  }, {
	    key: 'selectedFeedbackType',
	    value: function selectedFeedbackType(e) {
	      e.preventDefault();
	      var feedbackValue = _reactDom2.default.findDOMNode(this.refs.feedbackTypeValue).value;
	    ...
	    key: 'handleConfigureBlock',
	    value: function handleConfigureBlock(e) {
	      e.preventDefault();
	      this.setState({
	    ...
	    key: 'cancelFeedbackType',
	    value: function cancelFeedbackType(e) {
	      e.preventDefault();
	      this.setState({
	        questionaireDropdown: false,
	        selectFeedbackBlock: false
	    ...
	    key: 'handleFeedbackBlock',
	    value: function handleFeedbackBlock(e) {
	      this.setState({
	        selectFeedbackBlock: true
	      });
	    ...
	    key: 'handleCodecBlock',
	    value: function handleCodecBlock(e) {
	      this.setState({
	    ...
	    key: 'cancelCodecType',
	    value: function cancelCodecType(e) {
	      e.preventDefault();
	      this.setState({
	        selectCodecBlock: false
	      });
	    ...
	    key: 'saveCodecType',
	    value: function saveCodecType(e) {
	      var _this4 = this;
	
	      e.preventDefault();
	      var codecType = _reactDom2.default.findDOMNode(this.refs.codecTypeValue).value;
	      var uid = this.props.loggedInData.data._id;
	      var roomId = this.props.params.cid;
	      this.props.dispatch((0, _RoomActions.saveCodecTypeRequest)({ uid: uid, roomId: roomId, codecType: codecType })).then(function (res) {
	        return _this4.setForm(2);
	      });
	    }
	    ...
	    key: 'handleEnableLiveBlock',
	    value: function handleEnableLiveBlock(e) {
	      this.setState({
	        selectEnableLiveBlock: true
	      });
	    }
	  }, {
	    key: 'cancelEnableLive',
	    value: function cancelEnableLive(e) {
	      e.preventDefault();
	      this.setState({
	        selectEnableLiveBlock: false
	      });
	    ...
	    key: 'saveEnableLive',
	    value: function saveEnableLive(e) {
	      var _this5 = this;
	
	      e.preventDefault();
	      var enableLive = this.refs.enableLiveValue.value;
	      var uid = this.props.loggedInData.data._id;
	      var roomId = this.props.params.cid;
	      this.props.dispatch((0, _RoomActions.saveEnableLiveRequest)({ uid: uid, roomId: roomId, enableLive: enableLive })).then(function (res) {
	        return _this5.setForm(3);
	      });
	    }
	  }, {
	    key: 'render',
	    value: function render() {
	      ...
	      var cls_topmenu = _component2.default.iTopMenu + ' ' + _Admin2.default.oTopMenu;
	      ...
	      if (this.props.roomData && this.props.roomData.data && !_.isEmpty(this.props.roomData.data)) {
	        var _roomData = this.props.roomData.data;
	        if (_roomData.selPackage && _roomData.selPackage.features.indexOf("Topics") != -1) {
	          this.submenu = _Validator2.default.activeSubMenu(_RoomMenu.roomEditSubMenu, "lnkRoomConfiguration");
	      ...
	      return _jsx('div', {
	      ...
	      }, void 0, _jsx('ul', {}, void 0, _ref2, _ref3, _jsx('li', {}, void 0, this.props.roomData.data.roomName)))), _jsx('div', {
	        ...
	        fluid: true
	      }, void 0, this.props.roomData && this.props.roomData.data != undefined && this.props.roomData.data.roomConfiguration ? _jsx('div', {
	        className: _WorkEdu2.default.userCategoryInfo
	      }, void 0, _jsx('h2', {
	        className: _WorkEdu2.default.categoryHeading
	      }, void 0, _ref4), _jsx('ul', {}, void 0, _jsx('li', {}, void 0, this.state.selectFeedbackBlock == false ? _jsx('div', {}, void 0, _jsx('div', {
	      ...
	      }, void 0, _jsx('li', {}, void 0, this.props.roomData.data.roomConfiguration.feedback.feedbackType))))), _jsx('div', {
	        className: moreInfoBlock
	      }, void 0, _jsx('div', {
	        className: _WorkEdu2.default.moreIconBox
	      }, void 0, _jsx(_reactFontawesome2.default, {
	        name: 'pencil',
	        onClick: this.handleFeedbackBlock.bind(this)
	      })))), this.props.roomData.data.roomConfiguration.feedback.feedbackType == "Customize" ? _jsx('div', {
	        className: displayInfoBlock
	      }, void 0, _jsx('div', {
	        className: singleInfoBox
	      }, void 0, _jsx('div', {
	        ...
	        className: _WorkEdu2.default.leftInfoTxt
	      }, void 0, 'Questionnaire:')), _jsx('div', {
	        className: 'col-md-10'
	      }, void 0, _jsx('ul', {
	        className: _WorkEdu2.default.rightDetailInfo
	      }, void 0, _jsx('li', {}, void 0, this.state.questionnaireName)))))) : null) : null, this.state.selectFeedbackBlock && this.props.roomData && this.props.roomData.roomQuestionnaireList ? _jsx('div', {
	        ...
	        'select',
	        { id: 'feedbackType', className: 'form-control', ref: 'feedbackTypeValue', onChange: this.selectedFeedbackType.bind(this) },
	        _jsx('option', {
	          value: this.props.roomData.data.roomConfiguration.feedback.feedbackType
	        }, void 0, this.props.roomData.data.roomConfiguration.feedback.feedbackType),
	        _jsx('option', {
	          value: this.props.roomData.data.roomConfiguration.feedback.feedbackType == "Default" ? "None" : "Default"
	        }, void 0, this.props.roomData.data.roomConfiguration.feedback.feedbackType == "Default" ? "None" : "Default"),
	        _jsx('option', {
	          value: this.props.roomData.data.roomConfiguration.feedback.feedbackType == "Default" ? "Customize" : this.props.roomData.data.roomConfiguration.feedback.feedbackType == "None" ? "Customize" : "None"
	        }, void 0, this.props.roomData.data.roomConfiguration.feedback.feedbackType == "Default" ? "Customize" : this.props.roomData.data.roomConfiguration.feedback.feedbackType == "None" ? "Customize" : "None")
	      )))), this.state.questionaireDropdown ? _jsx('div', {
	        className: 'form-group'
	        ...
	        'select',
	        { id: 'assignQuestionaire', className: 'form-control', ref: 'feedbackQuestionnaire', onChange: this.selectedFeedbackType.bind(this) },
	        _jsx('option', {
	          value: ''
	        }, void 0, this.props.roomData.data.roomConfiguration.feedback.questionnaireId == undefined ? "Select Questionnaire" : this.state.questionnaireName),
	        this.props.roomData.roomQuestionnaireList.map(function (questionnaireData, index) {
	          if (_this6.state.questionnaireName != questionnaireData.questionnaireName) {
	
	            return _jsx('option', {
	              value: index
	            }, questionnaireData._id, questionnaireData.questionnaireName);
	          } else if (_this6.props.roomData.data.roomConfiguration.feedback.questionnaireId == undefined) {
	            return _jsx('option', {
	              value: index
	            }, questionnaireData._id, questionnaireData.questionnaireName);
	          }
	        ...
	        onClick: this.cancelFeedbackType.bind(this)
	      }, void 0, _ref8), _jsx('button', {
	        id: 'save',
	        type: 'submit',
	        className: cls_btnSaveEdit2,
	        onClick: this.saveFeedbackType.bind(this)
	      }, void 0, _ref9)))))) : null), _jsx('li', {}, void 0, this.state.selectCodecBlock == false ? _jsx('div', {}, void 0, _jsx('div', {
	        className: displayInfoBlock
	      }, void 0, _jsx('div', {
	        className: singleInfoBox
	      }, void 0, _jsx('div', {
	        ...
	        className: _WorkEdu2.default.rightDetailInfo
	      }, void 0, _jsx('li', {}, void 0, this.props.roomData.data.roomConfiguration.codecType))))), _jsx('div', {
	        className: moreInfoBlock
	      }, void 0, _jsx('div', {
	        className: _WorkEdu2.default.moreIconBox
	      }, void 0, _jsx(_reactFontawesome2.default, {
	        name: 'pencil',
	        onClick: this.handleCodecBlock.bind(this)
	      }))))) : _jsx('div', {
	        className: _WorkEdu2.default.profileEditBlock
	      }, void 0, _jsx('form', {
	        className: 'form-horizontal'
	        ...
	        'select',
	        { id: 'codecType', className: 'form-control', ref: 'codecTypeValue' },
	        _jsx('option', {
	          value: 'vp8',
	          selected: this.props.roomData.data.roomConfiguration.codecType == 'vp8'
	        }, void 0, 'Codec VP8'),
	        _jsx('option', {
	          value: 'vp9',
	          selected: this.props.roomData.data.roomConfiguration.codecType == 'vp9'
	        }, void 0, 'Codec VP9'),
	        _jsx('option', {
	          value: 'h264',
	          selected: this.props.roomData.data.roomConfiguration.codecType == 'h264'
	        }, void 0, 'Codec H.264')
	      )))), _jsx('div', {
	        className: 'form-group'
	      }, void 0, _jsx('div', {
	        ...
	        type: 'submit',
	        className: cls_btnCancle,
	        onClick: this.cancelCodecType.bind(this)
	      }, void 0, _ref12), _jsx('button', {
	        id: 'codectypeSubmit',
	        type: 'submit',
	        className: cls_btnSaveEdit2,
	        onClick: this.saveCodecType.bind(this)
	      }, void 0, _ref13))))))), _jsx('li', {}, void 0, this.state.userRole == _roles.Roles.Lmsadmin || this.state.userRole == _roles.Roles.Presenteradmin ? this.state.selectEnableLiveBlock == false ? _jsx('div', {}, void 0, _jsx('div', {
	        className: displayInfoBlock
	      }, void 0, _jsx('div', {
	        className: singleInfoBox
	      }, void 0, _jsx('div', {
	        ...
	        className: _WorkEdu2.default.rightDetailInfo
	      }, void 0, _jsx('li', {}, void 0, this.props.roomData.data.roomConfiguration.enableLive ? "True" : "False"))))), _jsx('div', {
	        className: moreInfoBlock
	      }, void 0, _jsx('div', {
	        className: _WorkEdu2.default.moreIconBox
	      }, void 0, _jsx(_reactFontawesome2.default, {
	        name: 'pencil',
	        onClick: this.handleEnableLiveBlock.bind(this)
	      }))))) : _jsx('div', {
	        className: _WorkEdu2.default.profileEditBlock
	      }, void 0, _jsx('form', {
	        className: 'form-horizontal'
	        ...
	        'select',
	        { id: 'enableLive', className: 'form-control', ref: 'enableLiveValue' },
	        _jsx('option', {
	          value: 'true',
	          selected: this.props.roomData.data.roomConfiguration.enableLive
	        }, void 0, 'True'),
	        _jsx('option', {
	          value: 'false',
	          selected: !this.props.roomData.data.roomConfiguration.enableLive
	        ...
	        type: 'submit',
	        className: cls_btnCancle,
	        onClick: this.cancelEnableLive.bind(this)
	      }, void 0, _ref16), _jsx('button', {
	        id: 'enableliveSubmit',
	        type: 'submit',
	        className: cls_btnSaveEdit2,
	        onClick: this.saveEnableLive.bind(this)
	      }, void 0, _ref17)))))) : null))) : null))));
	    }
	  }]);
	...
	exports.default = (0, _reactRedux.connect)(mapStateToProps)(RoomConfiguration);
