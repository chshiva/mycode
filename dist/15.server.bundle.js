...
/***/ function(module, exports, __webpack_require__) {
	...
	var _SettingSchema = __webpack_require__(476);
	...
	var _SettingsMenu = __webpack_require__(477);
	...
	var SetingsComponent = function (_Component) {
	  _inherits(SetingsComponent, _Component);
	
	  function SetingsComponent(props) {
	    _classCallCheck(this, SetingsComponent);
	
	    var _this = _possibleConstructorReturn(this, (SetingsComponent.__proto__ || Object.getPrototypeOf(SetingsComponent)).call(this, props));
	
	    _initialiseProps.call(_this);
	
	    _this.form = null;
	    _this.submenu = _Validator2.default.activeSubMenu(_SettingsMenu.settingsEditSubMenu, "lnkNewUsers");
	    _this.mainmenu = _SettingsMenu.settingsEditMainMenu;
	    _this.schema = _SettingSchema.SettingsSchema;
	    _this.res = {};
	    _this.mainmenu.menus[0].action = _this.save.bind(_this);
	    _this.mainmenu.menus[1].action = _this.deleteSMTPSettings.bind(_this);
	  ...
	  _createClass(SetingsComponent, [{
	    key: 'componentDidMount',
	    value: function componentDidMount() {
	      this.setdata(this.props.loggedInData);
	      this.props.dispatch((0, _SettingsActions.getSettings)());
	    }
	  }, {
	    key: 'setdata',
	    value: function setdata(result) {
	      ...
	      if (result && result.data && result.data._id) {
	        ...
	        if (response) {
	          ...
	          this.props.dispatch((0, _SettingsActions.UpdateSettingsSchema)(this.schema));
	          this.props.dispatch((0, _SettingsActions.settingsStore)({ uid: result.data._id }));
	        }
	      }
	    }
	  }, {
	    ...
	    value: function componentWillUnmount() {
	      this.props.dispatch((0, _SettingsActions.ClearSMTP)());
	    }
	  }, {
	    key: 'render',
	    value: function render() {
	      return _jsx('div', {}, void 0, _jsx(_ContainerComponent2.default, {
	        error: this.props.settingsData.error,
	...
	var _initialiseProps = function _initialiseProps() {
	  ...
	  this.save = function () {
	    ...
	    if (response.error.length > 0) {
	      ...
	      _this2.props.dispatch((0, _SettingsActions.UpdateSettingsSchema)(_this2.schema));
	    } else {
	      _this2.props.dispatch((0, _SettingsActions.saveSettings)(_this2.form));
	    }
	  };
	
	  this.deleteSMTPSettings = function () {
	    // var response = this.clearresponse;
	    var self = _this2;
	    var props = _this2.props;
	    alertify.confirm(_this2.props.intlData.messages.warning, _this2.props.intlData.messages.delete_SMTPSettings_alert, function (result) {
	      if (result) {
	        props.dispatch((0, _SettingsActions.deleteSMTPSettings)()).then(function (res) {
	  ...
	  this.clearresponse = function (res) {
	    if (res.status) {
	      var response = _Validator2.default.freeValue(_this2.schema);
	      if (response) {
	        _this2.props.dispatch((0, _SettingsActions.ClearSMTP)());
	        _this2.props.dispatch((0, _SettingsActions.UpdateSettingsSchema)(response));
	        _this2.props.dispatch((0, _SettingsActions.settingsStore)({ uid: _this2.props.loggedInData.data._id }));
	      }
	    }
	  };
	...
	function mapStateToProps(state) {
	  return {
	    ...
	    settingsData: (0, _SettingsReducer.settingsData)(state),
	...
	exports.default = (0, _reactRedux.connect)(mapStateToProps)(SetingsComponent);
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.SettingsSchema = undefined;
	...
	var SettingsSchema = exports.SettingsSchema = {
				_id: "Settings",
				...
				schemas: {
							SMTPDetails: {
										SMTPDetails: [{ type: "title", text: _jsx(_reactIntl.FormattedMessage, {
																id: 'smtp_details'
													}), icon: "fa fa-caret-right" }, { type: "hidden", _id: "_id", text: "", datafield: "uid" }, { type: "text", text: _jsx(_reactIntl.FormattedMessage, {
																id: 'api_key'
													}), _id: "apikeyId", datafield: "apiKey", required: true, error: "", exp: "", errormsg: "", limit: 30 }, { type: "text", text: _jsx(_reactIntl.FormattedMessage, {
																id: 'domain'
													}), _id: "domainId", datafield: "domain", required: true, error: "", exp: "", errormsg: "", limit: 100 }, { type: "text", text: _jsx(_reactIntl.FormattedMessage, {
																id: 'username'
													}), _id: "usernameId", datafield: "username", required: true, error: "", exp: "", errormsg: "", limit: 30 }, { type: "password", text: _jsx(_reactIntl.FormattedMessage, {
																id: 'password'
													}), _id: "passwordId", datafield: "password", required: true, error: "", exp: "", errormsg: "", limit: 30 }, { type: "text", text: _jsx(_reactIntl.FormattedMessage, {
																id: 'server'
													}), _id: "serverId", datafield: "server", required: true, error: "", exp: "", errormsg: "", limit: 50 }]
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.settingsEditSubMenu = exports.settingsEditMainMenu = undefined;
	...
	//Main Menu
	var settingsEditMainMenu = exports.settingsEditMainMenu = {
			...
			//SubMenu
	};var settingsEditSubMenu = exports.settingsEditSubMenu = {
