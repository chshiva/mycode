...
/***/ function(module, exports, __webpack_require__) {
	...
	var _ListQuestions = __webpack_require__(448);
	
	var _ListQuestions2 = _interopRequireDefault(_ListQuestions);
	
	var _QuestionPopup = __webpack_require__(451);
	
	var _QuestionPopup2 = _interopRequireDefault(_QuestionPopup);
	...
	var _ref6 = _jsx('li', {}, void 0, _jsx(_reactIntl.FormattedMessage, {
	  id: 'add_question'
	}));
	
	var _ref7 = _jsx(_TopMenu2.default, {
	  data: _QuestionnaireMenu.questionsViewMainMenu
	});
	
	var _ref8 = _jsx(_SubMenu2.default, {
	  data: _QuestionnaireMenu.questionnaireViewSubMenu
	});
	...
	var AddQuestions = function (_Component) {
	  ...
	  function AddQuestions(props) {
	    ...
	    // this.form = null;
	    var _this = _possibleConstructorReturn(this, (AddQuestions.__proto__ || Object.getPrototypeOf(AddQuestions)).call(this, props));
	
	    _this.viewQuestionnaire = function () {
	      var questionnaireId = _this.props.params.cid;
	      _reactRouter.browserHistory.push('/admin/questionnaire/view/' + questionnaireId);
	    };
	
	    _this.viewQuestions = function () {
	      var questionnaireId = _this.props.params.cid;
	      _reactRouter.browserHistory.push('/admin/questionnaire/questions/' + questionnaireId);
	    };
	    ...
	    _this.setResultResponse = function (response) {
	      if (_this.state.loading) {
	        _this.setState({ loading: false });
	      }
	    };
	
	    _this.hideAddQuestionModal = function () {
	      _this.setState({
	    ...
	    _this.submenu = _Validator2.default.activeSubMenu(_QuestionnaireMenu.questionnaireViewSubMenu, "lnkViewQuestions");
	    _this.mainmenu = _QuestionnaireMenu.questionsViewMainMenu;
	
	    _this.mainmenu.menus[0].action = _this.showAddQuestions.bind(_this);
	    _this.submenu.menus[0].action = _this.viewQuestionnaire.bind(_this);
	    _this.submenu.menus[1].action = _this.viewQuestions.bind(_this);
	  ...
	  _createClass(AddQuestions, [{
	    key: 'showAddQuestions',
	    value: function showAddQuestions(e) {
	    ...
	    value: function setdata(result) {
	      ...
	      if (result && result.data && result.data._id) {
	        ...
	        this.props.dispatch((0, _QuestionnaireActions.getQuestionnaireData)(obj, '/admin/questionnaire/questions/' + questionnaireId)).then(function (res) {
	          return _this2.setresponse(res);
	        });
	        this.props.dispatch((0, _QuestionnaireActions.getQuestionnaireResult)(questionnaireId)).then(function (res) {
	          return _this2.setResultResponse(res);
	        });
	      }
	    }
	  }, {
	    ...
	    value: function render() {
	      ...
	      return _jsx('div', {
	        ...
	        onClick: this.viewQuestionnaire
	      }, void 0, this.props.questionnaireData.data.questionnaireName)), _ref5, _ref6)), this.props.questionnaireData && this.props.questionnaireData.questionnaireResult && this.props.questionnaireData.questionnaireResult.submittedFlag && this.props.questionnaireData.questionnaireResult.submittedFlag == true ? _ref7 : null), _jsx('div', {
	        className: cls_isubmenu
	      }, void 0, _ref8), _jsx(_reactBootstrap.Modal, {
	        show: this.state.showModal,
	        onHide: this.hideAddQuestionModal.bind(this)
	      }, void 0, _jsx(_QuestionPopup2.default, {
	        hideAddQuestionModal: this.hideAddQuestionModal,
	        questionnaireId: this.props.params.cid,
	        uid: userObject._id,
	        questionnaireData: dataObject
	      })), _jsx(_ListQuestions2.default, {
	        hideAddQuestionModal: this.hideAddQuestionModal,
	        questionnaireData: dataObject,
	        success: this.props.questionnaireData.success,
	        uid: userObject._id,
	        questionnaireId: this.props.params.cid,
	...
	exports.default = (0, _reactRedux.connect)(mapStateToProps)(AddQuestions);
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.ListQuestions = undefined;
	...
	var _ref = _jsx(_reactIntl.FormattedMessage, {
	  id: 'no_questions_added_to_this_questionnaire'
	});
	...
	var _ref4 = _jsx('p', {}, void 0, _jsx(_reactIntl.FormattedMessage, {
	  id: 'title_question_details'
	}), '.');
	
	var ListQuestions = exports.ListQuestions = function (_Component) {
	  _inherits(ListQuestions, _Component);
	
	  function ListQuestions(props) {
	    _classCallCheck(this, ListQuestions);
	
	    var _this = _possibleConstructorReturn(this, (ListQuestions.__proto__ || Object.getPrototypeOf(ListQuestions)).call(this, props));
	  ...
	  _createClass(ListQuestions, [{
	    key: 'componentDidMount',
	    value: function componentDidMount() {
	      var questionnaireId = this.props.questionnaireData.data._id;
	      this.props.dispatch((0, _QuestionnaireActions.getQuestionnaireResult)(questionnaireId));;
	    }
	  }, {
	    key: 'componentWillReceiveProps',
	    value: function componentWillReceiveProps(nextProps) {
	    ...
	    value: function removeQuestion(e) {
	      ...
	      alertify.confirm(this.props.intl.messages.warning, this.props.intl.messages.delete_question_alert, function (result) {
	        if (result) {
	          var obj = {
	            questionnaireId: questionnaireId,
	            questionId: questionId
	          };
	          props.dispatch((0, _QuestionnaireActions.removeQuestionRequest)(obj)).then(function (res) {
	            return response(res, questionnaireId, questionId);
	          });
	        }
	    ...
	    key: 'handleEditQuestion',
	    value: function handleEditQuestion(id) {
	      var questionId = id;
	      this.props.dispatch((0, _QuestionnaireActions.editModal)(questionId));
	    ...
	    value: function render() {
	      ...
	      if (this.props.questionnaireData && this.props.questionnaireData.data && this.props.questionnaireData.data.questions && this.props.questionnaireData.data.questions.length > 0) {
	        var questions = this.props.questionnaireData.data.questions;
	        listQuestions = questions.map(function (question, index) {
	          return _jsx('li', {}, question._id, _jsx('div', {
	            className: 'clearfix'
	          }, void 0, _jsx(_RenderQuestions2.default, {
	            question: question.question
	          }), _this2.props.role != 1 ? _this2.props.questionnaireData && _this2.props.questionnaireData.questionnaireResult && _this2.props.questionnaireData.questionnaireResult.submittedFlag && _this2.props.questionnaireData.questionnaireResult.submittedFlag == true ? _jsx('div', {
	            className: _Admin2.default.userAction1,
	            title: _this2.props.intl.messages.view_edit_question_from_questionnaire
	          }, void 0, _jsx(_reactFontawesome2.default, {
	            name: 'pencil-square-o',
	            onClick: function onClick() {
	              return _this2.handleEditQuestion(question._id);
	            }
	          })) : null : null, _this2.props.role != 1 ? _this2.props.questionnaireData && _this2.props.questionnaireData.questionnaireResult && _this2.props.questionnaireData.questionnaireResult.submittedFlag && _this2.props.questionnaireData.questionnaireResult.submittedFlag == true ? _jsx('div', {
	            className: _Admin2.default.userAction,
	            title: _this2.props.intl.messages.remove_question_from_questionnaire
	          }, void 0, _jsx(_reactFontawesome2.default, {
	            name: 'times',
	            id: question._id,
	            onClick: _this2.removeQuestion.bind(_this2)
	          })) : null : null));
	        });
	      }
	      ...
	      return _jsx('div', {
	      ...
	      }, void 0, _ref2, ' - ', _jsx('b', {}, void 0, this.props.questionnaireData.data.questionnaireName))), _jsx('div', {
	        ...
	        fluid: true
	      }, void 0, listQuestions != _ref3 ? _jsx(_reactBootstrap.Row, {}, void 0, _jsx(_reactBootstrap.Col, {
	        md: 12
	      }, void 0, _jsx('div', {
	        className: _Admin2.default.infoTxt
	      }, void 0, _ref4))) : null, _jsx(_reactBootstrap.Row, {}, void 0, _jsx(_reactBootstrap.Col, {
	        md: 12
	      }, void 0, _jsx('div', {
	        className: _Admin2.default.userListGroup
	      }, void 0, _jsx('ul', {}, void 0, listQuestions)))))));
	    }
	  }]);
	...
	var _initialiseProps = function _initialiseProps() {
	  ...
	  this.confirmDeltetion = function (response, questionnaireId, questionId) {
	
	    //createdBy: pranathi, disc: reloading the conduct question component in conference side
	
	    var deleteQuestionnaireObj = {
	      command: 'RELOAD_CONDUCT_QUESTION',
	      content: { questionnaireId: questionnaireId },
	      type: 'OBJECT'
	    };
	
	    _this3.confObject.sendMessage(deleteQuestionnaireObj, 0);
	    var props = _this3.props;
	    if (response.httpStatusCode != '' && response.httpStatusCode != undefined) {
	      alertify.confirm(_this3.props.intl.messages.warning, _this3.props.intl.messages.confirm_delete_question_from_questionnaire, function (result) {
	        if (result) {
	          var obj = {
	            questionnaireId: questionnaireId,
	            questionId: questionId
	          };
	          props.dispatch((0, _QuestionnaireActions.confirmedRemoveQuestionRequest)(obj));
	        }
	      }, function () {}).setting('labels', { 'ok': _this3.props.intl.messages.ok, 'cancel': _this3.props.intl.messages.cancel });
	    }
	  };
	};
	...
	exports.default = (0, _reactRedux.connect)(mapStateToProps)((0, _reactIntl.injectIntl)(ListQuestions));
	...
	var MultipleChoice = function (_Component) {
	  ...
	  _createClass(MultipleChoice, [{
	    ...
	    value: function render() {
	      ...
	      return _jsx('div', {
	      ...
	      }), this.props.enableSWOT ? _jsx('div', {}, void 0, _jsx('div', {
	        className: 'col-xs-7'
	      }, void 0, _jsx('input', {
	        id: 'enableSWOT',
	        type: 'text',
	        ...
	        className: 'form-control',
	        value: swotValue,
	        onChange: this.props.handleSwotValue
	      }, void 0, _ref, _ref2, _ref3, _ref4, _ref5))) : _jsx('div', {
	        className: 'col-xs-10'
	      }, void 0, _jsx('input', {
	        id: 'answerValue',
	        type: 'text',
...
/***/ function(module, exports, __webpack_require__) {
	...
	var MultipleResponse = function (_Component) {
	  _inherits(MultipleResponse, _Component);
	
	  function MultipleResponse(props) {
	    _classCallCheck(this, MultipleResponse);
	
	    return _possibleConstructorReturn(this, (MultipleResponse.__proto__ || Object.getPrototypeOf(MultipleResponse)).call(this, props));
	  }
	
	  _createClass(MultipleResponse, [{
	    key: 'render',
	    value: function render() {
	      var checked;
	...
	exports.default = (0, _reactRedux.connect)(mapStateToProps)(MultipleResponse);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _MultipleChoice = __webpack_require__(449);
	
	var _MultipleChoice2 = _interopRequireDefault(_MultipleChoice);
	
	var _MultipleResponse = __webpack_require__(450);
	
	var _MultipleResponse2 = _interopRequireDefault(_MultipleResponse);
	...
	var _ref = _jsx(_reactIntl.FormattedMessage, {
	  id: 'Please_enter_Question'
	});
	
	var _ref2 = _jsx(_reactIntl.FormattedMessage, {
	  id: 'please_select_type'
	});
	
	var _ref3 = _jsx(_reactIntl.FormattedMessage, {
	  id: 'Please_enter_Options'
	});
	...
	var _ref23 = _jsx('p', {
	  ...
	  id: 'select_an_answer_otherwise_it_will_not_be_considered_for_evaluation'
	}));
	
	var _ref24 = _jsx('p', {
	  className: 'col-xs-10'
	}, void 0, _jsx(_reactIntl.FormattedMessage, {
	  id: 'enter_the_answer_choices_and_mark_which_answer_is_correct'
	}));
	...
	var _ref49 = _jsx('div', {
	  ...
	  className: 'col-xs-10'
	}, void 0, 'Enter the correct answer'));
	
	var _ref50 = _jsx('input', {
	  type: 'radio',
	  className: 'col-xs-2',
	  defaultChecked: true
	});
	...
	var _ref57 = _jsx('option', {
	  value: 'Checkbox'
	}, void 0, 'Multiple Response');
	
	var _ref58 = _jsx('option', {
	  value: 'TF'
	}, void 0, 'True/false');
	
	var _ref59 = _jsx('label', {
	  htmlFor: 'marks',
	  className: 'control-label col-xs-2'
	}, void 0, _jsx(_reactIntl.FormattedMessage, {
	  id: 'Marks'
	...
	var QuestionPopup = function (_Component) {
	  _inherits(QuestionPopup, _Component);
	
	  function QuestionPopup(props) {
	    _classCallCheck(this, QuestionPopup);
	
	    var _this = _possibleConstructorReturn(this, (QuestionPopup.__proto__ || Object.getPrototypeOf(QuestionPopup)).call(this, props));
	    ...
	    _this.setresponse = function (response) {
	      if (response.status) {
	        ...
	        _this.props.hideAddQuestionModal();
	
	        //changeBy: pranathi, disc: reloading conduct question component in conferencd side 
	        var addQuestionseObj = {
	          command: 'RELOAD_CONDUCT_QUESTION',
	          content: { questionnaireId: _this.props.questionnaireId },
	          type: 'OBJECT'
	          //  console.log('create question');
	        };_this.confObject.sendMessage(addQuestionseObj, 0);
	      } else {
	        var error = {};
	        ...
	        _this.setState({ validationError: error, submitted: false });
	      }
	    };
	
	    _this.handleMarks = function (e) {
	      _this.setState({
	    ...
	    _this.createQuestion = function () {
	      var errors = {};
	      if (_this.quill.getLength() <= 1) errors['questionError'] = _ref;
	      if (_this.state.type == '') errors['typeError'] = _ref2;
	      // if(this.state.type == '' || this.state.question == '') {
	      //   this.refs.questions_container.error("Please fill all the fields");
	      // } else {
	      if (_this.state.type == "Radio" || _this.state.type == "TF") {
	        ...
	        if (emptyOptions) {
	          errors['answerError'] = _ref3;
	        }if (/^\s+$/.test(_this.state.question)) {
	          errors['questionError'] = _ref4;
	        }if (_this.state.values.length < 2) {
	          errors['answerError'] = _ref5;
	        }if (whitespaceOptions) {
	          errors['answerError'] = _ref6;
	        }if (duplicateValues) {
	          errors['answerError'] = _ref7;
	        }if (_this.state.enableSWOT == false && _this.state.radioAnswer == '') {
	          errors['answerError'] = _ref8;
	        }if (_this.state.marks == '' && _this.state.enableSWOT == false) {
	          errors['marksError'] = _ref9;
	        }if (/^\d+$/.test(_this.state.marks) == false && _this.state.enableSWOT == false) {
	          errors['marksError'] = _ref10;
	        ...
	        if (!_.isEmpty(errors)) {
	          ...
	          var answers = [];
	          answers.push(_this.state.radioAnswer);
	          var question = {
	            question: _this.quill.getContents().ops,
	            questionType: _this.state.type,
	            options: trimValues,
	            answers: answers,
	            uid: _this.props.uid,
	            _id: _this.props.questionnaireId,
	            questionId: _this.state.questionId
	            //console.log("typed question", question);
	          };if (_this.state.enableSWOT) {
	            question['swots'] = _this.state.swotValue, question['marks'] = null;
	          } else {
	            question['swots'] = [];
	            question['marks'] = _this.state.marks;
	          }
	          _this.props.dispatch((0, _QuestionnaireActions.SaveQuestionRequest)({ question: question })).then(function (res) {
	            return _this.setresponse(res);
	          });
	        }
	      } else if (_this.state.type == "Checkbox") {
	        var emptyOptions = _.includes(_this.state.values, '');
	        var emptyAnswers = _.without(_this.state.checkboxAnswer, '');
	        var trimValues = _.map(_this.state.values, _.trim);
	        var duplicateValues = _.uniq(trimValues).length !== trimValues.length;
	        for (var i = 0; i < _this.state.values.length; i++) {
	          if (/^\s+$/.test(_this.state.values[i])) {
	        ...
	        if (emptyOptions) {
	          errors['answerError'] = _ref11;
	        }if (/^\s+$/.test(_this.state.question)) {
	          errors['questionError'] = _ref12;
	        }if (_this.state.values.length < 2) {
	          errors['answerError'] = _ref13;
	        }if (whitespaceOptions) {
	          errors['answerError'] = _ref14;
	        }if (duplicateValues) {
	          errors['answerError'] = _ref15;
	        }if (_.isEmpty(emptyAnswers) && _this.state.enableSWOT == false) {
	          errors['answerError'] = _ref16;
	        }if (_this.state.marks == '' && _this.state.enableSWOT == false) {
	          errors['marksError'] = _ref17;
	        }if (/^\d+$/.test(_this.state.marks) == false && _this.state.enableSWOT == false) {
	          errors['marksError'] = _ref18;
	        }
	        if (!_.isEmpty(errors)) {
	          _this.setState({
	            validationError: errors
	          ...
	          var question = {
	            ...
	            questionType: _this.state.type,
	            options: trimValues,
	            answers: _this.state.checkboxAnswer,
	            uid: _this.props.uid,
	            _id: _this.props.questionnaireId,
	            questionId: _this.state.questionId
	          };
	          if (_this.state.enableSWOT) {
	            question['swots'] = _this.state.swotValue;
	            question['marks'] = null;
	          } else {
	            question['swots'] = [];
	            question['marks'] = _this.state.marks;
	      ...
	      } else if (_this.state.type == "Subjective") {
	        if (_this.state.radioAnswer == '') {
	          errors['questionError'] = _ref19;
	        }
	        if (_this.state.marks == '' && _this.state.enableSWOT == false) {
	          errors['marksError'] = _ref20;
	        }
	        if (/^\d+$/.test(_this.state.marks) == false && _this.state.enableSWOT == false) {
	          errors['marksError'] = _ref21;
	        }
	        if (!_.isEmpty(errors)) {
	          _this.setState({
	            validationError: errors
	    ...
	    _this.handleQuill = function (e) {
	      _this.refs.marks.focus();
	    };
	  ...
	  _createClass(QuestionPopup, [{
	    key: 'componentDidMount',
	    value: function componentDidMount() {
	      this.quill = new Quill(_reactDom2.default.findDOMNode(this.refs.editor), {
	        modules: {
	          toolbar: [[{ 'header': [1, 2, 3, 4, 5, 6, false] }], ['bold', 'italic', 'underline', 'videoURL'], ['image', 'code-block'], ['formula'], [{ 'size': ['small', false, 'large', 'huge'] }], [{ 'list': 'ordered' }, { 'list': 'bullet' }], [{ 'script': 'sub' }, { 'script': 'super' }], [{ 'color': [] }, { 'background': [] }], [{ 'align': [] }]],
	          formula: true
	        },
	    ...
	    value: function componentWillUnmount() {
	      this.props.dispatch((0, _QuestionnaireActions.editModal)(''));
	    }
	  }, {
	    key: 'handleType',
	    ...
	    value: function handleRemoveOption() {
	      ...
	      if (this.state.type == 'Radio' || this.state.type == 'TF') {
	        ...
	        if (this.state.checkboxAnswer.includes(oldState[length])) {
	          var checkboxAnswer = this.state.checkboxAnswer;
	          checkboxAnswer.pop();
	          this.state.checkboxAnswer = checkboxAnswer;
	        }
	      }
	      var oldSwotState = this.state.swotValue;
	      oldSwotState.pop();
	      oldState.pop();
	      this.setState({
	        values: oldState,
	    ...
	    value: function handleRadioAnswer(index, e) {
	      this.setState({ radioAnswer: e.target.value });
	    }
	  }, {
	    key: 'handleCheckboxAnswer',
	    value: function handleCheckboxAnswer(index, e) {
	      var oldState = this.state.checkboxAnswer;
	    ...
	    key: 'handleTrue',
	    value: function handleTrue(index, e) {
	      this.setState({
	    ...
	    key: 'handleFalse',
	    value: function handleFalse(index, e) {
	      this.setState({
	    ...
	    key: 'handleSwotValue',
	    value: function handleSwotValue(index, e) {
	      var oldState = this.state.swotValue;
	      oldState[index] = e.target.value;
	    ...
	    value: function render() {
	      ...
	      var Radio = this.state.type == "Radio" ? _jsx('div', {}, void 0, _jsx('div', {
	        className: 'form-group'
	      }, void 0, _ref22, this.state.enableSWOT ? _ref23 : _ref24), this.state.values.map(function (item, index) {
	        return _jsx(_MultipleChoice2.default, {
	          value: item,
	          index: index,
	          change: _this2.handleOption.bind(_this2, index),
	          checked: _this2.state.radioAnswer,
	          answer: _this2.handleRadioAnswer.bind(_this2, index),
	          enableSWOT: _this2.state.enableSWOT,
	          swotValue: _this2.state.swotValue,
	          handleSwotValue: _this2.handleSwotValue.bind(_this2, index)
	        }, index);
	      }), _jsx('div', {
	        className: 'form-group'
	      }, void 0, _ref25, _jsx('p', {
	        className: 'col-xs-10'
	      }, void 0, _jsx('a', {
	        id: 'addOption',
	        onClick: this.handleAddOption.bind(this)
	      }, void 0, _ref26), ' / ', _jsx('a', {
	        id: 'removeOption',
	        onClick: this.handleRemoveOption.bind(this)
	      }, void 0, _ref27), ' ', _ref28))) : null;
	
	      var Checkbox = this.state.type == "Checkbox" ? _jsx('div', {}, void 0, _jsx('div', {
	        className: 'form-group'
	      }, void 0, _ref29, this.state.enableSWOT ? _ref30 : _ref31), this.state.values.map(function (item, index) {
	        return _jsx(_MultipleResponse2.default, {
	          value: item,
	          index: index,
	          change: _this2.handleOption.bind(_this2, index),
	          checked: _this2.state.checkboxAnswer,
	          answer: _this2.handleCheckboxAnswer.bind(_this2, index),
	          enableSWOT: _this2.state.enableSWOT,
	          swotValue: _this2.state.swotValue,
	          handleSwotValue: _this2.handleSwotValue.bind(_this2, index)
	        }, index);
	        ...
	        className: 'form-group'
	      }, void 0, _ref32, _jsx('p', {
	        className: 'col-xs-10'
	      }, void 0, _jsx('a', {
	        id: 'addOption',
	        onClick: this.handleAddOption.bind(this)
	      }, void 0, _ref33), ' / ', _jsx('a', {
	        id: 'removeOption',
	        onClick: this.handleRemoveOption.bind(this)
	      }, void 0, _ref34), ' ', _ref35))) : null;
	
	      var TF = this.state.type == "TF" ? _jsx('div', {}, void 0, _jsx('div', {
	        className: 'form-group'
	      }, void 0, _ref36, this.state.enableSWOT ? _ref37 : _ref38), _jsx('div', {
	        className: 'form-group'
	      }, void 0, _jsx('input', {
	        id: 'radioTrue',
	        type: 'radio',
	        ...
	        value: 'True',
	        onChange: this.handleTrue.bind(this, 0)
	      }), this.state.enableSWOT ? _jsx('div', {}, void 0, _jsx('div', {
	        className: 'col-xs-7'
	      }, void 0, _jsx('input', {
	        id: 'optionswot',
	        type: 'text',
	        ...
	        onChange: this.handleOption.bind(this, 0)
	      })), _jsx('div', {
	        className: 'col-xs-3'
	      }, void 0, _jsx('select', {
	        id: 'swot',
	        className: 'form-control',
	        value: this.state.swotValue[0],
	        onChange: this.handleSwotValue.bind(this, 0)
	      }, void 0, _ref39, _ref40, _ref41, _ref42, _ref43))) : _jsx('div', {
	        className: 'col-xs-10'
	      }, void 0, _jsx('input', {
	        id: 'optionvalue',
	        type: 'text',
	        ...
	        value: 'False',
	        onChange: this.handleFalse.bind(this, 1)
	      }), this.state.enableSWOT ? _jsx('div', {}, void 0, _jsx('div', {
	        className: 'col-xs-7'
	      }, void 0, _jsx('input', {
	        id: 'optionswot',
	        ...
	        onChange: this.handleOption.bind(this, 1)
	      })), _jsx('div', {
	        className: 'col-xs-3'
	      }, void 0, _jsx('select', {
	        id: 'swot',
	        className: 'form-control',
	        value: this.state.swotValue[1],
	        onChange: this.handleSwotValue.bind(this, 1)
	      }, void 0, _ref44, _ref45, _ref46, _ref47, _ref48))) : _jsx('div', {
	        className: 'col-xs-10'
	      }, void 0, _jsx('input', {
	        id: 'answerValue',
	        type: 'text',
	      ...
	      var Subjective = this.state.type == "Subjective" ? _jsx('div', {}, void 0, _ref49, _jsx('div', {
	        className: 'form-group'
	      }, void 0, _ref50, _jsx('div', {
	        className: 'col-xs-10'
	      }, void 0, _react2.default.createElement('textarea', { id: 'radioAnswer', className: 'form-control', value: this.state.radioAnswer, onChange: this.handleRadioAnswer.bind(this, 0), ref: 'desc', maxLength: 300 })))) : null;
	      ...
	      return _jsx('div', {}, void 0, this.state.loading ? _jsx('div', {
	        ...
	        loadType: loadType
	      }))) : _jsx('div', {}, void 0, _jsx(_Modal.Header, {
	        closeButton: true
	      }, void 0, this.state.questionId != '' ? _jsx(_Modal.Title, {
	        className: _Admin2.default.popHeadingAll
	      }, void 0, _ref51) : _jsx(_Modal.Title, {
	        className: _Admin2.default.popHeadingAll
	      }, void 0, _ref52)), _jsx(_Modal.Body, {}, void 0, _jsx('form', {
	        className: 'form-horizontal'
	      }, void 0, _jsx('div', {
	        className: 'form-group'
	      }, void 0, _ref53, _jsx('div', {
	        className: 'col-xs-10'
	      }, void 0, _react2.default.createElement('div', { ref: 'editor', className: cls_editor }), _jsx('label', {
	        id: 'questionError',
	        className: _component2.default.errorPre
	      }, void 0, this.state.validationError && this.state.validationError.questionError ? this.state.validationError.questionError : ''))), _jsx('div', {
	        className: 'form-group'
	        ...
	        style: this.state.validationError && this.state.validationError.typeError ? { borderColor: "#ff0000" } : {},
	        onChange: this.handleType.bind(this)
	      }, void 0, _ref55, _ref56, _ref57, _ref58), _jsx('label', {
	        id: 'typeError',
	        className: _component2.default.errorPre
	      }, void 0, this.state.validationError && this.state.validationError.typeError ? this.state.validationError.typeError : ''))), _jsx('div', {
	        className: 'form-group'
	      }, void 0, _ref59, _jsx(_reactBootstrap.Col, {
	        sm: 6
	      }, void 0, _react2.default.createElement('input', { type: 'text', id: 'marks', value: this.state.marks, ref: 'marks', onClick: this.handleQuill, onChange: this.handleMarks.bind(this), style: this.state.validationError && this.state.validationError.marksError ? { borderColor: "#ff0000" } : {},
	        className: 'form-control', maxLength: 3 }), _jsx('label', {
	        id: 'marksError',
	        className: _component2.default.errorPre
	      }, void 0, this.state.validationError && this.state.validationError.marksError ? this.state.validationError.marksError : ''))), Radio, Checkbox, TF, Subjective, _jsx('label', {
	        id: 'Error',
	        className: _component2.default.errorPre
	      }, void 0, this.state.validationError && this.state.validationError.answerError ? this.state.validationError.answerError : ''))), !this.state.submitted ? _jsx(_Modal.Footer, {
	        className: _Admin2.default.mainSaveAssign
	      }, void 0, _jsx('div', {
	        className: _Admin2.default.blockSaveAssign
	      }, void 0, _jsx('button', {
	        id: 'questionCancelBtn',
	        onClick: this.props.hideAddQuestionModal
	      }, void 0, _ref60), _jsx('button', {
	        id: 'questionSaveBtn',
	        className: cls_btnSaveAssign,
	        onClick: this.createQuestion
	      }, void 0, this.state.questionId != '' ? _ref61 : _ref62))) : null));
	    }
	  }]);
	...
	exports.default = (0, _reactRedux.connect)(mapStateToProps)(QuestionPopup);
