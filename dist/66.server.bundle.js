...
/***/ function(module, exports, __webpack_require__) {
	...
	var _ref3 = _jsx('ul', {}, void 0, _jsx('li', {}, void 0, _jsx(_reactIntl.FormattedMessage, {
	  id: 'you_are_in_category_list_panel'
	})));
	...
	var ListCategory = function (_Component) {
	  ...
	  function ListCategory(props) {
	    ...
	    var _this = _possibleConstructorReturn(this, (ListCategory.__proto__ || Object.getPrototypeOf(ListCategory)).call(this, props));
	    ...
	    _this.submenu = _Validator2.default.activeSubMenu(_CategoryMenu.categoryListSubMenu, "lnkCategory");
	    _this.mainmenu = _CategoryMenu.categoryListMainMenu;
	    _this.getData = _this.getData.bind(_this);
	
	    _this.currentPage = 1;
	    _this.itemsPerPage = 5;
	
	    _this.viewCategory = _this.viewCategory.bind(_this);
	  ...
	  _createClass(ListCategory, [{
	    ...
	    value: function getData(pageParam) {
	      ...
	      this.props.dispatch((0, _CategoryActions.CategoryListRequest)(pageParam, pageParam.currentPage)).then(function (res) {
	    ...
	    key: 'viewCategory',
	    value: function viewCategory(row) {
	      var link = "/admin/category/view/" + row._id;
	    ...
	    value: function corporateName(row) {
	      if (row.corporateId == null) {
	        ...
	        return _jsx(_reactRouter.Link, {
	          ...
	          to: link
	        }, void 0, _jsx('div', {}, void 0, row.corporateId.businessName, ' '));
	      }
	    }
	  }, {
	    key: 'categoryDesc',
	    value: function categoryDesc(row) {
	
	      if (row.categoryDesc.length > 10) {
	        var categoryDesc = row.categoryDesc.substring(0, 10) + '...';
	        return _jsx('div', {}, void 0, categoryDesc);
	      } else {
	        return _jsx('div', {}, void 0, row.categoryDesc);
	      }
	    }
	  }, {
	    key: 'clearError',
	    value: function clearError() {
	      ...
	      if (response) {
	        this.props.dispatch((0, _CategoryActions.UpdateCategorySchema)(response));
	        _reactRouter.browserHistory.push('/admin/category/new');
	      }
	    }
	  }, {
	    key: 'searchFilter',
	    ...
	    value: function render() {
	      ...
	      var objDisp = [{ title: _ref4, type: "function", callback: this.corporateName }, { fieldName: "categoryName", title: _ref5, type: "text", sort: true, dbName: 'categoryName' }, { title: _ref6, type: "function", callback: this.categoryDesc, sort: true, dbName: 'categoryDesc' }, { title: _ref7, type: "function", callback: this.viewCategory }];
	      ...
	      return _jsx('div', {}, void 0, _react2.default.createElement(_lib.ToastContainer, {
	        ...
	        data: this.props.categoryData.dataList,
	...
	exports.default = (0, _reactRedux.connect)(mapStateToProps)(ListCategory);
