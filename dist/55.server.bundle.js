...
/***/ function(module, exports, __webpack_require__) {
	...
	var _CategoryView = __webpack_require__(431);
	...
	var _CategorySchema = __webpack_require__(393);
	...
	var _CategoryMenu = __webpack_require__(392);
	...
	var _ref4 = _jsx(_TopMenu2.default, {
	  data: _CategoryMenu.categoryViewMainMenu
	});
	
	var ViewCategory = function (_Component) {
	  _inherits(ViewCategory, _Component);
	
	  function ViewCategory(props) {
	    _classCallCheck(this, ViewCategory);
	
	    var _this = _possibleConstructorReturn(this, (ViewCategory.__proto__ || Object.getPrototypeOf(ViewCategory)).call(this, props));
	
	    _initialiseProps.call(_this);
	
	    _this.state = { loading: true };
	    _this.mainmenu = _CategoryMenu.categoryViewMainMenu;
	    _this.schema = _CategorySchema.categorySchema;
	
	    _this.mainmenu.menus[1].action = _this.edit.bind(_this); //this.save.bind(this);
	    _this.mainmenu.menus[2].action = _this.deleteCategory.bind(_this);
	    return _this;
	  }
	  ...
	  _createClass(ViewCategory, [{
	    ...
	    value: function setdata(result) {
	      ...
	      if (result && result.data && result.data._id) {
	        ...
	        this.props.dispatch((0, _CategoryActions.getCategoryData)(obj, '/admin/category/view/' + categoryId)).then(function (res) {
	    ...
	    value: function setLoading() {
	      ...
	      this.props.dispatch((0, _CategoryActions.ClearCat)());
	    ...
	    value: function render() {
	      ...
	      var submenu = _CategoryMenu.categoryViewSubMenu;
	      ...
	      }, void 0, _jsx('ul', {}, void 0, _ref2, _ref3, _jsx('li', {}, void 0, this.props.categoryData && this.props.categoryData.data ? this.props.categoryData.data.categoryName : null))), _ref4), _jsx('div', {
	        className: cls_isubmenu
	      }, void 0, _jsx(_SubMenu2.default, {
	        data: submenu
	      })), _jsx(_CategoryView2.default, {
	        categoryData: this.props.categoryData.data,
	...
	var _initialiseProps = function _initialiseProps() {
	  ...
	  this.edit = function () {
	    ...
	    if (response) {
	      _this3.props.dispatch((0, _CategoryActions.UpdateCategorySchema)(response));
	      var categoryId = _this3.props.params.cid;
	      _reactRouter.browserHistory.push('/admin/category/edit/' + categoryId);
	    }
	  };
	  ...
	  this.deleteCategory = function () {
	    ...
	    alertify.confirm(_this3.props.intl.messages.warning, _this3.props.intl.messages.delete_category_alert, function (result) {
	      if (result) {
	        var obj = {
	          categoryId: categoryId
	        };
	        props.dispatch((0, _CategoryActions.DeleteCategory)(obj, '/admin/category/view/' + categoryId)).then(function (res) {
	          return response(res);
	        });
	      }
	  ...
	  this.setDeleteResponse = function (response) {
	    if (response.status) {
	      _reactRouter.browserHistory.push('/admin/category/list');
	    } else if (response.error) {
	      _this3.refs.category_container.error(response.error + ' ', '');
	    }
	  };
	};
	...
	function mapStateToProps(state) {
	  return {
	    intl: state.intl,
	    categoryData: (0, _CategoryReducer.categoryData)(state),
	...
	exports.default = (0, _reactRedux.connect)(mapStateToProps)(ViewCategory);
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.categoryViewSubMenu = exports.categoryListSubMenu = exports.categoryViewToEditMainMenu = exports.categoryViewToEditSubMenu = exports.categoryEditSubMenu = exports.categoryListMainMenu = exports.categoryViewMainMenu = exports.categoryEditMainMenu = undefined;
	...
	//Main Menu
	var categoryEditMainMenu = exports.categoryEditMainMenu = {
			menus: [{ _id: "btnCancel", text: _jsx(_reactIntl.FormattedMessage, {
							id: 'cancel'
					}), actionType: "URL", action: "/admin/category/list", icon: "fa fa-ban" }, { _id: "btnSave", text: _jsx(_reactIntl.FormattedMessage, {
							id: 'save'
					}), actionType: "Function", action: null, icon: "fa fa-floppy-o" }]
	};
	
	var categoryViewMainMenu = exports.categoryViewMainMenu = {
			menus: [{ _id: "btnList", text: _jsx(_reactIntl.FormattedMessage, {
							id: 'list'
					}), actionType: "URL", action: "/admin/category/list", icon: "fa fa-list" }, { _id: "btnEdit", text: _jsx(_reactIntl.FormattedMessage, {
							id: 'edit'
					}), actionType: "Function", action: null, icon: "fa fa-pencil", role: [_roles.Roles.Admin, _roles.Roles.Lmsadmin, _roles.Roles.Presenteradmin] }, { _id: "btnDelete", text: _jsx(_reactIntl.FormattedMessage, {
							id: 'delete'
					}), actionType: "Function", action: null, icon: "fa fa-trash", role: [_roles.Roles.Admin, _roles.Roles.Lmsadmin, _roles.Roles.Presenteradmin] }]
	};
	var categoryListMainMenu = exports.categoryListMainMenu = {
			menus: [{ _id: "btnNew", text: _jsx(_reactIntl.FormattedMessage, {
							id: 'new_category'
					}), actionType: "Function", action: null, icon: "fa fa-user", role: [_roles.Roles.Admin, _roles.Roles.Lmsadmin, _roles.Roles.Presenteradmin] }]
	
			//SubMenu
	};var categoryEditSubMenu = exports.categoryEditSubMenu = {
			menus: [{ _id: "lnkNewCategory", text: _jsx(_reactIntl.FormattedMessage, {
							id: 'new_category'
					}), actionType: "URL", action: "/admin/category/new", active: "active" }]
	};
	
	var categoryViewToEditSubMenu = exports.categoryViewToEditSubMenu = {
			menus: [{ _id: "editNewCategory", text: _jsx(_reactIntl.FormattedMessage, {
							id: 'edit_category'
					}), actionType: "Function", action: null, active: "active" }]
	};
	var categoryViewToEditMainMenu = exports.categoryViewToEditMainMenu = {
			menus: [{ _id: "btnCancel", text: _jsx(_reactIntl.FormattedMessage, {
							id: 'cancel'
	...
	var categoryListSubMenu = exports.categoryListSubMenu = {
			menus: [{ _id: "lnkCategory", text: _jsx(_reactIntl.FormattedMessage, {
							id: 'all_categories'
					}), actionType: "URL", action: "/admin/category/list", active: "active" }]
	};
	
	var categoryViewSubMenu = exports.categoryViewSubMenu = {
			menus: [{ _id: "lnkCategory", text: _jsx(_reactIntl.FormattedMessage, {
							id: 'category_info'
					}), actionType: "Function", action: null, active: "active" }]
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var categorySchema = exports.categorySchema = {
		_id: "NewCategory",
		formIcon: "fa fa-user",
		...
		schemas: {
			category_details: { //Position Name
				...
				{ type: "hidden", _id: "_id", text: _jsx(_reactIntl.FormattedMessage, {
						...
						id: 'category_details'
					}), icon: "fa fa-caret-right" }, { type: "dynamicdropdown", _id: "corporateid", text: _jsx(_reactIntl.FormattedMessage, {
						id: 'corporate_name'
					}), idfield: "corporateId", datafield: "corporateId", apicall: "corporate-ids", value: "", required: true, error: "", role: [_roles.Roles.Superadmin] }, { type: "text", _id: "categoryName", text: _jsx(_reactIntl.FormattedMessage, {
						id: 'category_name'
					}), datafield: "categoryName", required: true, exp: "SPACE", error: "", errormsg: "", limit: 50 }, { type: "textarea", _id: "categoryDesc", text: _jsx(_reactIntl.FormattedMessage, {
						id: 'category_desc'
					}), datafield: "categoryDesc", required: true, error: "", exp: "SPACE", errormsg: "", limit: 150 }]
...
/***/ function(module, exports, __webpack_require__) {
	...
	var CategoryView = exports.CategoryView = function (_Component) {
	  ...
	  _createClass(CategoryView, [{
	    ...
	    value: function render() {
	      ...
	      }, void 0, this.corporateName ? this.corporateName : "-")), _jsx('div', {
	        className: cls_inlineEditGroup
	      }, void 0, _ref4, _jsx('div', {
	        className: _Admin2.default.inlineEdit
	      }, void 0, this.categoryName ? this.categoryName : "-")), _jsx('div', {
	        className: cls_inlineEditGroup
	      }, void 0, _ref5, _jsx('div', {
	        className: _Admin2.default.inlineEdit
	      }, void 0, this.categoryDesc ? this.categoryDesc : "-")))))))));
	    }
	  }]);
