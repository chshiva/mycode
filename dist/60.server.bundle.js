...
/***/ function(module, exports, __webpack_require__) {
	...
	var ListRoom = function (_Component) {
	  _inherits(ListRoom, _Component);
	
	  function ListRoom(props) {
	    _classCallCheck(this, ListRoom);
	
	    var _this = _possibleConstructorReturn(this, (ListRoom.__proto__ || Object.getPrototypeOf(ListRoom)).call(this, props));
	
	    _this.showReports = function (row) {
	      var roleId = _this.props.loggedInData.data.role;
	      if (_roles.Roles.Lmsadmin == roleId || _roles.Roles.Instructor == roleId) {
	    ...
	    _this.submenu = _Validator2.default.activeSubMenu(_RoomMenu.roomSubMenu, "lnkRoom");
	    _this.mainmenu = _RoomMenu.roomMainMenu;
	    _this.getData = _this.getData.bind(_this);
	    //this.clear = this.clear.bind(this);
	    _this.currentPage = 1;
	    _this.itemsPerPage = 5;
	
	    _this.viewRoom = _this.viewRoom.bind(_this);
	  ...
	  _createClass(ListRoom, [{
	    ...
	    value: function getData(pageParam) {
	      ...
	      this.props.dispatch((0, _RoomActions.RoomList)(pageParam, pageParam.currentPage)).then(function (res) {
	    ...
	    key: 'packageName',
	    value: function packageName(row) {
	      if (row.selPackage && row.selPackage.packageName) {
	        return _jsx('div', {}, void 0, row.selPackage.packageName);
	      }
	    }
	  }, {
	    key: 'corporateName',
	    value: function corporateName(row) {
	      if (row.corporateId && row.corporateId.businessName) {
	        return _jsx('div', {}, void 0, row.corporateId.businessName);
	      }
	    }
	  }, {
	    key: 'viewRoom',
	    value: function viewRoom(row) {
	    ...
	    key: 'showRoomName',
	    value: function showRoomName(row) {
	      var link = "/admin/room/view/" + row._id;
	      return _jsx(_reactRouter.Link, {
	    ...
	    value: function render() {
	      ...
	      if (loggedInData && loggedInData.data && loggedInData.data.profile && loggedInData.data.profile.companyid && loggedInData.data.profile.companyid.businessType && loggedInData.data.profile.companyid.businessType == 'LMS') {
	        var objDisp = [{ title: _ref4, type: "function", callback: this.showRoomName, sort: true, dbName: "roomName" }, { fieldName: "roomType", title: _ref5, type: "text", sort: true, dbName: "roomType" }, { title: _ref6, type: "function", callback: this.packageName }, { title: _ref7, type: "function", callback: this.corporateName }, { title: _ref8, type: "function", callback: this.viewRoom }, { title: _ref9, type: "function", callback: this.showReports.bind(this) }];
	        var filter = [{ type: 'search', id: 'roomSearch', selectedfilter: this.searchFilter }];
	      } else {
	        var objDisp = [{ title: _ref10, type: "function", callback: this.showRoomName, sort: true, dbName: "roomName" }, { fieldName: "roomType", title: _ref11, type: "text", sort: true, dbName: "roomType" }, { title: _ref12, type: "function", callback: this.packageName }, { title: _ref13, type: "function", callback: this.corporateName }, { title: _ref14, type: "function", callback: this.viewRoom }];
	        var filter = [{ type: 'search', id: 'roomSearch', selectedfilter: this.searchFilter }];
	      }
	      return _jsx('div', {}, void 0, _react2.default.createElement(_lib.ToastContainer, {
	        ...
	        data: this.props.roomData.dataList,
	...
	exports.default = (0, _reactRedux.connect)(mapStateToProps)(ListRoom);
