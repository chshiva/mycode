...
/***/ function(module, exports, __webpack_require__) {
	...
	var _ref3 = _jsx('ul', {}, void 0, _jsx('li', {}, void 0, _jsx(_reactRouter.Link, {
	  to: '/course/reports'
	...
	var StudentAssignmentReportList = function (_Component) {
	  _inherits(StudentAssignmentReportList, _Component);
	
	  function StudentAssignmentReportList(props) {
	    _classCallCheck(this, StudentAssignmentReportList);
	
	    var _this = _possibleConstructorReturn(this, (StudentAssignmentReportList.__proto__ || Object.getPrototypeOf(StudentAssignmentReportList)).call(this, props));
	    ...
	    _this.showAssignmentName = function (row) {
	      var roomId = _this.props.params.rid;
	      var assignmentId = row._id;
	      ...
	      return _jsx(_reactRouter.Link, {
	        ...
	        to: link
	      }, void 0, row.assignmentName);
	    };
	
	    _this.viewCourse = function (row) {
	      var roomId = _this.props.params.rid;
	      var assignmentId = row._id;
	      var link = "/course/assignment-report-view/" + roomId + "/" + assignmentId;
	  ...
	  _createClass(StudentAssignmentReportList, [{
	    ...
	    value: function getData(pageParam) {
	      ...
	      this.props.dispatch((0, _ReportsActions.studentAssignmentList)(pageParam, pageParam.currentPage)).then(function (res) {
	    ...
	    key: 'showMarks',
	    value: function showMarks(row) {
	      var result = row.submissions[0].result;
	      if (result.length > 0) {
	        var marksObtained = 0;
	        var totalMarks = 0;
	    ...
	    value: function submittedOn(row) {
	      if (row && row.submissions[0].submittedAt) {
	        var date = moment(row.submissions[0].submittedAt).format('DD/MM/YYYY hh:mm A');
	    ...
	    value: function render() {
	      ...
	      var objDisp = [{ title: _ref4, type: "function", callback: this.showAssignmentName }, { title: _ref5, type: "function", callback: this.submittedOn }, { title: _ref6, type: "function", callback: this.showMarks }, { title: _ref7, type: "function", callback: this.viewCourse }];
	      ...
	      return _jsx('div', {}, void 0, _react2.default.createElement(_lib.ToastContainer, {
	        ...
	        data: this.props.reportsData.assignmentListData,
	  ...
	  return StudentAssignmentReportList;
	}(_react.Component);
	...
	exports.default = (0, _reactRedux.connect)(mapStateToProps)(StudentAssignmentReportList);
