...
/***/ function(module, exports, __webpack_require__) {
	...
	var _AddParticipantsGroup = __webpack_require__(440);
	
	var _AddParticipantsGroup2 = _interopRequireDefault(_AddParticipantsGroup);
	...
	var _ref2 = _jsx('ul', {}, void 0, _jsx('li', {}, void 0, _jsx(_reactIntl.FormattedMessage, {
	  id: 'you_are_in_participant_group_list_panel'
	})));
	...
	var ParticipantsGroupList = function (_Component) {
	  _inherits(ParticipantsGroupList, _Component);
	
	  function ParticipantsGroupList(props) {
	    _classCallCheck(this, ParticipantsGroupList);
	
	    var _this = _possibleConstructorReturn(this, (ParticipantsGroupList.__proto__ || Object.getPrototypeOf(ParticipantsGroupList)).call(this, props));
	    ...
	    _this.mainmenu = _ParticipantsGroupMenu.participantsMainMenu;
	    _this.mainmenu.menus[0].action = _this.showOrHideAddGroups.bind(_this);
	    _this.getData = _this.getData.bind(_this);
	    //this.clear = this.clear.bind(this);
	    _this.currentPage = 1;
	    _this.itemsPerPage = 5;
	    _this.viewParticipants = _this.viewParticipants.bind(_this);
	    //this.mainmenu.menus[0].action = this.clearError.bind(this);
	    _this.searchFilter = _this.searchFilter.bind(_this);
	    return _this;
	  }
	
	  _createClass(ParticipantsGroupList, [{
	    key: 'componentWillReceiveProps',
	    value: function componentWillReceiveProps(nextProps) {
	      if (nextProps.groupData.deleteSuccess != '') {
	        this.refs.room_container.success(nextProps.groupData.deleteSuccess + ' ', '');
	        this.props.dispatch((0, _ParticipantsGroupActions.clearParticipantsGroup)());
	      }
	    }
	  }, {
	    key: 'componentWillMount',
	    ...
	    value: function getData(pageParam) {
	      ...
	      this.props.dispatch((0, _ParticipantsGroupActions.listStudentsGroup)(pageParam, pageParam.currentPage)).then(function (res) {
	        return _this2.pageData(res);
	      });
	    }
	  }, {
	    key: 'viewParticipants',
	    value: function viewParticipants(row) {
	    ...
	    value: function createdByName(row) {
	      ...
	      return _jsx('div', {}, void 0, createdBy, ' ');
	    }
	  }, {
	    key: 'groupCount',
	    value: function groupCount(row) {
	      var count = '';
	      if (row && row.participants) {
	        count = row.participants.length;
	      }
	      return _jsx('div', {}, void 0, count);
	    }
	    ...
	    key: 'handleModel',
	    value: function handleModel(res) {
	      if (res.status) {
	    ...
	    value: function showGroupDetails(row) {
	      var link = "/admin/participants-group/view/" + row._id;
	      return _jsx(_reactRouter.Link, {
	        id: 'viewGroup',
	        className: _Admin2.default.removeStyle,
	        to: link
	      }, void 0, _jsx('div', {}, void 0, row.groupName, ' '));
	    }
	  }, {
	    key: 'render',
	    value: function render() {
	      ...
	      var objDisp = [{ title: _ref3, type: "function", callback: this.showGroupDetails }, { title: _ref4, type: "function", callback: this.createdByName }, { title: _ref5, type: "function", callback: this.groupCount }, { title: _ref6, type: "function", callback: this.viewParticipants }];
	      ...
	      return _jsx('div', {}, void 0, _react2.default.createElement(_lib.ToastContainer, {
	        ...
	        data: this.props.groupData.dataList,
	      ...
	      }), _jsx(_AddParticipantsGroup2.default, {
	        showModal: this.state.showAddGroup,
	        hidecallback: this.showOrHideAddGroups.bind(this),
	        callback: this.handleModel.bind(this)
	      }));
	    }
	  }]);
	
	  return ParticipantsGroupList;
	}(_react.Component);
	...
	exports.default = (0, _reactRedux.connect)(mapStateToProps)(ParticipantsGroupList);
	...
	var AddParticipantsGroup = function (_Component) {
	  ...
	  _createClass(AddParticipantsGroup, [{
	    ...
	    value: function removeStudent(studentdata) {
	      ...
	      var removeStudentArrayLength = studentsArray.length;
	    ...
	    value: function saveGroup(e) {
	      ...
	      var studentIdArray = this.state.addedStudentsIds;
	      ...
	      if ((groupName == '' || groupName == undefined || groupName == null) && (!studentIdArray || studentIdArray.length == 0)) {
	        ...
	        this.props.dispatch((0, _ParticipantsGroupActions.SaveGroupRequest)({ uid: uid, groupName: groupName, studentIdArray: studentIdArray })).then(function (res) {
	    ...
	    value: function render() {
	      ...
	      return _jsx('div', {}, void 0, _react2.default.createElement(_lib.ToastContainer, {
	        ...
	        className: 'form-control',
	        name: 'groupName',
	        placeholder: this.context.intl.messages.enter_group_name,
	      ...
	      }, void 0, this.state.groupNameError ? _ref4 : ''), _jsx('label', {
	        id: 'invalidGroupNameError',
	        className: _component2.default.errorPre
	      }, void 0, this.state.groupNotAlphaError ? _ref5 : ''))), _jsx('div', {
	        className: 'form-group'
	      }, void 0, _jsx('div', {
	        className: 'col-md-12'
	      }, void 0, _jsx('input', {
	        ...
	        className: _component2.default.errorPre
	      }, void 0, this.state.groupParticipantError ? _ref6 : ''), _jsx('input', {
	        id: 'searchStudentBtn',
	        type: '',
	      ...
	      }, void 0, _ref7)))), this.state.dropDownEnalbled ? _jsx('div', {
	        ...
	        }, void 0, _ref8), _jsx('p', {}, void 0, addedStudentsData.firstname));
	        ...
	        }, void 0, _this4.state.addedStudentsIds.includes(studentsData._id) == false ? _jsx('span', {
	          id: 'addedStudent',
	          onClick: _this4.addedStudent.bind(_this4, studentsData)
	        }, void 0, _ref9) : null)));
	      }) : null), this.state.noDataFound ? _ref10 : null))))) : null), _jsx(_Modal.Footer, {
