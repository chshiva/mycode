...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Feedback = __webpack_require__(407);
	...
	var ListRoomFeedback = function (_Component) {
	  _inherits(ListRoomFeedback, _Component);
	
	  function ListRoomFeedback(props) {
	    _classCallCheck(this, ListRoomFeedback);
	
	    /* default set submenu without topic */
	    var _this = _possibleConstructorReturn(this, (ListRoomFeedback.__proto__ || Object.getPrototypeOf(ListRoomFeedback)).call(this, props));
	
	    _this.getNewData = function () {
	      _this.getData({
	    ...
	    _this.viewroom = function () {
	      var roomId = _this.props.params.roomId;
	    ...
	    _this.submenu = _Validator2.default.activeSubMenu(_RoomMenu.roomNoTopicSubMenu, "lnkFeedback");
	    ...
	    _this.schema = _RoomSchema.roomSchema;
	    _this.res = {};
	
	    _this.mainmenu = _RoomMenu.feedbackListMainMenu;
	    _this.getData = _this.getData.bind(_this);
	    //this.clear = this.clear.bind(this);
	    _this.currentPage = 1;
	    _this.itemsPerPage = 5;
	    _this.viewRoomFeedback = _this.viewRoomFeedback.bind(_this);
	    //this.mainmenu.menus[0].action = this.clearError.bind(this);
	    return _this;
	  }
	
	  _createClass(ListRoomFeedback, [{
	    ...
	    value: function setdata(result) {
	      if (result && result.data && result.data._id) {
	        ...
	        this.props.dispatch((0, _RoomActions.RoomStore)({ uid: result.data._id }));
	        this.getData({
	    ...
	    value: function getData(pageParam) {
	      ...
	      this.props.dispatch((0, _RoomActions.RoomFeedbackList)(pageParam, pageParam.currentPage)).then(function (res) {
	    ...
	    key: 'showOrHideFeedback',
	    value: function showOrHideFeedback() {
	      this.setState({ showFeedback: !this.state.showFeedback });
	    }
	  }, {
	    key: 'viewRoomFeedback',
	    value: function viewRoomFeedback(row) {
	    ...
	    value: function clearError() {
	      ...
	      if (response) {
	        this.props.dispatch((0, _RoomActions.UpdateRoomSchema)(response));
	        _reactRouter.browserHistory.push('/admin/room/new');
	      }
	    }
	  }, {
	    key: 'submittedOn',
	    value: function submittedOn(row) {
	      if (row && row.createdOn) {
	        var date = (0, _moment2.default)(row.createdOn).format('DD/MM/YYYY');
	        return _jsx('div', {}, void 0, date);
	      } else {
	        return _ref2;
	      }
	    }
	    ...
	    key: 'viewRoomName',
	    value: function viewRoomName(row) {
	      var link = "/admin/room/view-feedback/" + row._id;
	      if (row.roomId && row.roomId.roomName) {
	        return _jsx(_reactRouter.Link, {
	          className: _Admin2.default.removeStyle,
	          to: link
	        }, void 0, _jsx('div', {}, void 0, row.roomId.roomName, ' '));
	      }
	    }
	  }, {
	    key: 'showFeedbackDetails',
	    value: function showFeedbackDetails(row) {
	      var link = "/admin/room/view-feedback/" + row._id;
	      return _jsx(_reactRouter.Link, {
	        className: _Admin2.default.removeStyle,
	        to: link
	      }, void 0, _jsx('div', {}, void 0, row.roomName, ' '));
	    }
	  }, {
	    key: 'combineName',
	    value: function combineName(row) {
	      if (row.userId && row.userId.firstname) {
	        return _jsx('div', {}, void 0, row.userId.firstname, ' ', row.userId.lastname);
	      }
	    }
	  }, {
	    key: 'render',
	    value: function render() {
	      var objDisp = [{ title: _ref3, type: "function", callback: this.viewRoomName }, { title: _ref4, type: "function", callback: this.combineName }, { title: _ref5, type: "function", callback: this.submittedOn }, { title: _ref6, type: "function", callback: this.viewRoomFeedback }];
	      var bredcrumb = _jsx('div', {
	        className: _component2.default.dynamicBreadCrumb
	      }, void 0, _jsx('ul', {}, void 0, _ref7, _ref8, _jsx('li', {}, void 0, this.props.roomData.data.roomName)));
	      ...
	      if (this.props.roomData && this.props.roomData.data && !_.isEmpty(this.props.roomData.data)) {
	        ...
	        if (_roomData.selPackage && _roomData.selPackage.features.indexOf("Topics") != -1) {
	          this.submenu = _Validator2.default.activeSubMenu(_RoomMenu.roomEditSubMenu, "lnkFeedback");
	      ...
	      return _jsx('div', {}, void 0, _react2.default.createElement(_lib.ToastContainer, {
	        ...
	        data: this.props.feedbackData.dataList,
	...
	function mapStateToProps(state) {
	  return {
	    ...
	    feedbackData: (0, _FeedbackReducer.feedbackData)(state),
	...
	exports.default = (0, _reactRedux.connect)(mapStateToProps)(ListRoomFeedback);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _FeedbackComment = __webpack_require__(408);
	...
	var Feedback = function (_Component) {
	  ...
	  function Feedback(props) {
	    ...
	    _this.callback = function (obj) {
	      //console.log("obj === ",obj);
	      var newObj = void 0;
	      newObj = Object.assign({}, _this.dataObjectFeedback, obj);
	      _this.dataObjectFeedback = newObj;
	  ...
	  _createClass(Feedback, [{
	    ...
	    value: function renderRadio() {
	      ...
	      var labels = this.state.labelArray;
	      //let numberValuesLabel = this.state.numberValuesLabel;
	      //let textAreaData = this.state.data
	      var self = this;
	      var buttons = self.props.radioGroupLabels.map(function (obj) {
	        return _jsx('div', {}, obj.id, _jsx('label', {}, void 0, ' ', obj.label, ' '), _jsx(_Radio2.default, {
	          data: obj,
	          values: self.props.radioButtonOptions,
	          callback: self.callback
	        }));
	      });
	
	      var numberButtons = self.props.overAllRatingLabel.map(function (obj) {
	
	        return _jsx('div', {}, obj.id, _jsx('label', {}, void 0, ' ', obj.label, ' '), _jsx(_Radio2.default, {
	          data: obj,
	          values: self.props.overAllRatingRadioOptions,
	          callback: self.callback
	        }));
	      });
	      buttons.push(numberButtons);
	
	      var feedbackText = self.props.feedbackCommentLabel.map(function (obj) {
	
	        return _jsx('div', {}, obj.id, _jsx('label', {}, void 0, ' ', obj.label, ' '), _jsx(_FeedbackComment2.default, {
	          data: obj,
	          callback: self.callback
	        }));
	      });
	    ...
	    value: function render() {
	      ...
	      return _jsx('div', {
	        ...
	        onHide: dataObject.hidecallback
	      ...
	      }, void 0, _jsx('form', {}, void 0, this.renderRadio()))), _jsx(_Modal.Footer, {}, void 0, _jsx('button', {
	        className: 'btn btn-success btn-icon btn-sm',
	        onClick: this.saveFeedback.bind(this)
	      }, void 0, 'Save'))));
	    }
	  }]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var FeedbackComment = function (_Component) {
	  _inherits(FeedbackComment, _Component);
	
	  function FeedbackComment(props) {
	    _classCallCheck(this, FeedbackComment);
	
	    var _this = _possibleConstructorReturn(this, (FeedbackComment.__proto__ || Object.getPrototypeOf(FeedbackComment)).call(this, props));
	
	    _this.changeHandler = function (e) {
	      //console.log(e.target.value);
	      var data = [];
	      var obj = {};
	      data[_this.props.data.id] = e.target.value;
	  ...
	  _createClass(FeedbackComment, [{
	    key: 'render',
	    value: function render() {
	      //console.log("Inside Feedback comment");
	      var cls = _component2.default.iElement + ' ' + _component2.default.feedbackTextArea;
	      var renderTextArea = null;
	      if (this.props) {
	        var self = this;
	        renderTextArea = _jsx('div', {
	          className: cls
	        }, self.props.data.id, _jsx('textarea', {
	          name: self.props.data.id,
	          className: 'col-xs-12',
	          onChange: self.changeHandler
	        }));
	      }
	      return _jsx('div', {}, void 0, renderTextArea);
	    }
	  }]);
	...
	exports.default = (0, _reactRedux.connect)(mapStateToProps)(FeedbackComment);
