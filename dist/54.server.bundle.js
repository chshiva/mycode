...
/***/ function(module, exports, __webpack_require__) {
	...
	var _CorporateView = __webpack_require__(432);
	
	var _CorporateView2 = _interopRequireDefault(_CorporateView);
	
	var _Validator = __webpack_require__(356);
	
	var _Validator2 = _interopRequireDefault(_Validator);
	
	var _CorporateSchema = __webpack_require__(395);
	...
	var _CorporateMenu = __webpack_require__(394);
	...
	var _ref4 = _jsx(_TopMenu2.default, {
	  data: _CorporateMenu.corporateViewMainMenu
	});
	
	var ViewCorporate = function (_Component) {
	  _inherits(ViewCorporate, _Component);
	
	  function ViewCorporate(props) {
	    _classCallCheck(this, ViewCorporate);
	
	    var _this = _possibleConstructorReturn(this, (ViewCorporate.__proto__ || Object.getPrototypeOf(ViewCorporate)).call(this, props));
	
	    _initialiseProps.call(_this);
	
	    _this.state = { loading: true };
	    _this.mainmenu = _CorporateMenu.corporateViewMainMenu;
	    _this.schema = _CorporateSchema.editCorporateSchema;
	
	    _this.mainmenu.menus[2].action = _this.edit.bind(_this); //this.save.bind(this);
	    _this.mainmenu.menus[1].action = _this.deleteCorporate.bind(_this);
	    return _this;
	  }
	
	  _createClass(ViewCorporate, [{
	    ...
	    value: function componentDidMount() {
	      ...
	      this.props.dispatch((0, _CorporateActions.getCorporateData)(this.props.params.cid)).then(function (res) {
	    ...
	    value: function setLoading() {
	      ...
	      this.props.dispatch((0, _CorporateActions.ClearCrop)());
	      this.setState({ loading: false });
	    }
	  }, {
	    key: 'setdata',
	    ...
	    value: function render() {
	      ...
	      var submenu = _Validator2.default.activeSubMenu(_CorporateMenu.corporateinfoSubMenu, "lnkCorporate");
	      return _jsx('div', {
	      ...
	      }, void 0, _jsx('ul', {}, void 0, _ref2, _ref3, _jsx('li', {}, void 0, this.props.corporateData && this.props.corporateData.data ? this.props.corporateData.data.businessName : null))), _ref4), _jsx('div', {
	      ...
	      }), _jsx(_CorporateView2.default, {
	        corporateData: this.props.corporateData.data,
	...
	var _initialiseProps = function _initialiseProps() {
	  ...
	  this.edit = function () {
	    var response = _Validator2.default.freeError(_this3.schema);
	    if (response) {
	      _this3.props.dispatch((0, _CorporateActions.UpdateCorporateSchema)(response));
	      var corporateId = _this3.props.params.cid;
	      _reactRouter.browserHistory.push('/admin/corporate/edit/' + corporateId);
	    }
	  };
	
	  this.deleteCorporate = function () {
	    var corporateId = _this3.props.params.cid;
	    var props = _this3.props;
	    var response = _this3.setdeleteresponse;
	
	    alertify.confirm(_this3.props.intl.messages.warning, _this3.props.intl.messages.delete_corporate_alert, function (result) {
	      if (result) {
	        props.dispatch((0, _CorporateActions.DeleteCorporate)(corporateId)).then(function (res) {
	          return response(res);
	        });
	      }
	  ...
	  this.setdeleteresponse = function (response) {
	    ...
	    if (response.status) {
	      _reactRouter.browserHistory.push('/admin/corporate/list');
	    } else if (response.error) {
	      _this3.refs.corporate_container.error(response.error + ' ', '');
	    }
	  };
	};
	...
	function mapStateToProps(state) {
	  return {
	    ...
	    corporateData: (0, _CorporateReducer.corporateData)(state),
	...
	exports.default = (0, _reactRedux.connect)(mapStateToProps)(ViewCorporate);
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.corporateEditSubMenu = exports.corporateinfoSubMenu = exports.corporateViewSubMenu = exports.corporateNewSubMenu = exports.corporateMainMenu = exports.corporateViewMainMenu = exports.corporateEditMainMenu = exports.corporateNewMainMenu = undefined;
	...
	//Main Menu
	var corporateNewMainMenu = exports.corporateNewMainMenu = {
			menus: [{ _id: "btnCancel", text: _jsx(_reactIntl.FormattedMessage, {
							id: 'cancel'
					}), actionType: "URL", action: "/admin/corporate/list", icon: "fa fa-ban" }, { _id: "btnSave", text: _jsx(_reactIntl.FormattedMessage, {
							id: 'save'
					}), actionType: "Function", action: null, icon: "fa fa-floppy-o" }]
	};
	
	var corporateEditMainMenu = exports.corporateEditMainMenu = {
			menus: [{ _id: "btnCancel", text: _jsx(_reactIntl.FormattedMessage, {
							id: 'cancel'
	...
	var corporateViewMainMenu = exports.corporateViewMainMenu = {
			menus: [{ _id: "btnList", text: _jsx(_reactIntl.FormattedMessage, {
							id: 'list'
					}), actionType: "URL", action: "/admin/corporate/list", icon: "fa fa-list" }, { _id: "btnDelete", text: _jsx(_reactIntl.FormattedMessage, {
							id: 'delete'
					}), actionType: "Function", action: null, icon: "fa fa-trash" }, { _id: "btnEdit", text: _jsx(_reactIntl.FormattedMessage, {
							id: 'edit'
					}), actionType: "Function", action: null, icon: "fa fa-pencil" }]
	};
	
	var corporateMainMenu = exports.corporateMainMenu = {
			menus: [
			//{_id: "btnNew", text: "New", actionType: "URL", action: "/admin/corporate/new", icon: "fa fa-plus"},
			{ _id: "btnNew", text: _jsx(_reactIntl.FormattedMessage, {
							id: 'new'
					}), actionType: "Function", action: null, icon: "fa fa-plus" }]
	
			//SubMenu
	};var corporateNewSubMenu = exports.corporateNewSubMenu = {
			menus: [{ _id: "lnkCorporate", text: _jsx(_reactIntl.FormattedMessage, {
							id: 'new_corporate'
					}), actionType: "Function", action: null, active: "active" }]
	};
	
	var corporateViewSubMenu = exports.corporateViewSubMenu = {
			menus: [{ _id: "lnkCorporate", text: _jsx(_reactIntl.FormattedMessage, {
							id: 'all_corporates'
					}), actionType: "Function", action: null, active: "active" }]
	};
	var corporateinfoSubMenu = exports.corporateinfoSubMenu = {
			menus: [{ _id: "lnkCorporate", text: _jsx(_reactIntl.FormattedMessage, {
							id: 'corporate_info'
					}), actionType: "Function", action: null, active: "active" }]
	};
	var corporateEditSubMenu = exports.corporateEditSubMenu = {
			menus: [{ _id: "lnkCorporate", text: _jsx(_reactIntl.FormattedMessage, {
							id: 'edit_corporate'
					}), actionType: "Function", action: null, active: "active" }]
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.editCorporateSchema = exports.corporateSchema = undefined;
	...
	var corporateSchema = exports.corporateSchema = {
		_id: "Corporate",
		formIcon: "fa fa-key",
		...
		schemas: {
			company_details: { //Position Name
				...
				{ type: "hidden", _id: "cid", text: _jsx(_reactIntl.FormattedMessage, {
						...
						id: 'company_details'
					}), icon: "fa fa-caret-right" }, { type: "text", _id: "businessId", text: _jsx(_reactIntl.FormattedMessage, {
						id: 'business_id'
					}), datafield: "businessId", required: true, error: "", exp: "ALPHANUMERICwithSPACE", limit: 15, errorId: "bissinessIdError" }, { type: "text", _id: "businessName", text: _jsx(_reactIntl.FormattedMessage, {
						id: 'business_name'
					}), datafield: "businessName", required: true, error: "", exp: "ALPHANUMERICwithSPACE", limit: 50, errorId: "businessNameError" }, { type: "phone", _id: "phoneNo", text: _jsx(_reactIntl.FormattedMessage, {
						id: 'phone'
					}), datafield: "phoneNo", required: true, error: "", errormsg: "Invalid phone number", limit: 15, errorId: "phoneNoError" }, { type: "text", _id: "websiteAddr", text: _jsx(_reactIntl.FormattedMessage, {
						id: 'website'
					}), datafield: "websiteAddr", required: false, error: "", exp: "URL", limit: 50, errorId: "websiteError" }, { type: "dropdown", _id: "companyStatus", text: _jsx(_reactIntl.FormattedMessage, {
						id: 'company_status'
					}), datafield: "companyStatus", data: [["Active", "active"], ["Inactive", 'inactive']], value: "Active", required: true, error: "" }, { type: "dropdown", _id: "scheduleType", text: _jsx(_reactIntl.FormattedMessage, {
						id: 'schedule_type'
					}), datafield: "scheduleType", data: [["Calendar", "calendar"] /*, ["Timeslot", "Calendar"]*/], value: "Calendar", required: true, error: "" }],
				contact_fields: [//Form Groups Name
				{ type: "title", text: _jsx(_reactIntl.FormattedMessage, {
						id: 'contact_details'
					}), icon: "fa fa-caret-right" }, { type: "text", _id: "cName", text: _jsx(_reactIntl.FormattedMessage, {
						id: 'name'
					}), datafield: "contactDetails.name", required: true, error: "", exp: "ALPHAwithSPACE", limit: 30, errorId: "cnameError" }, { type: "phone", _id: "cPhoneNo", text: _jsx(_reactIntl.FormattedMessage, {
						id: 'phone'
					}), datafield: "contactDetails.phoneNo", required: true, error: "", limit: 15, errorId: "cphoneError" }, { type: "email", _id: "cEmail", text: _jsx(_reactIntl.FormattedMessage, {
						id: 'email'
					}), datafield: "contactDetails.email", required: true, error: "", exp: "EMAIL", limit: 50, errorId: "cEmailError" }]
			},
			col_2: {
				address_fields: [//Form Groups Name
				{ type: "title", text: _jsx(_reactIntl.FormattedMessage, {
						id: 'address'
					}), icon: "fa fa-caret-right" }, { type: "text", _id: "street", text: _jsx(_reactIntl.FormattedMessage, {
						id: 'street'
					}), datafield: "address.street", required: true, error: "", limit: 50, caps: true, errorId: "streetError" }, { type: "text", _id: "district", text: _jsx(_reactIntl.FormattedMessage, {
						id: 'district'
					}), datafield: "address.district", required: true, error: "", exp: "ALPHAwithSPACE", limit: 20, caps: true, errorId: "districtError" }, { type: "text", _id: "state", text: _jsx(_reactIntl.FormattedMessage, {
						id: 'state'
					}), datafield: "address.state", required: true, error: "", exp: "ALPHAwithSPACE", limit: 20, caps: true, errorId: 'stateError' }, { type: "text", _id: "country", text: _jsx(_reactIntl.FormattedMessage, {
						id: 'country'
					}), datafield: "address.country", required: true, error: "", exp: "ALPHAwithSPACE", limit: 20, caps: true, errorId: 'countryError' }, { type: "text", _id: "pincode", text: _jsx(_reactIntl.FormattedMessage, {
						id: 'pincode'
					}), datafield: "address.pincode", required: true, error: "", exp: "NUMBER", limit: 10, errorId: "pincodeError" }],
				business_fields: [//Form Groups Name
				{ type: "title", text: _jsx(_reactIntl.FormattedMessage, {
						id: 'corporate_type'
					}), icon: "fa fa-caret-right" }, { type: "dropdown", _id: "businessType", text: _jsx(_reactIntl.FormattedMessage, {
						id: 'business_type'
					}), datafield: "businessType", data: [["Conference", "conference"], ["LMS", "lms"], /*["CRM", "crm"]*/["Presenter", "presenter"]], value: "Conference", required: true, error: "" }]
			},
			legalDocuments_details: { //Position Name
	   		...
	   		{ type : "text", _id : "usersLimit", text: <FormattedMessage id='users_limit' />, datafield : "licenses.usersLimit", value : "-1", required : false, error : "", exp : "LIMIT" }
				...
				{ type: "title", text: _jsx(_reactIntl.FormattedMessage, {
					...
					}), icon: "fa fa-caret-right" }, { type: "text", _id: "panNumber", text: _jsx(_reactIntl.FormattedMessage, {
						id: 'pan_number'
					}), datafield: "legalDocuments.panNumber", error: "", exp: "ALPHANUMERICwithSPACE", limit: 10, errorId: "panError" }, { type: "text", _id: "tanID", text: _jsx(_reactIntl.FormattedMessage, {
						id: 'tan_id'
					}), datafield: "legalDocuments.tanID", error: "", exp: "ALPHANUMERICwithSPACE", limit: 20, errorId: "tanError" }]
			}
		}
	};
	
	var editCorporateSchema = exports.editCorporateSchema = {
		_id: "Corporate",
		formIcon: "fa fa-key",
		formTitle: _jsx(_reactIntl.FormattedMessage, {
			id: 'corporate_directory'
		...
		schemas: {
			...
			col_2: {
				...
				{ type: "title", text: _jsx(_reactIntl.FormattedMessage, {
						...
						id: 'street'
					}), datafield: "address.street", required: true, error: "", limit: 50, errorId: "streetError" }, { type: "text", _id: "district", text: _jsx(_reactIntl.FormattedMessage, {
						id: 'district'
					}), datafield: "address.district", required: true, error: "", exp: "ALPHAwithSPACE", limit: 20, errorId: "districtError" }, { type: "text", _id: "state", text: _jsx(_reactIntl.FormattedMessage, {
						id: 'state'
					}), datafield: "address.state", required: true, error: "", exp: "ALPHAwithSPACE", limit: 20, errorId: 'stateError' }, { type: "text", _id: "country", text: _jsx(_reactIntl.FormattedMessage, {
						id: 'country'
					}), datafield: "address.country", required: true, error: "", exp: "ALPHAwithSPACE", limit: 20, errorId: 'countryError' }, { type: "text", _id: "pincode", text: _jsx(_reactIntl.FormattedMessage, {
						id: 'pincode'
					}), datafield: "address.pincode", required: true, error: "", exp: "NUMBER", limit: 10, errorId: "pincodeError" }],
				business_fields: [//Form Groups Name
				{ type: "title", text: _jsx(_reactIntl.FormattedMessage, {
						id: 'corporate_type'
					}), icon: "fa fa-caret-right" }, { type: "view", _id: "businessType", text: _jsx(_reactIntl.FormattedMessage, {
						id: 'business_type'
					}), field: "businessType", idfield: "businessType", datafield: "businessType", value: "" }]
			},
			legalDocuments_details: { //Position Name
				/*license_details : [
	   		{ type : "title", text : <FormattedMessage id='license_details' />, icon : "fa fa-caret-right" },
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.CorporateView = undefined;
	...
	var _ref14 = _jsx('h2', {}, void 0, _jsx(_reactIntl.FormattedMessage, {
	  id: 'address'
	}));
	...
	var _ref19 = _jsx('label', {
	  htmlFor: 'Pincode'
	}, void 0, _jsx(_reactIntl.FormattedMessage, {
	  id: 'pincode'
	}), ':');
	
	var _ref20 = _jsx('h2', {}, void 0, _jsx(_reactIntl.FormattedMessage, {
	  id: 'legal_doc_details'
	}));
	
	var _ref21 = _jsx('label', {
	  htmlFor: 'Pan Number'
	}, void 0, _jsx(_reactIntl.FormattedMessage, {
	  id: 'pan_number'
	}), ':');
	
	var _ref22 = _jsx('label', {
	  htmlFor: 'Tan Id'
	}, void 0, _jsx(_reactIntl.FormattedMessage, {
	  id: 'tan_id'
	}), ':');
	
	var CorporateView = exports.CorporateView = function (_Component) {
	  _inherits(CorporateView, _Component);
	
	  function CorporateView(props) {
	    _classCallCheck(this, CorporateView);
	
	    return _possibleConstructorReturn(this, (CorporateView.__proto__ || Object.getPrototypeOf(CorporateView)).call(this, props));
	  }
	
	  _createClass(CorporateView, [{
	    key: 'render',
	    value: function render() {
	      ...
	      return _jsx('div', {
	      ...
	      }, void 0, this.businesId ? this.businesId : "-")), _jsx('div', {
	        className: cls_inlineEditGroup
	      }, void 0, _ref4, _jsx('div', {
	        className: _Admin2.default.inlineEdit
	      }, void 0, this.businessName ? this.businessName : "-")), _jsx('div', {
	        className: cls_inlineEditGroup
	      }, void 0, _ref5, _jsx('div', {
	        className: _Admin2.default.inlineEdit
	      }, void 0, this.businessType ? this.businessType : "-")), _jsx('div', {
	        className: cls_inlineEditGroup
	      }, void 0, _ref6, _jsx('div', {
	        className: _Admin2.default.inlineEdit
	      }, void 0, this.phoneNo ? this.phoneNo[1] : "-")), _jsx('div', {
	        className: cls_inlineEditGroup
	      }, void 0, _ref7, _jsx('div', {
	        className: _Admin2.default.inlineEdit
	      }, void 0, this.website ? this.website : "-")), _jsx('div', {
	        className: cls_inlineEditGroup
	      }, void 0, _ref8, _jsx('div', {
	        className: _Admin2.default.inlineEdit
	      }, void 0, this.companyStatus ? this.companyStatus : "-")), _jsx('div', {
	        className: cls_inlineEditGroup
	      }, void 0, _ref9, _jsx('div', {
	        className: _Admin2.default.inlineEdit
	      }, void 0, this.scheduleType ? this.scheduleType : "-")))), _jsx('div', {
	        className: _Admin2.default.formField
	        ...
	        className: _Admin2.default.inlineEdit
	      }, void 0, this.contactDetails ? this.contactDetails.name ? this.contactDetails.name : "-" : "-")), _jsx('div', {
	        className: cls_inlineEditGroup
	      }, void 0, _ref12, _jsx('div', {
	        className: _Admin2.default.inlineEdit
	      }, void 0, this.contactDetails ? this.contactDetails.phoneNo ? this.contactDetails.phoneNo[1] : "-" : "-")), _jsx('div', {
	        className: cls_inlineEditGroup
	      }, void 0, _ref13, _jsx('div', {
	        className: _Admin2.default.inlineEdit
	      }, void 0, this.contactDetails ? this.contactDetails.email ? this.contactDetails.email : "-" : "-"))))), _jsx(_reactBootstrap.Col, {
	        md: 6
	      }, void 0, _jsx('div', {
	        className: _Admin2.default.formField
	        ...
	        className: _Admin2.default.inlineEdit
	      }, void 0, this.address ? this.address.street ? this.address.street : "-" : "-")), _jsx('div', {
	        className: cls_inlineEditGroup
	      }, void 0, _ref16, _jsx('div', {
	        className: _Admin2.default.inlineEdit
	      }, void 0, this.address ? this.address.district ? this.address.district : "-" : "-")), _jsx('div', {
	        className: cls_inlineEditGroup
	      }, void 0, _ref17, _jsx('div', {
	        className: _Admin2.default.inlineEdit
	      }, void 0, this.address ? this.address.state ? this.address.state : "-" : "-")), _jsx('div', {
	        className: cls_inlineEditGroup
	      }, void 0, _ref18, _jsx('div', {
	        className: _Admin2.default.inlineEdit
	      }, void 0, this.address ? this.address.country ? this.address.country : "-" : "-")), _jsx('div', {
	        className: cls_inlineEditGroup
	      }, void 0, _ref19, _jsx('div', {
	        className: _Admin2.default.inlineEdit
	      }, void 0, this.address ? this.address.pincode ? this.address.pincode : "-" : "-")))), _jsx('div', {
	        className: _Admin2.default.formField
	        ...
	        className: _Admin2.default.inlineEdit
	      }, void 0, this.legalDocuments ? this.legalDocuments.panNumber ? this.legalDocuments.panNumber : "-" : "-")), _jsx('div', {
	        className: cls_inlineEditGroup
	      }, void 0, _ref22, _jsx('div', {
	        className: _Admin2.default.inlineEdit
	      }, void 0, this.legalDocuments ? this.legalDocuments.tanID ? this.legalDocuments.tanID : "-" : "-")))))))));
	    }
	  }]);
