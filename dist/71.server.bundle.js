...
/***/ function(module, exports, __webpack_require__) {
	...
	var _underscore = __webpack_require__(530);
	...
	var ListCertificates = function (_Component) {
	  _inherits(ListCertificates, _Component);
	
	  function ListCertificates(props) {
	    _classCallCheck(this, ListCertificates);
	
	    var _this = _possibleConstructorReturn(this, (ListCertificates.__proto__ || Object.getPrototypeOf(ListCertificates)).call(this, props));
	    ...
	    _this.searchFilter = function (e) {
	      ...
	      if (!pattern.test(expVal)) {
	        _this.state.searchValue = e.target.value.trim();
	        _this.getData({
	    ...
	    _this.submenu = _Validator2.default.activeSubMenu(_RoomMenu.roomEditSubMenu, 'lnkCertificates');
	    _this.mainmenu = _RoomMenu.roomCertificatesMainMenu;
	    _this.getData = _this.getData.bind(_this);
	    _this.approveCertificate = _this.approveCertificate.bind(_this);
	    _this.searchFilter = _this.searchFilter.bind(_this);
	    _this.pageData = _this.pageData.bind(_this);
	    _this.toggleCertificate = _this.toggleCertificate.bind(_this);
	  ...
	  _createClass(ListCertificates, [{
	    ...
	    value: function getData(pageParam) {
	      ...
	      var sort = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : { 'student.firstname': 1 };
	      ...
	      if (_underscore2.default.isEmpty(this.props.roomData.certificateData)) {
	        this.setState({ loading: true });
	      } else {
	        this.setState({ loading: false });
	      }
	      this.props.dispatch((0, _RoomActions.getCertificateData)(pageParam, pageParam.currentPage)).then(function (res) {
	        _this2.pageData(res);
	      });
	    }
	  }, {
	    ...
	    key: 'approveCertificate',
	    value: function approveCertificate(row) {
	      return _jsx('input', {
	        type: 'checkbox',
	        id: row._id,
	    ...
	    key: 'toggleCertificate',
	    value: function toggleCertificate(e) {
	      var _this3 = this;
	
	      var roomId = this.props.params.cid;
	      var studentId = e.currentTarget.id;
	
	      this.props.dispatch((0, _RoomActions.toggleCertificateDownload)(roomId, studentId)).then(function (res) {
	        if (res.status !== true) {
	          _this3.refs.room_container.error(res.error + ' ', '');
	        }
	      });
	    }
	  }, {
	    key: 'showStudentName',
	    value: function showStudentName(row) {
	      var name = row.name;
	      return _jsx('div', {}, void 0, name);
	    }
	  }, {
	    key: 'showTopicsCompleted',
	    value: function showTopicsCompleted(row) {
	      var topicsCompleted = row.topicsCompletedPercentage;
	
	      return _jsx('div', {}, void 0, topicsCompleted, '%');
	    }
	  }, {
	    key: 'showQuestionnaireCompleted',
	    value: function showQuestionnaireCompleted(row) {
	      var questionnairePercentage = row.questionnairePercentage;
	      var questionnaireCount = row.questionnaireCount;
	      var totalQuestionnaire = row.totalQuestionnaire;
	      return _jsx('div', {}, void 0, questionnairePercentage, '%, ', questionnaireCount, '/', totalQuestionnaire, ' completed');
	    }
	  }, {
	    key: 'showQuestionnaireGrade',
	    value: function showQuestionnaireGrade(row) {
	      return _jsx('div', {}, void 0, row.questionnaireGrade);
	    }
	  }, {
	    key: 'render',
	    value: function render() {
	      var objDisp = [{ title: _ref, type: 'function', callback: this.showStudentName, sort: true, dbName: 'student.firstname' }, { title: _ref2, type: 'function', callback: this.showTopicsCompleted }, { title: _ref3, type: 'function', callback: this.showQuestionnaireCompleted }, { title: _ref4, type: 'function', callback: this.showQuestionnaireGrade }, { title: _ref5, type: 'function', callback: this.approveCertificate }];
	
	      var filter = [{ type: 'search', id: 'studentSearch', selectedfilter: this.searchFilter }];
	
	      var breadcrumb = _jsx('div', {
	        className: _component2.default.dynamicBreadCrumb
	      }, void 0, _jsx('ul', {}, void 0, _ref6, _ref7, _jsx('li', {}, void 0, this.props.roomData.data.roomName)));
	...
	exports.default = (0, _reactRedux.connect)(mapStateToProps)(ListCertificates);
