...
/***/ function(module, exports, __webpack_require__) {
	...
	var _LDAPSettingsSchema = __webpack_require__(436);
	...
	var _LDAPSettingsMenu = __webpack_require__(435);
	...
	var LDAPSettingsComponent = function (_Component) {
	  _inherits(LDAPSettingsComponent, _Component);
	
	  function LDAPSettingsComponent(props) {
	    _classCallCheck(this, LDAPSettingsComponent);
	
	    var _this = _possibleConstructorReturn(this, (LDAPSettingsComponent.__proto__ || Object.getPrototypeOf(LDAPSettingsComponent)).call(this, props));
	
	    _initialiseProps.call(_this);
	
	    _this.form = null;
	    _this.submenu = _Validator2.default.activeSubMenu(_LDAPSettingsMenu.LDAPSettingsEditSubMenu, "lnkNewUsers");
	    _this.mainmenu = _LDAPSettingsMenu.LDAPSettingsEditMainMenu;
	    _this.schema = _LDAPSettingsSchema.LDAPSettingsSchema;
	    _this.res = {};
	    _this.mainmenu.menus[0].action = _this.save.bind(_this); //this.save.bind(this);
	    _this.mainmenu.menus[1].action = _this.deleteLDAPSettings.bind(_this);
	    _this.state = {
	      activeIcon: null
	    };
	    return _this;
	  ...
	  _createClass(LDAPSettingsComponent, [{
	    key: 'componentDidMount',
	    value: function componentDidMount() {
	      this.setdata(this.props.loggedInData);
	      this.props.dispatch((0, _LDAPSettingsActions.getLDAPSettings)(this.props.loggedInData.data._id)); // to get the LDAP Settings data when component mounts
	    }
	  }, {
	    key: 'setdata',
	    value: function setdata(result) {
	      if (result && result.data && result.data._id) {
	        ...
	        if (response) {
	          ...
	          this.props.dispatch((0, _LDAPSettingsActions.UpdateLDAPSchema)(this.schema));
	          this.props.dispatch((0, _LDAPSettingsActions.LDAPSettingsStore)({ uid: result.data._id }));
	        }
	      }
	    }
	  }, {
	    ...
	    value: function componentWillUnmount() {
	      this.props.dispatch((0, _LDAPSettingsActions.ClearLDAP)());
	    }
	  }, {
	    key: 'render',
	    value: function render() {
	      ...
	      return _jsx('div', {}, void 0, _react2.default.createElement(_lib.ToastContainer, {
	        ...
	        data: this.props.LDAPSettingsData.schema,
	...
	var _initialiseProps = function _initialiseProps() {
	  ...
	  this.save = function (event) {
	    var response = _Validator2.default.validate(_this2.form, _this2.schema, null, _this2.context.intl);
	    if (response.error.length > 0) {
	      _this2.schema = response.schema;
	      _this2.props.dispatch((0, _LDAPSettingsActions.UpdateLDAPSchema)(_this2.schema));
	    } else {
	      _this2.setState({ activeIcon: event.currentTarget.id });
	      _this2.props.dispatch((0, _LDAPSettingsActions.saveLDAPSettings)(_this2.form)).then(function (res) {
	        return _this2.getresponse(res);
	      });
	    }
	  };
	
	  this.deleteLDAPSettings = function () {
	    var userID = _this2.props.loggedInData.data._id;
	    var self = _this2;
	    var props = _this2.props;
	    alertify.confirm(_this2.props.intlData.messages.warning, _this2.props.intlData.messages.delete_LDAPSettings_alert, function (result) {
	      if (result) {
	        props.dispatch((0, _LDAPSettingsActions.deleteLDAPSettings)() /*{ userID}*/).then(function (res) {
	          return self.clearresponse(res);
	        });
	      }
	    }, function () {}).setting('labels', { 'ok': _this2.props.intlData.messages.ok, 'cancel': _this2.props.intlData.messages.cancel });;
	  };
	
	  this.clearresponse = function () {
	    var response = _Validator2.default.freeValue(_this2.schema);
	    if (response) {
	      _this2.props.dispatch((0, _LDAPSettingsActions.ClearLDAP)());
	      _this2.props.dispatch((0, _LDAPSettingsActions.UpdateLDAPSchema)(response));
	      _this2.props.dispatch((0, _LDAPSettingsActions.LDAPSettingsStore)({ uid: _this2.props.loggedInData.data._id }));
	    }
	  };
	
	  this.datareceive = function (data) {
	    _this2.form = data;
	  };
	};
	...
	function mapStateToProps(state) {
	  return {
	    ...
	    LDAPSettingsData: (0, _LDAPSettingsReducer.LDAPSettingsData)(state),
	...
	exports.default = (0, _reactRedux.connect)(mapStateToProps)(LDAPSettingsComponent);
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.LDAPSettingsEditSubMenu = exports.LDAPSettingsEditMainMenu = undefined;
	...
	//Main Menu
	var LDAPSettingsEditMainMenu = exports.LDAPSettingsEditMainMenu = {
			menus: [{ _id: "btnSave", text: _jsx(_reactIntl.FormattedMessage, {
							id: 'save'
					}), actionType: "Function", action: null, icon: "fa fa-floppy-o" }, { _id: "btnDelete", text: _jsx(_reactIntl.FormattedMessage, {
							id: 'delete'
					}), actionType: "Function", action: null, icon: "fa fa-trash-o" }]
	
			//SubMenu
	};var LDAPSettingsEditSubMenu = exports.LDAPSettingsEditSubMenu = {
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.LDAPSettingsSchema = undefined;
	...
	var LDAPSettingsSchema = exports.LDAPSettingsSchema = {
				_id: "LDAPSettings",
				...
				schemas: {
							LDAPDetails: {
										LDAPDetails: [{ type: "title", text: _jsx(_reactIntl.FormattedMessage, {
																id: 'ldap_details'
													}), icon: "fa fa-caret-right" }, { type: "hidden", _id: "_id", text: _jsx(_reactIntl.FormattedMessage, {
																id: 'hidden'
													}), datafield: "uid" }, { type: "text", text: _jsx(_reactIntl.FormattedMessage, {
																id: 'domain'
													}), _id: "domainId", datafield: "domain", required: true, error: "", exp: "", errormsg: "", limit: 60 }, { type: "text", text: _jsx(_reactIntl.FormattedMessage, {
																id: 'base_dn'
													}), _id: "baseDnId", datafield: "baseDn", required: true, error: "", exp: "", errormsg: "", limit: 40 }, { type: "text", text: _jsx(_reactIntl.FormattedMessage, {
																id: 'url'
													}), _id: "urlId", datafield: "url", required: true, error: "", exp: "", errormsg: "", limit: 60 }, { type: "text", text: _jsx(_reactIntl.FormattedMessage, {
																id: 'bind_cn'
													}), _id: "bindCnId", datafield: "bindCn", required: true, error: "", exp: "", errormsg: "", limit: 30 },
										...
										{ type: "text", _id: "bindPasswordID", text: _jsx(_reactIntl.FormattedMessage, {
																id: 'bind_password'
													}), datafield: "bindPassword", required: true, error: "", exp: "", errormsg: "", limit: 30 }, { type: "dropdown", text: _jsx(_reactIntl.FormattedMessage, {
																id: 'force_login'
													}), _id: "forceLoginId", datafield: "forceLogin", data: [["true", "true"], ["false", "false"]], value: "false" }]
							},
							col_2: {}
				}
	};
