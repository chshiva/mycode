...
/***/ function(module, exports, __webpack_require__) {
	...
	var _ref = _jsx('li', {}, void 0, _jsx(_reactRouter.Link, {
	...
	var _ref5 = _jsx('div', {}, void 0, 'Loading...');
	
	var EditCorporate = function (_Component) {
	  _inherits(EditCorporate, _Component);
	
	  function EditCorporate(props) {
	    _classCallCheck(this, EditCorporate);
	
	    var _this = _possibleConstructorReturn(this, (EditCorporate.__proto__ || Object.getPrototypeOf(EditCorporate)).call(this, props));
	
	    _this.save = function (event) {
	      //console.log("this.form === ",this.form);
	      var response = _Validator2.default.validate(_this.form, _this.schema, null, _this.context.intl);
	      if (response.error.length > 0) {
	        _this.schema = response.schema;
	        var data = {};
	        data['businessType'] = _this.props.corporateData.data.businessType;
	
	        _this.props.dispatch((0, _CorporateActions.UpdateCorporateSchema)(_this.schema, data));
	      } else {
	        _this.setState({ activeIcon: event.currentTarget.id });
	        var phno = _this.form['phoneNo'];
	        phno.splice(2, 1);
	        var cphno = _this.form['contactDetails.phoneNo'];
	        cphno.splice(2, 1);
	        _this.form['phoneNo'] = phno;
	        _this.form['contactDetails.phoneNo'] = cphno;
	        _this.props.dispatch((0, _CorporateActions.SaveCorporate)(_this.form)).then(function (res) {
	    ...
	    _this.setresponse = function (response) {
	      if (response.status) {
	        _reactRouter.browserHistory.push('/admin/corporate/view/' + response.id);
	      } else {
	        _this.setState({ activeIcon: null });
	        _this.refs.corporate_container.error(response.error + ' ', '');
	      }
	    };
	
	    _this.view = function () {
	      var corporateId = _this.props.params.cid;
	      _reactRouter.browserHistory.push('/admin/corporate/view/' + corporateId);
	    };
	    ...
	    _this.submenu = _Validator2.default.activeSubMenu(_CorporateMenu.corporateEditSubMenu, "lnkCorporate");
	    _this.mainmenu = _CorporateMenu.corporateEditMainMenu;
	
	    _this.mainmenu.menus[1].action = _this.save.bind(_this); //this.save.bind(this);
	    _this.mainmenu.menus[0].action = _this.view.bind(_this);
	    _this.state = {
	      activeIcon: null
	    };
	    return _this;
	  ...
	  _createClass(EditCorporate, [{
	    ...
	    value: function setuserdata(result) {
	      ...
	      if (result && result.data && result.data._id) {
	        ...
	        this.props.dispatch((0, _CorporateActions.CorporateStore)({ uid: result.data._id }));
	      }
	    }
	  }, {
	    key: 'setdata',
	    value: function setdata(result) {
	      ...
	      this.props.dispatch((0, _CorporateActions.CorporateStore)(new _DataObject2.default(result.data)));
	    }
	  }, {
	    key: 'datareceive',
	    ...
	    value: function render() {
	      ...
	      }, void 0, _jsx('ul', {}, void 0, _ref, _ref2, _jsx('li', {}, void 0, _jsx(_reactRouter.Link, {
	        onClick: this.view
	      }, void 0, this.roomName ? this.roomName : null)), _ref3, _ref4));
	
	      var clsContainerRight = _Admin2.default.containerRight + ' pull-right';
	...
	exports.default = (0, _reactRedux.connect)(mapStateToProps)(EditCorporate);
