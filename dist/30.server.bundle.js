...
/***/ function(module, exports, __webpack_require__) {
	...
	var _ref = _jsx('ul', {}, void 0, _jsx('li', {}, void 0, _jsx(_reactRouter.Link, {
	...
	var CreateCorporate = function (_Component) {
	  _inherits(CreateCorporate, _Component);
	
	  function CreateCorporate(props) {
	    _classCallCheck(this, CreateCorporate);
	
	    var _this = _possibleConstructorReturn(this, (CreateCorporate.__proto__ || Object.getPrototypeOf(CreateCorporate)).call(this, props));
	    ...
	    _this.save = function (event) {
	      ...
	      if (response.error.length > 0) {
	        ...
	        _this.props.dispatch((0, _CorporateActions.UpdateCorporateSchema)(_this.schema));
	      } else {
	    ...
	    _this.submenu = _Validator2.default.activeSubMenu(_CorporateMenu.corporateNewSubMenu, "lnkCorporate");
	    _this.mainmenu = _CorporateMenu.corporateNewMainMenu;
	  ...
	  _createClass(CreateCorporate, [{
	    ...
	    value: function setdata(result) {
	      if (result && result.data && result.data._id) {
	        ...
	        this.props.dispatch((0, _CorporateActions.UpdateCorporateSchema)(this.schema));
	    ...
	    value: function render() {
	      ...
	      return _jsx('div', {}, void 0, _react2.default.createElement(_lib.ToastContainer, {
	        ...
	        data: this.props.corporateData.schema,
	...
	exports.default = (0, _reactRedux.connect)(mapStateToProps)(CreateCorporate);
