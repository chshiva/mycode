...
/***/ function(module, exports, __webpack_require__) {
	...
	var _RoomSchema = __webpack_require__(380);
	...
	var _ref29 = _jsx(_Uploading2.default, {});
	
	var UploadToTopic = function (_Component) {
	  _inherits(UploadToTopic, _Component);
	
	  function UploadToTopic(props) {
	    _classCallCheck(this, UploadToTopic);
	
	    var _this = _possibleConstructorReturn(this, (UploadToTopic.__proto__ || Object.getPrototypeOf(UploadToTopic)).call(this, props));
	    ...
	    _this.schema = _RoomSchema.roomTopicSchema;
	    _this.res = {};
	
	    _this.submenu = _Validator2.default.activeSubMenu(_RoomMenu.roomEditSubMenu, "lnkRoomTopic");
	    _this.mainmenu = _RoomMenu.roomTopicMainMenuUpload;
	    _this.getData = _this.getData.bind(_this);
	    //this.clear = this.clear.bind(this);
	    _this.currentPage = 1;
	    _this.itemsPerPage = 5;
	
	    _this.viewRoomTopic = _this.viewRoomTopic.bind(_this);
	    _this.editRoomTopic = _this.editRoomTopic.bind(_this);
	    _this.downloadFile = _this.downloadFile.bind(_this);
	    _this.deleteFile = _this.deleteFile.bind(_this);
	    _this.fileFilter = _this.fileFilter.bind(_this);
	    _this.searchFilter = _this.searchFilter.bind(_this);
	    _this.showRecord = _this.showRecord.bind(_this);
	    _this.multipleDelete = _this.multipleDelete.bind(_this);
	    _this.pdfView = _this.pdfView.bind(_this);
	    _this.description = _this.description.bind(_this);
	    _this.fileEnable = _this.fileEnable.bind(_this);
	    //this.mainmenu.menus[0].action = this.clearError.bind(this);
	
	    _this.mainmenu.menus[0].action = _this.backButton.bind(_this);
	    _this.mainmenu.menus[1].action = _this.multidelete.bind(_this);
	
	    _this.submenu.menus[0].action = _this.viewroom.bind(_this);
	    _this.submenu.menus[1].action = _this.adduser.bind(_this);
	    _this.submenu.menus[2].action = _this.listtopic.bind(_this);
	    _this.submenu.menus[3].action = _this.feedbackList.bind(_this);
	    _this.submenu.menus[4].action = _this.roomConfiguration.bind(_this);
	    _this.submenu.menus[5].action = _this.listAssignments.bind(_this);
	    _this.submenu.menus[6].action = _this.courseReports.bind(_this);
	
	    _this.confObject = new _WoogeenManager2.default();
	    return _this;
	  }
	
	  _createClass(UploadToTopic, [{
	    ...
	    value: function setdata(result) {
	      if (result && result.data && result.data._id) {
	        ...
	        this.props.dispatch((0, _RoomActions.RoomTopicStore)({ obj: obj }));
	        this.getData({
	    ...
	    value: function getData(pageParam) {
	      ...
	      this.props.dispatch((0, _RoomActions.RoomTopicFileList)(pageParam, pageParam.currentPage)).then(function (res) {
	    ...
	    key: 'viewRoomTopic',
	    value: function viewRoomTopic(row) {
	    ...
	    key: 'editRoomTopic',
	    value: function editRoomTopic(row) {
	      //console.log(row)
	    ...
	    key: 'downloadFile',
	    value: function downloadFile(row) {
	      //console.log(row);
	      var link = "/uploads/" + row.fileName;
	    ...
	    key: 'deleteFile',
	    value: function deleteFile(row) {
	      var deleteFileAccess = row.createdBy == this.props.loggedInData.data._id || this.props.loggedInData.data.role == _roles.Roles.Lmsadmin || this.props.loggedInData.data.role == _roles.Roles.Superadmin ? _jsx('a', {
	        id: row._id,
	        onClick: this.deletetopicFile
	      }, void 0, _ref5) : "Not Allowed";
	      return deleteFileAccess;
	    }
	  }, {
	    key: 'multipleDelete',
	    value: function multipleDelete(row) {
	      deletingIDs = [];
	      ...
	      return _jsx('input', {
	        ...
	        id: row._id,
	        value: row.fileName,
	        onChange: this.deleteMultipleTopicFile.bind(this, row),
	        checked: checked
	      });
	    }
	  }, {
	    key: 'showRecord',
	    value: function showRecord(row) {
	      if (row.fileType == 'link') {
	        var youtube = "https://www.youtube.com/watch?v=" + row.fileName;
	        return youtube;
	      } else {
	        var fileName = row.fileName.substring(row.fileName.indexOf("_") + 1);
	        return fileName;
	      }
	    }
	  }, {
	    ...
	    value: function multidelete() {
	      if (deletingIDs.length <= 0) {
	        ...
	        alertify.confirm(this.props.intl.messages.warning, this.props.intl.messages.delete_all_files_alert, function (result) {
	          if (result) {
	            var obj = {
	            ...
	            props.dispatch((0, _RoomActions.DeleteMultipleFile)(obj, '')).then(function (res) {
	              return response(res, obj.topicId, obj.idsDelete);
	            });
	          }
	    ...
	    value: function saveFile(obj) {
	      ...
	      obj['topicId'] = this.props.params.tid, obj['roomId'] = this.props.params.rid, obj['uid'] = this.props.loggedInData.data._id;
	      var data = obj;
	      var url = "/api/uploadroomtopicfile";
	      var self = this;
	        ...
	        complete: function complete(err, res) {
	          ...
	          if (err) {
	            ...
	            if (resData.status) {
	              ...
	              self.props.dispatch((0, _RoomActions.NewFileUpload)(resData));
	    ...
	    key: 'handleUrlUpload',
	    value: function handleUrlUpload(value) {
	      var url = value;
	      if (url == '') {
	        alertify.alert(this.props.intl.messages.warning, this.props.intl.messages.url_alert, function () {}).setting({ 'label': this.props.intl.messages.ok });
	      }
	      if (url != undefined || url != '') {
	        ...
	        if (match && match[2].length == 11) {
	          ...
	          if (url == '') {} else {
	            alertify.alert(this.props.intl.messages.warning, this.props.intl.messages.valid_url_alert, function () {}).setting({ 'label': this.props.intl.messages.ok });
	          }
	        }
	      }
	    }
	    ...
	    key: 'pdfView',
	    value: function pdfView(row) {
	      var tpid = this.props.params.tid;
	      var pdfLink = "/admin/room/viewpdf/" + row._id + "/" + row.roomId + "/" + row.fileName + "/" + tpid;
	      var ext = row.fileName.substr(row.fileName.lastIndexOf(".") + 1);
	    ...
	    value: function description(row) {
	      if (row.fileType == 'link') {
	        ...
	        return _jsx(_reactRouter.Link, {
	          id: 'setDescription',
	          onClick: this.setDescription.bind(this, row._id, row.description)
	        }, void 0, _ref9);
	      }
	    }
	  }, {
	    key: 'setDescription',
	    value: function setDescription(id, desc) {
	      if (desc == undefined) {
	        desc = '';
	      }
	      this.setState({
	    ...
	    key: 'hideAddDescriptionModal',
	    value: function hideAddDescriptionModal() {
	      this.setState({
	        showAddDescriptionModal: false,
	        uploadId: '',
	        desc: ''
	    ...
	    value: function setDesc(e) {
	      ...
	      if (this.state.desc) {
	        if (this.state.desc.length > 10) {
	          ...
	          obj["currentPage"] = this.currentPage, obj["totalItems"] = 0, obj["itemsPerPage"] = this.itemsPerPage;
	          this.props.dispatch((0, _RoomActions.setUploadFileDescRequest)(obj, obj.currentPage)).then(function (res) {
	            return _this3.descData(res);
	          });
	        }
	      } else {
	    ...
	    key: 'descData',
	    value: function descData(response) {
	    ...
	    key: 'viewDescription',
	    value: function viewDescription(row) {
	      if (row.fileType == 'link') {
	        return _jsx('span', {}, void 0, row.title);
	      } else {
	        if (row.description) {
	          return _jsx('span', {}, void 0, row.description);
	        } else {
	          return _ref10;
	        }
	      }
	    ...
	    key: 'fileEnable',
	    value: function fileEnable(row) {
	      var viewFileEnable = row.createdBy == this.props.loggedInData.data._id ? _jsx('input', {
	        type: 'checkbox',
	        id: row._id,
	        value: row.isEnable,
	        onChange: this.handleEnableFile,
	    ...
	    value: function render() {
	      ...
	      }, void 0, _jsx('ul', {}, void 0, _ref11, _ref12, _jsx('li', {}, void 0, _jsx(_reactRouter.Link, {
	        onClick: this.viewroom
	      }, void 0, this.props.roomData.data.roomName)), _ref13, _jsx('li', {}, void 0, _jsx(_reactRouter.Link, {
	        onClick: this.listtopic
	      }, void 0, _ref14)), _ref15, _ref16));
	      var objDisp = [{ title: _ref17, type: "function", callback: this.multipleDelete }, { fieldName: "fileName", title: _ref18, type: "function", callback: this.showRecord }, { title: _ref19, type: "function", callback: this.downloadFile }, { title: _ref20, type: "function", callback: this.deleteFile }, { title: _ref21, type: "function", callback: this.pdfView }, { title: _ref22, type: "function", callback: this.viewDescription }, { title: _ref23, type: "function", callback: this.description }, { title: _ref24, type: "function", callback: this.fileEnable }];
	      var filter = [{ type: 'search', id: 'fileSearch', selectedfilter: this.searchFilter }, { type: 'dropdown', id: 'fileType', data: [['', 'all'], ['image', 'image'], ['zip', 'zip'], ['audio', 'audio'], ['video', 'video']], selectedfilter: this.fileFilter, value: this.state.filterValue }];
	
	      var showAddDescriptionModal = this.state.showAddDescriptionModal ? _jsx(_reactBootstrap.Modal, {
	        show: this.state.showAddDescriptionModal,
	        onHide: this.hideAddDescriptionModal.bind(this)
	      }, void 0, _jsx(_Modal.Header, {
	        closeButton: true
	      }, void 0, _jsx(_Modal.Title, {
	        className: _component2.default.popHeadingAll
	      }, void 0, _ref25)), _jsx(_Modal.Body, {}, void 0, _jsx('form', {
	        className: 'form-horizontal'
	      }, void 0, _jsx('div', {
	        className: 'form-group'
	      }, void 0, _ref26, _jsx('div', {
	        className: 'col-md-10'
	      }, void 0, _react2.default.createElement('input', { id: 'discriptionField', type: 'text', className: 'form-control', placeholder: this.props.intl.messages.desc, value: this.state.desc, onChange: this.handleDesc.bind(this), ref: 'description', onKeyPress: this.handleDesc.bind(this) }))))), _jsx(_Modal.Footer, {}, void 0, _ref27, _jsx('button', {
	        id: 'save',
	        className: _component2.default.btnApplyAll,
	        onClick: this.setDesc.bind(this)
	      }, void 0, _ref28))) : null;
	      ...
	      if (this.state.uploading) {
	        ...
	        return _jsx('div', {}, void 0, _react2.default.createElement(_lib.ToastContainer, {
	          ...
	          data: this.props.roomData.topicFileList,
	...
	var _initialiseProps = function _initialiseProps() {
	  ...
	  this.deleteMultipleTopicFile = function (row, e) {
	    if (row.createdBy == _this4.props.loggedInData.data._id || _this4.props.loggedInData.data.role == _roles.Roles.Lmsadmin || _this4.props.loggedInData.data.role == _roles.Roles.Superadmin) {
	      ...
	      var a = str.split('_');
	      _this4.refs.room_container.error('Permission denied; ' + a[1] + ' has been uploaded by Admin.');
	    }
	  };
	
	  this.deletetopicFile = function (e) {
	    var id = e.currentTarget.id;
	    var props = _this4.props;
	    var response = _this4.setdeleteresponse;
	
	    alertify.confirm(_this4.props.intl.messages.warning, _this4.props.intl.messages.delete_file_alert, function (result) {
	      if (result) {
	        var obj = {
	          roomId: props.params.rid,
	          _id: id,
	        ...
	        props.dispatch((0, _RoomActions.DeleteFile)(obj, '')).then(function (res) {
	          return response(res, obj.topicId, obj._id);
	        });
	      }
	    }, function () {}).setting('labels', { 'ok': _this4.props.intl.messages.ok, 'cancel': _this4.props.intl.messages.cancel });;
	  };
	
	  this.setdeleteresponse = function (res, tId, fId) {
	    ...
	    _this4.confObject.sendMessage(obj, 0);
	    ...
	    _this4.confObject.sendMessage(pdfViewObj, 0);
	  ...
	  this.viewroom = function () {
	    ...
	    var roomId = _this4.props.params.rid;
	  ...
	  this.setmultipledeleteresponse = function (res, tId, fileIds) {
	    var obj = {
	  ...
	  this.fileFilter = function (e) {
	    e.preventDefault();
	    _this4.state.filterValue = e.target.value;
	    _this4.getData({
	      currentPage: _this4.currentPage,
	      totalItems: 0,
	      itemsPerPage: _this4.itemsPerPage
	  ...
	  this.handleUpload = function (e) {
	    ...
	    if (!file) {
	      ...
	      alertify.alert(_this4.props.intl.messages.warning, _this4.props.intl.messages.topic_file_alert, function () {}).setting({ 'label': _this4.props.intl.messages.ok });
	      return;
	    }
	    //console.log(file)
	  ...
	  this.handleEnableFile = function (e) {
	    var isEnable = e.currentTarget.value == "true" ? false : true;
	    var id = e.currentTarget.id;
	    _this4.props.dispatch((0, _RoomActions.handleFileEnable)(isEnable, id)).then(function (res) {
	      return _this4.fileEnableResponse(res);
	    });
	  };
	
	  this.fileEnableResponse = function (res) {
	    var tId = res && res.fileData && res.fileData.topicId ? res.fileData.topicId : '';
	    var fId = res && res.fileData && res.fileData.id ? res.fileData.id : '';
	    var topicContentObj = {
	      command: 'RELOAD_TOPICS_CONTENT',
	      content: { tid: tId },
	      type: 'OBJECT'
	    };
	    _this4.confObject.sendMessage(topicContentObj, 0);
	...
	exports.default = (0, _reactRedux.connect)(mapStateToProps)(UploadToTopic);
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.roomTopicSchema = exports.editRoomSchema = exports.roomSchema = undefined;
		...
		schemas: {
			about_me: { //Position Name
				...
				{ type: "hidden", _id: "cid", text: _jsx(_reactIntl.FormattedMessage, {
						...
						id: 'basic_info'
					}), icon: "fa fa-caret-right" }, { type: "dynamicdropdown", _id: "selPackage", text: _jsx(_reactIntl.FormattedMessage, {
						id: 'select_package'
					}), idfield: "selPackage._id", datafield: "selPackage", apicall: "package-ids", value: " ", required: true, error: "", errorId: "packageError" },
				// { type: "text", _id : "selPackage", text: "Select Package", datafield:"selPackage", required : true},
				{ type: "text", _id: "roomName", text: _jsx(_reactIntl.FormattedMessage, {
						id: 'room_name'
					}), datafield: "roomName", required: true, error: "", exp: "ALPHANUMERICwithSPACE", errormsg: "", limit: 30, errorId: "roomNameError" }, { type: "dropdown", _id: "roomType", text: _jsx(_reactIntl.FormattedMessage, {
						id: 'room_type'
					}), datafield: "roomType", data: [["Forward", "forward"], ["Mix", "mix"], ["Hybrid", "hybrid"]], value: "Forward", required: true, errorId: "roomTypeError" }]
			},
			other_info: { //Position Name
				other_details: [{ type: "title", text: _jsx(_reactIntl.FormattedMessage, {
						id: 'other_details'
				...
				{ type: "password", _id: "hostPassword", text: _jsx(_reactIntl.FormattedMessage, {
						id: 'host_password'
					}), datafield: "hostPassword", required: true, error: "", exp: "", errormsg: "", limit: 15, errorId: "hostPasswordError" }, { type: "date", _id: "expiryDate", text: _jsx(_reactIntl.FormattedMessage, {
						id: 'expiry_Date'
					}), datafield: "expiryDate", required: true, error: "", exp: "", errormsg: "", errorId: "expiryDateError" }]
			}
		}
	};
	
	var editRoomSchema = exports.editRoomSchema = {
		_id: "RoomManager",
		formIcon: "fa fa-key",
		formTitle: _jsx(_reactIntl.FormattedMessage, {
			id: 'room_management'
		...
		schemas: {
			about_me: { //Position Name
				...
				{ type: "hidden", _id: "cid", text: _jsx(_reactIntl.FormattedMessage, {
						...
						id: 'basic_info'
					}), icon: "fa fa-caret-right" }, { type: "view", _id: "selPackage", text: _jsx(_reactIntl.FormattedMessage, {
						id: 'select_package'
					}), field: "selPackage", idfield: "selPackage._id", datafield: "selPackage.packageName", value: "", role: [_roles.Roles.Superadmin, _roles.Roles.Admin, _roles.Roles.Lmsadmin, _roles.Roles.CRMadmin, _roles.Roles.Presenteradmin] },
			...
			other_info: { //Position Name
				other_details: [{ type: "title", text: _jsx(_reactIntl.FormattedMessage, {
						id: 'other_details'
					}), icon: "fa fa-caret-right" }, { type: "view", _id: "corporateId", text: _jsx(_reactIntl.FormattedMessage, {
						id: 'corporate_name'
					}), field: "corporateId", idfield: "corporateId._id", datafield: "corporateId.businessName", role: [_roles.Roles.Superadmin] },
	...
	var roomTopicSchema = exports.roomTopicSchema = {
		...
		schemas: {
			about_me: { //Position Name
				...
				{ type: "hidden", _id: "cid", text: _jsx(_reactIntl.FormattedMessage, {
						...
						id: 'hidden'
					}), datafield: "uid" }, { type: "hidden", _id: "rid", text: _jsx(_reactIntl.FormattedMessage, {
						id: 'hidden'
					}), datafield: "roomId" }, { type: "title", text: _jsx(_reactIntl.FormattedMessage, {
						id: 'topic_details'
					}), icon: "fa fa-caret-right" }, { type: "text", _id: "topicName", text: _jsx(_reactIntl.FormattedMessage, {
						id: 'topic_name'
					}), datafield: "topicName", required: true, error: "", errormsg: "", limit: 60, errorId: "topicNameError" }]
			},
			other_info: { //Position Name
				other_details: [{ type: "textarea", _id: "Description", text: _jsx(_reactIntl.FormattedMessage, {
						id: 'description'
					}), datafield: "description", required: true, error: "", limit: 250, errorId: "descriptionError" }]
			}
		}
	};
