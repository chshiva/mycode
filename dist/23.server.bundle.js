...
/***/ function(module, exports, __webpack_require__) {
	...
	var _ProfileSchema = __webpack_require__(405);
	...
	var CreateLocale = function (_Component) {
	  _inherits(CreateLocale, _Component);
	
	  function CreateLocale(props) {
	    _classCallCheck(this, CreateLocale);
	
	    var _this = _possibleConstructorReturn(this, (CreateLocale.__proto__ || Object.getPrototypeOf(CreateLocale)).call(this, props));
	    ...
	    _this.save = function () {
	      ...
	      if (response.error.length > 0) {
	        ...
	        _this.props.dispatch((0, _ProfileActions.UpdateLocaleSchema)(_this.schema));
	      } else {
	        var localeobj = _this.form;
	        _this.props.dispatch((0, _ProfileActions.saveLocaleSettings)(localeobj)).then(function (res) {
	    ...
	    _this.setresponse = function (response) {
	      if (response.status) {
	        _this.refs.profile_container.success(response.message + ' ', '');
	        _this.props.dispatch((0, _LoginActions.isLoggedIn)(_AuthController2.default.getSession())).then(function (res) {
	          if (res.status) {
	            var businessType = res.data && res.data.profile && res.data.profile.companyid && res.data.profile.companyid.businessType != 'undefined' ? res.data.profile.companyid.businessType : 'Conference';
	            _this.props.dispatch((0, _IntlActions.loginLanguage)(response.data, _this.props.intlData.setlocale));
	            _this.props.dispatch((0, _IntlActions.switchLanguage)(response.data.locale.preferedlanguage, businessType, _this.props.intlData.setlocale));
	            _reactRouter.browserHistory.push('/admin/locale/view');
	          }
	        });
	      } else {
	        _this.refs.profile_container.error(response.error + ' ', '');
	      }
	    };
	    ...
	    _this.submenu = _Validator2.default.activeSubMenu(_ProfileEditMenu.localeEditSubMenu, "lnkEditLocale");
	    _this.mainmenu = _ProfileEditMenu.localeEditMainMenu;
	    _this.schema = _ProfileSchema.LocaleSchema;
	    _this.res = {};
	  ...
	  _createClass(CreateLocale, [{
	    ...
	    value: function setdata(result) {
	      ...
	      if (result && result.data && result.data._id) {
	        ...
	        this.props.dispatch((0, _ProfileActions.UpdateLocaleSchema)(this.schema));
	        this.props.dispatch((0, _ProfileActions.localesettingsStore)({ uid: result.data._id }));
	      }
	    }
	  }, {
	    key: 'datareceive',
	    ...
	    value: function render() {
	      ...
	      if (this.props.profileData.data) {
	        return _jsx('div', {}, void 0, _react2.default.createElement(_lib.ToastContainer, {
	          ...
	          data: this.props.profileData.schema,
	...
	exports.default = (0, _reactRedux.connect)(mapStateToProps)(CreateLocale);
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.LocaleSchema = exports.profileSchema = undefined;
	...
	var profileSchema = exports.profileSchema = {
		_id: "MyProfile",
		formIcon: "fa fa-key",
		...
		schemas: {
			...
			about_me: { //Position Name
				...
				{ type: "hidden", _id: "uid", text: _jsx(_reactIntl.FormattedMessage, {
						id: 'hidden'
					}), datafield: "_id" }, { type: "title", text: _jsx(_reactIntl.FormattedMessage, {
						id: 'about_me'
					}), icon: "fa fa-caret-right" }, { type: "textarea", _id: "aboutMe", text: _jsx(_reactIntl.FormattedMessage, {
						id: 'summary'
					}), datafield: "profile.aboutme", required: false, limit: 150 }],
				...
				{ type: "title", text: _jsx(_reactIntl.FormattedMessage, {
						...
						id: 'first_name'
					}), datafield: "firstname", error: "", exp: "ALPHAwithSPACE", required: true, limit: 30, caps: true }, { type: "text", _id: "lastName", text: _jsx(_reactIntl.FormattedMessage, {
						id: 'last_name'
					}), datafield: "lastname", error: "", exp: "ALPHAwithSPACE", limit: 30, caps: true }]
			},
			personal_info: { //Position Name
				contact_details: [{ type: "title", text: _jsx(_reactIntl.FormattedMessage, {
						id: 'contact_details'
					}), icon: "fa fa-caret-right" }, { type: "email", _id: "emailId", text: _jsx(_reactIntl.FormattedMessage, {
						id: 'email'
					}), datafield: "email", error: "", exp: "EMAIL", errormsg: "", required: true, limit: 50 }, { type: "phone", _id: "phone", text: _jsx(_reactIntl.FormattedMessage, {
						id: 'phone'
					}), datafield: "profile.phone", error: "", errormsg: "", exp: "" }, { type: "dropdown", _id: "gender", text: _jsx(_reactIntl.FormattedMessage, {
						id: 'gender'
					}), datafield: "profile.gender", data: [["Male", "male"], ["Female", "female"]], value: "Male" }],
				company_details: [//Form Groups
				{ type: "title", text: _jsx(_reactIntl.FormattedMessage, {
						id: 'company_details'
					}), icon: "fa fa-caret-right" }, { type: "text", _id: "position", text: _jsx(_reactIntl.FormattedMessage, {
						id: 'position'
					}), datafield: "profile.position", error: "", exp: "", errormsg: "", limit: 30, caps: true }, { type: "text", _id: "department", text: _jsx(_reactIntl.FormattedMessage, {
						id: 'department'
					}), datafield: "profile.dept", error: "", exp: "ALPHAwithSPACE", errormsg: "", limit: 30, caps: true }]
			}
		}
	};
	...
	Responsible : Prateek*/
	var LocaleSchema = exports.LocaleSchema = {
		_id: "Locale",
		formTitle: _jsx(_reactIntl.FormattedMessage, {
			id: 'my_account'
		}),
		serverCollection: _jsx(_reactIntl.FormattedMessage, {
			id: 'local_settings'
		}),
		schemas: {
			LocaleSettings: {
				LocaleSettings: [{ type: "title", text: _jsx(_reactIntl.FormattedMessage, {
						id: 'local_settings'
					}), icon: "fa fa-caret-right" }, { type: "hidden", _id: "uid", text: _jsx(_reactIntl.FormattedMessage, {
						id: 'hidden'
					}), datafield: "_id" },
	   ...
	   { type : "dropdown", text : <FormattedMessage id='time_format' />, _id : "timeformatId", datafield : "timeformat", data : [["HH:MM:SS", "hh_mm_ss"]], value : "HH:MM:SS" },
	    { type : "dropdown", text : <FormattedMessage id='currency_format' />, _id : "currencyformatId", datafield : "currencyformat", data : [["Indian Rupee", "indian_rupee"], ["USD", "usd"]], value : "Indian Rupee" },*/
				{ type: "dropdown", text: _jsx(_reactIntl.FormattedMessage, {
						id: 'prefered_language'
					}), _id: "preferedlanguageId", datafield: "preferedlanguage", data: [["", "select_language"], ["en", "english"], ["hi", "hindi"]], value: "en" }]
