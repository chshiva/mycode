...
/***/ function(module, exports, __webpack_require__) {
	...
	var ProfileEdit = function (_Component) {
	  ...
	  function ProfileEdit(props) {
	    ...
	    _this.save = function () {
	      ...
	      if (response.error.length > 0) {
	        ...
	        _this.props.dispatch((0, _ProfileActions.UpdateProfileSchema)(_this.schema));
	      } else {
	        var phno = _this.form['profile.phone'];
	        // if(phno && typeof(phno)!='string' && phno.length>0)
	        phno.splice(2, 1);
	        // else
	        //   phno = [];
	        _this.form['profile.phone'] = phno;
	        //console.log("this.form === ",this.form);
	        _this.props.dispatch((0, _LoginActions.SaveProfile)(_this.form)).then(function (res) {
	    ...
	    _this.setresponse = function (response) {
	      if (response.status) {
	        ...
	        _reactRouter.browserHistory.push('/admin/profile');
	        _this.props.dispatch((0, _LoginActions.isLoggedIn)(_AuthController2.default.getSession()));
	        _this.props.dispatch((0, _IntlActions.switchLanguage)(response.data.locale.preferedlanguage, response.data.profile.companyid.businessType, _this.props.intlData.setlocale));
	      } else {
	    ...
	    _this.schema = _ProfileSchema.profileSchema;
	    _this.res = {};
	    // this.state.schema = this.schema;
	    _this.submenu = _Validator2.default.activeSubMenu(_ProfileEditMenu.profileEditSubMenu, "lnkGenaralInfo");
	  ...
	  _createClass(ProfileEdit, [{
	    ...
	    value: function setdata(result) {
	      if (result && result.data && result.data._id) {
	        ...
	        if (response) {
	          ...
	          this.props.dispatch((0, _ProfileActions.UpdateProfileSchema)(this.schema));
	          this.props.dispatch((0, _ProfileActions.ProfileStore)(new _DataObject2.default(result.data)));
	        }
	      }
	    }
	  }, {
	    ...
	    value: function render() {
	      ...
	      }, void 0, _jsx('ul', {}, void 0, _ref, _ref2, _jsx('li', {}, void 0, this.props.loggedInData && this.props.loggedInData.data ? this.props.loggedInData.data.firstname : null)));
	...
	exports.default = (0, _reactRedux.connect)(mapStateToProps)(ProfileEdit);
