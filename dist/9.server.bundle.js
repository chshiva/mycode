...
/***/ function(module, exports, __webpack_require__) {
	...
	var _ListQuestionnaire = __webpack_require__(457);
	
	var _ListQuestionnaire2 = _interopRequireDefault(_ListQuestionnaire);
	
	var _QuestionnairePopup = __webpack_require__(460);
	
	var _QuestionnairePopup2 = _interopRequireDefault(_QuestionnairePopup);
	...
	var _ref6 = _jsx('li', {}, void 0, '/');
	
	var _ref7 = _jsx(_TopMenu2.default, {
	  data: _RoomMenu.assignQuestionnaireMainMenu
	});
	
	var _ref8 = _jsx(_SubMenu2.default, {
	  data: _RoomMenu.roomEditSubMenu
	});
	
	var AssignQuestionnaire = function (_Component) {
	  _inherits(AssignQuestionnaire, _Component);
	
	  function AssignQuestionnaire(props) {
	    _classCallCheck(this, AssignQuestionnaire);
	
	    var _this = _possibleConstructorReturn(this, (AssignQuestionnaire.__proto__ || Object.getPrototypeOf(AssignQuestionnaire)).call(this, props));
	    ...
	    _this.mainmenu = _RoomMenu.assignQuestionnaireMainMenu;
	
	    _this.mainmenu.menus[0].action = _this.listtopic.bind(_this);
	    _this.mainmenu.menus[1].action = _this.assignQuestionnaire.bind(_this);
	  ...
	  _createClass(AssignQuestionnaire, [{
	    ...
	    key: 'setuserdata',
	    value: function setuserdata(result) {
	      var _this2 = this;
	      ...
	      if (result && result.data && result.data._id) {
	        ...
	        this.props.dispatch((0, _RoomActions.getRoomTopicData)(obj, '/admin/room/questionnaire/' + obj.topicId + '/' + obj.roomId)).then(function (res) {
	          return _this2.setdata(res);
	        });
	        this.props.dispatch((0, _RoomActions.RoomTopicStore)({ uid: result.data._id }));
	    ...
	    value: function setdata(result) {
	      ...
	      this.props.dispatch((0, _RoomActions.RoomTopicStore)(new _DataObject2.default(result.data)));
	    }
	  }, {
	    key: 'assignQuestionnaire',
	    value: function assignQuestionnaire() {
	      var data = "true";
	      var obj = {
	      ...
	      this.props.dispatch((0, _RoomActions.getTopicQuestionnaireData)(obj));
	      this.props.dispatch((0, _RoomActions.showModal)(data));
	    }
	  }, {
	    key: 'render',
	    value: function render() {
	      ...
	      }, void 0, _jsx('ul', {}, void 0, _ref2, _ref3, _jsx('li', {}, void 0, _jsx(_reactRouter.Link, {
	        onClick: this.viewroom
	      }, void 0, this.props.roomData.data.roomName)), _ref4, _jsx('li', {}, void 0, _jsx(_reactRouter.Link, {
	        onClick: this.listtopic
	      }, void 0, _ref5)), _ref6, _jsx('li', {}, void 0, this.props.roomData.topicdata.topicName))), _ref7), _jsx('div', {
	        className: cls_isubmenu
	      }, void 0, _ref8), _jsx(_ListQuestionnaire2.default, {
	        topicData: dataObject,
	        success: this.props.roomData.success,
	        uid: userObject._id,
	        role: userObject.role,
	        roomId: this.props.params.rid,
	        topicId: this.props.params.tid
	      }), _jsx(_QuestionnairePopup2.default, {
	        showModal: showModal,
	        editModal: editModal,
	        topicData: dataObject,
	        uid: userObject._id,
	...
	exports.default = (0, _reactRedux.connect)(mapStateToProps)(AssignQuestionnaire);
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.ListQuestionnaire = undefined;
	...
	var _ref = _jsx(_reactIntl.FormattedMessage, {
	  id: 'No_Questionnaires_assigned_to_this_topic'
	});
	...
	var _ref3 = _jsx('p', {}, void 0, _jsx(_reactIntl.FormattedMessage, {
	  id: 'title_questionnaire_assigned'
	}), '.');
	
	var ListQuestionnaire = exports.ListQuestionnaire = function (_Component) {
	  ...
	  function ListQuestionnaire(props) {
	    ...
	    _this.setresponse = function (response) {
	      if (response.status) {
	        _this.refs.questions_container.success(response.message + ' ', '');
	      } else {
	        _this.refs.questions_container.error(response.error + ' ', '');
	      }
	    };
	  ...
	  _createClass(ListQuestionnaire, [{
	    ...
	    key: 'removeQuestionnaire',
	    value: function removeQuestionnaire(e) {
	      var questionnaireId = e.target.id;
	      var topicId = this.props.topicId;
	      var props = this.props;
	      // var response = this.setDeleteResponse;
	      var self = this;
	      alertify.confirm(this.props.intl.messages.warning, this.props.intl.messages.unassign_question_alert, function (result) {
	        if (result) {
	          var obj = {
	            questionnaireId: questionnaireId,
	            topicId: topicId
	          };
	          props.dispatch((0, _RoomActions.unassignQuestionnaireRequest)(obj)).then(function (res) {
	            return self.setDeleteResponse(res, obj.topicId, obj.questionnaireId);
	          });
	        }
	    ...
	    value: function setDeleteResponse(response, tId, qId) {
	      ...
	      if (response.httpStatusCode && !response.status) {
	        ...
	        alertify.confirm(this.props.intl.messages.warning, this.props.intl.messages.confirm_unassign_questionnaire_topics, function (result) {
	          if (result) {
	            var _obj = {
	              questionnaireId: questionnaireId,
	              topicId: topicId
	            };
	            props.dispatch((0, _RoomActions.confirmedUnassignQuestionnaireRequest)(_obj));
	          }
	        }, function () {}).setting('labels', { 'ok': this.props.intl.messages.ok, 'cancel': this.props.intl.messages.cancel });
	    ...
	    key: 'handleEditQuestionnaire',
	    value: function handleEditQuestionnaire(id) {
	      var editId = id;
	      var data = "true";
	      this.props.dispatch((0, _RoomActions.showModal)(data));
	      this.props.dispatch((0, _RoomActions.editModal)(editId));
	    }
	  }, {
	    key: 'handleListResults',
	    value: function handleListResults(id) {
	      _reactRouter.browserHistory.push("/admin/room/list-results/" + this.props.roomId + '/' + this.props.topicId + '/' + id);
	    }
	  }, {
	    key: 'render',
	    value: function render() {
	      ...
	      var listQuestionnaires = _ref;
	      if (this.props.topicData && this.props.topicData.questionnaire && this.props.topicData.questionnaire.length > 0) {
	        var questionnaire = this.props.topicData.questionnaire;
	        listQuestionnaires = questionnaire.map(function (questionnaire) {
	
	          return _jsx('li', {}, questionnaire._id, _jsx('div', {
	            className: 'clearfix'
	          }, void 0, _jsx('h4', {
	            className: 'pull-left'
	          }, void 0, questionnaire.questionnaireId.questionnaireName ? questionnaire.questionnaireId.questionnaireName : "-"), _this2.props.role != 1 ? _jsx('div', {
	            id: 'listResults',
	            className: _Admin2.default.userAction2,
	            title: _this2.props.intl.messages.list_results
	          }, void 0, _jsx(_reactFontawesome2.default, {
	            name: 'list-alt',
	            id: questionnaire._id,
	            onClick: function onClick() {
	              return _this2.handleListResults(questionnaire.questionnaireId._id);
	            }
	          })) : null, _this2.props.role != 1 ? _jsx('div', {
	            id: 'viewEditQuestionnaire',
	            className: _Admin2.default.userAction1,
	            title: _this2.props.intl.messages.view_edit_questionaire_from_topic
	          }, void 0, _jsx(_reactFontawesome2.default, {
	            name: 'pencil-square-o',
	            onClick: function onClick() {
	              return _this2.handleEditQuestionnaire(questionnaire._id);
	            }
	          })) : null, _this2.props.role != 1 ? _jsx('div', {
	            id: 'removeQuestionnaire',
	            className: _Admin2.default.userAction,
	            title: _this2.props.intl.messages.unassign_questionnaire_from_topic
	          }, void 0, _jsx(_reactFontawesome2.default, {
	            name: 'times',
	            id: questionnaire.questionnaireId._id,
	            onClick: _this2.removeQuestionnaire.bind(_this2)
	          })) : null));
	        });
	      }
	      ...
	      }, void 0, _ref2, ' - ', _jsx('b', {}, void 0, this.props.topicData.topicName))), _jsx('div', {
	        className: _Admin2.default.whiteCard
	      }, void 0, _jsx(_reactBootstrap.Grid, {
	        fluid: true
	      }, void 0, listQuestionnaires != "No Questionnaires assigned to this topic." ? _jsx(_reactBootstrap.Row, {}, void 0, _jsx(_reactBootstrap.Col, {
	        md: 12
	      }, void 0, _jsx('div', {
	        className: _Admin2.default.infoTxt
	      }, void 0, _ref3))) : null, _jsx(_reactBootstrap.Row, {}, void 0, _jsx(_reactBootstrap.Col, {
	        md: 12
	      }, void 0, _jsx('div', {
	        className: _Admin2.default.userListGroup
	      }, void 0, _jsx('ul', {}, void 0, listQuestionnaires)))))));
	    }
	  }]);
	...
	exports.default = (0, _reactRedux.connect)(mapStateToProps)((0, _reactIntl.injectIntl)(ListQuestionnaire));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _ref3 = _jsx('option', {
	  value: ''
	}, void 0, 'No questionnaires present');
	...
	var QuestionnairePopup = function (_Component) {
	  _inherits(QuestionnairePopup, _Component);
	
	  function QuestionnairePopup(props) {
	    _classCallCheck(this, QuestionnairePopup);
	
	    var _this = _possibleConstructorReturn(this, (QuestionnairePopup.__proto__ || Object.getPrototypeOf(QuestionnairePopup)).call(this, props));
	
	    _this.assignQuestionnaire = function () {
	      var index = _reactDom2.default.findDOMNode(_this.refs.questionnaire).value;
	      var questionnaireId = null;
	      var questionnaireQuestionCount = null;
	      if (_this.props.editModal == undefined || _this.props.editModal == true) {
	        var questionnaireData = index != '' ? _this.props.questionnaireData[index] : null;
	      ...
	      var ipstime = (0, _moment2.default)(_this.state.openFrom, "DD/MM/YYYY hh:mm A");
	      var ipetime = (0, _moment2.default)(_this.state.closeFrom, "DD/MM/YYYY hh:mm A");
	      var now = (0, _moment2.default)();
	
	      if (questionnaireId != "") {
	        if (_this.state.timeLimit) {
	          if (_this.state.inputFromDate == false) {
	            _this.refs.questionnaire_container.error("Invalid Start Time");
	          } else if (_this.state.inputCloseDate == false) {
	            _this.refs.questionnaire_container.error("Invalid End Time");
	          } else if (+ipstime < +now && _this.props.editModal == undefined) {
	            _this.refs.questionnaire_container.error("Start time should be greater than current time");
	          } else if (+ipstime == +ipetime) {
	            _this.refs.questionnaire_container.error("Start and end time cannot be same");
	          } else if (+ipstime > +ipetime) {
	            _this.refs.questionnaire_container.error("End time should be greater than Start time");
	          } else if (_this.props.editModal == undefined && questionnaireQuestionCount <= 0 || _this.props.editModal == true && questionnaireQuestionCount <= 0) {
	            _this.refs.questionnaire_container.error("Please assign a questionnaire which has atleast one question in it");
	          } else {
	            var questionnaire = {
	              openFrom: (0, _moment2.default)(_this.state.openFrom, "DD/MM/YYYY hh:mm A").utc().toDate(),
	              closeFrom: (0, _moment2.default)(_this.state.closeFrom, "DD/MM/YYYY hh:mm A").utc().toDate(),
	              uid: _this.props.uid,
	              questionnaireId: questionnaireId,
	              topicId: _this.props.topicData._id,
	              editId: _this.state.editId,
	              showResult: _this.state.showResult
	            };
	            _this.props.dispatch((0, _RoomActions.AssignQuestionnaireRequest)({ questionnaire: questionnaire })).then(function (res) {
	              return _this.setresponse(res, questionnaire.topicId, questionnaire.questionnaireId);
	            });
	          }
	        } else {
	          if (_this.props.editModal == undefined && questionnaireQuestionCount <= 0 || _this.props.editModal == true && questionnaireQuestionCount <= 0) {
	            _this.refs.questionnaire_container.error("Please assign a questionnaire which has atleast one question in it");
	          } else {
	            var questionnaire = {
	              uid: _this.props.uid,
	        ...
	        _this.refs.questionnaire_container.error("Please assign a questionnaire");
	      }
	    };
	
	    _this.setresponse = function (response, tId, qId) {
	      if (response.status) {
	        _this.setState({
	          uid: null,
	          showModal: false,
	          openFrom: (0, _moment2.default)().format('DD/MM/YYYY hh:mm A'),
	          openFromFormat: "DD/MM/YYYY hh:mm A",
	          openFromInputFormat: "DD/MM/YYYY hh:mm A",
	          // openFromMode: "date",  
	          closeFrom: (0, _moment2.default)().format('DD/MM/YYYY hh:mm A'),
	          minDate: (0, _moment2.default)(),
	          inputFromDate: null,
	          inputCloseDate: null,
	          timeLimit: false,
	        ...
	        var data = "";
	        var editId = '';
	        _this.props.dispatch((0, _RoomActions.showModal)(data));
	        _this.props.dispatch((0, _RoomActions.editModal)(editId));
	        ...
	        var conductQuestionObj = {
	          command: 'RELOAD_REMOVED_QUESTIONNAIRES',
	          content: { tid: tId, questionnaireId: qId },
	          type: 'OBJECT'
	        };
	        _this.confObject.sendMessage(conductQuestionObj, 0);
	      } else {
	        if (response.error[0] == 409) {
	          _this.refs.questionnaire_container.error("Time Conflict: Already questionnaire is assigned from " + (0, _moment2.default)(response.openFrom).format("DD/MM/YYYY hh:mm A") + " " + "to" + " " + (0, _moment2.default)(response.closeFrom).format("DD/MM/YYYY hh:mm A"));
	        } else {
	          _this.refs.questionnaire_container.error(response.error + ' ', '');
	        }
	      }
	    };
	  ...
	  _createClass(QuestionnairePopup, [{
	    key: 'componentWillReceiveProps',
	    value: function componentWillReceiveProps(nextProps) {
	        ...
	        for (var i = 0; i < nextProps.topicData.questionnaire.length; i++) {
	          if (nextProps.topicData.questionnaire[i]._id == nextProps.editModal) {
	            ...
	            if (data.openFrom == undefined && data.closeFrom == undefined || data.openFrom == null && data.closeFrom == null) {
	              ...
	              this.setState({
	                uid: null,
	                openFrom: (0, _moment2.default)(data.openFrom).format('DD/MM/YYYY hh:mm A'),
	                closeFrom: (0, _moment2.default)(data.closeFrom).format('DD/MM/YYYY hh:mm A'),
	                openFromFormat: "DD/MM/YYYY hh:mm A",
	                openFromInputFormat: "DD/MM/YYYY hh:mm A",
	                // openFromMode: "date",  
	                minDate: (0, _moment2.default)(),
	    ...
	    key: 'hideAssignQuestionnaireModal',
	    value: function hideAssignQuestionnaireModal() {
	      //console.log('coming');
	      this.setState({
	        uid: null,
	        showModal: false,
	    ...
	    key: 'handleOpenFrom',
	    value: function handleOpenFrom(newDate) {
	      (0, _moment2.default)(newDate, "DD/MM/YYYY hh:mm A").isValid() ? this.setState({
	        openFrom: newDate,
	        inputFromDate: null
	    ...
	    key: 'handleCloseFrom',
	    value: function handleCloseFrom(newDate) {
	      (0, _moment2.default)(newDate, "DD/MM/YYYY hh:mm A").isValid() ? this.setState({
	        closeFrom: newDate,
	        inputCloseDate: null
	    ...
	    key: 'handleTimeLimit',
	    value: function handleTimeLimit() {
	      this.setState({
	    ...
	    value: function render() {
	      ...
	      var listQuestionnaires = null;
	      var disabledListQuestionnaire = null;
	      if (this.props.questionnaireData && this.props.questionnaireData.length > 0) {
	        var _questionnaire = this.props.questionnaireData;
	        listQuestionnaires = _questionnaire.map(function (questionnaire, index) {
	          return _jsx('option', {
	            value: index
	          }, questionnaire._id, questionnaire.questionnaireName);
	        });
	      }
	      ...
	      if (this.props.editModal != undefined && this.props.editModal != true) {
	        for (var i = 0; i < this.props.topicData.questionnaire.length; i++) {
	          if (this.props.topicData.questionnaire[i]._id == this.props.editModal) {
	            ...
	            disabledListQuestionnaire = _react2.default.createElement(
	              'select',
	              { className: 'form-control', onChange: this.handleQuestionnaire.bind(this), ref: 'questionnaire', disabled: true },
	              _jsx('option', {
	                value: questionnaire.questionnaireId._id
	              }, questionnaire.questionnaireId._id, questionnaire.questionnaireId.questionnaireName)
	            );
	          }
	        }
	      }
	      ...
	      var _state = this.state,
	          openFrom = _state.openFrom,
	          openFromFormat = _state.openFromFormat,
	          openFromInputFormat = _state.openFromInputFormat,
	          openFromMode = _state.openFromMode,
	          closeFrom = _state.closeFrom,
	      ...
	      return _jsx('div', {}, void 0, _react2.default.createElement(_lib.ToastContainer, {
	        ...
	        onHide: this.hideAssignQuestionnaireModal.bind(this)
	      }, void 0, _jsx(_Modal.Header, {
	        closeButton: true
	      }, void 0, _jsx(_Modal.Title, {
	        className: _Admin2.default.popHeadingAll
	        ...
	        className: 'col-md-10'
	      }, void 0, disabledListQuestionnaire != null ? disabledListQuestionnaire : _react2.default.createElement(
	        'select',
	        { id: 'questionnaire', className: 'form-control', onChange: this.handleQuestionnaire.bind(this), ref: 'questionnaire' },
	        listQuestionnaires != null ? listQuestionnaires : _ref3
	      ))), _jsx('div', {
	        className: 'form-group'
	      }, void 0, _jsx('div', {
	        ...
	        type: 'checkbox',
	        id: 'timeLimit',
	        className: _Admin2.default.checkAssignQues,
	        checked: this.state.timeLimit,
	        onChange: this.handleTimeLimit.bind(this)
	      }), _ref4))), _jsx(_reactBootstrap.Col, {
	        sm: 4
	      }, void 0, _jsx('div', {
	        className: 'checkbox'
	      }, void 0, _jsx('label', {
	        ...
	        onChange: this.handleShowResult.bind(this)
	      }), _ref5)))))), this.state.timeLimit ? _jsx('div', {
	        className: 'form-group'
	        ...
	        mode: openFromMode,
	        minDate: minDate
	      }))) : null, this.state.timeLimit ? _jsx('div', {
	        className: 'form-group'
	        ...
	        mode: openFromMode,
	        minDate: minDate
	      }))) : null)), _jsx(_Modal.Footer, {
	        className: _Admin2.default.mainSaveAssign
	      }, void 0, _jsx('div', {
	        className: _Admin2.default.blockSaveAssign
	      }, void 0, _jsx('button', {
	        id: 'cancel',
	        onClick: this.hideAssignQuestionnaireModal.bind(this)
	      }, void 0, _ref8), _jsx('button', {
	        id: 'save',
	        className: cls_btnSaveAssign,
	        onClick: this.assignQuestionnaire
	      }, void 0, _ref9)))));
	    }
	  }]);
	...
	exports.default = (0, _reactRedux.connect)(mapStateToProps)(QuestionnairePopup);
