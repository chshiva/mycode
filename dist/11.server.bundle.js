...
/***/ function(module, exports, __webpack_require__) {
	...
	var ListAssignment = function (_Component) {
	  _inherits(ListAssignment, _Component);
	
	  function ListAssignment(props) {
	    _classCallCheck(this, ListAssignment);
	
	    var _this = _possibleConstructorReturn(this, (ListAssignment.__proto__ || Object.getPrototypeOf(ListAssignment)).call(this, props));
	    ...
	    _this.mainmenu = _RoomMenu.roomAssignmentMainMenu;
	    _this.getData = _this.getData.bind(_this);
	    _this.currentPage = 1;
	    _this.itemsPerPage = 5;
	
	    _this.viewSubmissions = _this.viewSubmissions.bind(_this);
	    _this.editAssignment = _this.editAssignment.bind(_this);
	    _this.delete = _this.delete.bind(_this);
	    _this.setDeleteResponse = _this.setDeleteResponse.bind(_this);
	    _this.mainmenu.menus[0].action = _this.addAssignment.bind(_this);
	  ...
	  _createClass(ListAssignment, [{
	    ...
	    value: function getData(pageParam) {
	      ...
	      this.props.dispatch((0, _RoomActions.RoomAssignmentList)(pageParam, pageParam.currentPage)).then(function (res) {
	    ...
	    key: 'assignedTo',
	    value: function assignedTo(row) {
	      if (row.assignedTo == null) {
	        return _ref;
	      } else {
	        return _jsx('div', {}, void 0, row.assignedTo.topicName);
	      }
	    }
	  }, {
	    key: 'searchFilter',
	    ...
	    key: 'viewSubmissions',
	    value: function viewSubmissions(row) {
	    ...
	    key: 'editAssignment',
	    value: function editAssignment(row) {
	    ...
	    key: 'showAuthorsName',
	    value: function showAuthorsName(row) {
	      return _jsx('div', {}, void 0, row.createdBy.firstname, ' ', row.createdBy.lastname);
	    }
	  }, {
	    key: 'render',
	    value: function render() {
	      ...
	      }, void 0, _jsx('ul', {}, void 0, _ref5, _ref6, _jsx('li', {}, void 0, this.props.roomData.data.roomName)));
	
	      var objDisp = [{ fieldName: "assignmentName", title: _ref7, type: "text" }, { title: _ref8, type: "function", callback: this.assignedTo }, { title: _ref9, type: "function", callback: this.editAssignment }, { title: _ref10, type: "function", callback: this.delete }, { title: _ref11, type: "function", callback: this.viewSubmissions }];
	
	      if (this.props.loggedInData && this.props.loggedInData.data) {
	        var role = this.props.loggedInData.data.role;
	        if (role == _roles.Roles.Lmsadmin || role == _roles.Roles.Admin) {
	          objDisp.splice(2, 0, { title: _ref12, type: "function", callback: this.showAuthorsName });
	        }
	      }
	
	      var filter = [{ type: 'search', id: 'assignmentSearch', selectedfilter: this.searchFilter }];
	      ...
	      return _jsx('div', {}, void 0, _react2.default.createElement(_lib.ToastContainer, {
	        ...
	        data: this.props.roomData.assignmentList,
	...
	var _initialiseProps = function _initialiseProps() {
	  ...
	  this.addAssignment = function () {
	    var roomId = _this3.props.params.cid;
	    _reactRouter.browserHistory.push('/admin/room/assignment/add/' + roomId);
	  };
	  ...
	  this.deleteAssignment = function (e) {
	    ...
	    alertify.confirm(_this3.props.intlData.messages.warning, _this3.props.intlData.messages.delete_assignment_alert, function (result) {
	      if (result) {
	        var obj = {
	          roomId: props.params.cid,
	          assignmentId: id
	        };
	        props.dispatch((0, _RoomActions.deleteAssignmentRequest)(obj, '')).then(function (res) {
	          return response(res);
	        });
	      }
	...
	exports.default = (0, _reactRedux.connect)(mapStateToProps)(ListAssignment);
