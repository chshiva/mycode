...
/***/ function(module, exports, __webpack_require__) {
	...
	var _PlagiarismView = __webpack_require__(459);
	
	var _PlagiarismView2 = _interopRequireDefault(_PlagiarismView);
	...
	var _ref2 = _jsx(_SubMenu2.default, {
	  data: _RoomMenu.submissionViewSubMenu
	});
	
	var _ref3 = _jsx(_Uploading2.default, {
	  type: 'loading'
	});
	
	var _ref4 = _jsx(_Uploading2.default, {
	  type: 'loading'
	});
	
	var ViewPlagiarism = function (_Component) {
	  _inherits(ViewPlagiarism, _Component);
	
	  function ViewPlagiarism(props) {
	    _classCallCheck(this, ViewPlagiarism);
	
	    var _this = _possibleConstructorReturn(this, (ViewPlagiarism.__proto__ || Object.getPrototypeOf(ViewPlagiarism)).call(this, props));
	    ...
	    _Validator2.default.activeSubMenu(_RoomMenu.submissionViewSubMenu, "plagiarism");
	  ...
	  _createClass(ViewPlagiarism, [{
	    ...
	    value: function setdata(result) {
	      ...
	      if (result && result.data && result.data._id) {
	        ...
	        this.props.dispatch((0, _RoomActions.getPlagiarismData)(obj));
	      }
	    }
	  }, {
	    ...
	    value: function componentWillUnmount() {
	      this.props.dispatch((0, _RoomActions.ClearPlagiarism)());
	    }
	  }, {
	    key: 'setPlagiarism',
	    ...
	    value: function render() {
	      ...
	      return _jsx('div', {}, void 0, this.state.credits != '' && this.state.credits != null && this.state.credits != undefined ? _jsx('div', {}, void 0, _react2.default.createElement(_lib.ToastContainer, {
	      ...
	      }, void 0, _ref2), this.props && this.props.roomData && this.props.roomData.plagiarismData.length >= 0 ? _jsx(_PlagiarismView2.default, {
	        roomData: this.props.loggedInData.data,
	        plagiarismData: this.props.roomData.plagiarismData
	      }) : _jsx('div', {
	...
	exports.default = (0, _reactRedux.connect)(mapStateToProps)(ViewPlagiarism);
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.PlagiarismView = undefined;
	...
	var _ref = _jsx('p', {}, void 0, _jsx(_reactIntl.FormattedMessage, {
	  id: 'title_created_plagiarism_details'
	}));
	...
	var _ref5 = _jsx('label', {
	  htmlFor: 'Number Of CopiedWords'
	}, void 0, _jsx(_reactIntl.FormattedMessage, {
	  id: 'copied_words'
	}), ':');
	
	var _ref6 = _jsx('label', {
	  htmlFor: 'Comparison Report'
	}, void 0, _jsx(_reactIntl.FormattedMessage, {
	  id: 'comparison_report'
	}), ':');
	
	var _ref7 = _jsx('label', {
	  htmlFor: 'CachedVersion'
	}, void 0, _jsx(_reactIntl.FormattedMessage, {
	  id: 'cached_version'
	}), ':');
	...
	var _ref10 = _jsx('label', {
	  htmlFor: 'Embeded Comparison'
	}, void 0, _jsx(_reactIntl.FormattedMessage, {
	  id: 'embeded_comparison'
	}), ':');
	
	var _ref11 = _jsx('span', {}, void 0, 'No Data Copied');
	
	var PlagiarismView = exports.PlagiarismView = function (_Component) {
	  _inherits(PlagiarismView, _Component);
	
	  function PlagiarismView() {
	    _classCallCheck(this, PlagiarismView);
	
	    return _possibleConstructorReturn(this, (PlagiarismView.__proto__ || Object.getPrototypeOf(PlagiarismView)).apply(this, arguments));
	  }
	
	  _createClass(PlagiarismView, [{
	    key: 'componentWillReceiveProps',
	    value: function componentWillReceiveProps(nextProps) {
	    ...
	    key: 'render',
	    value: function render() {
	      var plagiarismData = this.props.plagiarismData;
	      ...
	      return _jsx('div', {
	        ...
	        className: _Admin2.default.plagiarism
	      }, void 0, plagiarismData.length > 0 ? plagiarismData.map(function (plagiarismInfo, i) {
	        return _jsx('li', {}, i, _jsx('div', {
	          className: cls_inlineEditGroup
	        }, void 0, _ref3, _jsx('div', {
	          className: _Admin2.default.inlineEdit
	        }, void 0, plagiarismInfo.URL)), _jsx('div', {
	          className: cls_inlineEditGroup
	        }, void 0, _ref4, _jsx('div', {
	          className: _Admin2.default.inlineEdit
	        }, void 0, plagiarismInfo.Percents)), _jsx('div', {
	          className: cls_inlineEditGroup
	        }, void 0, _ref5, _jsx('div', {
	          className: _Admin2.default.inlineEdit
	        }, void 0, plagiarismInfo.NumberOfCopiedWords)), _jsx('div', {
	          className: cls_inlineEditGroup
	        }, void 0, _ref6, _jsx('div', {
	          className: _Admin2.default.inlineEdit
	        }, void 0, plagiarismInfo.ComparisonReport)), _jsx('div', {
	          className: cls_inlineEditGroup
	        }, void 0, _ref7, _jsx('div', {
	          className: _Admin2.default.inlineEdit
	        }, void 0, plagiarismInfo.CachedVersion)), _jsx('div', {
	          className: cls_inlineEditGroup
	        }, void 0, _ref8, _jsx('div', {
	          className: _Admin2.default.inlineEdit
	        }, void 0, plagiarismInfo.Title)), _jsx('div', {
	          className: cls_inlineEditGroup
	        }, void 0, _ref9, _jsx('div', {
	          className: _Admin2.default.inlineEdit
	        }, void 0, plagiarismInfo.Introduction)), _jsx('div', {
	          className: cls_inlineEditGroup
	        }, void 0, _ref10, _jsx('div', {
	          className: _Admin2.default.inlineEdit
	        }, void 0, plagiarismInfo.EmbededComparison)));
	      }) : _ref11)), _jsx('hr', {
	...
	exports.default = PlagiarismView;
