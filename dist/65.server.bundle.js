...
/***/ function(module, exports, __webpack_require__) {
	...
	var _ref2 = _jsx('ul', {}, void 0, _jsx('li', {}, void 0, _jsx(_reactIntl.FormattedMessage, {
	  id: 'you_are_in_corporate_list_panel'
	})));
	...
	var ListCorporate = function (_Component) {
	  _inherits(ListCorporate, _Component);
	
	  function ListCorporate(props) {
	    _classCallCheck(this, ListCorporate);
	
	    var _this = _possibleConstructorReturn(this, (ListCorporate.__proto__ || Object.getPrototypeOf(ListCorporate)).call(this, props));
	    ...
	    _this.schema = _CorporateSchema.corporateSchema;
	    _this.res = {};
	
	    _this.submenu = _Validator2.default.activeSubMenu(_CorporateMenu.corporateViewSubMenu, "lnkCorporate");
	    _this.mainmenu = _CorporateMenu.corporateMainMenu;
	    _this.getData = _this.getData.bind(_this);
	
	    _this.currentPage = 1;
	    _this.itemsPerPage = 5;
	
	    _this.viewCorporate = _this.viewCorporate.bind(_this);
	    _this.mainmenu.menus[0].action = _this.clearError.bind(_this);
	    _this.searchFilter = _this.searchFilter.bind(_this);
	    return _this;
	  }
	
	  _createClass(ListCorporate, [{
	    ...
	    value: function getData(pageParam) {
	      ...
	      this.props.dispatch((0, _CorporateActions.CorporateList)(pageParam, pageParam.currentPage)).then(function (res) {
	    ...
	    key: 'viewCorporate',
	    value: function viewCorporate(row) {
	      var link = "/admin/corporate/view/" + row._id;
	    ...
	    key: 'address',
	    value: function address(row) {
	      return _jsx('div', {}, void 0, row.address.state, ', ', row.address.country);
	    }
	  }, {
	    key: 'contactName',
	    value: function contactName(row) {
	      return _jsx('div', {}, void 0, row.contactDetails.name);
	    }
	  }, {
	    key: 'contactPhoneNumber',
	    value: function contactPhoneNumber(row) {
	      return _jsx('div', {}, void 0, row.contactDetails.phoneNo[1]);
	    }
	  }, {
	    key: 'clearError',
	    value: function clearError() {
	      ...
	      if (response) {
	        this.props.dispatch((0, _CorporateActions.UpdateCorporateSchema)(response));
	        _reactRouter.browserHistory.push('/admin/corporate/new');
	      }
	    }
	  }, {
	    key: 'searchFilter',
	    ...
	    key: 'showCorporateDetails',
	    value: function showCorporateDetails(row) {
	      var link = "/admin/corporate/view/" + row._id;
	      return _jsx(_reactRouter.Link, {
	        id: 'view',
	        className: _Admin2.default.removeStyle,
	        to: link
	      }, void 0, _jsx('div', {}, void 0, row.businessName, ' '));
	    }
	  }, {
	    key: 'render',
	    value: function render() {
	      ...
	      var objDisp = [{ fieldName: "businessId", title: _ref3, type: "text", sort: true, dbName: "businessId" }, { title: _ref4, type: "function", callback: this.showCorporateDetails, sort: true, dbName: "businessName" }, { fieldName: "businessType", title: _ref5, type: "text", sort: true, dbName: "businessType" }, { title: _ref6, type: "function", callback: this.contactName, sort: true, dbName: "contactDetails.name" }, { title: _ref7, type: "function", callback: this.contactPhoneNumber }, { title: _ref8, type: "function", callback: this.address, sort: true, dbName: "address.state" }, { title: _ref9, type: "function", callback: this.viewCorporate }];
	      ...
	      return _jsx('div', {}, void 0, _react2.default.createElement(_lib.ToastContainer, {
	        ...
	        data: this.props.corporateData.dataList,
	...
	exports.default = (0, _reactRedux.connect)(mapStateToProps)(ListCorporate);
