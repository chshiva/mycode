...
/***/ function(module, exports, __webpack_require__) {
	...
	var EditRoom = function (_Component) {
	  ...
	  function EditRoom(props) {
	    ...
	    _this.save = function (event) {
	      if (_this.form.expiryDate && _this.form.expiryDate == "") {
	        _this.form['expiryDate'] = moment().endOf('day').utc().toDate();
	      }
	      ...
	      if (response.error.length > 0) {
	        ...
	        var data = {};
	        data['_id'] = _this.props.roomData.data._id;
	        data['corporateId._id'] = _this.props.roomData.data["corporateId._id"];
	        data['corporateId.businessName'] = _this.props.roomData.data["corporateId.businessName"];
	        data['corporateId.id'] = _this.props.roomData.data["corporateId.id"];
	        data['selPackage._id'] = _this.props.roomData.data["selPackage._id"];
	        data['selPackage.features'] = _this.props.roomData.data["selPackage.features"];
	        data['selPackage.id'] = _this.props.roomData.data["selPackage.id"];
	        data['selPackage.packageName'] = _this.props.roomData.data["selPackage.packageName"];
	        data['selPackage.packageValidity'] = _this.props.roomData.data["selPackage.packageValidity"];
	
	        _this.props.dispatch((0, _RoomActions.UpdateRoomSchema)(_this.schema, data));
	      } else {
	        _this.setState({ activeIcon: event.currentTarget.id });
	        _this.form['expiryDate'] = moment(_this.form['expiryDate']).endOf('day').utc().toDate();
	        _this.props.dispatch((0, _RoomActions.UpdateRoom)(_this.form, _this.props.params.cid)).then(function (res) {
	    ...
	    _this.setresponse = function (response) {
	      if (response.status) {
	        _reactRouter.browserHistory.push('/admin/room/view/' + _this.props.params.cid);
	      } else {
	    ...
	    _this.schema = _RoomSchema.editRoomSchema;
	    _this.res = {};
	    _this.roomData = {};
	    _this.roomName = "";
	
	    _this.mainmenu = _RoomMenu.roomEditMainMenu;
	    ...
	    _this.submenu = _Validator2.default.activeSubMenu(_RoomMenu.roomNoTopicSubMenu, "lnkMyRoom");
	  ...
	  _createClass(EditRoom, [{
	    ...
	    value: function setuserdata(result) {
	      ...
	      if (result && result.data && result.data._id) {
	        ...
	        this.props.dispatch((0, _RoomActions.getRoomData)(obj, '/admin/room/edit/' + obj.roomId)).then(function (res) {
	    ...
	    value: function setdata(result) {
	      ...
	      this.props.dispatch((0, _RoomActions.RoomStore)(new _DataObject2.default(result.data)));
	    }
	    ...
	    value: function render() {
	      ...
	      */
	      ...
	      if (this.roomData.selPackage && this.roomData.selPackage.features.indexOf("Topics") != -1) {
	        this.submenu = _Validator2.default.activeSubMenu(_RoomMenu.roomEditSubMenu, "lnkMyRoom");
	...
	exports.default = (0, _reactRedux.connect)(mapStateToProps)(EditRoom);
