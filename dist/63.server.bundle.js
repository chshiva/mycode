...
/***/ function(module, exports, __webpack_require__) {
	...
	var _ref2 = _jsx('ul', {}, void 0, _jsx('li', {}, void 0, _jsx(_reactIntl.FormattedMessage, {
	  id: 'you_are_in_package_list_panel'
	})));
	...
	var ListPackage = function (_Component) {
	  _inherits(ListPackage, _Component);
	
	  function ListPackage(props) {
	    _classCallCheck(this, ListPackage);
	
	    var _this = _possibleConstructorReturn(this, (ListPackage.__proto__ || Object.getPrototypeOf(ListPackage)).call(this, props));
	    ...
	    _this.submenu = _Validator2.default.activeSubMenu(_PackageMenu.packageListSubMenu, "lnkPackage");
	    _this.mainmenu = _PackageMenu.packageMainMenu;
	    _this.getData = _this.getData.bind(_this);
	
	    _this.currentPage = 1;
	    _this.itemsPerPage = 5;
	
	    _this.viewPackage = _this.viewPackage.bind(_this);
	  ...
	  _createClass(ListPackage, [{
	    ...
	    value: function getData(pageParam) {
	      ...
	      this.props.dispatch((0, _PackageActions.PackageList)(pageParam, pageParam.currentPage)).then(function (res) {
	        return _this2.pageData(res);
	      });
	    }
	  }, {
	    key: 'pageData',
	    value: function pageData(res) {
	      // console.log(res);
	    ...
	    key: 'viewPackage',
	    value: function viewPackage(row) {
	      var link = "/admin/package/view/" + row._id;
	    ...
	    key: 'createdByName',
	    value: function createdByName(row) {
	    ...
	    value: function clearError() {
	      ...
	      if (response) {
	        this.props.dispatch((0, _PackageActions.UpdatePackageSchema)(response));
	        _reactRouter.browserHistory.push('/admin/package/new');
	      }
	    }
	  }, {
	    key: 'showFormattedDate',
	    value: function showFormattedDate(row) {
	      return _jsx('div', {}, void 0, (0, _moment2.default)(row.packageValidity).format('DD-MM-YYYY'));
	    }
	  }, {
	    key: 'searchFilter',
	    ...
	    key: 'showPackageName',
	    value: function showPackageName(row) {
	      var link = "/admin/package/view/" + row._id;
	      return _jsx(_reactRouter.Link, {
	        id: 'viewPackage',
	        className: _Admin2.default.removeStyle,
	        to: link
	      }, void 0, _jsx('div', {}, void 0, row.packageName, ' '));
	    }
	  }, {
	    key: 'render',
	    value: function render() {
	      ...
	      var objDisp = [{ title: _ref3, type: "function", sort: true, callback: this.showPackageName, dbName: "packageName" }, { title: _ref4, type: "function", sort: true, callback: this.showFormattedDate, dbName: "packageValidity" }, { fieldName: "userCount", title: _ref5, type: "text", sort: true, dbName: "userCount" }, { fieldName: "continuousPresence", title: _ref6, type: "text", sort: true, dbName: "continuousPresence" }, { fieldName: "serverLocation", title: _ref7, sort: true, type: "text", dbName: "serverLocation" }, { title: _ref8, type: "function", callback: this.viewPackage }];
	      ...
	      return _jsx('div', {}, void 0, _react2.default.createElement(_lib.ToastContainer, {
	        ...
	        data: this.props.packageData.dataList,
	...
	exports.default = (0, _reactRedux.connect)(mapStateToProps)(ListPackage);
