...
/***/ function(module, exports, __webpack_require__) {
	...
	var _ref19 = _jsx('li', {}, void 0, _jsx(_reactRouter.Link, {
	  to: '/admin/room/list'
	...
	var ListTopic = function (_Component) {
	  _inherits(ListTopic, _Component);
	
	  function ListTopic(props) {
	    _classCallCheck(this, ListTopic);
	
	    var _this = _possibleConstructorReturn(this, (ListTopic.__proto__ || Object.getPrototypeOf(ListTopic)).call(this, props));
	    ...
	    _this.mainmenu = _RoomMenu.roomTopicMainMenu;
	    ...
	    _this.uploadOnTopic = _this.uploadOnTopic.bind(_this);
	    _this.deleteRoomTopic = _this.deleteRoomTopic.bind(_this);
	    _this.topicEnable = _this.topicEnable.bind(_this);
	    //this.mainmenu.menus[0].action = this.clearError.bind(this);
	
	    _this.mainmenu.menus[0].action = _this.addtopic.bind(_this);
	    ...
	    _this.submenu.menus[7].action = _this.listCertificates.bind(_this);
	  ...
	  _createClass(ListTopic, [{
	    ...
	    value: function getData(pageParam) {
	      ...
	      this.props.dispatch((0, _RoomActions.RoomTopicList)(pageParam, pageParam.currentPage)).then(function (res) {
	    ...
	    key: 'deleteRoomTopic',
	    value: function deleteRoomTopic(row) {
	      var viewTopicDelete = row.createdBy == this.props.loggedInData.data._id ? _jsx('a', {
	        id: row._id,
	        onClick: this.deletetopic
	      }, void 0, _ref3) : "Not Allowed";
	      return viewTopicDelete;
	    }
	  }, {
	    key: 'uploadOnTopic',
	    value: function uploadOnTopic(row) {
	      //console.log(row)
	    ...
	    value: function assignQuestionnaire(row) {
	    ...
	    value: function showTopicName(row) {
	      ...
	      return _jsx(_reactRouter.Link, {
	        ...
	        to: link
	      }, void 0, _jsx('div', {}, void 0, row.topicName, ' '));
	    }
	  }, {
	    key: 'topicEnable',
	    value: function topicEnable(row) {
	      var viewTopicEnable = row.createdBy == this.props.loggedInData.data._id ? _jsx('input', {
	        type: 'checkbox',
	        id: row._id,
	        value: row.topicEnable,
	        onChange: this.handleEnableTopic,
	        checked: row.topicEnable
	      }) : "Not Allowed ";
	    ...
	    value: function render() {
	      ...
	      if (role != _roles.Roles.Superadmin) {
	        var objDisp = [{ title: _ref6, type: "functon", callback: this.showTopicName, sort: true, dbName: 'topicName' }, { title: _ref7, type: "function", callback: this.description, sort: true, dbName: 'description' }, { title: _ref8, type: "function", callback: this.editRoomTopic }, { title: _ref9, type: "function", callback: this.deleteRoomTopic }, { title: _ref10, type: "function", callback: this.viewRoomTopic }, { title: _ref11, type: "function", callback: this.uploadOnTopic }, { title: _ref12, type: "function", callback: this.assignQuestionnaire }, { title: _ref13, type: "function", callback: this.topicEnable }];
	      } else {
	        var objDisp = [{ title: _ref14, type: "functon", callback: this.showTopicName, sort: true, dbName: 'topicName' }, { title: _ref15, type: "function", callback: this.description, sort: true, dbName: 'description' }, { title: _ref16, type: "function", callback: this.viewRoomTopic }, { title: _ref17, type: "function", callback: this.uploadOnTopic }, { title: _ref18, type: "function", callback: this.assignQuestionnaire }];
	      }
	      ...
	      }, void 0, _jsx('ul', {}, void 0, _ref19, _ref20, _jsx('li', {}, void 0, this.props.roomData.data.roomName)));
	      return _jsx('div', {}, void 0, _react2.default.createElement(_lib.ToastContainer, {
	        toastMessageFactory: ToastMessageFactory,
	        ref: 'room_container',
	        className: 'toast-top-right'
	      }), _jsx(_DataTable2.default, {
	        data: this.props.roomData.topicList,
	...
	var _initialiseProps = function _initialiseProps() {
	  ...
	  this.deletetopic = function (e) {
	    ...
	    alertify.confirm(_this3.props.intl.messages.warning, _this3.props.intl.messages.delete_topic_alert, function (result) {
	      if (result) {
	        var obj = {
	        ...
	        props.dispatch((0, _RoomActions.DeleteTopic)(obj, '')).then(function (res) {
	  ...
	  this.setdeleteresponse = function (res, id) {
	    ...
	    _this3.confObject.sendMessage(obj, 0);
	  ...
	  this.addtopic = function () {
	    ...
	    var roomId = _this3.props.params.cid;
	    if (response) {
	      _this3.props.dispatch((0, _RoomActions.UpdateRoomSchema)(response));
	      _reactRouter.browserHistory.push('/admin/room/addtopic/' + roomId);
	    }
	  };
	  ...
	  this.handleEnableTopic = function (e) {
	    var topicEnable = e.currentTarget.value == "true" ? false : true;
	    var id = e.currentTarget.id;
	    _this3.props.dispatch((0, _RoomActions.handleTopicEnable)(topicEnable, id)).then(function (res) {
	      return _this3.topicEnableResponse(res);
	    });
	  };
	
	  this.topicEnableResponse = function (res) {
	    var tid = res && res.topicData && res.topicData.id ? res.topicData.id : '';
	...
	exports.default = (0, _reactRedux.connect)(mapStateToProps)(ListTopic);
