...
/***/ function(module, exports, __webpack_require__) {
	...
	var _ref4 = _jsx(_TopMenu2.default, {
	  data: _RoomMenu.addUserViewMainMenu
	});
	...
	var AddUser = function (_Component) {
	  ...
	  function AddUser(props) {
	    ...
	    _this.mainmenu = _RoomMenu.addUserViewMainMenu;
	    _this.mainmenu.menus[0].action = _this.showOrHideAddContacts.bind(_this);
	
	    /* default set submenu without topic */
	    _this.submenu = _Validator2.default.activeSubMenu(_RoomMenu.roomNoTopicSubMenu, "lnkRoomUser");
	  ...
	  _createClass(AddUser, [{
	    ...
	    value: function setdata(result) {
	      ...
	      if (result && result.data && result.data._id) {
	        ...
	        this.props.dispatch((0, _RoomActions.getRoomData)(obj, '/admin/room/adduser/' + roomId)).then(function (res) {
	    ...
	    value: function handleValue(userId) {
	      ...
	      // console.log(obj);
	      this.props.dispatch((0, _RoomActions.addRoomUser)(obj)).then(function (res) {
	    ...
	    value: function render() {
	      ...
	      if (this.props.roomData && this.props.roomData.data && !_.isEmpty(this.props.roomData.data)) {
	        ...
	        if (dataObject.selPackage && dataObject.selPackage.features && dataObject.selPackage.features.indexOf("Topics") != -1) {
	          this.submenu = _Validator2.default.activeSubMenu(_RoomMenu.roomEditSubMenu, "lnkRoomUser");
	...
	exports.default = (0, _reactRedux.connect)(mapStateToProps)(AddUser);
