...
/***/ function(module, exports, __webpack_require__) {
	...
	var _ref6 = _jsx('div', {}, void 0, 'Loading...');
	
	var EditTopic = function (_Component) {
	  _inherits(EditTopic, _Component);
	
	  function EditTopic(props) {
	    _classCallCheck(this, EditTopic);
	
	    var _this = _possibleConstructorReturn(this, (EditTopic.__proto__ || Object.getPrototypeOf(EditTopic)).call(this, props));
	    ...
	    _this.save = function (event) {
	      ...
	      if (response.error.length > 0) {
	        ...
	        _this.props.dispatch((0, _RoomActions.UpdateRoomSchema)(_this.schema));
	      } else {
	        var obj = _this.form;
	        ...
	        _this.props.dispatch((0, _RoomActions.SaveRoomTopic)(obj)).then(function (res) {
	    ...
	    _this.mainmenu = _RoomMenu.roomEditTopicNewMainMenu;
	  ...
	  _createClass(EditTopic, [{
	    ...
	    value: function componentWillMount() {
	      ...
	      this.props.dispatch((0, _LoginActions.isLoggedIn)(_AuthController2.default.getSession(), '/admin/room/edittopic/' + topicId + '/' + roomId)).then(function (res) {
	        return _this2.setuserdata(res);
	      });
	    }
	  }, {
	    ...
	    value: function setuserdata(result) {
	      ...
	      if (result && result.data && result.data._id) {
	        ...
	        var response = _Validator2.default.freeError(this.schema);
	        if (response) {
	          this.schema = response;
	          this.props.dispatch((0, _RoomActions.UpdateRoomSchema)(this.schema));
	          this.props.dispatch((0, _RoomActions.getRoomTopicData)(obj, '/admin/room/edittopic/' + obj.topicId + '/' + obj.roomId)).then(function (res) {
	    ...
	    value: function render() {
	      ...
	      }, void 0, this.props.roomData.data.roomName)), _ref3, _jsx('li', {}, void 0, _jsx(_reactRouter.Link, {
	        onClick: this.listtopic
	      }, void 0, _ref4)), _ref5, _jsx('li', {}, void 0, this.props.roomData.topicdata.topicName)));
	...
	exports.default = (0, _reactRedux.connect)(mapStateToProps)(EditTopic);
