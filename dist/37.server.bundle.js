...
/***/ function(module, exports, __webpack_require__) {
	...
	var _FeedbackActions = __webpack_require__(433);
	...
	var _FeedbackMenu = __webpack_require__(434);
	...
	var ListFeedback = function (_Component) {
	  _inherits(ListFeedback, _Component);
	
	  function ListFeedback(props) {
	    _classCallCheck(this, ListFeedback);
	
	    var _this = _possibleConstructorReturn(this, (ListFeedback.__proto__ || Object.getPrototypeOf(ListFeedback)).call(this, props));
	
	    _this.state = {
	      showFeedback: false,
	      isLmsadmin: false,
	      values: ['Poor', 'Average', 'Good', 'Excellent'],
	      labelArrayLMS: [{ label: 'Video Quality', id: 'videoQuality' }, { label: 'Audio Quality', id: 'audioQuality' }, { label: 'Content Sharing', id: 'contentSharing' }, { label: 'Knowledgeable Session', id: 'knowlegableSession' }, { label: 'Instructor Skills', id: 'instructorSkills' }],
	      labelArrayCONF: [{ label: 'Video Quality', id: 'videoQuality' }, { label: 'Audio Quality', id: 'audioQuality' }, { label: 'Content Sharing', id: 'contentSharing' }],
	    ...
	    _this.res = {};
	    _this.submenu = _FeedbackMenu.feedbackListSubMenu;
	    _this.mainmenu = _FeedbackMenu.feedbackListMainMenu;
	    _this.getData = _this.getData.bind(_this);
	    //this.clear = this.clear.bind(this);
	    _this.currentPage = 1;
	    _this.itemsPerPage = 5;
	
	    _this.viewFeedback = _this.viewFeedback.bind(_this);
	    _this.mainmenu.menus[0].action = _this.showOrHideFeedback.bind(_this);
	    return _this;
	  }
	
	  _createClass(ListFeedback, [{
	    key: 'componentWillReceiveProps',
	    value: function componentWillReceiveProps(nextProps) {
	      if (nextProps.feedbackData.success != '') {
	        this.refs.feedback_container.success(nextProps.feedbackData.success + ' ', '');
	        this.props.dispatch((0, _FeedbackActions.ClearRoom)());
	      }
	    }
	  }, {
	    ...
	    value: function setdata(result) {
	      if (result && result.data && result.data._id) {
	        ...
	        if (_roles.Roles.Lmsadmin == this.props.loggedInData.data.role) {
	    ...
	    key: 'viewFeedback',
	    value: function viewFeedback(row) {
	    ...
	    value: function clearError() {
	      ...
	      if (response) {
	        this.props.dispatch((0, _FeedbackActions.UpdateFeedbackSchema)(response));
	        _reactRouter.browserHistory.push('/admin/feedback/list');
	      }
	    }
	  }, {
	    ...
	    key: 'handleValue',
	    value: function handleValue(userId) {
	      this.setState({ showFeedback: !this.state.showFeedback });
	    }
	    // handleRatingClick() {
	    ...
	    value: function render() {
	      ...
	      var objDisp = [{ fieldName: "firstname", title: _ref2, type: "text" }, { fieldName: "rating", title: _ref3, type: "text" }, { fieldName: "comment", title: _ref4, type: "text" }, { title: _ref5, type: "function", callback: this.viewFeedback }];
	      var startRatingNumber = 1;
	      var endRatingNumber = 5;
	      return _jsx('div', {}, void 0, _react2.default.createElement(_lib.ToastContainer, {
	        toastMessageFactory: ToastMessageFactory,
	        ref: 'room_container',
	        className: 'toast-top-right'
	      }), _jsx(_DataTable2.default, {
	        data: this.props.feedbackData.data,
	        count: 0,
	      ...
	      }), _jsx(_Feedback2.default, {
	        showModal: this.state.showFeedback,
	        radioButtonOptions: this.state.values,
	        radioGroupLabels: this.state.isLmsadmin ? this.state.labelArrayLMS : this.state.labelArrayCONF,
	        overAllRatingLabel: this.state.numberValuesLabel,
	        overAllRatingRadioOptions: this.state.numberValues,
	        feedbackCommentLabel: this.state.feedbackComment,
	        userId: this.props.loggedInData.data._id,
	        roomName: this.props.virtualRoomName,
	        hidecallback: this.showOrHideFeedback.bind(this)
	      }));
	    }
	  }]);
	...
	exports.default = (0, _reactRedux.connect)(mapStateToProps)(ListFeedback);
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.feedbackListSubMenu = exports.feedbackListMainMenu = undefined;
	...
	var feedbackListMainMenu = exports.feedbackListMainMenu = {
		...
		//SubMenu
	};var feedbackListSubMenu = exports.feedbackListSubMenu = {
		menus: [{ _id: "lnkFeedback", text: _jsx(_reactIntl.FormattedMessage, {
				id: 'all_feedback'
			}), actionType: "URL", action: "/admin/feedback/list", active: "active" }]
	};
