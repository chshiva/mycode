...
/***/ function(module, exports, __webpack_require__) {
	...
	var _ref2 = _jsx('ul', {}, void 0, _jsx('li', {}, void 0, _jsx(_reactIntl.FormattedMessage, {
	  id: 'you_are_in_location_list_panel'
	})));
	...
	var ListLocation = function (_Component) {
	  _inherits(ListLocation, _Component);
	
	  function ListLocation(props) {
	    _classCallCheck(this, ListLocation);
	
	    var _this = _possibleConstructorReturn(this, (ListLocation.__proto__ || Object.getPrototypeOf(ListLocation)).call(this, props));
	    ...
	    _this.submenu = _Validator2.default.activeSubMenu(_LocationMenu.locationlistSubMenu, "lnkListLocation");
	    _this.mainmenu = _LocationMenu.locationListMainMenu;
	  ...
	  _createClass(ListLocation, [{
	    ...
	    value: function getData(pageParam) {
	      ...
	      this.props.dispatch((0, _LocationActions.LocationList)(pageParam, pageParam.currentPage)).then(function (res) {
	    ...
	    value: function userView(row) {
	      var rowId = row._id;
	      var viewlink = "/admin/location/view/" + rowId;
	    ...
	    value: function clearError() {
	      ...
	      if (response) {
	        this.props.dispatch((0, _LocationActions.UpdateLocationSchema)(response));
	        _reactRouter.browserHistory.push('/admin/location/new');
	      }
	    }
	  }, {
	    key: 'locationDesc',
	    value: function locationDesc(row) {
	      if (row.description.length > 10) {
	        var locationDesc = row.description.substring(0, 10) + '...';
	        return _jsx('div', {}, void 0, locationDesc);
	      } else {
	    ...
	    value: function showLocationDetails(row) {
	      var rowId = row._id;
	      var link = "/admin/location/view/" + rowId;
	      return _jsx(_reactRouter.Link, {
	        className: _Admin2.default.removeStyle,
	        to: link
	      }, void 0, _jsx('div', {}, void 0, row.locationName, ' '));
	    }
	  }, {
	    key: 'render',
	    value: function render() {
	      ...
	      var objDisp = [{ title: _ref3, type: "function", callback: this.showLocationDetails }, { title: _ref4, type: "function", callback: this.locationDesc }, { title: _ref5, type: "function", callback: this.userView }];
	      ...
	      return _jsx('div', {}, void 0, _react2.default.createElement(_lib.ToastContainer, {
	        ...
	        data: this.props.locationData.dataList,
	...
	exports.default = (0, _reactRedux.connect)(mapStateToProps)(ListLocation);
