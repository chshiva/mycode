...
/***/ function(module, exports, __webpack_require__) {
	...
	var _ref4 = _jsx(_TopMenu2.default, {
	  data: _RoomMenu.roomViewMainMenu
	});
	
	var ViewRoom = function (_Component) {
	  _inherits(ViewRoom, _Component);
	
	  function ViewRoom(props) {
	    _classCallCheck(this, ViewRoom);
	
	    var _this = _possibleConstructorReturn(this, (ViewRoom.__proto__ || Object.getPrototypeOf(ViewRoom)).call(this, props));
	
	    _initialiseProps.call(_this);
	
	    _this.state = { loading: true };
	    _this.mainmenu = _RoomMenu.roomViewMainMenu;
	    _this.schema = _RoomSchema.editRoomSchema;
	
	    _this.mainmenu.menus[2].action = _this.edit.bind(_this); //this.save.bind(this);
	    _this.mainmenu.menus[1].action = _this.deleteRoom.bind(_this);
	  ...
	  _createClass(ViewRoom, [{
	    ...
	    value: function setdata(result) {
	      ...
	      if (result && result.data && result.data._id) {
	        ...
	        this.props.dispatch((0, _RoomActions.getRoomData)(obj, '/admin/room/view/' + roomId)).then(function (res) {
	          return _this2.setLoading(res);
	        });
	      }
	    }
	  }, {
	    key: 'setLoading',
	    value: function setLoading(res) {
	    ...
	    value: function render() {
	      ...
	      }, void 0, _jsx('ul', {}, void 0, _ref2, _ref3, _jsx('li', {}, void 0, this.props.roomData.data.roomName))), _ref4), _jsx('div', {
	        className: cls_isubmenu
	      }, void 0, _jsx(_SubMenu2.default, {
	        data: this.submenu
	      })), _jsx(_RoomView2.default, {
	...
	var _initialiseProps = function _initialiseProps() {
	  ...
	  this.edit = function () {
	    ...
	    if (response) {
	      ...
	      _reactRouter.browserHistory.push('/admin/room/edit/' + roomId);
	    }
	  };
	  ...
	  this.deleteRoom = function () {
	    ...
	    alertify.confirm(_this3.props.intlData.messages.warning, _this3.props.intlData.messages.delete_room_alert, function (result) {
	      if (result) {
	        var obj = {
	          roomId: roomId
	        };
	        props.dispatch((0, _RoomActions.DeleteRoom)(obj, '/admin/room/view/' + roomId)).then(function (res) {
	          return response(res);
	        });
	      }
	  ...
	  this.setresponse = function (response) {
	    if (response.status) {
	      _reactRouter.browserHistory.push('/admin/room/list');
	    } else {
	      _this3.refs.room_container.error(response.error + ' ', '');
	    }
	  };
	...
	exports.default = (0, _reactRedux.connect)(mapStateToProps)(ViewRoom);
