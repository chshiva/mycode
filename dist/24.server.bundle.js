...
/***/ function(module, exports, __webpack_require__) {
	...
	var EditPackage = function (_Component) {
	  _inherits(EditPackage, _Component);
	
	  function EditPackage(props) {
	    _classCallCheck(this, EditPackage);
	
	    var _this = _possibleConstructorReturn(this, (EditPackage.__proto__ || Object.getPrototypeOf(EditPackage)).call(this, props));
	
	    _this.save = function () {
	      //console.log("this.form === ",this.form);
	      if (_this.form.packageValidity == "") {
	        _this.form['packageValidity'] = moment().endOf('day').utc().toDate();
	      }
	      ...
	      if (response.error.length > 0) {
	        ...
	        _this.props.dispatch((0, _PackageActions.UpdatePackageSchema)(_this.schema));
	      } else {
	        if (_this.form.packageValidity) {
	          _this.form['packageValidity'] = moment(_this.form.packageValidity).endOf('day').utc().toDate();
	        }
	        _this.setState({ activeIcon: event.currentTarget.id });
	        _this.props.dispatch((0, _PackageActions.UpdatePackage)(_this.form, _this.props.params.pid)).then(function (res) {
	    ...
	    _this.setresponse = function (response) {
	      ...
	      if (response.status) {
	        _reactRouter.browserHistory.push('/admin/package/view/' + response.id);
	      } else {
	        _this.setState({ activeIcon: null });
	        _this.refs.package_container.error('' + response.error, '');
	      }
	    };
	
	    _this.view = function () {
	      var packageId = _this.props.params.pid;
	      _reactRouter.browserHistory.push('/admin/package/view/' + packageId);
	    };
	    ...
	    _this.submenu = _Validator2.default.activeSubMenu(_PackageMenu.packageEditSubMenu, "lnkPackage");
	    _this.mainmenu = _PackageMenu.packageEditMainMenu;
	  ...
	  _createClass(EditPackage, [{
	    ...
	    value: function setuserdata(result) {
	      ...
	      if (result && result.data && result.data._id) {
	        ...
	        this.props.dispatch((0, _PackageActions.PackageStore)({ uid: result.data._id }));
	      }
	    }
	  }, {
	    key: 'setdata',
	    value: function setdata(result) {
	      this.props.dispatch((0, _PackageActions.PackageStore)(result.data));
	    }
	    ...
	    value: function render() {
	      var bredcrumb = _jsx('div', {
	        ...
	        onClick: this.view
	      }, void 0, this.props.packageData && this.props.packageData.data ? this.props.packageData.data.packageName : null)), _ref3, _ref4));
	...
	exports.default = (0, _reactRedux.connect)(mapStateToProps)(EditPackage);
