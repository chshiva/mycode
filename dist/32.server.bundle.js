	  ...
	  function CreateCorporate(props) {
	    ...
	    _this.setresponse = function (response) {
	      if (response.status) {
	        ...
	        _this.refs.category_container.error(response.error + ' ', '');
	      }
	    };
	    ...
	    _this.submenu = _Validator2.default.activeSubMenu(_CategoryMenu.categoryEditSubMenu, "lnkNewCategory");
	    _this.mainmenu = _CategoryMenu.categoryEditMainMenu;
	  ...
	  _createClass(CreateCorporate, [{
	    ...
	    value: function setdata(result) {
	      ...
	      if (result && result.data && result.data._id) {
	        ...
	        this.props.dispatch((0, _CategoryActions.UpdateCategorySchema)(this.schema));
	    ...
	    value: function render() {
	      ...
	      return _jsx('div', {}, void 0, _react2.default.createElement(_lib.ToastContainer, {
	        ...
	        data: this.props.categoryData.schema,
