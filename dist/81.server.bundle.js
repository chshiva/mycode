...
/***/ function(module, exports, __webpack_require__) {
	...
	var EditGradeConfiguration = function (_Component) {
	  _inherits(EditGradeConfiguration, _Component);
	
	  function EditGradeConfiguration(props) {
	    _classCallCheck(this, EditGradeConfiguration);
	
	    var _this = _possibleConstructorReturn(this, (EditGradeConfiguration.__proto__ || Object.getPrototypeOf(EditGradeConfiguration)).call(this, props));
	    ...
	    _this.addOption = function (e) {
	      ...
	      var addFieldOption = _this.state.UIArray;
	    ...
	    _this.removeOption = function (index, e) {
	      e.preventDefault();
	      if (_this.state.activeGrid) {
	        var removeFieldOption = _this.state.UIArray;
	        var length = removeFieldOption.length;
	        if (length > 1) {
	          ...
	          _this.refs.questionnaire_container.error('Should have grades for all percentage in range 0 to 100');
	        }
	        _this.setState({
	    ...
	    _this.cancelOption = function (e) {
	      e.preventDefault();
	      _this.setState({
	        activeGrid: false,
	        UIArray: _.cloneDeep(_this.props.questionnaireData.gradeData)
	      });
	    };
	    ...
	    _this.submenu = _Validator2.default.activeSubMenu(_QuestionnaireMenu.questionnaireListSubMenu, "gradeConfiguration");
	  ...
	  _createClass(EditGradeConfiguration, [{
	    ...
	    value: function setdata(result) {
	      ...
	      this.props.dispatch((0, _QuestionnaireActions.getQuestionnaireGradesData)()).then(function (res) {
	        return _this2.setGrades(res);
	      });
	    }
	  }, {
	    key: 'saveGradeConfiguration',
	    value: function saveGradeConfiguration(e) {
	      var _this3 = this;
	
	      e.preventDefault();
	      var gradesArray = this.state.UIArray;
	      var length = gradesArray.length;
	      var count = 0;
	      loop1: for (var index = 0; index < length; index++) {
	        var gradeInfo = gradesArray[index];
	        ...
	        if (gradeInfo.from === '' || gradeInfo.to === '' || gradeInfo.grade === '' || gradeInfo.result === '') {
	          ...
	          var array = _.clone(this.state.UIArray);
	          array.splice(index, 1);
	          var arrayLength = array.length;
	          for (var index2 = 0; index2 < arrayLength; ++index2) {
	            var secondObj = array[index2];
	            if (secondObj.result !== '' && secondObj.grade !== '' && secondObj.from !== '' && secondObj.to !== '') {
	              if (gradeInfo.result == secondObj.result) {
	                ...
	                if (count === 101) {
	                  this.props.dispatch((0, _QuestionnaireActions.saveGrades)(this.state.UIArray)).then(function (res) {
	                    return _this3.setGrades(res);
	                  });
	                } else {
	    ...
	    key: 'handleInputTo',
	    value: function handleInputTo(index, e) {
	      e.preventDefault();
	      var addFieldValue = this.state.UIArray;
	      var length = addFieldValue.length;
	      if (e.target.value != '' && e.target.value <= 100) {
	        var value = parseInt(e.target.value);
	        var findIndex = _.findIndex(addFieldValue, function (o) {
	        ...
	        this.setState({
	          UIArray: _.reverse(_.sortBy(addFieldValue, function (elements) {
	            return elements.to;
	          }))
	        });
	      } else {
	    ...
	    key: 'handleInputFrom',
	    value: function handleInputFrom(index, e) {
	      e.preventDefault();
	      var addFieldValue = this.state.UIArray;
	      var length = addFieldValue.length;
	      if (e.target.value != '' && e.target.value <= 100) {
	    ...
	    key: 'handleInputResult',
	    value: function handleInputResult(index, e) {
	      e.preventDefault();
	      this.state.UIArray[index]['result'] = e.target.value.toUpperCase();
	    }
	  }, {
	    key: 'handleInputGrade',
	    value: function handleInputGrade(index, e) {
	      e.preventDefault();
	    ...
	    value: function render() {
	      ...
	      var cls_flexItem = _Admin2.default.flexItem + ' clearfix';
	      var cls_smalldevice_closebtn = _Admin2.default.actionRightAbs + ' hidden-xs hidden-sm';
	      var cls_flexContainer = _Admin2.default.flexContainer + ' ' + _Admin2.default.headerAdustPd;
	      var cls_largeDevice = _Admin2.default.qgHeader + ' hidden-lg hidden-md';
	      var cls_qgHeader = _Admin2.default.qgHeader + ' hidden-lg hidden-md';
	      var cls_formH5 = _Admin2.default.formH5 + ' hidden-lg hidden-md';
	      var cls_formControl = this.state.activeGrid ? '' + _Admin2.default.editableFormControl : _Admin2.default.editableFormControl + ' ' + _Admin2.default.formControl;
	      var cls_deleteBtn = this.state.activeGrid ? '' + _Admin2.default.closebtn : _Admin2.default.editClosebtn + ' ' + _Admin2.default.closebtn;
	      var cls_btnCancelGrade = ' ' + _Admin2.default.btnCancelGrade + ' ';
	      var cls_btnSaveGrade = ' ' + _Admin2.default.btnSaveGrade + ' ';
	      var cls_blockAddGrade = ' ' + _Admin2.default.blockAddGrade + ' ';
	      var cls_btnAddGrade = ' ' + _Admin2.default.btnAddGrade + ' ';
	
	      var _ref13 = _jsx('h5', {
	        className: cls_formH5
	      }, void 0, 'From');
	      ...
	      return _jsx('div', {}, void 0, _jsx('div', {
	        ...
	        id: 'allQuestionnaire',
	        onClick: this.questionnaireList
	        ...
	        className: _Admin2.default.whiteTile
	      }, void 0, _jsx('div', {
	        className: _Admin2.default.infoTxt
	      }, void 0, _jsx('div', {
	        className: _Admin2.default.headerActionBlock
	      }, void 0, _jsx('div', {
	        className: _Admin2.default.headerTxt
	      }, void 0, _ref5), _jsx('div', {
	        className: _Admin2.default.headerAction
	      }, void 0, _jsx('div', {
	        className: _Admin2.default.actionBtnGroup
	      }, void 0, _jsx('div', {
	        className: _Admin2.default.blockSaveGrade
	      }, void 0, this.state.activeGrid == false ? _jsx('div', {}, void 0, _jsx('a', {
	        href: '#',
	        id: 'gradeManage',
	        className: cls_btnSaveGrade,
	        onClick: this.editOption.bind(this)
	      }, void 0, ' ', _ref6)) : _jsx('div', {}, void 0, _jsx('a', {
	        href: '#',
	        id: 'gradeCancel',
	        className: cls_btnCancelGrade,
	        onClick: this.cancelOption.bind(this)
	      }, void 0, _ref7), _jsx('a', {
	        href: '#',
	        id: 'gradeSave',
	        className: cls_btnSaveGrade,
	        onClick: this.saveGradeConfiguration.bind(this)
	      }, void 0, _ref8))))))), _jsx('form', {
	        className: 'form-inline',
	        role: 'form'
	      }, void 0, _jsx('ul', {
	        className: _Admin2.default.inLine
	      }, void 0, _jsx('li', {
	        className: 'hidden-xs hidden-sm'
	      }, void 0, _jsx('div', {
	        className: cls_flexContainer
	      }, void 0, _jsx('div', {
	        className: cls_flexItem
	      }, void 0, _jsx('h5', {
	        className: _Admin2.default.formH5
	        ...
	        className: _Admin2.default.formH5
	      }, void 0, _ref12)))), this.props && this.props.questionnaireData && this.props.questionnaireData.gradeData && this.props.questionnaireData.gradeData.length > 0 ? this.state.UIArray.map(function (data, i) {
	        var _this4 = this;
	
	        var randomNumber = Math.floor(Math.random(0 - 9) * 1000000000);
	        return _jsx('li', {}, randomNumber, _jsx('div', {
	          className: cls_qgHeader
	        }, void 0, _jsx('div', {
	          ...
	          className: _Admin2.default.flexContainer
	        }, void 0, _jsx('div', {
	          className: cls_flexItem
	        }, void 0, _ref13, _jsx('div', {
	          className: _Admin2.default.formInputBox
	        }, void 0, _react2.default.createElement('input', { type: 'text', className: cls_formControl, id: 'sevenPer', placeholder: 'From Marks', defaultValue: data.from != undefined ? data.from : '', onBlur: this.handleInputFrom.bind(this, i), readOnly: this.state.activeGrid == true ? false : true, ref: function ref(input) {
	            return _this4.myinput = input;
	          }, maxLength: '3' }))), _jsx('div', {
	          className: cls_flexItem
	        }, void 0, _ref14, _jsx('div', {
	          className: _Admin2.default.formInputBox
	        }, void 0, _jsx('input', {
	          type: 'text',
	          className: cls_formControl,
	          id: 'hundPer',
	          placeholder: 'To Marks',
	          defaultValue: data.to != undefined ? data.to : '',
	          onBlur: this.handleInputTo.bind(this, i),
	          readOnly: this.state.activeGrid == true ? false : true,
	          maxLength: '3'
	        }))), _jsx('div', {
	          className: cls_flexItem
	          ...
	          id: 'grade1',
	          placeholder: 'Grade',
	          defaultValue: data.grade != undefined ? data.grade : '',
	          onBlur: this.handleInputGrade.bind(this, i),
	          readOnly: this.state.activeGrid == true ? false : true,
	          maxLength: '4'
	        }))), _jsx('div', {
	          className: cls_flexItem
	          ...
	          id: 'resultsD',
	          placeholder: 'Result',
	          defaultValue: data.result != undefined ? data.result : '',
	          onBlur: this.handleInputResult.bind(this, i),
	          readOnly: this.state.activeGrid == true ? false : true,
	          maxLength: '12'
	        }))), _jsx('div', {
	          className: cls_smalldevice_closebtn
	        }, void 0, _jsx('div', {
	          className: cls_deleteBtn
	        }, void 0, _jsx('span', {}, void 0, _jsx('i', {
	          className: 'fa fa-trash-o',
	      ...
	      }.bind(this)) : null)), this.state.activeGrid ? _jsx('div', {
	        className: cls_blockAddGrade
	      }, void 0, _jsx('a', {
	        href: '#',
	        id: 'addGrade',
	        className: cls_btnAddGrade,
	        onClick: this.addOption.bind(this)
	      }, void 0, this.props.intlData.messages.add_another_field)) : null))));
	    }
	  }]);
	
	  return EditGradeConfiguration;
	}(_react.Component);
	...
	exports.default = (0, _reactRedux.connect)(mapStateToProps)(EditGradeConfiguration);
