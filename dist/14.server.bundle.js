...
/***/ function(module, exports, __webpack_require__) {
	...
	var _ref2 = _jsx('ul', {}, void 0, _jsx('li', {}, void 0, _jsx(_reactRouter.Link, {
	  ...
	  id: 'all_users'
	}))), _jsx('li', {}, void 0, '/'), _jsx('li', {}, void 0, 'Create User'));
	...
	var CreateUser = function (_Component) {
	  ...
	  function CreateUser(props) {
	    ...
	    _this.save = function (event) {
	      ...
	      if (response.error.length > 0) {
	        ...
	        _this.props.dispatch((0, _UsersActions.UpdateUserSchema)(_this.schema));
	      } else {
	        _this.setState({ activeIcon: event.currentTarget.id });
	        var phno = _this.form['profile.phone'];
	        phno.splice(2, 1);
	        _this.form['profile.phone'] = phno;
	        _this.props.dispatch((0, _UsersActions.SaveUser)(_this.form)).then(function (res) {
	    ...
	    _this.setresponse = function (response) {
	      if (response.status) {
	        _reactRouter.browserHistory.push('/admin/users/view/' + response.data._id);
	      } else {
	        _this.setState({ activeIcon: null });
	        _this.refs.user_container.error(response.error + ' ', '');
	      }
	    };
	
	    _this.datareceive = function (data) {
	      if (data.role == _roles.Roles.Student && _this.schema.schemas.other_details.company_info[3]._id !== "studentId" && _this.companyid != '' && _this.companyid != null && _this.companyid == data['profile.companyid']) {
	        var newschema = _this.updateschema(data, _this.schema, null, null);
	        newschema.schemas.other_details.company_info.splice(3, 0, { type: "text", _id: "studentId", text: _ref, datafield: "studentId", exp: "ALPHANUMERIC", error: "" });
	        _this.props.dispatch((0, _UsersActions.UpdateUserSchema)(newschema));
	      } else if (data.role != '' && data.role != _roles.Roles.Student && _this.schema.schemas.other_details.company_info[3]._id == "studentId" && _this.companyid != '' && _this.companyid != null && _this.companyid == data['profile.companyid'] || data.role == "" && _this.schema.schemas.other_details.company_info[3]._id == "studentId" && _this.companyid != '' && _this.companyid != null && _this.companyid == data['profile.companyid']) {
	        var _newschema = _this.updateschema(data, _this.schema, null, null);
	        _newschema.schemas.other_details.company_info.splice(3, 1);
	        delete data["studentId"];
	        _this.props.dispatch((0, _UsersActions.UpdateUserSchema)(_newschema));
	      } else if (_this.companyid != '' && _this.companyid != null && _this.companyid != data['profile.companyid']) {
	        _this.form['roomid'] = '';
	        _this.form['role'] = '';
	        //wrote for cant set state error 
	        var _newschema2 = _this.updateschema(_this.form, _this.schema, null, null);
	        if (_this.schema.schemas.other_details.company_info[3]._id == "studentId") {
	          _newschema2.schemas.other_details.company_info.splice(3, 1);
	        }
	        _this.props.dispatch((0, _UsersActions.UpdateUserSchema)(_newschema2));
	      }
	
	      if (_this.companyid == null) _this.companyid = data['profile.companyid'];
	      if (_this.companyid != null && _this.companyid != data['profile.companyid']) {
	        _this.changeRole(data['profile.companyid']);
	        _this.companyid = data['profile.companyid'];
	      }
	    ...
	    _this.changeRole = function (companyid) {
	      if (companyid != '') {
	        _this.props.dispatch((0, _UsersActions.getRoles)(companyid)).then(function (res) {
	          return _this.setroleres(res);
	        });
	        // this.props.dispatch(getRooms(companyid)).then(res => this.setRooms(res));
	      } else {
	        var options = [['', 'Select Role']];
	        // let roomOptions = [['', 'select_room']];
	        var newschema = _this.updateschema(_this.form, _this.schema, options, 'role');
	        // let schema = this.updateschema(this.form, newschema, roomOptions, 'room');
	        _this.props.dispatch((0, _UsersActions.UpdateUserSchema)(newschema));
	      }
	    };
	
	    _this.setroleres = function (response) {
	      var newschema = _this.updateschema(_this.form, _this.schema, response.data, 'role');
	      _this.props.dispatch((0, _UsersActions.UpdateUserSchema)(newschema));
	    };
	    ...
	    _this.companydata = null;
	    _this.submenu = _Validator2.default.activeSubMenu(_UserMenu.userEditSubMenu, "lnkNewUsers");
	    _this.mainmenu = _UserMenu.userEditMainMenu;
	  ...
	  _createClass(CreateUser, [{
	    ...
	    value: function componentDidMount() {
	      ...
	      this.props.dispatch((0, _UsersActions.GetCompanyData)()).then(function (res) {
	        return _this2.setrespdata(res);
	      });
	    }
	  }, {
	    key: 'componentWillUnmount',
	    value: function componentWillUnmount() {
	      this.props.dispatch((0, _UsersActions.UpdateUserSchema)(null));
	    }
	  }, {
	    key: 'setdata',
	    ...
	    key: 'setrespdata',
	    value: function setrespdata(result) {
	      ...
	      var newschema = this.updateschema(this.form, this.schema, result.data, 'companyid');
	      this.props.dispatch((0, _UsersActions.UpdateUserSchema)(newschema));
	    }
	  }, {
	    key: 'updateschema',
	    value: function updateschema(dataObj, schema, options, id) {
	    ...
	    value: function render() {
	      ...
	      return _jsx('div', {}, void 0, _react2.default.createElement(_lib.ToastContainer, {
	        ...
	        data: this.props.userData.schema,
