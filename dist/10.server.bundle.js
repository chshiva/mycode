...
/***/ function(module, exports, __webpack_require__) {
	...
	var _ref6 = _jsx('li', {}, void 0, _jsx(_reactRouter.Link, {
	  to: '/admin/room/list'
	...
	var ListSubmissions = function (_Component) {
	  _inherits(ListSubmissions, _Component);
	
	  function ListSubmissions(props) {
	    _classCallCheck(this, ListSubmissions);
	
	    var _this = _possibleConstructorReturn(this, (ListSubmissions.__proto__ || Object.getPrototypeOf(ListSubmissions)).call(this, props));
	    ...
	    _this.listAssignments = function () {
	      _reactRouter.browserHistory.push('/admin/room/assignment/submissions/' + _this.props.params.cid + '/' + _this.props.params.aid);
	    };
	    ...
	    _this.submenu = _Validator2.default.activeSubMenu(_RoomMenu.submissionListSubMenu, "linkAssignmentList");
	    _this.mainmenu = _RoomMenu.listSubmissionMainMenu;
	    ...
	    _this.submenu.menus[0].action = _this.backToAssignments.bind(_this);
	    _this.submenu.menus[1].action = _this.listAssignments.bind(_this);
	  ...
	  _createClass(ListSubmissions, [{
	    ...
	    value: function getData(pageParam) {
	      ...
	      this.props.dispatch((0, _RoomActions.assignmentSubmissionList)(pageParam, pageParam.currentPage)).then(function (res) {
	    ...
	    key: 'studentName',
	    value: function studentName(row) {
	      if (row.studentId == null) {
	        return _ref;
	      } else {
	        return _jsx('div', {}, void 0, row.studentId.firstname, ' ', row.studentId.lastname);
	      }
	    }
	  }, {
	    key: 'submittedOn',
	    value: function submittedOn(row) {
	      if (row && row.submittedAt) {
	        var date = (0, _moment2.default)(row.submittedAt).format('DD/MM/YYYY hh:mm A');
	    ...
	    key: 'view',
	    value: function view(row) {
	      var assignmendId = this.props.params.aid;
	    ...
	    key: 'obtainedMarks',
	    value: function obtainedMarks(row) {
	      var marksObtained = 0;
	      var totalMarks = 0;
	    ...
	    value: function render() {
	      ...
	      }, void 0, _jsx('ul', {}, void 0, _ref6, _ref7, _jsx('li', {}, void 0, _jsx(_reactRouter.Link, {
	        onClick: this.viewroom
	      }, void 0, this.props.roomData.data.roomName)), _ref8, _jsx('li', {}, void 0, _jsx(_reactRouter.Link, {
	      ...
	      var objDisp = [{ title: _ref12, type: "function", callback: this.studentName }, { title: _ref13, type: "function", callback: this.submittedOn }, { title: _ref14, type: "function", callback: this.obtainedMarks }, { title: _ref15, type: "function", callback: this.download }, { title: _ref16, type: "function", callback: this.view }];
	...
	exports.default = (0, _reactRedux.connect)(mapStateToProps)(ListSubmissions);
