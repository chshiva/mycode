...
/***/ function(module, exports, __webpack_require__) {
	...
	var EditLocation = function (_Component) {
	  ...
	  function EditLocation(props) {
	    ...
	    _this.cancel = function () {
	      var locationId = _this.props.params.cid;
	    ...
	    _this.schema = _LocationSchema.participantEditLocationSchema;
	    _this.res = {};
	
	    _this.submenu = _Validator2.default.activeSubMenu(_LocationMenu.locationEditSubMenu, "lnkMyLocation");
	    _this.mainmenu = _LocationMenu.locationEditMainMenu;
	  ...
	  _createClass(EditLocation, [{
	    ...
	    value: function setlocationdata(result) {
	      ...
	      if (result && result.data && result.data._id) {
	        ...
	        this.props.dispatch((0, _LocationActions.getLocationData)(locationId, '/admin/location/edit/' + locationId)).then(function (res) {
	          return _this2.setdata(res);
	        });
	        this.props.dispatch((0, _LocationActions.LocationStore)({ uid: result.data._id, _id: locationId }));
	      }
	    }
	  }, {
	    key: 'setdata',
	    value: function setdata(result) {
	      ...
	      this.props.dispatch((0, _LocationActions.LocationStore)(new _DataObject2.default(result.data)));
	    }
	  }, {
	    key: 'datareceive',
	...
	exports.default = (0, _reactRedux.connect)(mapStateToProps)(EditLocation);
