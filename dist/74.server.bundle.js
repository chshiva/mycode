...
/***/ function(module, exports, __webpack_require__) {
	...
	var _ref13 = _jsx('h2', {}, void 0, _jsx(_reactFontawesome2.default, {
		name: 'frown-o'
	}));
	...
	var _ref22 = _jsx('span', {}, void 0, '| ');
	
	var _ref23 = _jsx('h2', {}, void 0, _jsx(_reactFontawesome2.default, {
		name: 'frown-o'
	}));
	...
	var ViewWorkEdu = function (_Component) {
		_inherits(ViewWorkEdu, _Component);
	
		function ViewWorkEdu(props) {
			_classCallCheck(this, ViewWorkEdu);
	
			var _this = _possibleConstructorReturn(this, (ViewWorkEdu.__proto__ || Object.getPrototypeOf(ViewWorkEdu)).call(this, props));
		...
		_createClass(ViewWorkEdu, [{
			...
			value: function render() {
				...
				var submenu = _Validator2.default.activeSubMenu(_UserMenu.userProfileSubMenu, "lnkProfileWorkEdu");
				var profile = this.state.data;
				var workplace = profile && profile.experience && profile.experience.workplace && profile.experience.workplace.length > 0 ? profile.experience.workplace : null;
				var skills = profile && profile.experience && profile.experience.professionalSkills && profile.experience.professionalSkills.length > 0 ? profile.experience.professionalSkills : null;
				var college = profile && profile.education && profile.education.college && profile.education.college.length > 0 ? profile.education.college : null;
				var school = profile && profile.education && profile.education.highSchool ? profile.education.highSchool : null;
				...
				return _jsx('div', {
				...
				}, void 0, _ref6), _jsx('ul', {}, void 0, workplace != null ? workplace.map(function (data) {
					...
					}, void 0, data.company), _jsx('span', {}, void 0, data.position, ' '), _ref8, _jsx('span', {}, void 0, data.yearFrom, ' to ', data.yearTo == null && data.present == true ? "present" : data.yearTo, ' '), _ref9, _jsx('span', {}, void 0, data.city, ', '), _jsx('span', {}, void 0, data.country), _jsx('p', {
						className: _WorkEdu2.default.descriptionTxt
					}, void 0, data.description))));
					...
					className: _WorkEdu2.default.categoryHeading
				}, void 0, _ref12), _jsx('ul', {}, void 0, skills != null ? _jsx('li', {}, void 0, _jsx('div', {
					className: displayInfoBlock
				}, void 0, _jsx('div', {
					className: singleInfoBox
				}, void 0, _jsx('h2', {
					className: _WorkEdu2.default.displayHeadingTxt
				}, void 0, skills.map(function (data, index) {
					return _jsx('div', {
						className: cls_vr
					}, index, _jsx('span', {
						className: cls_email
					...
					className: _WorkEdu2.default.categoryHeading
				}, void 0, _ref15), _jsx('ul', {}, void 0, college != null ? college.map(function (data) {
					return _jsx('li', {}, data._id, _jsx('div', {
						className: displayInfoBlock
						...
						className: _WorkEdu2.default.displayHeadingTxt
					}, void 0, data.university), _jsx('span', {}, void 0, data.yearFrom, ' to ', data.yearTo, ' '), _ref17, _jsx('span', {}, void 0, data.city, ', '), _jsx('span', {}, void 0, data.country), _jsx('p', {
						className: _WorkEdu2.default.descriptionTxt
					}, void 0, data.description))));
				}) : _jsx('li', {}, void 0, _jsx(_reactBootstrap.Row, {}, void 0, _jsx('div', {
					className: _component2.default.whiteCard
					...
					className: _WorkEdu2.default.categoryHeading
				}, void 0, _ref20), _jsx('ul', {}, void 0, school != null ? _jsx('li', {}, void 0, _jsx('div', {
					className: displayInfoBlock
				}, void 0, _jsx('div', {
					className: iconBox
					...
					className: _WorkEdu2.default.displayHeadingTxt
				}, void 0, school.school), _jsx('span', {}, void 0, school.yearFrom, ' to ', school.yearTo, ' '), _ref22, _jsx('span', {}, void 0, school.city, ', '), _jsx('span', {}, void 0, school.country), _jsx('p', {
					className: _WorkEdu2.default.descriptionTxt
				}, void 0, school.description)))) : _jsx('li', {}, void 0, _jsx(_reactBootstrap.Row, {}, void 0, _jsx('div', {
					className: _component2.default.whiteCard
				}, void 0, _jsx('div', {
					className: _DataTable2.default.noDataBox
	...
	exports.default = (0, _reactRedux.connect)(mapStateToProps)(ViewWorkEdu);
