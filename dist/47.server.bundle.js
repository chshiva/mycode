...
/***/ function(module, exports, __webpack_require__) {
	...
	var _ref7 = _jsx(_TopMenu2.default, {
	  data: _RoomMenu.roomEditTopicNewMainMenu
	});
	...
	var ViewRoomTopic = function (_Component) {
	  _inherits(ViewRoomTopic, _Component);
	
	  function ViewRoomTopic(props) {
	    _classCallCheck(this, ViewRoomTopic);
	
	    var _this = _possibleConstructorReturn(this, (ViewRoomTopic.__proto__ || Object.getPrototypeOf(ViewRoomTopic)).call(this, props));
	  ...
	  _createClass(ViewRoomTopic, [{
	    key: 'componentDidMount',
	    value: function componentDidMount() {
	      this.quill = new Quill(_reactDom2.default.findDOMNode(this.refs.editor), {
	        modules: {
	          toolbar: [[{ 'header': [1, 2, 3, 4, 5, 6, false] }], ['bold', 'italic', 'underline', 'link' /*, 'video'*/, 'videoURL'], ['image', 'code-block'], ['formula'], [{ 'size': ['small', false, 'large', 'huge'] }], [{ 'list': 'ordered' }, { 'list': 'bullet' }], [{ 'script': 'sub' }, { 'script': 'super' }], [{ 'color': [] }, { 'background': [] }], [{ 'align': [] }]],
	          formula: true
	        },
	    ...
	    value: function setdata(result) {
	      ...
	      if (result && result.data && result.data._id) {
	        ...
	        this.props.dispatch((0, _RoomActions.getRoomTopicData)(obj, '/admin/room/viewtopic/' + topicId + '/' + roomId));
	    ...
	    value: function save() {
	      ...
	      this.props.dispatch((0, _RoomActions.SaveEditorContent)(obj)).then(function (res) {
	        return _this2.setResponse(res, topicId);
	      });
	    }
	  }, {
	    key: 'setResponse',
	    value: function setResponse(res, id) {
	    ...
	    value: function render() {
	      ...
	      var topicTitle = this.props.roomData && this.props.roomData.topicdata && this.props.roomData.topicdata.topicName ? this.props.roomData.topicdata.topicName : '';
	      ...
	      var cls_formcontent = ' ' + _component2.default.heightForScroll + ' ';
	      ...
	      return _jsx('div', {
	        ...
	        className: ''
	      }, void 0, _ref, ': ', topicTitle), _jsx('div', {
	        ...
	        className: _component2.default.innerWhiteTopic
	      }, void 0, _react2.default.createElement('div', { ref: 'editor', className: cls_formcontent })))));
	    }
	  }]);
	
	  return ViewRoomTopic;
	}(_react.Component);
	...
	exports.default = (0, _reactRedux.connect)(mapStateToProps)(ViewRoomTopic);
