...
/***/ function(module, exports, __webpack_require__) {
	...
	var _SearchStudentPopup = __webpack_require__(462);
	
	var _SearchStudentPopup2 = _interopRequireDefault(_SearchStudentPopup);
	
	var _ListStudentToRoom = __webpack_require__(458);
	
	var _ListStudentToRoom2 = _interopRequireDefault(_ListStudentToRoom);
	...
	var AddStudent = function (_Component) {
	  ...
	  function AddStudent(props) {
	    ...
	    _this.submenu = _RoomMenu.addUserSubMenu;
	    _this.mainmenu = _RoomMenu.addStudentMainMenu;
	    _this.mainmenu.menus[0].action = _this.showOrHideAddContacts.bind(_this);
	    _this.submenu.menus[0].action = _this.backToRoom.bind(_this);
	    // this.dataObj = null;
	    _this.state = {
	      showAddContacts: false,
	      dataObj: {
	        roomId: _this.props.params.rid,
	        instId: _this.props.params.iid
	      }
	    };
	    return _this;
	  }
	  ...
	  _createClass(AddStudent, [{
	    ...
	    value: function setdata(result) {
	      if (result && result.data && result.data._id) {
	        ...
	        this.props.dispatch((0, _RoomActions.getRoomData)(this.state.dataObj, ''));
	      }
	    }
	  }, {
	    ...
	    key: 'handleValue',
	    value: function handleValue(toBeAddedId, addUserType) {
	      var _this2 = this;
	
	      var roomId = this.props.params.rid;
	      var instId = this.props.params.iid;
	
	      if (addUserType == 'GROUP') {
	        var groupId = toBeAddedId;
	        this.props.dispatch((0, _RoomActions.addGroupStudentRequest)({ roomId: roomId, instId: instId, groupId: groupId })).then(function (res) {
	          return _this2.setresponse(res);
	        });
	      } else if (addUserType == 'INDIVIDUAL USER') {
	        var userId = toBeAddedId;
	        this.props.dispatch((0, _RoomActions.addRoomStudent)({ roomId: roomId, instId: instId, userId: userId })).then(function (res) {
	          return _this2.setresponse(res);
	        });
	      }
	    }
	    ...
	    value: function render() {
	      ...
	      }, void 0, _ref5)), _ref6, _ref7)), _jsx(_TopMenu2.default, {
	        data: this.mainmenu
	      })), _jsx('div', {
	        className: cls_isubmenu
	      }, void 0, _jsx(_SubMenu2.default, {
	        data: this.submenu
	      })), _jsx(_SearchStudentPopup2.default, {
	      ...
	      }), _jsx(_ListStudentToRoom2.default, {
	        dataObj: this.state.dataObj
	      }));
	    }
	  }]);
	...
	exports.default = (0, _reactRedux.connect)(mapStateToProps)(AddStudent);
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.ListGroupItems = undefined;
	...
	var ListGroupItems = exports.ListGroupItems = function (_Component) {
	  _inherits(ListGroupItems, _Component);
	
	  function ListGroupItems(props) {
	    _classCallCheck(this, ListGroupItems);
	
	    var _this = _possibleConstructorReturn(this, (ListGroupItems.__proto__ || Object.getPrototypeOf(ListGroupItems)).call(this, props));
	  ...
	  _createClass(ListGroupItems, [{
	    ...
	    key: 'sendUserId',
	    value: function sendUserId(listItem, e) {
	      var groupId = e.target.id;
	      var groupName = listItem.groupName;
	    ...
	    value: function render() {
	      ...
	      if (this.props && this.props.value) {
	        ...
	        var btnRemoveUser = null;
	        if (userRole == _roles.Roles.Superadmin || userRole == _roles.Roles.Admin || userRole == _roles.Roles.Lmsadmin || userRole == _roles.Roles.Instructor || userRole == _roles.Roles.Presenteradmin || userRole == _roles.Roles.Attendee) {
	          btnRemoveUser = _jsx('div', {
	            className: _Admin2.default.userAction,
	            title: this.props.classTitle
	          }, void 0, _jsx(_reactFontawesome2.default, {
	            name: this.props.classname,
	            id: listItem._id,
	            onClick: this.sendUserId.bind(this, listItem)
	          }));
	        }
	        return _jsx('li', {}, void 0, _jsx(_reactRouter.Link, {
	          className: 'clearfix'
	          ...
	          className: 'pull-left'
	        }, void 0, listItem.groupName ? listItem.groupName : "-"), btnAddStudent, btnRemoveUser));
	      }
	    }
	  }]);
	...
	// export default ListItem;
	exports.default = (0, _reactRedux.connect)(mapStateToProps)((0, _reactIntl.injectIntl)(ListGroupItems));
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.ListStudentToRoom = undefined;
	...
	var ListStudentToRoom = exports.ListStudentToRoom = function (_Component) {
	  _inherits(ListStudentToRoom, _Component);
	
	  function ListStudentToRoom(props) {
	    _classCallCheck(this, ListStudentToRoom);
	
	    var _this = _possibleConstructorReturn(this, (ListStudentToRoom.__proto__ || Object.getPrototypeOf(ListStudentToRoom)).call(this, props));
	  ...
	  _createClass(ListStudentToRoom, [{
	    key: 'componentDidMount',
	    value: function componentDidMount() {
	      this.setdata(this.props.loggedInData);
	    }
	    ...
	    value: function setdata(response) {
	      if (response && response.data && response.data._id) {
	        if (this.props && this.props.dataObj && this.props.dataObj.roomId && this.props.dataObj.instId) {
	          ...
	          // console.log(obj);
	          this.props.dispatch((0, _RoomActions.getStudentData)({ roomId: roomId, instId: instId }));
	        }
	      }
	    }
	  }, {
	    key: 'removeUser',
	    value: function removeUser(studId) {
	      var _this2 = this;
	
	      var roomId = this.props.studentData.data.roomId._id;
	      var instId = this.props.studentData.data.instId._id;
	      this.props.dispatch((0, _RoomActions.removeRoomStud)({ roomId: roomId, instId: instId, studId: studId })).then(function (res) {
	        return _this2.setresponse(res);
	      });
	    }
	  }, {
	    ...
	    value: function render() {
	      ...
	      var studData = this.props.studentData;
	      ...
	      if (studData && studData.data && studData.data.roomId && studData.data.instId) {
	        if (studData.data.students && studData.data.students.length > 0) {
	          var roomUsers = studData.data.students;
	          var roomId = studData.data.roomId._id;
	      ...
	      }, void 0, _ref2, ' - ', _jsx('b', {}, void 0, roomName)), _jsx('h2', {
	        className: _Admin2.default.headingTxt
	      }, void 0, _ref3, ' - ', _jsx('b', {}, void 0, instName))), _jsx('div', {
	...
	function mapStateToProps(state) {
	  return {
	    studentData: (0, _StudentReducer.studentData)(state),
	    loggedInData: (0, _LoginReducer.loggedInData)(state),
	    roomData: (0, _RoomReducer.roomData)(state),
	    intl: state.intl
	  };
	...
	exports.default = (0, _reactRedux.connect)(mapStateToProps)((0, _reactIntl.injectIntl)(ListStudentToRoom));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _ListGroupItems = __webpack_require__(456);
	
	var _ListGroupItems2 = _interopRequireDefault(_ListGroupItems);
	...
	var _ref4 = _jsx('p', {}, void 0, 'Select add user type:');
	...
	var SearchStudentPopup = function (_Component) {
	  _inherits(SearchStudentPopup, _Component);
	
	  function SearchStudentPopup(props) {
	    _classCallCheck(this, SearchStudentPopup);
	
	    var _this = _possibleConstructorReturn(this, (SearchStudentPopup.__proto__ || Object.getPrototypeOf(SearchStudentPopup)).call(this, props));
	  ...
	  _createClass(SearchStudentPopup, [{
	    key: 'componentDidMount',
	    value: function componentDidMount() {
	    ...
	    value: function searchUsers(e) {
	      ...
	      var query = "roomId=" + dataObj.roomId + "&instId=" + dataObj.instId + "&input=" + e.target.value;
	      this.setState({ inputValue: e.target.value.trim() });
	      if (this.state.selectedAddUserType == 'GROUP' && e.target.value.trim() != "") {
	        (0, _apiCaller2.default)('searchgroups?' + query, 'get').then(function (res) {
	          return _this2.myStudents(res);
	        });
	      } else if (this.state.selectedAddUserType == 'INDIVIDUAL USER' && e.target.value.trim() != "") {
	        (0, _apiCaller2.default)('searchstudents?' + query, 'get').then(function (res) {
	          return _this2.myStudents(res);
	        });
	      } else {
	    ...
	    key: 'submittedAddUserType',
	    value: function submittedAddUserType(e) {
	      var addUserTypeValue = e.target.value;
	      this.setState({
	    ...
	    value: function render() {
	      ...
	      var listUsers = this.state.myStudentsData && this.state.myStudentsData.length <= 0 ? this.state.selectedAddUserType == 'INDIVIDUAL USER' ? _ref : _ref2 : null;
	      if (this.props) {
	        dataObject = this.props;
	        // console.log(dataObject);
	      }
	      if (this.state.myStudentsData && this.state.myStudentsData.length > 0) {
	        var usersData = this.state.myStudentsData;
	        if (this.state.selectedAddUserType == 'INDIVIDUAL USER') {
	          listUsers = usersData.map(function (userData) {
	            return _jsx(_ListItem.ListItem, {
	              ...
	              classname: 'plus',
	              classTitle: _this3.props.intl.messages.add_student,
	              intl: _this3.props.intl
	            }, userData._id);
	          });
	        } else if (this.state.selectedAddUserType == 'GROUP') {
	          listUsers = usersData.map(function (userData) {
	            return _jsx(_ListGroupItems2.default, {
	              value: userData,
	              getUserId: _this3.sendUserId.bind(_this3),
	              loggedInData: _this3.props.loggedInData,
	              classname: 'plus',
	      ...
	      return _jsx(_reactBootstrap.Modal, {
	      ...
	      }, void 0, _ref3)), _jsx(_Modal.Body, {}, void 0, _jsx('div', {
	        className: _Admin2.default.addStudPop1
	      }, void 0, _ref4), _jsx('div', {
	        className: _Admin2.default.addStudPop2
	      }, void 0, _jsx('input', {
	        type: 'radio',
	        value: 'INDIVIDUAL USER',
	        checked: this.state.selectedAddUserType == 'INDIVIDUAL USER',
	        onChange: this.submittedAddUserType.bind(this)
	      }), _jsx('span', {
	        className: _Admin2.default.addStudText
	      }, void 0, ' ', _ref5), _jsx('input', {
	        className: _Admin2.default.addStudInput,
	        type: 'radio',
	        value: 'GROUP',
	        checked: this.state.selectedAddUserType == 'GROUP',
	        onChange: this.submittedAddUserType.bind(this)
	      }), _jsx('span', {
	        className: _Admin2.default.addStudText
	      }, void 0, ' ', _ref6)), this.state.selectedAddUserType != "" ? _jsx('div', {}, void 0, _jsx('div', {
	        className: _Admin2.default.searchBox
	      }, void 0, _jsx('form', {}, void 0, _jsx('input', {
	        type: 'search',
	        name: 'search',
	        placeholder: this.state.selectedAddUserType == 'INDIVIDUAL USER' ? this.context.intl.messages.add_contacts : this.context.intl.messages.add_groups,
	        ...
	        className: _Admin2.default.userListGroup
	      }, void 0, _jsx('ul', {}, void 0, listUsers))))))) : null));
	    }
	  }]);
	
	  return SearchStudentPopup;
	}(_react.Component);
	...
	exports.default = (0, _reactRedux.connect)(mapStateToProps)((0, _reactIntl.injectIntl)(SearchStudentPopup));
