...
/***/ function(module, exports, __webpack_require__) {
	...
	var _ref = _jsx(_reactIntl.FormattedMessage, {
	  id: 'questionnaire_name_error'
	});
	
	var _ref2 = _jsx(_reactIntl.FormattedMessage, {
	  id: 'questionnaire_description_error'
	});
	...
	var _ref4 = _jsx('li', {}, void 0, _jsx(_reactRouter.Link, {
	...
	var _ref9 = _jsx('h2', {}, void 0, _jsx('i', {
	  ...
	  'aria-hidden': 'true'
	}), '\xA0', _jsx(_reactIntl.FormattedMessage, {
	...
	var _ref11 = _jsx('h2', {}, void 0, _jsx('i', {
	  className: '',
	  'aria-hidden': 'true'
	}), '\xA0');
	...
	var _ref13 = _jsx('div', {}, void 0, 'Loading...');
	
	var EditQuestionnaire = function (_Component) {
	  _inherits(EditQuestionnaire, _Component);
	
	  function EditQuestionnaire(props) {
	    _classCallCheck(this, EditQuestionnaire);
	
	    var _this = _possibleConstructorReturn(this, (EditQuestionnaire.__proto__ || Object.getPrototypeOf(EditQuestionnaire)).call(this, props));
	
	    _this.save = function () {
	
	      var errors = {};
	      if (_this.state.questionnaireName == "") {
	        errors['nameError'] = _ref;
	      }
	      if (_this.state.description == "") {
	        errors['descriptionError'] = _ref2;
	      }
	
	      if (_this.state.qId == "" && _this.state.isChecked == true) {
	        errors['selectQidError'] = _ref3;
	      }
	      ...
	      if (!_.isEmpty(errors)) {
	        ...
	        _this.form['_id'] = _this.props.params.cid;
	        _this.form['description'] = _this.state.description;
	        _this.form['questionnaireName'] = _this.state.questionnaireName;
	
	        if (_this.state.qId != "") {
	          _this.form['qId'] = _this.state.qId;
	        }
	        _this.props.dispatch((0, _QuestionnaireActions.updateQuestionnaireRequest)(_this.form)).then(function (res) {
	    ...
	    _this.setresponse = function (response) {
	      ...
	      if (response.status) {
	        _reactRouter.browserHistory.push('/admin/questionnaire/view/' + response.data._id);
	      } else {
	        if (response.error[0] == 409 && response.openFrom != undefined) {
	          _this.refs.questionnaire_container.error("Can't Edit: Already questionnaire is assigned from " + (0, _moment2.default)(response.openFrom).format("DD/MM/YYYY hh:mm A") + " " + "to" + " " + (0, _moment2.default)(response.closeFrom).format("DD/MM/YYYY hh:mm A"));
	          _this.form["_id"] = _this.props.params.cid;
	        } else if (response.error[0] == 409 && response.openFrom == undefined) {
	          _this.refs.questionnaire_container.error("Can't Edit: Already questionnaire is assigned");
	        } else {
	    ...
	    _this.schema = _QuestionnaireSchema.editQuestionnaireSchema;
	    _this.res = {};
	    _this.mainmenu = _QuestionnaireMenu.questionnaireEditMainMenu;
	    _this.submenu = _Validator2.default.activeSubMenu(_QuestionnaireMenu.questionnaireEditSubMenu, "lnkViewQuestionnaire");
	  ...
	  _createClass(EditQuestionnaire, [{
	    ...
	    value: function setuserdata(result) {
	      ...
	      if (result && result.data && result.data._id) {
	        ...
	        this.props.dispatch((0, _QuestionnaireActions.getQuestionnaireData)(obj, '/admin/questionnaire/edit/' + obj.questionnaireId)).then(function (res) {
	          return _this2.setdata(res);
	        });
	        this.props.dispatch((0, _QuestionnaireActions.QuestionnaireStore)({ uid: result.data._id }));
	        this.props.dispatch((0, _QuestionnaireActions.fetchQuestionnaire)(this.props.params.cid));
	      }
	    }
	  }, {
	    key: 'setdata',
	    value: function setdata(result) {
	      if (result && result.data && result.data._id) {
	        this.props.dispatch((0, _QuestionnaireActions.QuestionnaireStore)(new _DataObject2.default(result.data)));
	    ...
	    value: function handleQuestionnaire(e) {
	      e.preventDefault();
	      this.setState({
	        qId: e.target.value
	      });
	    ...
	    value: function render() {
	      ...
	      }, void 0, _jsx('ul', {}, void 0, _ref4, _ref5, _jsx('li', {}, void 0, _jsx(_reactRouter.Link, {
	        onClick: this.viewQuestionnaire
	      }, void 0, this.props.questionnaireData && this.props.questionnaireData.data ? this.props.questionnaireData.data.questionnaireName : null)), _ref6, _ref7));
	      ...
	      */
	      ...
	      var cls_group = _component2.default.iFormGroup + ' ' + _component2.default.oFormGroup;
	      var cls_fg = _component2.default.iSubFormGroup + ' ' + _component2.default.oSubFormGroup;
	      var cls_element = _component2.default.iElement + ' ' + _component2.default.oElement;
	      var cls_error_element = _component2.default.iElement + ' ' + _component2.default.oElement + ' ' + _component2.default.errorclass;
	      ...
	      if (this.props.questionnaireData && this.props.questionnaireData.data) {
	        ...
	        return _jsx('div', {
	        ...
	        }, void 0, _ref8, _jsx('div', {}, void 0, _jsx('div', {}, void 0, bredcrumb)), _jsx(_TopMenu2.default, {
	          data: this.mainmenu,
	          activeIcon: null
	        })), _jsx('div', {
	          ...
	          fluid: true
	        }, void 0, _jsx(_reactBootstrap.Row, {}, void 0, _jsx('form', {
	          id: 'AddQuestionnaire'
	        }, void 0, _jsx('div', {
	          className: 'col-md-6'
	        }, void 0, _jsx('div', {
	          ...
	          className: cls
	        }, void 0, _jsx('formfield', {}, void 0, _jsx(_Label2.default, {
	          data: { text: _ref10 },
	          required: true
	        }), _react2.default.createElement('input', { id: 'questionnaire_name', ref: 'questionnari_name', type: 'text',
	          ...
	          maxLength: 250 }), _jsx('label', {
	          id: 'questionnaireNameError',
	          className: errcls
	        }, void 0, this.state.validationError && this.state.validationError.nameError ? this.state.validationError.nameError : ''))), _jsx('div', {
	          className: cls
	        }, void 0, _jsx('formfield', {}, void 0, _jsx('input', {
	          type: 'checkbox',
	          onChange: this.handleToggleChange.bind(this),
	          checked: this.state.isChecked
	        }), '\xA0', this.props.intlData.messages.clone_from_previoues_questionnaire)), this.state.isChecked == true ? _jsx('div', {
	          className: cls
	        }, void 0, _jsx('formfield', {}, void 0, _jsx('select', {
	          id: 'selectQuestionnaire',
	          className: this.state.validationError && this.state.validationError.selectQidError ? cls_error_element : cls_element,
	          onChange: this.handleQuestionnaire.bind(this)
	        }, void 0, this.props.questionnaireData && this.props.questionnaireData.questionnaireCloneData && this.props.questionnaireData.questionnaireCloneData.length > 0 ? this.props.questionnaireData.questionnaireCloneData.map(function (data, i) {
	          return _jsx('option', {
	            value: data[0]
	          }, i, ' ', data[1], ' ');
	        }) : null), _jsx('label', {
	          id: 'questionnaireDropdownError',
	          className: errcls
	        }, void 0, this.state.isChecked && this.state.validationError && this.state.validationError.selectQidError ? this.state.validationError.selectQidError : ''))) : null))), _jsx('div', {
	          className: 'col-md-6'
	        }, void 0, _jsx('div', {
	          className: cls_group
	          ...
	          data: { text: _ref12 },
	          required: true
	        }), _react2.default.createElement('textarea', { id: 'Description', ref: 'description',
	          ...
	          id: 'DescriptionError',
	          className: errcls
	        }, void 0, this.state.validationError && this.state.validationError.descriptionError ? this.state.validationError.descriptionError : ''))))))))))));
	      } else {
	        return _ref13;
	      }
	    }
	...
	exports.default = (0, _reactRedux.connect)(mapStateToProps)(EditQuestionnaire);
