...
/***/ function(module, exports, __webpack_require__) {
	...
	var _ref10 = _jsx('div', {}, void 0, _jsx(_reactIntl.FormattedMessage, {
	  id: 'no_locations_yet'
	}));
	...
	var ListRoomLocation = function (_Component) {
	  ...
	  function ListRoomLocation(props) {
	    ...
	    _this.mainmenu = _RoomMenu.roomLocationMainMenu;
	    _this.mainmenu.menus[0].action = _this.addlocation.bind(_this);
	
	    /* default set submenu without topic */
	    _this.submenu = _Validator2.default.activeSubMenu(_RoomMenu.roomNoTopicSubMenu, "lnkLocation");
	    _this.submenu.menus[0].action = _this.viewroom.bind(_this);
	    _this.submenu.menus[1].action = _this.adduser.bind(_this);
	    _this.submenu.menus[2].action = _this.feedback.bind(_this);
	  ...
	  _createClass(ListRoomLocation, [{
	    ...
	    value: function componentWillReceiveProps(nextProps) {
	      ...
	      if (nextProps.roomData.success != '') {
	        ...
	        this.props.dispatch((0, _RoomActions.getRoomLocations)(roomId)).then(function (result) {
	          if (result) {
	            _this2.refs.room_container.success(nextProps.roomData.success + ' ', '');
	            _this2.props.dispatch((0, _RoomActions.ClearRoom)());
	          }
	        });
	      }
	    }
	    ...
	    value: function setdata(result) {
	      ...
	      this.props.dispatch((0, _IntlActions.loginLanguage)(result.data, this.props.intl.setlocale));
	      ...
	      this.props.dispatch((0, _RoomActions.getRoomLocations)(roomId)).then(function (res) {
	    ...
	    value: function addlocation() {
	      var roomId = this.props.params.cid;
	      _reactRouter.browserHistory.push('/admin/room/addlocation/new/' + roomId);
	    }
	  }, {
	    key: 'deleteLocation',
	    value: function deleteLocation(locationId) {
	      var roomLocationId = locationId;
	      var roomId = this.props.params.cid;
	      var uid = this.props.loggedInData.data._id;
	      this.props.dispatch((0, _RoomActions.deleteRoomLocation)({ roomLocationId: roomLocationId, roomId: roomId }));
	    }
	  }, {
	    key: 'roleName',
	    ...
	    key: 'deleteLocationParticipant',
	    value: function deleteLocationParticipant(participantId, locationId) {
	      var uid = this.props.loggedInData.data._id;
	      var roomId = this.props.params.cid;
	      var roomLocationId = locationId;
	      var roomParticipantId = participantId;
	      this.props.dispatch((0, _RoomActions.deleteRoomLocationParticipant)({ roomId: roomId, roomLocationId: roomLocationId, roomParticipantId: roomParticipantId }));
	    }
	  }, {
	    key: 'viewUser',
	    ...
	    value: function render() {
	      ...
	      if (this.props.roomData && this.props.roomData.data && !_.isEmpty(this.props.roomData.data)) {
	        ...
	        if (_roomData.selPackage && _roomData.selPackage.features.indexOf("Topics") != -1) {
	          this.submenu = _Validator2.default.activeSubMenu(_RoomMenu.roomEditSubMenu, "lnkLocation");
	      ...
	      return _jsx('div', {}, void 0, _jsx('div', {
	      ...
	      }, void 0, this.props.roomData.data.roomName)), _ref4, _ref5)), _jsx(_TopMenu2.default, {
	        data: this.mainmenu
	      })), _jsx('div', {
	      ...
	      }, void 0, _ref6))), _jsx(_reactBootstrap.Row, {}, void 0, _jsx(_reactBootstrap.Col, {
	        md: 12
	      }, void 0, this.props.roomData && this.props.roomData.roomLocationList && this.props.roomData.roomLocationList.locations.length > 0 ? this.props.roomData.roomLocationList.locations.map(function (roomLocationData) {
	        ...
	        return _jsx('div', {
	          ...
	          className: _Admin2.default.locationContainer
	        }, void 0, _jsx('div', {
	          className: _Admin2.default.locationHeader
	        }, void 0, _jsx('h2', {}, void 0, roomLocationData.locationId.locationName), _this4.props.loggedInData.data.role == 1 ? null : _jsx('span', {
	          className: _Admin2.default.deleteLocation,
	          title: _this4.props.intl.messages.delete_this_location,
	          onClick: _this4.deleteLocation.bind(_this4, locationId)
	        }, void 0, _ref7)), _jsx('div', {
	          className: _Admin2.default.locationBody
	        }, void 0, _jsx('ul', {
	          className: 'clearfix'
	        }, void 0, roomLocationData.locationParticipants.map(function (participantsData) {
	          var imgSrc = '';
	          ...
	          return _jsx('li', {}, participantsData._id, _jsx('img', {
	            src: imgSrc,
	            onClick: _this4.viewUser.bind(_this4, participantsData._id),
	            title: _this4.props.intl.messages.viewprofile
	          }), _jsx('h3', {}, void 0, _jsx('span', {
	            className: _Admin2.default.viewUserCurser,
	            onClick: _this4.viewUser.bind(_this4, participantsData._id),
	            title: _this4.props.intl.messages.viewprofile
	          }, void 0, participantsData.firstname, '  ', participantsData.lastname), _jsx('p', {}, void 0, _this4.roleName(participantsData)), _this4.props.loggedInData.data.role == 1 ? null : _jsx('p', {
	            className: _Admin2.default.remove,
	            onClick: _this4.deleteLocationParticipant.bind(_this4, participantId, locationId)
	          }, void 0, _ref8, ' ', _ref9)));
	        })))));
	      }) : _ref10)))))));
	    }
