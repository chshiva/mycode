...
class PatientHeaderContainer extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      anchorEl: null,
  ...
  profile(e) {
    console.log("Redirect To Patient Profile");
    e.preventDefault();
      ...
      <div>
        <AppBar position="fixed">
          <Toolbar>
            ...
            <Menu id="simple-menu" anchorEl={this.state.anchorEl} open={this.state.open} onClose={this.menuClose} className="dropdDown" >
...
export default connect(mapStateToProps, mapDispatchToProps)(PatientHeaderContainer);