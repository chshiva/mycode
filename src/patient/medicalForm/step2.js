...
class Step2 extends Component {
  ...
  handleSubmitStep(e) {
    ...
    if (this.state.streetname == "") formErrorMessage = "Street Name Should Not be Empty";
    if (this.state.appartmentname == "") formErrorMessage = "Appartment Name Should Not be Empty";
    if (this.state.area == "") formErrorMessage = "Area Should Not be Empty";
    if (this.state.cityid == "") formErrorMessage = "City Should Not be Empty";
    if (this.state.stateid == "") formErrorMessage = "State Should Not be Empty";
    if (this.state.countryid == "") formErrorMessage = "Country Should Not be Empty";
