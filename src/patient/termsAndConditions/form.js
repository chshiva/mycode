        ...
        <div>
            <AppBar position="fixed">
                <Toolbar>
                    ...
                    <Typography type="title" color="inherit" className="appTytle">Terms &amp; Conditions</Typography>
                </Toolbar>
            </AppBar>
                ...
                <div className="termsPanel">
                    <div className="loginFormPanel">
                        ...
                        {/*<div className="formBlock">
                            <div className="errorBox">Please enter a vaild Email address</div>
                            <form method="post" onSubmit={handleSubmit(onSubmit)}>
                                <TextField id="firstName" type="text" name="firstName" label="First Name" className="overwriteLabel" fullWidth />
                                <br />
                                <TextField id="lastName" type="text" name="lastName" label="Last Name" className="overwriteLabel" fullWidth />
                                <br />
                                <div className="checkTerms">
                                    <Checkbox />
                                    <p className="pTxt">I agree to the <Link to={'/terms'} className="termsTxt" >Terms &amp; Conditions </Link></p>
                                </div>
                                <div className="btnDiv">
                                    <Button id="signinBtn" raised color="primary" className="button" type="submit">Submit</Button>
                                </div>
                            </form>
                        </div>*/}
                    </div>
...
export default connect(mapStateToProps)(withStyles(styles)(TermsAgreement));